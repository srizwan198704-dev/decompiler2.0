...
.method public static ˊ(Landroid/accounts/Account;Ljava/util/ArrayList;[Ljava/lang/String;ZLjava/lang/String;Ljava/lang/String;[Ljava/lang/String;Landroid/os/Bundle;)Landroid/content/Intent;
    ...
    invoke-static {v1, v2}, Lvi5;->ˊ(ZLjava/lang/Object;)V
...
.method public static ॱ(Lϳ$ᐨ;)Landroid/content/Intent;
    .locals 4
    .param p0    # Lϳ$ᐨ;
        .annotation build Landroidx/annotation/RecentlyNonNull;
        .end annotation
    ...
    invoke-static {p0}, Lϳ$ᐨ;->ˏ(Lϳ$ᐨ;)Z

    invoke-static {p0}, Lϳ$ᐨ;->ॱॱ(Lϳ$ᐨ;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lϳ$ᐨ;->ʽ(Lϳ$ᐨ;)Ljava/util/ArrayList;
    ...
    invoke-static {p0}, Lϳ$ᐨ;->ˊॱ(Lϳ$ᐨ;)Ljava/util/ArrayList;
    ...
    :cond_0
    invoke-static {p0}, Lϳ$ᐨ;->ˋॱ(Lϳ$ᐨ;)Landroid/os/Bundle;
    ...
    invoke-static {p0}, Lϳ$ᐨ;->ˏॱ(Lϳ$ᐨ;)Landroid/accounts/Account;
    ...
    invoke-static {p0}, Lϳ$ᐨ;->ͺ(Lϳ$ᐨ;)Z
    ...
    invoke-static {p0}, Lϳ$ᐨ;->ॱˊ(Lϳ$ᐨ;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lϳ$ᐨ;->ॱˋ(Lϳ$ᐨ;)Z

    const-string v1, "setGmsCoreAccount"

    invoke-virtual {v0, v1, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    invoke-static {p0}, Lϳ$ᐨ;->ॱˎ(Lϳ$ᐨ;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lϳ$ᐨ;->ʼ(Lϳ$ᐨ;)I
    ...
    invoke-static {p0}, Lϳ$ᐨ;->ॱᐝ(Lϳ$ᐨ;)Z

    invoke-static {p0}, Lϳ$ᐨ;->ᐝॱ(Lϳ$ᐨ;)Z
