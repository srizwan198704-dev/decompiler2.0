...
.method public constructor <init>(Landroid/hardware/camera2/CameraManager;Ljava/lang/String;ZI)V
    ...
    invoke-virtual {v0, v6}, Lys;->ᐝ(I)Lrw1;

    move-result-object v6

    if-eqz v6, :cond_0

    iget-object v7, p0, Lyt;->ˊ:Ljava/util/Set;
    ...
    invoke-virtual {v0, v5}, Lys;->ʽ(I)Lkr8;

    move-result-object v5

    if-eqz v5, :cond_2

    iget-object v6, p0, Lyt;->ॱ:Ljava/util/Set;
    ...
    :cond_3
    iget-object p1, p0, Lyt;->ˋ:Ljava/util/Set;
    ...
    invoke-virtual {v0, v5}, Lys;->ʻ(I)Ljava/util/Set;

    move-result-object v5

    iget-object v6, p0, Lyt;->ˋ:Ljava/util/Set;
    ...
    :cond_4
    iget-object p1, p0, Lyt;->ˎ:Ljava/util/Set;
    ...
    invoke-virtual {v0, v5}, Lys;->ʼ(I)Ldo2;

    move-result-object v5

    if-eqz v5, :cond_5

    iget-object v6, p0, Lyt;->ˎ:Ljava/util/Set;
    ...
    :goto_b
    iget-object v7, p0, Lyt;->ˏ:Ljava/util/Set;

    new-instance v8, Ll57;

    invoke-direct {v8, v6, v5}, Ll57;-><init>(II)V

    invoke-interface {v7, v8}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    iget-object v7, p0, Lyt;->ᐝ:Ljava/util/Set;

    invoke-static {v6, v5}, Lᐴ;->ॱᐝ(II)Lᐴ;
    ...
    :cond_13
    new-instance p4, Ll57;

    const v0, 0x7fffffff

    invoke-direct {p4, v0, v0}, Ll57;-><init>(II)V

    invoke-static {p2, p4}, Lqr;->ˊ(Ljava/lang/String;Ll57;)Landroid/media/CamcorderProfile;
    ...
    invoke-direct {p4, v0, p2}, Ll57;-><init>(II)V
    ...
    :goto_e
    iget-object v7, p0, Lyt;->ॱॱ:Ljava/util/Set;
    ...
    iget-object v7, p0, Lyt;->ʻ:Ljava/util/Set;
    ...
    :cond_19
    iget-object p2, p0, Lyt;->ʼ:Ljava/util/Set;

    sget-object p3, Lbe5;->ˊ:Lbe5;
    ...
    :cond_1b
    iget-object p2, p0, Lyt;->ʽ:Ljava/util/Set;
    ...
    iget-object p4, p0, Lyt;->ʽ:Ljava/util/Set;
