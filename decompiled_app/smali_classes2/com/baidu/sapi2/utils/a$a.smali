...
# direct methods
.method public constructor <init>(Lcom/baidu/sapi2/SapiConfiguration;Ljava/util/Map;Ljava/lang/String;)V
    .locals 0
...
.method public run()V
    ...
    iget-object v3, p0, Lcom/baidu/sapi2/utils/a$a;->b:Ljava/util/Map;

    invoke-direct {v2, v3}, Lcom/baidu/cloudsdk/common/http/RequestParams;-><init>(Ljava/util/Map;)V

    new-instance v3, Lcom/baidu/sapi2/utils/a$a$a;

    invoke-direct {v3, p0}, Lcom/baidu/sapi2/utils/a$a$a;-><init>(Lcom/baidu/sapi2/utils/a$a;)V

    const-string v4, "http://nsclick.baidu.com/v.gif"

    invoke-virtual {v0, v1, v4, v2, v3}, Lcom/baidu/cloudsdk/common/http/AsyncHttpClient;->get(Landroid/content/Context;Ljava/lang/String;Lcom/baidu/cloudsdk/common/http/RequestParams;Lcom/baidu/cloudsdk/common/http/HttpResponseHandler;)V
