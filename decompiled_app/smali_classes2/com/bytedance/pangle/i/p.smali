.class public Lcom/bytedance/pangle/i/p;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/bytedance/pangle/i/p;->p:Ljava/util/Map;
    ...
    sget-object v0, Lcom/bytedance/pangle/i/p;->p:Ljava/util/Map;
    ...
    invoke-static {}, Lcom/bytedance/pangle/i/p;->q()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/bytedance/pangle/i/p;->k:Ljava/lang/String;

    return-void
.end method

.method private static ak()Lorg/json/JSONObject;
    .locals 3
...
.method public static k(Ljava/io/File;)Lcom/bytedance/pangle/util/i;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_1
    invoke-static {v4}, Lcom/bytedance/pangle/i/p;->k(Ljava/util/zip/ZipFile;)Ljava/util/Map;
    ...
    :cond_0
    sget-object v3, Lcom/bytedance/pangle/i/p;->k:Ljava/lang/String;

    invoke-static {v2, v3}, Lcom/bytedance/pangle/i/p;->k(Ljava/util/Map;Ljava/lang/String;)Z
    ...
    :goto_1
    new-instance v3, Lcom/bytedance/pangle/util/i;

    invoke-static {p0}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object p0

    invoke-direct {v3, p0, v2}, Lcom/bytedance/pangle/util/i;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_2
    ...
    invoke-direct {p0, v4, v2}, Lcom/bytedance/pangle/util/i;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_4
...
.method public static k()Ljava/lang/String;
    ...
    sget-object v0, Lcom/bytedance/pangle/i/p;->k:Ljava/lang/String;
...
.method private static k(Lorg/json/JSONObject;)Ljava/lang/String;
    ...
    invoke-static {p0, v0, v2}, Lcom/bytedance/pangle/i/p;->k(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;)V

    if-eqz v2, :cond_3

    invoke-static {}, Lcom/bytedance/pangle/util/x;->by()Z
    ...
    invoke-static {p0, v0, v4}, Lcom/bytedance/pangle/i/p;->k(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0, v0, v1}, Lcom/bytedance/pangle/i/p;->k(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;)V
...
.method private static k(Ljava/util/Map;)Ljava/util/List;
    ...
    sget-object v2, Lcom/bytedance/pangle/i/p;->k:Ljava/lang/String;
    ...
    :pswitch_0
    invoke-static {p0, v4, v0, v1}, Lcom/bytedance/pangle/i/p;->k(Ljava/util/Map;Ljava/lang/String;Ljava/util/List;Ljava/util/Set;)V

    goto :goto_1

    :pswitch_1
    invoke-static {p0, v9, v0, v1}, Lcom/bytedance/pangle/i/p;->k(Ljava/util/Map;Ljava/lang/String;Ljava/util/List;Ljava/util/Set;)V

    invoke-static {p0, v10, v0, v1}, Lcom/bytedance/pangle/i/p;->k(Ljava/util/Map;Ljava/lang/String;Ljava/util/List;Ljava/util/Set;)V

    goto :goto_1

    :pswitch_2
    invoke-static {p0, v5, v0, v1}, Lcom/bytedance/pangle/i/p;->k(Ljava/util/Map;Ljava/lang/String;Ljava/util/List;Ljava/util/Set;)V

    goto :goto_1

    :pswitch_3
    invoke-static {p0, v6, v0, v1}, Lcom/bytedance/pangle/i/p;->k(Ljava/util/Map;Ljava/lang/String;Ljava/util/List;Ljava/util/Set;)V
    ...
    :pswitch_5
    invoke-static {p0, v7, v0, v1}, Lcom/bytedance/pangle/i/p;->k(Ljava/util/Map;Ljava/lang/String;Ljava/util/List;Ljava/util/Set;)V

    goto :goto_1

    :pswitch_6
    invoke-static {p0, v8, v0, v1}, Lcom/bytedance/pangle/i/p;->k(Ljava/util/Map;Ljava/lang/String;Ljava/util/List;Ljava/util/Set;)V
...
.method private static k(Ljava/util/zip/ZipFile;)Ljava/util/Map;
    ...
    sget-object v5, Lcom/bytedance/pangle/i/p;->p:Ljava/util/Map;
...
.method public static k(Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/util/Map;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    invoke-static {p2, p1}, Lcom/bytedance/pangle/i/p;->k(Ljava/lang/String;Ljava/io/File;)V
    ...
    :try_start_1
    invoke-static {v1}, Lcom/bytedance/pangle/i/p;->k(Ljava/util/zip/ZipFile;)Ljava/util/Map;
    ...
    :cond_0
    :goto_0
    sget-object p0, Lcom/bytedance/pangle/i/p;->k:Ljava/lang/String;

    invoke-static {p3, p0}, Lcom/bytedance/pangle/i/p;->k(Ljava/util/Map;Ljava/lang/String;)Z
    ...
    invoke-static {p3}, Lcom/bytedance/pangle/i/p;->k(Ljava/util/Map;)Ljava/util/List;
    ...
    invoke-static {v1, p2, p1}, Lcom/bytedance/pangle/i/p;->k(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;)V
...
.method private static k(Ljava/lang/String;Ljava/io/File;)V
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {v5, v7}, Lcom/bytedance/pangle/util/yz;->k(Ljava/lang/String;Ljava/lang/String;)V
...
.method private static k(Ljava/util/Map;Ljava/lang/String;Ljava/util/List;Ljava/util/Set;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static k(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {v3, v4}, Lcom/bytedance/pangle/util/f;->k(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    :try_end_0
...
.method private static k(Ljava/util/Map;Ljava/lang/String;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static p()I
    ...
    sget-object v1, Lcom/bytedance/pangle/i/p;->p:Ljava/util/Map;
...
.method private static p(Lorg/json/JSONObject;)Ljava/lang/String;
    ...
    invoke-static {v3}, Lcom/bytedance/pangle/i/p;->k(Ljava/util/zip/ZipFile;)Ljava/util/Map;
    ...
    invoke-static {p0, v3, v4}, Lcom/bytedance/pangle/i/p;->k(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0, v2, v6}, Lcom/bytedance/pangle/i/p;->k(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    invoke-static {p0, v2, v0}, Lcom/bytedance/pangle/i/p;->k(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0, v1, v0}, Lcom/bytedance/pangle/i/p;->k(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;)V
...
.method private static q()Ljava/lang/String;
    ...
    invoke-static {}, Lcom/bytedance/pangle/i/p;->ak()Lorg/json/JSONObject;

    move-result-object v0

    invoke-static {v0}, Lcom/bytedance/pangle/i/p;->k(Lorg/json/JSONObject;)Ljava/lang/String;

    move-result-object v1

    if-nez v1, :cond_0

    invoke-static {v0}, Lcom/bytedance/pangle/i/p;->p(Lorg/json/JSONObject;)Ljava/lang/String;
