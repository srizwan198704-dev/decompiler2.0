...
.method public static a(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/os/Bundle;Ljava/lang/String;)I
    ...
    invoke-static {p0, p3, p2}, Les/sz6;->a(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/os/Bundle;)I
    ...
    invoke-static {p0, p1, p2}, Les/sz6;->a(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/os/Bundle;)I
...
.method public static a(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Landroid/os/Bundle;Landroid/os/CancellationSignal;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-static {p0, p5, p2, p3, p4}, Les/wz6;->a(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Landroid/os/Bundle;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    invoke-static {p0, p1, p2, p3, p4}, Les/wz6;->a(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Landroid/os/Bundle;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
...
.method public static a(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/content/ContentValues;Landroid/os/Bundle;Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-static {p0, p4, p2, p3}, Les/dz6;->a(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/content/ContentValues;Landroid/os/Bundle;)Landroid/net/Uri;
    ...
    invoke-static {p0, p1, p2, p3}, Les/dz6;->a(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/content/ContentValues;Landroid/os/Bundle;)Landroid/net/Uri;
...
.method private static a(Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-static {p2, p0, p1}, Lcom/bytedance/pangle/provider/k;->k(Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;)Ljava/lang/String;

    move-result-object p0

    invoke-static {p0}, Lcom/bytedance/pangle/util/by;->k(Ljava/lang/String;)Ljava/lang/String;
    ...
    check-cast p1, Lcom/bytedance/pangle/provider/ContentProviderManager$q;

    iget-object p1, p1, Lcom/bytedance/pangle/provider/ContentProviderManager$p;->p:Ljava/lang/String;
...
.method public static a(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;Ljava/lang/String;)Landroid/os/Bundle;
    ...
    check-cast v3, Lcom/bytedance/pangle/provider/ContentProviderManager$q;

    iget-object v3, v3, Lcom/bytedance/pangle/provider/ContentProviderManager$p;->p:Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {p0, v3, p2, p3, p4}, Les/mz6;->a(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-static {p0, p1, p2, p3, p4}, Les/mz6;->a(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
...
.method public static b(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/content/ContentValues;Landroid/os/Bundle;Ljava/lang/String;)I
    ...
    invoke-static {p0, p4, p2, p3}, Les/yz6;->a(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/content/ContentValues;Landroid/os/Bundle;)I
    ...
    invoke-static {p0, p1, p2, p3}, Les/yz6;->a(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/content/ContentValues;Landroid/os/Bundle;)I
