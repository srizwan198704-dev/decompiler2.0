...
# instance fields
.field public final a:Lcom/bytedance/msdk/adapter/ks/KsSplashLoader;
...
.method public constructor <init>(Lcom/bytedance/msdk/adapter/ks/KsSplashLoader;)V
    ...
    iput-object p1, p0, Les/ap7;->a:Lcom/bytedance/msdk/adapter/ks/KsSplashLoader;

    return-void
.end method

.method public static synthetic c(Les/ap7;)Z
    .locals 0

    iget-boolean p0, p0, Les/ap7;->b:Z

    return p0
.end method

.method public static synthetic d(Les/ap7;)Lcom/bytedance/msdk/adapter/ks/KsSplashLoader;
    .locals 0

    iget-object p0, p0, Les/ap7;->a:Lcom/bytedance/msdk/adapter/ks/KsSplashLoader;
...
.method public a(Landroid/content/Context;Lcom/bytedance/msdk/adapter/ks/base/config/MediationAdSlotValueSet;)V
    ...
    iget-object v0, p0, Les/ap7;->a:Lcom/bytedance/msdk/adapter/ks/KsSplashLoader;
    ...
    iput-boolean v0, p0, Les/ap7;->b:Z

    if-eqz v0, :cond_0

    new-instance v0, Les/ap7$a;

    invoke-direct {v0, p0, p2, p1}, Les/ap7$a;-><init>(Les/ap7;Lcom/bytedance/msdk/adapter/ks/base/config/MediationAdSlotValueSet;Landroid/content/Context;)V
    ...
    :cond_0
    invoke-virtual {p0, p2}, Les/ap7;->b(Lcom/bytedance/msdk/adapter/ks/base/config/MediationAdSlotValueSet;)V
...
.method public b(Lcom/bytedance/msdk/adapter/ks/base/config/MediationAdSlotValueSet;)V
    ...
    iget-object v1, p0, Les/ap7;->a:Lcom/bytedance/msdk/adapter/ks/KsSplashLoader;
    ...
    new-instance v1, Les/ap7$b;

    iget-object v2, p0, Les/ap7;->a:Lcom/bytedance/msdk/adapter/ks/KsSplashLoader;
    ...
    invoke-direct {v1, p0, p1, v2}, Les/ap7$b;-><init>(Les/ap7;Lcom/bytedance/msdk/adapter/ks/base/config/MediationAdSlotValueSet;Ljava/util/function/Function;)V

    invoke-virtual {v1, v0}, Les/ap7$b;->f(Lcom/kwad/sdk/api/KsScene;)V

    return-void

    :catch_0
    iget-object p1, p0, Les/ap7;->a:Lcom/bytedance/msdk/adapter/ks/KsSplashLoader;
