...
.method private synthetic constructor <init>(Ljava/util/stream/DoubleStream;)V
    ...
    iput-object p1, p0, Lj$/util/stream/B;->a:Ljava/util/stream/DoubleStream;

    return-void
.end method

.method public static synthetic j(Ljava/util/stream/DoubleStream;)Lj$/util/stream/D;
    .locals 1
    ...
    iget-object p0, p0, Lj$/util/stream/C;->a:Lj$/util/stream/D;
    ...
    invoke-direct {v0, p0}, Lj$/util/stream/B;-><init>(Ljava/util/stream/DoubleStream;)V
...
# virtual methods
.method public final synthetic a()Lj$/util/stream/D;
    .locals 2

    const/4 v0, 0x0

    .line 0
    iget-object v1, p0, Lj$/util/stream/B;->a:Ljava/util/stream/DoubleStream;
    ...
    invoke-static {v0}, Lj$/util/stream/B;->j(Ljava/util/stream/DoubleStream;)Lj$/util/stream/D;
...
.method public final synthetic average()Lj$/util/B;
    ...
    iget-object v0, p0, Lj$/util/stream/B;->a:Ljava/util/stream/DoubleStream;

    invoke-interface {v0}, Ljava/util/stream/DoubleStream;->average()Ljava/util/OptionalDouble;

    move-result-object v0

    invoke-static {v0}, Lj$/util/T;->j(Ljava/util/OptionalDouble;)Lj$/util/B;
...
.method public final synthetic b()Lj$/util/stream/D;
    .locals 2
...
.method public final synthetic c()Lj$/util/stream/D;
    .locals 2
...
.method public final synthetic d()Lj$/util/stream/D;
    .locals 2
...
.method public final synthetic distinct()Lj$/util/stream/D;
    .locals 1
...
.method public final e(Lj$/util/stream/a;)Lj$/util/stream/D;
    .locals 3
    ...
    invoke-static {p1}, Lj$/util/stream/B;->j(Ljava/util/stream/DoubleStream;)Lj$/util/stream/D;
...
.method public final synthetic equals(Ljava/lang/Object;)Z
    ...
    iget-object p1, p1, Lj$/util/stream/B;->a:Ljava/util/stream/DoubleStream;
...
.method public final synthetic i()Lj$/util/stream/LongStream;
    ...
    invoke-static {v0}, Lj$/util/stream/k0;->j(Ljava/util/stream/LongStream;)Lj$/util/stream/LongStream;
...
.method public final synthetic iterator()Lj$/util/H;
    .locals 1
    ...
    invoke-static {v0}, Lj$/util/F;->a(Ljava/util/PrimitiveIterator$OfDouble;)Lj$/util/H;
...
.method public final synthetic limit(J)Lj$/util/stream/D;
    .locals 1
...
.method public final synthetic onClose(Ljava/lang/Runnable;)Lj$/util/stream/BaseStream;
    ...
    invoke-static {p1}, Lj$/util/stream/f;->j(Ljava/util/stream/BaseStream;)Lj$/util/stream/BaseStream;
...
.method public final synthetic parallel()Lj$/util/stream/BaseStream;
    ...
    invoke-static {v0}, Lj$/util/stream/f;->j(Ljava/util/stream/BaseStream;)Lj$/util/stream/BaseStream;
...
.method public final synthetic parallel()Lj$/util/stream/D;
    .locals 1
...
.method public final synthetic peek(Ljava/util/function/DoubleConsumer;)Lj$/util/stream/D;
    .locals 1
...
.method public final synthetic reduce(Ljava/util/function/DoubleBinaryOperator;)Lj$/util/B;
    ...
    invoke-static {p1}, Lj$/util/T;->j(Ljava/util/OptionalDouble;)Lj$/util/B;
...
.method public final synthetic sequential()Lj$/util/stream/D;
    .locals 1
...
.method public final synthetic skip(J)Lj$/util/stream/D;
    .locals 1
...
.method public final synthetic sorted()Lj$/util/stream/D;
    .locals 1
...
.method public final synthetic spliterator()Lj$/util/W;
    .locals 1
...
.method public final synthetic t()Lj$/util/stream/IntStream;
    .locals 2
