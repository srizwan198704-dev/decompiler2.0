...
.method constructor <init>(Lj$/util/stream/b;I)V
    ...
    invoke-static {p2, v1}, Lj$/util/stream/a3;->i(II)I
    ...
    .line 211
    invoke-virtual {p0}, Lj$/util/stream/b;->P()Z
...
.method private R(I)Lj$/util/Spliterator;
    .locals 7
    ...
    .line 422
    invoke-virtual {v2}, Lj$/util/stream/b;->P()Z
    ...
    invoke-virtual {v3, v4}, Lj$/util/stream/a3;->m(I)Z
    ...
    .line 434
    :cond_0
    invoke-virtual {v2, v0, v1}, Lj$/util/stream/b;->O(Lj$/util/stream/b;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    invoke-static {v4, v0}, Lj$/util/stream/a3;->i(II)I
    ...
    invoke-static {p1, v0}, Lj$/util/stream/a3;->i(II)I
...
.method final B(Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/I0;
    ...
    .line 548
    invoke-virtual {p0, v0, v1, p3}, Lj$/util/stream/b;->M(JLjava/util/function/IntFunction;)Lj$/util/stream/A0;

    move-result-object p2

    .line 550
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/b;->U(Lj$/util/Spliterator;Lj$/util/stream/m2;)Lj$/util/stream/m2;
...
.method final C(Lj$/util/stream/G3;)Ljava/lang/Object;
    .locals 1
    ...
    .line 233
    invoke-interface {p1}, Lj$/util/stream/G3;->d()I

    move-result v0

    invoke-direct {p0, v0}, Lj$/util/stream/b;->R(I)Lj$/util/Spliterator;

    move-result-object v0

    invoke-interface {p1, p0, v0}, Lj$/util/stream/G3;->c(Lj$/util/stream/b;Lj$/util/Spliterator;)Ljava/lang/Object;
    ...
    invoke-interface {p1, p0, v0}, Lj$/util/stream/G3;->b(Lj$/util/stream/b;Lj$/util/Spliterator;)Ljava/lang/Object;
...
.method final D(Ljava/util/function/IntFunction;)Lj$/util/stream/I0;
    ...
    .line 257
    invoke-direct {v1, v2}, Lj$/util/stream/b;->R(I)Lj$/util/Spliterator;

    move-result-object v0

    invoke-virtual {p0, v1, v0, p1}, Lj$/util/stream/b;->N(Lj$/util/stream/b;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/I0;
    ...
    .line 260
    :cond_0
    invoke-direct {p0, v2}, Lj$/util/stream/b;->R(I)Lj$/util/Spliterator;
...
.method abstract M(JLjava/util/function/IntFunction;)Lj$/util/stream/A0;
.end method

.method N(Lj$/util/stream/b;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/I0;
    .locals 0
...
.method O(Lj$/util/stream/b;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    .locals 2
    ...
    .line 710
    invoke-virtual {p0, p1, p2, v0}, Lj$/util/stream/b;->N(Lj$/util/stream/b;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/I0;
...
.method abstract Q(ILj$/util/stream/m2;)Lj$/util/stream/m2;
.end method

.method final S()Lj$/util/Spliterator;
    .locals 3
...
.method abstract T(Lj$/util/stream/b;Ljava/util/function/Supplier;Z)Lj$/util/Spliterator;
.end method

.method final U(Lj$/util/Spliterator;Lj$/util/stream/m2;)Lj$/util/stream/m2;
    .locals 1
    ...
    invoke-virtual {p0, v0}, Lj$/util/stream/b;->V(Lj$/util/stream/m2;)Lj$/util/stream/m2;
...
.method final V(Lj$/util/stream/m2;)Lj$/util/stream/m2;
    .locals 3
    ...
    invoke-virtual {v0, v2, p1}, Lj$/util/stream/b;->Q(ILj$/util/stream/m2;)Lj$/util/stream/m2;
...
.method final W(Lj$/util/Spliterator;)Lj$/util/Spliterator;
    .locals 2
    ...
    .line 534
    invoke-virtual {p0, p0, v0, p1}, Lj$/util/stream/b;->T(Lj$/util/stream/b;Ljava/util/function/Supplier;Z)Lj$/util/Spliterator;
...
.method public spliterator()Lj$/util/Spliterator;
    ...
    .line 367
    invoke-virtual {p0, p0, v1, v0}, Lj$/util/stream/b;->T(Lj$/util/stream/b;Ljava/util/function/Supplier;Z)Lj$/util/Spliterator;
