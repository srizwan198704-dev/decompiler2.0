...
.method public static c(Lj$/time/chrono/ChronoLocalDateTime;Lj$/time/chrono/ChronoLocalDateTime;)I
    ...
    .line 507
    invoke-interface {p0}, Lj$/time/chrono/ChronoLocalDateTime;->c()Lj$/time/chrono/b;

    move-result-object v0

    invoke-interface {p1}, Lj$/time/chrono/ChronoLocalDateTime;->c()Lj$/time/chrono/b;
    ...
    invoke-virtual {v0, v1}, Lj$/time/j;->B(Lj$/time/j;)I
    ...
    .line 511
    invoke-interface {p0}, Lj$/time/chrono/ChronoLocalDateTime;->a()Lj$/time/chrono/l;

    move-result-object p0

    invoke-interface {p1}, Lj$/time/chrono/ChronoLocalDateTime;->a()Lj$/time/chrono/l;
...
.method public static d(Lj$/time/chrono/ChronoZonedDateTime;Lj$/time/chrono/ChronoZonedDateTime;)I
    ...
    .line 577
    invoke-interface {p0}, Lj$/time/chrono/ChronoZonedDateTime;->A()J

    move-result-wide v0

    invoke-interface {p1}, Lj$/time/chrono/ChronoZonedDateTime;->A()J
    ...
    .line 581
    invoke-interface {p0}, Lj$/time/chrono/ChronoZonedDateTime;->x()Lj$/time/chrono/ChronoLocalDateTime;

    move-result-object v0

    invoke-interface {p1}, Lj$/time/chrono/ChronoZonedDateTime;->x()Lj$/time/chrono/ChronoLocalDateTime;

    move-result-object v1

    invoke-interface {v0, v1}, Lj$/time/chrono/ChronoLocalDateTime;->w(Lj$/time/chrono/ChronoLocalDateTime;)I
...
.method public static g(Lj$/time/chrono/m;Lj$/time/temporal/r;)J
    .locals 1
...
.method public static i(Lj$/time/chrono/m;Lj$/time/temporal/r;)Z
    .locals 3
...
.method public static k(Lj$/time/chrono/ChronoLocalDateTime;Lj$/time/temporal/t;)Ljava/lang/Object;
    .locals 1
...
.method public static m(Lj$/time/chrono/m;Lj$/time/temporal/t;)Ljava/lang/Object;
    .locals 1
...
.method public static o(Lj$/time/chrono/ChronoZonedDateTime;)J
    ...
    invoke-virtual {v2}, Lj$/time/j;->S()I
...
.method public static p(Lj$/time/temporal/o;)Lj$/time/chrono/l;
    .locals 1
