...
# instance fields
.field public final ˊ:Landroid/os/ParcelFileDescriptor;
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
.end field

.field public final ˋ:Ljava/io/BufferedOutputStream;
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
.end field

.field public final ˎ:Ljava/io/FileOutputStream;
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
.end field
...
.method public constructor <init>(Landroid/content/Context;Landroid/net/Uri;I)V
    ...
    iput-object p1, p0, Lkc1;->ˊ:Landroid/os/ParcelFileDescriptor;
    ...
    iput-object p2, p0, Lkc1;->ˎ:Ljava/io/FileOutputStream;

    invoke-virtual {p2}, Ljava/io/FileOutputStream;->getChannel()Ljava/nio/channels/FileChannel;

    move-result-object p1

    iput-object p1, p0, Lkc1;->ॱ:Ljava/nio/channels/FileChannel;

    new-instance p1, Ljava/io/BufferedOutputStream;

    invoke-direct {p1, p2, p3}, Ljava/io/BufferedOutputStream;-><init>(Ljava/io/OutputStream;I)V

    iput-object p1, p0, Lkc1;->ˋ:Ljava/io/BufferedOutputStream;
...
.method public constructor <init>(Ljava/nio/channels/FileChannel;Landroid/os/ParcelFileDescriptor;Ljava/io/FileOutputStream;Ljava/io/BufferedOutputStream;)V
    ...
    iput-object p2, p0, Lkc1;->ˊ:Landroid/os/ParcelFileDescriptor;

    iput-object p3, p0, Lkc1;->ˎ:Ljava/io/FileOutputStream;

    iput-object p4, p0, Lkc1;->ˋ:Ljava/io/BufferedOutputStream;
...
.method public close()V
    ...
    iget-object v0, p0, Lkc1;->ˋ:Ljava/io/BufferedOutputStream;

    invoke-virtual {v0}, Ljava/io/BufferedOutputStream;->close()V

    iget-object v0, p0, Lkc1;->ˎ:Ljava/io/FileOutputStream;

    invoke-virtual {v0}, Ljava/io/FileOutputStream;->close()V

    iget-object v0, p0, Lkc1;->ˊ:Landroid/os/ParcelFileDescriptor;
...
.method public ˋ(J)V
    ...
    iget-object v0, p0, Lkc1;->ॱ:Ljava/nio/channels/FileChannel;
...
.method public ॱ(J)V
    ...
    invoke-static {v3, v0}, Lp68;->ˋᐝ(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v3, p1}, Lp68;->ˋᐝ(Ljava/lang/String;Ljava/lang/String;)V
