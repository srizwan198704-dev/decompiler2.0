...
# direct methods
.method public constructor <init>(Loj7;Lio/reactivex/Scheduler$Worker;ZI)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->downstream:Loj7;
...
.method public onSubscribe(Lak7;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lak7;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lak7;
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->downstream:Loj7;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->downstream:Loj7;
...
.method public poll()Ljava/lang/Object;
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lak7;

    invoke-interface {v3, v1, v2}, Lak7;->request(J)V
...
.method public runAsync()V
    ...
    :goto_2
    invoke-virtual {p0, v9, v11, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLoj7;)Z
    ...
    :cond_4
    invoke-interface {v0, v10}, Loj7;->onNext(Ljava/lang/Object;)V
    ...
    :cond_5
    iget-object v8, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lak7;

    invoke-interface {v8, v2, v3}, Lak7;->request(J)V
    ...
    invoke-interface {v0, v2}, Loj7;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0, v6, v7, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLoj7;)Z
...
.method public runBackfused()V
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->downstream:Loj7;

    const/4 v4, 0x0

    invoke-interface {v3, v4}, Loj7;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->downstream:Loj7;

    invoke-interface {v1, v0}, Loj7;->onError(Ljava/lang/Throwable;)V
...
.method public runSync()V
    ...
    :cond_2
    invoke-interface {v0, v8}, Loj7;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lak7;

    invoke-interface {v2}, Lak7;->cancel()V
