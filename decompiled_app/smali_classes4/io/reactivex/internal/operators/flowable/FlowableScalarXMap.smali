...
.method public static tryScalarXMapSubscribe(Lfp5;Loj7;Lio/reactivex/functions/Function;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {p2, p1, p0}, Lio/reactivex/internal/subscriptions/ScalarSubscription;-><init>(Loj7;Ljava/lang/Object;)V

    invoke-interface {p1, p2}, Loj7;->onSubscribe(Lak7;)V
    ...
    invoke-static {p0, p1}, Lio/reactivex/internal/subscriptions/EmptySubscription;->error(Ljava/lang/Throwable;Loj7;)V

    return v0

    :cond_2
    invoke-interface {p0, p1}, Lfp5;->subscribe(Loj7;)V
