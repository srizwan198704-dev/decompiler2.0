...
# virtual methods
.method public checkTerminated(ZZZLoj7;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZZ",
    ...
    invoke-interface {p4, p1}, Loj7;->onError(Ljava/lang/Throwable;)V
    ...
    :cond_2
    invoke-interface {p4}, Loj7;->onComplete()V
...
.method public drain()V
    ...
    invoke-virtual {p0, v1}, Lio/reactivex/processors/UnicastProcessor;->drainFused(Loj7;)V

    goto :goto_1

    :cond_1
    invoke-virtual {p0, v1}, Lio/reactivex/processors/UnicastProcessor;->drainRegular(Loj7;)V
...
.method public drainFused(Loj7;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_2
    invoke-interface {p1, v4}, Loj7;->onNext(Ljava/lang/Object;)V
...
.method public drainRegular(Loj7;)V
    .locals 17
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual/range {v0 .. v5}, Lio/reactivex/processors/UnicastProcessor;->checkTerminated(ZZZLoj7;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    invoke-interface {v5, v8}, Loj7;->onNext(Ljava/lang/Object;)V
