.class public Lsy4$ﾞ$ᐨ;
.super Ljava/security/KeyStoreSpi;


# annotations
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lsy4$ﾞ;-><init>([Ljava/security/cert/X509Certificate;Z)V
.end annotation
...
.method public constructor <init>(Z[Ljava/security/cert/X509Certificate;)V
    ...
    iput-boolean p1, p0, Lsy4$ﾞ$ᐨ;->ˊ:Z

    iput-object p2, p0, Lsy4$ﾞ$ᐨ;->ˋ:[Ljava/security/cert/X509Certificate;
    ...
    iput-object p1, p0, Lsy4$ﾞ$ᐨ;->ॱ:Ljava/util/Date;
...
.method public engineGetCertificate(Ljava/lang/String;)Ljava/security/cert/Certificate;
    ...
    invoke-virtual {p0, p1}, Lsy4$ﾞ$ᐨ;->engineContainsAlias(Ljava/lang/String;)Z

    move-result p1

    if-eqz p1, :cond_0

    iget-object p1, p0, Lsy4$ﾞ$ᐨ;->ˋ:[Ljava/security/cert/X509Certificate;
...
.method public engineGetCertificateAlias(Ljava/security/cert/Certificate;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lsy4$ﾞ$ᐨ;->ˋ:[Ljava/security/cert/X509Certificate;
...
.method public engineGetCreationDate(Ljava/lang/String;)Ljava/util/Date;
    ...
    iget-object p1, p0, Lsy4$ﾞ$ᐨ;->ॱ:Ljava/util/Date;
...
.method public engineGetKey(Ljava/lang/String;[C)Ljava/security/Key;
    ...
    iget-boolean v0, p0, Lsy4$ﾞ$ᐨ;->ˊ:Z
    ...
    invoke-direct {v0, p1, p2}, Liy4;-><init>(J)V
