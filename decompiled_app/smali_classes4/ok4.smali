...
.method public static ˊ()Ljava/net/Inet6Address;
    .locals 2
...
.method public static ˋ(Ljava/net/Inet4Address;Ljava/net/Inet6Address;)Lok4$ᐨ;
    .locals 8
    ...
    invoke-static {v4}, Lz77;->ˋ(Ljava/net/NetworkInterface;)Ljava/util/Enumeration;
    ...
    invoke-static {v5}, Lz77;->ˋ(Ljava/net/NetworkInterface;)Ljava/util/Enumeration;
    ...
    invoke-static {v3}, Lz77;->ˋ(Ljava/net/NetworkInterface;)Ljava/util/Enumeration;
    ...
    invoke-interface {p0, v0, p1}, Lh93;->ʻॱ(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    sget-object v0, Lok4;->ॱ:Lh93;

    const-string v2, "Using hard-coded IPv6 localhost address: {}"

    invoke-interface {v0, v2, p1}, Lh93;->ˎˏ(Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_4
    ...
    :goto_6
    sget-object p1, Lok4;->ॱ:Lh93;

    invoke-interface {p1, v1, p0}, Lh93;->ˎˏ(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    :goto_8
    new-instance p1, Lok4$ᐨ;

    invoke-direct {p1, v5, p0}, Lok4$ᐨ;-><init>(Ljava/net/NetworkInterface;Ljava/net/InetAddress;)V

    return-object p1
.end method

.method public static ॱ()Ljava/net/Inet4Address;
    .locals 2
