...
.method public static final ˊ(Ljava/util/Map;Lb82;)Ljava/util/Map;
    ...
    invoke-static {v1}, Lkx7;->ˏॱ(Ljava/lang/Object;)Ljava/util/Map$Entry;
    ...
    :cond_0
    invoke-static {p0}, Lkx7;->ˊॱ(Ljava/lang/Object;)Ljava/util/Map;
...
.method public static final ॱ(Lvk2;)Ljava/util/Map;
    .locals 6
    .param p0    # Lvk2;
    ...
    new-instance v3, Lc16$י;

    invoke-direct {v3}, Lc16$י;-><init>()V

    :cond_1
    check-cast v3, Lc16$י;

    iget v5, v3, Lc16$י;->ॱ:I

    add-int/2addr v5, v4

    iput v5, v3, Lc16$י;->ॱ:I
    ...
    check-cast v1, Lc16$י;

    iget v1, v1, Lc16$י;->ॱ:I
    ...
    :cond_3
    invoke-static {v0}, Lkx7;->ˊॱ(Ljava/lang/Object;)Ljava/util/Map;
