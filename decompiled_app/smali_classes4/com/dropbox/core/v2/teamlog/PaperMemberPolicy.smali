...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lcom/dropbox/core/v2/teamlog/PaperMemberPolicy;

    const-string v3, "ONLY_TEAM"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/dropbox/core/v2/teamlog/PaperMemberPolicy;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/dropbox/core/v2/teamlog/PaperMemberPolicy;->ONLY_TEAM:Lcom/dropbox/core/v2/teamlog/PaperMemberPolicy;

    new-instance v3, Lcom/dropbox/core/v2/teamlog/PaperMemberPolicy;

    const-string v5, "TEAM_AND_EXPLICITLY_SHARED"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/dropbox/core/v2/teamlog/PaperMemberPolicy;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/dropbox/core/v2/teamlog/PaperMemberPolicy;->TEAM_AND_EXPLICITLY_SHARED:Lcom/dropbox/core/v2/teamlog/PaperMemberPolicy;

    new-instance v5, Lcom/dropbox/core/v2/teamlog/PaperMemberPolicy;

    const-string v7, "OTHER"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/dropbox/core/v2/teamlog/PaperMemberPolicy;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/dropbox/core/v2/teamlog/PaperMemberPolicy;->OTHER:Lcom/dropbox/core/v2/teamlog/PaperMemberPolicy;

    const/4 v7, 0x4

    new-array v7, v7, [Lcom/dropbox/core/v2/teamlog/PaperMemberPolicy;
    ...
    sput-object v7, Lcom/dropbox/core/v2/teamlog/PaperMemberPolicy;->$VALUES:[Lcom/dropbox/core/v2/teamlog/PaperMemberPolicy;
