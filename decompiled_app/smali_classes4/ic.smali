...
.method public static ˊ(Landroid/view/View;Lkc;)Landroid/graphics/Bitmap;
    .locals 1
    ...
    invoke-static {p0, v0, p1}, Lic;->ॱ(Landroid/content/Context;Landroid/graphics/Bitmap;Lkc;)Landroid/graphics/Bitmap;
...
.method public static ˋ(Landroid/content/Context;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    .locals 6
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
...
.method public static ˎ(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
    .locals 36
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
...
.method public static ॱ(Landroid/content/Context;Landroid/graphics/Bitmap;Lkc;)Landroid/graphics/Bitmap;
    .locals 7
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-static {p0, v0, p1}, Lic;->ˋ(Landroid/content/Context;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, p0, v3}, Lic;->ˎ(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
