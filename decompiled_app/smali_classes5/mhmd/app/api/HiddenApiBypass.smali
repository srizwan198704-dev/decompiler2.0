.class public final Lmhmd/app/api/HiddenApiBypass;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmhmd/app/api/HiddenApiBypass;->n:Ljava/util/Set;
    ...
    sput-object v0, Lmhmd/app/api/HiddenApiBypass;->a:Lsun/misc/Unsafe;

    const-class v1, Lmhmd/app/api/HiddenApiBypass$c;
    ...
    sput-wide v3, Lmhmd/app/api/HiddenApiBypass;->b:J
    ...
    sput-wide v3, Lmhmd/app/api/HiddenApiBypass;->c:J

    const-class v1, Lmhmd/app/api/HiddenApiBypass$f;
    ...
    sput-wide v3, Lmhmd/app/api/HiddenApiBypass;->d:J

    const-class v1, Lmhmd/app/api/HiddenApiBypass$g;
    ...
    sput-wide v5, Lmhmd/app/api/HiddenApiBypass;->e:J

    const-class v1, Lmhmd/app/api/HiddenApiBypass$b;
    ...
    sput-wide v5, Lmhmd/app/api/HiddenApiBypass;->f:J
    ...
    sput-wide v7, Lmhmd/app/api/HiddenApiBypass;->g:J
    ...
    sput-wide v9, Lmhmd/app/api/HiddenApiBypass;->h:J

    const-class v1, Lmhmd/app/api/HiddenApiBypass$d;
    ...
    sput-wide v9, Lmhmd/app/api/HiddenApiBypass;->i:J

    const-class v1, Lmhmd/app/api/HiddenApiBypass$h;
    ...
    const-class v9, Lmhmd/app/api/HiddenApiBypass$h;
    ...
    const-class v12, Lmhmd/app/api/HiddenApiBypass$h;
    ...
    sput-wide v1, Lmhmd/app/api/HiddenApiBypass;->j:J

    sub-long/2addr v10, v5

    sub-long/2addr v10, v1

    sput-wide v10, Lmhmd/app/api/HiddenApiBypass;->k:J
    ...
    const-class v2, Lmhmd/app/api/HiddenApiBypass$h;
    ...
    const-class v3, Lmhmd/app/api/HiddenApiBypass$h;
    ...
    sput-wide v1, Lmhmd/app/api/HiddenApiBypass;->l:J

    sub-long/2addr v5, v3

    sput-wide v5, Lmhmd/app/api/HiddenApiBypass;->m:J
    :try_end_0
...
.method public static varargs addHelper([Ljava/lang/String;)Z
    .locals 1

    sget-object v0, Lmhmd/app/api/HiddenApiBypass;->n:Ljava/util/Set;
    ...
    invoke-static {p0}, Lmhmd/app/api/HiddenApiBypass;->setHelper([Ljava/lang/String;)Z
...
.method public static clearHelper()Z
    .locals 1
    ...
    invoke-static {v0}, Lmhmd/app/api/HiddenApiBypass;->setHelper([Ljava/lang/String;)Z
...
.method public static varargs getDeclaredConstructor(Ljava/lang/Class;[Ljava/lang/Class;)Ljava/lang/reflect/Constructor;
    ...
    invoke-static {p0}, Lmhmd/app/api/HiddenApiBypass;->getDeclaredMethods(Ljava/lang/Class;)Ljava/util/List;
...
.method public static getDeclaredMethods(Ljava/lang/Class;)Ljava/util/List;
    ...
    sget-object v2, Lmhmd/app/api/HiddenApiBypass;->a:Lsun/misc/Unsafe;

    sget-wide v4, Lmhmd/app/api/HiddenApiBypass;->f:J
    ...
    sget-wide v6, Lmhmd/app/api/HiddenApiBypass;->j:J

    mul-long v4, v4, v6

    add-long/2addr v4, v10

    sget-wide v6, Lmhmd/app/api/HiddenApiBypass;->k:J

    add-long v8, v4, v6

    sget-object v2, Lmhmd/app/api/HiddenApiBypass;->a:Lsun/misc/Unsafe;

    sget-wide v6, Lmhmd/app/api/HiddenApiBypass;->d:J
    ...
    sget-wide v4, Lmhmd/app/api/HiddenApiBypass;->e:J
    ...
    sget-wide v5, Lmhmd/app/api/HiddenApiBypass;->i:J
...
.method public static getInstanceFields(Ljava/lang/Class;)Ljava/util/List;
    ...
    sget-wide v3, Lmhmd/app/api/HiddenApiBypass;->g:J
    ...
    sget-wide v5, Lmhmd/app/api/HiddenApiBypass;->l:J

    mul-long v3, v3, v5

    add-long/2addr v3, v9

    sget-wide v5, Lmhmd/app/api/HiddenApiBypass;->m:J

    add-long v7, v3, v5

    sget-object v11, Lmhmd/app/api/HiddenApiBypass;->a:Lsun/misc/Unsafe;

    sget-wide v5, Lmhmd/app/api/HiddenApiBypass;->d:J
    ...
    sget-wide v3, Lmhmd/app/api/HiddenApiBypass;->e:J
    ...
    :catchall_0
    sget-object v3, Lmhmd/app/api/HiddenApiBypass;->a:Lsun/misc/Unsafe;
...
.method public static getStaticFields(Ljava/lang/Class;)Ljava/util/List;
    ...
    sget-wide v3, Lmhmd/app/api/HiddenApiBypass;->h:J
...
.method public static varargs invoke(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-class v4, Lmhmd/app/api/HiddenApiBypass$e;
    ...
    sget-wide v6, Lmhmd/app/api/HiddenApiBypass;->f:J
    ...
    sget-wide v8, Lmhmd/app/api/HiddenApiBypass;->j:J

    mul-long v6, v6, v8

    add-long/2addr v6, v13

    sget-wide v8, Lmhmd/app/api/HiddenApiBypass;->k:J

    add-long v11, v6, v8

    sget-object v7, Lmhmd/app/api/HiddenApiBypass;->a:Lsun/misc/Unsafe;

    sget-wide v9, Lmhmd/app/api/HiddenApiBypass;->b:J
    ...
    invoke-static {v6, v1}, Lmhmd/app/api/HiddenApiBypass;->a([Ljava/lang/Class;[Ljava/lang/Object;)Z
...
.method public static varargs newInstance(Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-class v6, Lmhmd/app/api/HiddenApiBypass$e;
    ...
    sget-wide v9, Lmhmd/app/api/HiddenApiBypass;->j:J

    mul-long v7, v7, v9

    add-long/2addr v7, v13

    sget-wide v9, Lmhmd/app/api/HiddenApiBypass;->k:J

    add-long v15, v7, v9

    sget-object v11, Lmhmd/app/api/HiddenApiBypass;->a:Lsun/misc/Unsafe;

    sget-wide v17, Lmhmd/app/api/HiddenApiBypass;->b:J
    ...
    sget-wide v7, Lmhmd/app/api/HiddenApiBypass;->c:J
    ...
    invoke-static {v7, v1}, Lmhmd/app/api/HiddenApiBypass;->a([Ljava/lang/Class;[Ljava/lang/Object;)Z
...
.method public static varargs setHelper([Ljava/lang/String;)Z
    .locals 6

    const-string v0, "setHelperExemptions"
    ...
    invoke-static {v2, v3, v4, v5}, Lmhmd/app/api/HiddenApiBypass;->invoke(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v3, v2, v0, v5}, Lmhmd/app/api/HiddenApiBypass;->invoke(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
