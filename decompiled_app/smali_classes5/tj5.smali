...
.field public static final ॱ:I = 0xd3
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Ltj5;->ˊ:Ljava/math/BigInteger;
    ...
    sput-object v0, Ltj5;->ˋ:Ljava/math/BigInteger;
    ...
    sput-object v0, Ltj5;->ˎ:Ljava/math/BigInteger;
...
.method public static ʻ(Ljava/math/BigInteger;)Z
    .locals 3
...
.method public static ʼ(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;ILjava/math/BigInteger;)Z
    .locals 3
    ...
    sget-object p4, Ltj5;->ˊ:Ljava/math/BigInteger;
    ...
    sget-object v2, Ltj5;->ˋ:Ljava/math/BigInteger;
    ...
    :cond_1
    sget-object v2, Ltj5;->ˊ:Ljava/math/BigInteger;
...
.method public static ʽ(Lr51;I[B)Ltj5$ﾞ;
    .locals 16
    ...
    invoke-interface/range {p0 .. p0}, Lr51;->ᐝ()I
    ...
    :goto_0
    invoke-static {v0, v2, v8, v6}, Ltj5;->ॱॱ(Lr51;[B[BI)V

    invoke-static {v2, v7}, Ltj5;->ˊॱ([BI)V

    invoke-static {v0, v2, v3, v6}, Ltj5;->ॱॱ(Lr51;[B[BI)V

    invoke-static {v2, v7}, Ltj5;->ˊॱ([BI)V

    invoke-static {v8}, Ltj5;->ˋ([B)I

    move-result v10

    invoke-static {v3}, Ltj5;->ˋ([B)I
    ...
    invoke-static {v10, v11}, Ltj5;->ͺ(J)Z

    move-result v12

    if-eqz v12, :cond_0

    new-instance v0, Ltj5$ﾞ;

    invoke-static {v10, v11}, Ljava/math/BigInteger;->valueOf(J)Ljava/math/BigInteger;

    move-result-object v1

    invoke-direct {v0, v1, v2, v9, v5}, Ltj5$ﾞ;-><init>(Ljava/math/BigInteger;[BILtj5$ᐨ;)V
    ...
    invoke-static {v0, v8, v2}, Ltj5;->ʽ(Lr51;I[B)Ltj5$ﾞ;

    move-result-object v2

    invoke-virtual {v2}, Ltj5$ﾞ;->ॱ()Ljava/math/BigInteger;

    move-result-object v8

    invoke-virtual {v2}, Ltj5$ﾞ;->ˋ()[B

    move-result-object v9

    invoke-virtual {v2}, Ltj5$ﾞ;->ˊ()I
    ...
    invoke-static {v0, v9, v3}, Ltj5;->ᐝ(Lr51;[BI)Ljava/math/BigInteger;

    move-result-object v11

    sget-object v12, Ltj5;->ˊ:Ljava/math/BigInteger;
    ...
    sget-object v6, Ltj5;->ˊ:Ljava/math/BigInteger;
    ...
    invoke-static {v12}, Ltj5;->ʻ(Ljava/math/BigInteger;)Z
    ...
    sget-object v7, Ltj5;->ˎ:Ljava/math/BigInteger;
    ...
    sget-object v7, Ltj5;->ˋ:Ljava/math/BigInteger;
    ...
    sget-object v11, Ltj5;->ˊ:Ljava/math/BigInteger;
    ...
    invoke-direct {v0, v12, v9, v14, v6}, Ltj5$ﾞ;-><init>(Ljava/math/BigInteger;[BILtj5$ᐨ;)V
    ...
    invoke-static {v9, v3}, Ltj5;->ˊॱ([BI)V
...
.method public static ˊ(Ljava/math/BigInteger;Ljava/security/SecureRandom;I)Ltj5$ﹳ;
    .locals 11

    const-string v0, "candidate"

    invoke-static {p0, v0}, Ltj5;->ॱ(Ljava/math/BigInteger;Ljava/lang/String;)V
    ...
    sget-object p0, Ltj5;->ˋ:Ljava/math/BigInteger;

    invoke-static {p0}, Ltj5$ﹳ;->ˊ(Ljava/math/BigInteger;)Ltj5$ﹳ;
    ...
    sget-object v3, Ltj5;->ˋ:Ljava/math/BigInteger;
    ...
    invoke-static {v7, v3, p1}, Lv8;->ॱॱ(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
    ...
    sget-object v9, Ltj5;->ˊ:Ljava/math/BigInteger;
    ...
    invoke-static {v8}, Ltj5$ﹳ;->ˊ(Ljava/math/BigInteger;)Ltj5$ﹳ;
    ...
    sget-object v9, Ltj5;->ˋ:Ljava/math/BigInteger;
    ...
    :cond_4
    sget-object v10, Ltj5;->ˊ:Ljava/math/BigInteger;
    ...
    sget-object p1, Ltj5;->ˊ:Ljava/math/BigInteger;
    ...
    sget-object p2, Ltj5;->ˋ:Ljava/math/BigInteger;
...
.method public static ˋॱ(Ljava/math/BigInteger;Ljava/security/SecureRandom;I)Z
    .locals 8
    ...
    invoke-static {p0, v2, v5, v4, v7}, Ltj5;->ʼ(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;ILjava/math/BigInteger;)Z
...
.method public static ˎ(Lr51;I[B)Ltj5$ﾞ;
    .locals 1
    ...
    invoke-static {p0, p1, p2}, Ltj5;->ʽ(Lr51;I[B)Ltj5$ﾞ;
...
.method public static ˏ(Ljava/math/BigInteger;)Z
    .locals 1
    ...
    invoke-static {p0}, Ltj5;->ʻ(Ljava/math/BigInteger;)Z
...
.method public static ˏॱ(Ljava/math/BigInteger;Ljava/math/BigInteger;)Z
    ...
    invoke-static {p1, v0}, Ltj5;->ॱ(Ljava/math/BigInteger;Ljava/lang/String;)V

    sget-object v0, Ltj5;->ˊ:Ljava/math/BigInteger;
    ...
    invoke-static {p0, v0, v2, v1, p1}, Ltj5;->ʼ(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;ILjava/math/BigInteger;)Z
...
.method public static ॱॱ(Lr51;[B[BI)V
    .locals 2
...
.method public static ᐝ(Lr51;[BI)Ljava/math/BigInteger;
    .locals 5
    ...
    invoke-static {p0, p1, v2, v1}, Ltj5;->ॱॱ(Lr51;[B[BI)V

    invoke-static {p1, v4}, Ltj5;->ˊॱ([BI)V
