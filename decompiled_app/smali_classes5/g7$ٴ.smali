...
.method public constructor <init>(Lmd3;)V
    ...
    invoke-direct {p0, p1}, Lg7;-><init>(Lmd3;)V
    ...
    iput-object v0, p0, Lg7$ٴ;->ʻॱ:[B

    const-string v1, "DEFAULT"

    invoke-interface {p1, v1}, Lmd3;->ॱᐝ(Ljava/lang/String;)Ljava/security/SecureRandom;
    ...
    iput-object p1, p0, Lg7$ٴ;->ᐝॱ:Ljava/util/Map;
...
.method public engineGetKey(Ljava/lang/String;[C)Ljava/security/Key;
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2}, Lg7$ٴ;->ॱᐝ(Ljava/lang/String;[C)[B

    move-result-object v1
    :try_end_0
    .catch Ljava/security/InvalidKeyException; {:try_start_0 .. :try_end_0} :catch_0

    iget-object v2, p0, Lg7$ٴ;->ᐝॱ:Ljava/util/Map;
    ...
    iget-object v0, p0, Lg7$ٴ;->ᐝॱ:Ljava/util/Map;
...
.method public final ॱᐝ(Ljava/lang/String;[C)[B
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/NoSuchAlgorithmException;,
    ...
    invoke-static {p2, p1}, Lर;->ˊˋ([B[B)[B
