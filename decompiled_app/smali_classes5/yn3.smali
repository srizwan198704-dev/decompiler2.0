...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Lyn3;->ॱ:Ljava/lang/Object;

    new-instance v2, Lpg1;

    invoke-direct {v2}, Lpg1;-><init>()V

    iput-object v2, p0, Lyn3;->ˊ:Lpg1;

    iput-object v0, p0, Lyn3;->ˋ:Ljava/lang/String;

    const/16 v0, 0xef

    iput v0, p0, Lyn3;->ˏ:I

    iput-object v1, p0, Lyn3;->ॱॱ:Ljava/security/SecureRandom;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lyn3;->ᐝ:Z
...
.method public generateKeyPair()Ljava/security/KeyPair;
    ...
    iget-boolean v0, p0, Lyn3;->ᐝ:Z

    if-eqz v0, :cond_2

    iget-object v0, p0, Lyn3;->ˊ:Lpg1;
    ...
    iget-object v2, p0, Lyn3;->ॱ:Ljava/lang/Object;
    ...
    iget-object v4, p0, Lyn3;->ˋ:Ljava/lang/String;

    invoke-direct {v3, v4, v1, v2}, Lぃ;-><init>(Ljava/lang/String;Luh1;Ljh1;)V

    new-instance v1, Ljava/security/KeyPair;

    new-instance v4, L々;

    iget-object v5, p0, Lyn3;->ˋ:Ljava/lang/String;

    invoke-direct {v4, v5, v0, v3, v2}, L々;-><init>(Ljava/lang/String;Lqh1;Lぃ;Ljh1;)V
    ...
    invoke-direct {v3, v4, v1}, Lぃ;-><init>(Ljava/lang/String;Luh1;)V

    new-instance v1, L々;

    iget-object v4, p0, Lyn3;->ˋ:Ljava/lang/String;

    invoke-direct {v1, v4, v0}, L々;-><init>(Ljava/lang/String;Lqh1;)V
    ...
    invoke-direct {v3, v4, v1, v2}, Lぃ;-><init>(Ljava/lang/String;Luh1;Ljava/security/spec/ECParameterSpec;)V
    ...
    invoke-direct {v4, v5, v0, v3, v2}, L々;-><init>(Ljava/lang/String;Lqh1;Lぃ;Ljava/security/spec/ECParameterSpec;)V
...
.method public initialize(ILjava/security/SecureRandom;)V
    ...
    iput-object p2, p0, Lyn3;->ॱॱ:Ljava/security/SecureRandom;

    iget-object p1, p0, Lyn3;->ॱ:Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lyn3;->initialize(Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    :try_end_0
...
.method public initialize(Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    invoke-virtual {p0, p1, p2}, Lyn3;->ॱ(Lxb2;Ljava/security/SecureRandom;)V
    ...
    iput-object p1, p0, Lyn3;->ॱ:Ljava/lang/Object;
    ...
    :goto_0
    iput-object p1, p0, Lyn3;->ˎ:Log1;

    iget-object p2, p0, Lyn3;->ˊ:Lpg1;

    invoke-virtual {p2, p1}, Lpg1;->ˊ(Lqn3;)V

    :goto_1
    iput-boolean v1, p0, Lyn3;->ᐝ:Z
    ...
    iput-object v3, p0, Lyn3;->ˎ:Log1;

    iget-object p1, p0, Lyn3;->ˊ:Lpg1;
    ...
    invoke-virtual {p0, v0, p2}, Lyn3;->ॱ(Lxb2;Ljava/security/SecureRandom;)V
...
.method public final ॱ(Lxb2;Ljava/security/SecureRandom;)V
    ...
    iput-object v8, p0, Lyn3;->ॱ:Ljava/lang/Object;
    ...
    invoke-direct {v3, v4, v0}, Ldh1;-><init>(Lﹲ;Ljx8;)V
    ...
    invoke-direct {v2, v3, v0, v4, p1}, Lig1;-><init>(Lvf1;Lﹲ;Lﹲ;Lﹲ;)V

    invoke-direct {v1, v2, p2}, Log1;-><init>(Lvf1;Ljava/security/SecureRandom;)V

    iput-object v1, p0, Lyn3;->ˎ:Log1;

    iget-object p1, p0, Lyn3;->ˊ:Lpg1;

    invoke-virtual {p1, v1}, Lpg1;->ˊ(Lqn3;)V

    const/4 p1, 0x1

    iput-boolean p1, p0, Lyn3;->ᐝ:Z
