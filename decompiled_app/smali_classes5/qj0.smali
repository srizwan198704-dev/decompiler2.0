...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lqj0;->ˊ:Ljava/util/Map;
...
.method public static ˊ(Ljava/security/cert/CertificateFactory;Ljava/net/URI;)Ljava/util/Collection;
    .locals 1
...
.method public static ˋ(Ljava/security/cert/CertificateFactory;Ljava/net/URI;)Ljava/util/Collection;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
...
.method public static declared-synchronized ॱ(Ljava/security/cert/CertificateFactory;Ljava/util/Date;Ljava/net/URI;)Lh55;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    :try_start_0
    sget-object v1, Lqj0;->ˊ:Ljava/util/Map;
    ...
    invoke-interface {v1, v2}, Lh55;->ॱ(Lft6;)Ljava/util/Collection;
    ...
    invoke-static {p0, p2}, Lqj0;->ˋ(Ljava/security/cert/CertificateFactory;Ljava/net/URI;)Ljava/util/Collection;
    ...
    :cond_4
    invoke-static {p0, p2}, Lqj0;->ˊ(Ljava/security/cert/CertificateFactory;Ljava/net/URI;)Ljava/util/Collection;

    move-result-object p0

    :goto_1
    new-instance p1, Lqj0$ᐨ;

    new-instance v1, Lk70;

    invoke-direct {v1, p0}, Lk70;-><init>(Ljava/util/Collection;)V

    invoke-direct {p1, v1}, Lqj0$ᐨ;-><init>(Llg7;)V

    sget-object p0, Lqj0;->ˊ:Ljava/util/Map;
