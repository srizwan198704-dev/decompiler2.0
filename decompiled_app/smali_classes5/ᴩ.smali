...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lᴩ;->ॱ:Ljava/lang/String;

    new-instance v0, Lk35;

    invoke-direct {v0}, Lk35;-><init>()V

    iput-object v0, p0, Lᴩ;->ॱॱ:Lk35;
...
.method public constructor <init>(Lfk5;)V
    ...
    invoke-virtual {p0, p1}, Lᴩ;->ᐝ(Lfk5;)V
...
.method public constructor <init>(Ljava/lang/String;Lqh1;)V
    ...
    iput-object p1, p0, Lᴩ;->ॱ:Ljava/lang/String;

    invoke-virtual {p2}, Lqh1;->ॱॱ()Ljava/math/BigInteger;

    move-result-object p1

    iput-object p1, p0, Lᴩ;->ˋ:Ljava/math/BigInteger;

    const/4 p1, 0x0

    iput-object p1, p0, Lᴩ;->ˎ:Ljava/security/spec/ECParameterSpec;

    return-void
.end method

.method public constructor <init>(Ljava/lang/String;Lqh1;Lᴭ;Ljava/security/spec/ECParameterSpec;)V
    .locals 2
    ...
    invoke-static {p4}, Lgf1;->ॱॱ(Lkh1;)Ljava/security/spec/ECPoint;
    ...
    iput-object p2, p0, Lᴩ;->ˎ:Ljava/security/spec/ECParameterSpec;

    goto :goto_0

    :cond_0
    iput-object p4, p0, Lᴩ;->ˎ:Ljava/security/spec/ECParameterSpec;

    :goto_0
    invoke-virtual {p0, p3}, Lᴩ;->ॱॱ(Lᴭ;)Lbm0;

    move-result-object p1

    iput-object p1, p0, Lᴩ;->ˏ:Lbm0;

    return-void
.end method

.method public constructor <init>(Ljava/lang/String;Lqh1;Lᴭ;Ljh1;)V
    .locals 2
...
.method public constructor <init>(Ljava/security/interfaces/ECPrivateKey;)V
    ...
    iput-object v0, p0, Lᴩ;->ˋ:Ljava/math/BigInteger;
...
.method public constructor <init>(Lᴩ;)V
    .locals 1
    ...
    iget-object v0, p1, Lᴩ;->ˋ:Ljava/math/BigInteger;

    iput-object v0, p0, Lᴩ;->ˋ:Ljava/math/BigInteger;

    iget-object v0, p1, Lᴩ;->ˎ:Ljava/security/spec/ECParameterSpec;

    iput-object v0, p0, Lᴩ;->ˎ:Ljava/security/spec/ECParameterSpec;

    iget-boolean v0, p1, Lᴩ;->ˊ:Z

    iput-boolean v0, p0, Lᴩ;->ˊ:Z

    iget-object v0, p1, Lᴩ;->ॱॱ:Lk35;

    iput-object v0, p0, Lᴩ;->ॱॱ:Lk35;

    iget-object p1, p1, Lᴩ;->ˏ:Lbm0;
...
.method private writeObject(Ljava/io/ObjectOutputStream;)V
    ...
    invoke-virtual {p0}, Lᴩ;->getEncoded()[B
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0}, Lᴩ;->ˈˊ()Ljava/math/BigInteger;

    move-result-object v0

    invoke-virtual {p1}, Lᴩ;->ˈˊ()Ljava/math/BigInteger;
    ...
    invoke-virtual {p0}, Lᴩ;->ˋ()Ljh1;

    move-result-object v0

    invoke-virtual {p1}, Lᴩ;->ˋ()Ljh1;
...
.method public getAlgorithm()Ljava/lang/String;
    ...
    iget-object v0, p0, Lᴩ;->ॱ:Ljava/lang/String;
...
.method public getEncoded()[B
    ...
    iget-object v0, p0, Lᴩ;->ˎ:Ljava/security/spec/ECParameterSpec;
    ...
    iget-object v1, p0, Lᴩ;->ˎ:Ljava/security/spec/ECParameterSpec;
    ...
    invoke-virtual {p0}, Lᴩ;->getS()Ljava/math/BigInteger;

    move-result-object v3

    invoke-static {v0, v2, v3}, Lwh1;->ͺ(Lpn5;Ljava/math/BigInteger;Ljava/math/BigInteger;)I
    ...
    invoke-static {v4, v1}, Lgf1;->ˎ(Lkf1;Ljava/security/spec/ECPoint;)Lkh1;

    move-result-object v1

    iget-boolean v3, p0, Lᴩ;->ˊ:Z

    invoke-direct {v5, v1, v3}, Llx8;-><init>(Lkh1;Z)V
    ...
    iget-object v3, p0, Lᴩ;->ˎ:Ljava/security/spec/ECParameterSpec;
    ...
    invoke-static {v0, v3, v4}, Lwh1;->ͺ(Lpn5;Ljava/math/BigInteger;Ljava/math/BigInteger;)I

    move-result v0

    :goto_1
    iget-object v3, p0, Lᴩ;->ˏ:Lbm0;
    ...
    iget-object v5, p0, Lᴩ;->ˏ:Lbm0;

    invoke-direct {v3, v0, v4, v5, v1}, Lph1;-><init>(ILjava/math/BigInteger;Lbm0;Lᒻ;)V
    ...
    invoke-direct {v3, v0, v4, v1}, Lph1;-><init>(ILjava/math/BigInteger;Lᒻ;)V
    ...
    invoke-virtual {v3}, Lph1;->ˏ()Lﻧ;

    move-result-object v1

    invoke-direct {v0, v4, v1}, Lfk5;-><init>(Lᵍ;Lᒻ;)V
...
.method public getS()Ljava/math/BigInteger;
    ...
    iget-object v0, p0, Lᴩ;->ˋ:Ljava/math/BigInteger;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lᴩ;->ˋ:Ljava/math/BigInteger;
...
.method public final ॱॱ(Lᴭ;)Lbm0;
    .locals 0

    :try_start_0
    invoke-virtual {p1}, Lᴭ;->getEncoded()[B
...
.method public final ᐝ(Lfk5;)V
    ...
    invoke-static {v0}, Ljq0;->ॱ(Lﹲ;)Lvf1;
    ...
    :goto_0
    iput-object v2, p0, Lᴩ;->ˎ:Ljava/security/spec/ECParameterSpec;
    ...
    invoke-virtual {v0}, Lmq0;->ʿ()Z

    move-result v1

    if-eqz v1, :cond_4

    invoke-virtual {v0}, Lmq0;->ʾ()Lﹲ;
    ...
    :cond_4
    invoke-virtual {v0}, Lmq0;->ʻॱ()Lhq0;

    move-result-object v0

    invoke-virtual {v0}, Lhq0;->ᐝॱ()[B
    ...
    invoke-virtual {p0, v1}, Lᴩ;->ʻ([B)V

    :cond_5
    invoke-virtual {v0}, Lhq0;->ʻॱ()Lgq0;

    move-result-object v2

    new-instance v11, Lkf1$ՙ;
    ...
    invoke-virtual {v0}, Lhq0;->ˊॱ()Ljava/math/BigInteger;
    ...
    invoke-static {v11, v1}, Lnq0;->ॱ(Lkf1;[B)Lkh1;

    move-result-object v1

    invoke-virtual {v0}, Lhq0;->ʿ()Ljava/math/BigInteger;

    move-result-object v0

    invoke-direct {v9, v11, v1, v0}, Ljh1;-><init>(Lkf1;Lkh1;Ljava/math/BigInteger;)V

    :goto_1
    invoke-virtual {v9}, Ljh1;->ॱ()Lkf1;

    move-result-object v0

    invoke-virtual {v9}, Ljh1;->ˏ()[B
    ...
    invoke-virtual {v9}, Ljh1;->ˎ()Ljava/math/BigInteger;

    move-result-object v3

    invoke-virtual {v9}, Ljh1;->ˋ()Ljava/math/BigInteger;
    ...
    iput-object v1, p0, Lᴩ;->ˎ:Ljava/security/spec/ECParameterSpec;
