...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lvh4;->ʼ:Ljava/math/BigInteger;
...
.method public static ˋ(I)Ljava/util/Vector;
    .locals 4
...
.method public static ˎ(IILjava/security/SecureRandom;)Ljava/math/BigInteger;
    .locals 2

    :goto_0
    invoke-static {p0, p1, p2}, Lv8;->ᐝ(IILjava/security/SecureRandom;)Ljava/math/BigInteger;
...
.method public static ˏ(Ljava/security/SecureRandom;I)I
    .locals 4
...
.method public static ॱॱ(Ljava/util/Vector;Ljava/security/SecureRandom;)Ljava/util/Vector;
    .locals 5
    ...
    invoke-static {p1, v3}, Lvh4;->ˏ(Ljava/security/SecureRandom;I)I
...
.method public ॱ()Lᘢ;
    ...
    iget-object v1, v0, Lvh4;->ᐝ:Luh4;

    invoke-virtual {v1}, Lqn3;->ˊ()I

    move-result v1

    iget-object v2, v0, Lvh4;->ᐝ:Luh4;

    invoke-virtual {v2}, Lqn3;->ॱ()Ljava/security/SecureRandom;

    move-result-object v2

    iget-object v3, v0, Lvh4;->ᐝ:Luh4;

    invoke-virtual {v3}, Luh4;->ˋ()I

    move-result v3

    iget-object v4, v0, Lvh4;->ᐝ:Luh4;

    invoke-virtual {v4}, Luh4;->ˏ()Z
    ...
    iget-object v7, v0, Lvh4;->ᐝ:Luh4;

    invoke-virtual {v7}, Luh4;->ˎ()I
    ...
    :cond_0
    iget-object v5, v0, Lvh4;->ᐝ:Luh4;

    invoke-virtual {v5}, Luh4;->ˎ()I

    move-result v5

    invoke-static {v5}, Lvh4;->ˋ(I)Ljava/util/Vector;

    move-result-object v5

    invoke-static {v5, v2}, Lvh4;->ॱॱ(Ljava/util/Vector;Ljava/security/SecureRandom;)Ljava/util/Vector;

    move-result-object v10

    sget-object v5, Lvh4;->ʼ:Ljava/math/BigInteger;
    ...
    invoke-static {v9, v3, v2}, Lvh4;->ˎ(IILjava/security/SecureRandom;)Ljava/math/BigInteger;
    ...
    invoke-static {v15, v3, v2}, Lvh4;->ˎ(IILjava/security/SecureRandom;)Ljava/math/BigInteger;
    ...
    sget-object v15, Lvh4;->ʼ:Ljava/math/BigInteger;
    ...
    invoke-static {v1, v3, v2}, Lv8;->ᐝ(IILjava/security/SecureRandom;)Ljava/math/BigInteger;
    ...
    sget-object v1, Lvh4;->ʼ:Ljava/math/BigInteger;
    ...
    sget-object v12, Lvh4;->ʼ:Ljava/math/BigInteger;
    ...
    sget-object v6, Lvh4;->ʼ:Ljava/math/BigInteger;
    ...
    invoke-direct {v2, v6, v1, v9, v3}, Lwh4;-><init>(ZLjava/math/BigInteger;Ljava/math/BigInteger;I)V
    ...
    invoke-direct/range {v6 .. v11}, Lxh4;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;ILjava/util/Vector;Ljava/math/BigInteger;)V

    invoke-direct {v0, v2, v3}, Lᘢ;-><init>(Lᴫ;Lᴫ;)V
