...
.field public static final ॱॱ:J = 0x8a5b6470af95L

.field public static ᐝ:Ljava/security/SecureRandom;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lm83;->ॱ:Ljava/math/BigInteger;
    ...
    sput-object v0, Lm83;->ˊ:Ljava/math/BigInteger;
    ...
    sput-object v0, Lm83;->ˋ:Ljava/math/BigInteger;
    ...
    sput-object v0, Lm83;->ˎ:Ljava/math/BigInteger;
    ...
    sput-object v0, Lm83;->ˏ:[I

    const/4 v0, 0x0

    sput-object v0, Lm83;->ᐝ:Ljava/security/SecureRandom;
...
.method public static ʻ([Ljava/math/BigInteger;Ljava/math/BigInteger;)[Ljava/math/BigInteger;
    .locals 3
    ...
    invoke-static {v2, p1}, Lm83;->ᐝ(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
...
.method public static ʻॱ(Ljava/math/BigInteger;Ljava/math/BigInteger;)I
    .locals 9

    sget-object v0, Lm83;->ॱ:Ljava/math/BigInteger;
    ...
    sget-object p1, Lm83;->ˊ:Ljava/math/BigInteger;
    ...
    sget-object v2, Lm83;->ˊ:Ljava/math/BigInteger;

    invoke-virtual {v0, v2}, Ljava/math/BigInteger;->add(Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v0

    sget-object v2, Lm83;->ˋ:Ljava/math/BigInteger;
    ...
    sget-object v3, Lm83;->ˊ:Ljava/math/BigInteger;

    invoke-virtual {v0, v3}, Ljava/math/BigInteger;->add(Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v0

    sget-object v3, Lm83;->ˋ:Ljava/math/BigInteger;
    ...
    :cond_b
    sget-object p0, Lm83;->ˊ:Ljava/math/BigInteger;
...
.method public static ʼ(II)[I
    ...
    invoke-static {p0, p1}, Lm83;->ʽ(Ljava/math/BigInteger;Ljava/math/BigInteger;)[Ljava/math/BigInteger;
...
.method public static ʼॱ([Ljava/math/BigInteger;)Ljava/math/BigInteger;
    .locals 5
...
.method public static ʽ(Ljava/math/BigInteger;Ljava/math/BigInteger;)[Ljava/math/BigInteger;
    .locals 9

    sget-object v0, Lm83;->ˊ:Ljava/math/BigInteger;

    sget-object v1, Lm83;->ॱ:Ljava/math/BigInteger;
...
.method public static ʾ(D)D
    ...
    invoke-static {v0, v1}, Lm83;->ʾ(D)D
    ...
    invoke-static {p0, p1}, Lm83;->ˈ(D)D
...
.method public static ʿ(J)D
    ...
    invoke-static {v0}, Lm83;->ˏॱ(Ljava/math/BigInteger;)I
...
.method public static ˋˋ(J)Ljava/math/BigInteger;
    .locals 17
...
.method public static ˋᐝ(Ljava/math/BigInteger;)Ljava/math/BigInteger;
    .locals 1

    const/16 v0, 0x14

    invoke-static {p0, v0}, Lm83;->ˌ(Ljava/math/BigInteger;I)Ljava/math/BigInteger;
...
.method public static ˌ(Ljava/math/BigInteger;I)Ljava/math/BigInteger;
    .locals 7
    ...
    :cond_2
    sget-object v0, Lm83;->ˋ:Ljava/math/BigInteger;
    ...
    :cond_5
    :goto_1
    sget-object p0, Lm83;->ˋ:Ljava/math/BigInteger;
...
.method public static ˎˎ([B)Ljava/math/BigInteger;
    .locals 2
    ...
    invoke-static {p0, v1, v0}, Lm83;->ˎˏ([BII)Ljava/math/BigInteger;
...
.method public static ˎˏ([BII)Ljava/math/BigInteger;
    .locals 2
...
.method public static ˏˏ(Ljava/math/BigInteger;)Z
    .locals 6
    ...
    sget-object v5, Lm83;->ॱ:Ljava/math/BigInteger;
...
.method public static ˏॱ(Ljava/math/BigInteger;)I
    .locals 3
...
.method public static ـ(Ljava/math/BigInteger;)Ljava/math/BigInteger;
    .locals 1

    sget-object v0, Lm83;->ᐝ:Ljava/security/SecureRandom;
    ...
    invoke-static {p0, v0}, Lm83;->ॱʻ(Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
...
.method public static ॱ(II)Ljava/math/BigInteger;
    .locals 4
    ...
    :cond_0
    sget-object p0, Lm83;->ॱ:Ljava/math/BigInteger;
...
.method public static ॱʻ(Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
    .locals 4
    ...
    sget-object p1, Lm83;->ᐝ:Ljava/security/SecureRandom;
...
.method public static ॱʼ(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    .locals 0
...
.method public static ॱʽ(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    .locals 21
    ...
    :cond_1
    sget-object v1, Lm83;->ˋ:Ljava/math/BigInteger;
    ...
    invoke-static {v2, v0}, Lm83;->ʻॱ(Ljava/math/BigInteger;Ljava/math/BigInteger;)I

    move-result v1

    if-ne v1, v6, :cond_3

    sget-object v1, Lm83;->ˊ:Ljava/math/BigInteger;
    ...
    :goto_1
    invoke-static {v1, v0}, Lm83;->ʻॱ(Ljava/math/BigInteger;Ljava/math/BigInteger;)I

    move-result v15

    if-ne v15, v6, :cond_7

    sget-object v15, Lm83;->ˊ:Ljava/math/BigInteger;
    ...
    :cond_7
    sget-object v15, Lm83;->ˋ:Ljava/math/BigInteger;
    ...
    :goto_3
    sget-object v6, Lm83;->ˊ:Ljava/math/BigInteger;
...
.method public static ॱˊ(II)F
    ...
    :goto_1
    invoke-static {v0, p1}, Lm83;->ˊॱ(FI)F
    ...
    invoke-static {v0, v3}, Lm83;->ˊॱ(FI)F
...
.method public static ॱˋ(Ljava/math/BigInteger;)[B
    .locals 4
...
.method public static ॱͺ(Ljava/math/BigInteger;)Ljava/math/BigInteger;
    .locals 8
    ...
    sget-object v3, Lm83;->ˎ:Ljava/math/BigInteger;
    ...
    sget-object v4, Lm83;->ˊ:Ljava/math/BigInteger;

    invoke-virtual {v3, v4}, Ljava/math/BigInteger;->add(Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v3

    sget-object v5, Lm83;->ˋ:Ljava/math/BigInteger;
...
.method public static ᐝ(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    .locals 1
    ...
    invoke-static {p0, p1}, Lm83;->ᐝ(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
