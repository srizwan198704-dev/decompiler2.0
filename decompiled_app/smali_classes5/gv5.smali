...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lgv5;->ʻ:Ljava/math/BigInteger;
...
.method public ˊ(Lqn3;)V
    ...
    iput-object p1, p0, Lgv5;->ᐝ:Lfv5;

    return-void
.end method

.method public ˋ(ILjava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    .locals 4
    ...
    invoke-static {p1, v2, v1}, Lv8;->ᐝ(IILjava/security/SecureRandom;)Ljava/math/BigInteger;
    ...
    sget-object v3, Lgv5;->ʻ:Ljava/math/BigInteger;
    ...
    :cond_1
    invoke-virtual {p0, v1}, Lgv5;->ˏ(Ljava/math/BigInteger;)Z
...
.method public ˏ(Ljava/math/BigInteger;)Z
    .locals 2
    ...
    invoke-virtual {v1}, Lfv5;->ˋ()I

    move-result v1

    invoke-static {v0, v1}, Lgv5;->ˎ(II)I

    move-result v0

    invoke-static {p1}, Ltj5;->ˏ(Ljava/math/BigInteger;)Z
    ...
    invoke-static {p1, v1, v0}, Ltj5;->ˋॱ(Ljava/math/BigInteger;Ljava/security/SecureRandom;I)Z
...
.method public ॱ()Lᘢ;
    ...
    sget-object v7, Lgv5;->ʻ:Ljava/math/BigInteger;
    ...
    iget-object v12, v0, Lgv5;->ᐝ:Lfv5;

    invoke-virtual {v12}, Lfv5;->ˎ()Ljava/math/BigInteger;

    move-result-object v15

    :goto_1
    invoke-virtual {v0, v2, v15, v8}, Lgv5;->ˋ(ILjava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v12

    :goto_2
    invoke-virtual {v0, v3, v15, v8}, Lgv5;->ˋ(ILjava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    :cond_2
    invoke-static {v14}, Lnn8;->ʼ(Ljava/math/BigInteger;)I
    ...
    :goto_3
    sget-object v13, Lgv5;->ʻ:Ljava/math/BigInteger;
    ...
    invoke-static {v12, v9}, Lv8;->ˏॱ(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-direct {v0, v11, v14, v15}, Lhv5;-><init>(ZLjava/math/BigInteger;Ljava/math/BigInteger;)V

    new-instance v13, Liv5;
    ...
    invoke-direct/range {v13 .. v21}, Liv5;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    move-object/from16 v1, v22

    invoke-direct {v10, v0, v1}, Lᘢ;-><init>(Lᴫ;Lᴫ;)V
