...
# direct methods
.method public static synthetic $r8$lambda$_bB6QtAd1HZh5dmRw6Jrm_YCiuo(Lorg/telegram/ui/Stories/StoryCaptionView$Panel;Lorg/telegram/tgnet/tl/TL_stories$StoryItem;)V
    .locals 0
...
.method public constructor <init>()V
    ...
    iput-object v7, p0, Lorg/telegram/ui/Stories/StoryCaptionView$Panel;->animatedSmall:Lorg/telegram/ui/Components/AnimatedFloat;
...
.method public static from(Lorg/telegram/tgnet/TLRPC$Document;)Lorg/telegram/ui/Stories/StoryCaptionView$Panel;
    ...
    invoke-static {v1, v2}, Lorg/telegram/messenger/AndroidUtilities;->find(Ljava/util/ArrayList;Ljava/lang/Class;)Ljava/lang/Object;
...
.method public draw(Landroid/graphics/Canvas;F)V
    ...
    iget-object v6, v0, Lorg/telegram/ui/Stories/StoryCaptionView$Panel;->title:Ljava/lang/CharSequence;
    ...
    :goto_1
    invoke-direct {v2, v6, v9, v8}, Lorg/telegram/ui/Components/Text;-><init>(Ljava/lang/CharSequence;FLandroid/graphics/Typeface;)V

    iput-object v2, v0, Lorg/telegram/ui/Stories/StoryCaptionView$Panel;->titleLayout:Lorg/telegram/ui/Components/Text;

    .line 821
    :cond_3
    iget-object v2, v0, Lorg/telegram/ui/Stories/StoryCaptionView$Panel;->textLayout:Lorg/telegram/ui/Components/Text;

    if-eqz v2, :cond_4

    iget-boolean v2, v0, Lorg/telegram/ui/Stories/StoryCaptionView$Panel;->updateText:Z
    ...
    iget-object v6, v0, Lorg/telegram/ui/Stories/StoryCaptionView$Panel;->text:Ljava/lang/CharSequence;
    ...
    iput-object v2, v0, Lorg/telegram/ui/Stories/StoryCaptionView$Panel;->textLayout:Lorg/telegram/ui/Components/Text;

    .line 825
    :cond_6
    iget-object v2, v0, Lorg/telegram/ui/Stories/StoryCaptionView$Panel;->animatedSmall:Lorg/telegram/ui/Components/AnimatedFloat;

    iget-boolean v3, v0, Lorg/telegram/ui/Stories/StoryCaptionView$Panel;->small:Z
    ...
    .line 827
    iget-object v3, v0, Lorg/telegram/ui/Stories/StoryCaptionView$Panel;->backgroundPaint:Landroid/graphics/Paint;
    ...
    invoke-static {v4, v6, v2}, Lorg/telegram/messenger/AndroidUtilities;->lerp(IIF)I

    move-result v4

    int-to-float v4, v4

    iget-object v6, v0, Lorg/telegram/ui/Stories/StoryCaptionView$Panel;->titleLayout:Lorg/telegram/ui/Components/Text;
    ...
    iput v4, v0, Lorg/telegram/ui/Stories/StoryCaptionView$Panel;->width:I
    ...
    invoke-static {v8, v9, v2}, Lorg/telegram/messenger/AndroidUtilities;->lerp(IIF)I
    ...
    invoke-virtual {v7, v9, v9, v11, v13}, Landroid/graphics/Canvas;->scale(FFFF)V
    ...
    invoke-static {v11, v14, v2}, Lorg/telegram/messenger/AndroidUtilities;->lerp(IIF)I
    ...
    invoke-virtual {v7, v14, v11, v11, v15}, Landroid/graphics/Canvas;->drawRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/Paint;)V
    ...
    invoke-virtual {v14, v15, v11, v11, v13}, Landroid/graphics/Path;->addRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/Path$Direction;)V

    .line 841
    iget-object v11, v0, Lorg/telegram/ui/Stories/StoryCaptionView$Panel;->clipRipple:Landroid/graphics/Path;

    invoke-virtual {v7, v11}, Landroid/graphics/Canvas;->clipPath(Landroid/graphics/Path;)Z

    .line 842
    iget-object v11, v0, Lorg/telegram/ui/Stories/StoryCaptionView$Panel;->ripple:Landroid/graphics/drawable/Drawable;

    const/4 v13, 0x0

    invoke-virtual {v11, v13, v13, v4, v8}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    .line 843
    iget-object v8, v0, Lorg/telegram/ui/Stories/StoryCaptionView$Panel;->ripple:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v7, v13, v13, v8, v11}, Landroid/graphics/Canvas;->clipRect(IIII)Z
    ...
    invoke-virtual {v8, v12, v12, v13, v6}, Landroid/graphics/RectF;->set(FFFF)V

    .line 849
    iget-object v6, v0, Lorg/telegram/ui/Stories/StoryCaptionView$Panel;->linePaint:Landroid/graphics/Paint;
    ...
    iget-object v13, v0, Lorg/telegram/ui/Stories/StoryCaptionView$Panel;->linePaint:Landroid/graphics/Paint;

    invoke-virtual {v7, v8, v6, v9, v13}, Landroid/graphics/Canvas;->drawRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/Paint;)V
