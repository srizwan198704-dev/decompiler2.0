...
# direct methods
.method public static synthetic $r8$lambda$PF7f0o2w5VHxpAuWB8WOrnSNic4(Lorg/telegram/ui/Components/conference/message/GroupCallMessageCell;)V
    .locals 0
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v6, p0, Lorg/telegram/ui/Components/conference/message/GroupCallMessageCell;->isSendDelayedAnimator:Lme/vkryl/android/animator/BoolAnimator;
    ...
    iput-object v6, p0, Lorg/telegram/ui/Components/conference/message/GroupCallMessageCell;->isSendErrorAnimator:Lme/vkryl/android/animator/BoolAnimator;

    .line 65
    new-instance v0, Lme/vkryl/android/util/ClickHelper;

    invoke-direct {v0, p0}, Lme/vkryl/android/util/ClickHelper;-><init>(Lme/vkryl/android/util/ClickHelper$Delegate;)V

    iput-object v0, p0, Lorg/telegram/ui/Components/conference/message/GroupCallMessageCell;->clickHelper:Lme/vkryl/android/util/ClickHelper;
    ...
    iput-object v0, p0, Lorg/telegram/ui/Components/conference/message/GroupCallMessageCell;->bgPaint:Landroid/graphics/Paint;
    ...
    iput-object v2, p0, Lorg/telegram/ui/Components/conference/message/GroupCallMessageCell;->errPaint:Landroid/graphics/Paint;
    ...
    iput-object v3, p0, Lorg/telegram/ui/Components/conference/message/GroupCallMessageCell;->flickerDrawable:Lorg/telegram/ui/Components/voip/CellFlickerDrawable;

    .line 104
    new-instance v4, Lorg/telegram/ui/Components/conference/message/GroupCallMessageCell$$ExternalSyntheticLambda0;

    invoke-direct {v4, p0}, Lorg/telegram/ui/Components/conference/message/GroupCallMessageCell$$ExternalSyntheticLambda0;-><init>(Lorg/telegram/ui/Components/conference/message/GroupCallMessageCell;)V

    iput-object v4, p0, Lorg/telegram/ui/Components/conference/message/GroupCallMessageCell;->onMessageStateUpdateListener:Ljava/lang/Runnable;

    .line 199
    new-instance v4, Lorg/telegram/ui/Components/conference/message/GroupCallMessageCell$1;

    invoke-direct {v4, p0}, Lorg/telegram/ui/Components/conference/message/GroupCallMessageCell$1;-><init>(Lorg/telegram/ui/Components/conference/message/GroupCallMessageCell;)V

    iput-object v4, p0, Lorg/telegram/ui/Components/conference/message/GroupCallMessageCell;->senderNameSpan:Landroid/text/style/ClickableSpan;
    ...
    iput-object v4, p0, Lorg/telegram/ui/Components/conference/message/GroupCallMessageCell;->tmpRectF:Landroid/graphics/RectF;
    ...
    iput-object v4, p0, Lorg/telegram/ui/Components/conference/message/GroupCallMessageCell;->messageTextView:Lorg/telegram/ui/Components/spoilers/SpoilersTextView;

    .line 85
    invoke-virtual {v4, v1}, Lorg/telegram/ui/Components/spoilers/SpoilersTextView;->setDisablePaddingsOffset(Z)V
    ...
    iput-object v0, p0, Lorg/telegram/ui/Components/conference/message/GroupCallMessageCell;->avatarReceiver:Lorg/telegram/messenger/ImageReceiver;
    ...
    invoke-virtual {v3, v0}, Lorg/telegram/ui/Components/voip/CellFlickerDrawable;->setStrokeWidth(F)V
    ...
    iput-object v0, p0, Lorg/telegram/ui/Components/conference/message/GroupCallMessageCell;->animatedReactionReceiver:Lorg/telegram/messenger/ImageReceiver;
...
.method static synthetic access$000(Lorg/telegram/ui/Components/conference/message/GroupCallMessageCell;)Lorg/telegram/ui/Components/conference/message/GroupCallMessageCell$Delegate;
    .locals 0
...
.method static synthetic access$100(Lorg/telegram/ui/Components/conference/message/GroupCallMessageCell;)Lorg/telegram/messenger/voip/GroupCallMessage;
    .locals 0
...
.method public synthetic forceEnableVibration()Z
    .locals 1

    .line 0
    invoke-static {p0}, Lme/vkryl/android/util/ClickHelper$Delegate$-CC;->$default$forceEnableVibration(Lme/vkryl/android/util/ClickHelper$Delegate;)Z
...
.method public bridge synthetic getLongPressDuration()J
    ...
    invoke-static {p0}, Lme/vkryl/android/util/ClickHelper$Delegate$-CC;->$default$getLongPressDuration(Lme/vkryl/android/util/ClickHelper$Delegate;)J
...
.method public synthetic ignoreHapticFeedbackSettings(FF)Z
    .locals 0

    .line 0
    invoke-static {p0, p1, p2}, Lme/vkryl/android/util/ClickHelper$Delegate$-CC;->$default$ignoreHapticFeedbackSettings(Lme/vkryl/android/util/ClickHelper$Delegate;FF)Z
...
.method public synthetic needLongPress(FF)Z
    .locals 0

    .line 0
    invoke-static {p0, p1, p2}, Lme/vkryl/android/util/ClickHelper$Delegate$-CC;->$default$needLongPress(Lme/vkryl/android/util/ClickHelper$Delegate;FF)Z
...
.method public synthetic onClickTouchDown(Landroid/view/View;FF)V
    .locals 0

    .line 0
    invoke-static {p0, p1, p2, p3}, Lme/vkryl/android/util/ClickHelper$Delegate$-CC;->$default$onClickTouchDown(Lme/vkryl/android/util/ClickHelper$Delegate;Landroid/view/View;FF)V

    return-void
.end method

.method public synthetic onClickTouchMove(Landroid/view/View;FF)V
    .locals 0

    .line 0
    invoke-static {p0, p1, p2, p3}, Lme/vkryl/android/util/ClickHelper$Delegate$-CC;->$default$onClickTouchMove(Lme/vkryl/android/util/ClickHelper$Delegate;Landroid/view/View;FF)V

    return-void
.end method

.method public synthetic onClickTouchUp(Landroid/view/View;FF)V
    .locals 0

    .line 0
    invoke-static {p0, p1, p2, p3}, Lme/vkryl/android/util/ClickHelper$Delegate$-CC;->$default$onClickTouchUp(Lme/vkryl/android/util/ClickHelper$Delegate;Landroid/view/View;FF)V
...
.method public synthetic onLongPressCancelled(Landroid/view/View;FF)V
    .locals 0

    .line 0
    invoke-static {p0, p1, p2, p3}, Lme/vkryl/android/util/ClickHelper$Delegate$-CC;->$default$onLongPressCancelled(Lme/vkryl/android/util/ClickHelper$Delegate;Landroid/view/View;FF)V

    return-void
.end method

.method public synthetic onLongPressFinish(Landroid/view/View;FF)V
    .locals 0

    .line 0
    invoke-static {p0, p1, p2, p3}, Lme/vkryl/android/util/ClickHelper$Delegate$-CC;->$default$onLongPressFinish(Lme/vkryl/android/util/ClickHelper$Delegate;Landroid/view/View;FF)V

    return-void
.end method

.method public synthetic onLongPressMove(Landroid/view/View;Landroid/view/MotionEvent;FFFF)V
    .locals 0

    .line 0
    invoke-static/range {p0 .. p6}, Lme/vkryl/android/util/ClickHelper$Delegate$-CC;->$default$onLongPressMove(Lme/vkryl/android/util/ClickHelper$Delegate;Landroid/view/View;Landroid/view/MotionEvent;FFFF)V

    return-void
.end method

.method public synthetic onLongPressRequestedAt(Landroid/view/View;FF)Z
    .locals 0

    .line 0
    invoke-static {p0, p1, p2, p3}, Lme/vkryl/android/util/ClickHelper$Delegate$-CC;->$default$onLongPressRequestedAt(Lme/vkryl/android/util/ClickHelper$Delegate;Landroid/view/View;FF)Z
