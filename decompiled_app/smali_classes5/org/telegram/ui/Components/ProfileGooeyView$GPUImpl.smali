...
.method private constructor <init>(Lorg/telegram/ui/Components/ProfileGooeyView;F)V
    ...
    invoke-static {p1, p2}, Lorg/telegram/messenger/ImageReceiver$$ExternalSyntheticApiModelOutline1;->m(Landroid/graphics/Paint;Landroid/graphics/BlendMode;)V

    return-void
.end method

.method synthetic constructor <init>(Lorg/telegram/ui/Components/ProfileGooeyView;FLorg/telegram/ui/Components/ProfileGooeyView$1;)V
    .locals 0
...
.method public draw(Lorg/telegram/ui/Components/ProfileGooeyView$Drawer;Landroid/graphics/Canvas;)V
    ...
    invoke-static {v9, v3, v3, v2, v4}, Lorg/telegram/messenger/BotFullscreenButtons$$ExternalSyntheticApiModelOutline5;->m(Landroid/graphics/RenderNode;IIII)Z
    ...
    invoke-virtual {v9, v5, v5, v2, v4}, Landroid/graphics/RectF;->set(FFFF)V

    .line 343
    iget-object v9, v0, Lorg/telegram/ui/Components/ProfileGooeyView$GPUImpl;->node:Landroid/graphics/RenderNode;

    invoke-static {v9}, Lorg/telegram/messenger/BotFullscreenButtons$$ExternalSyntheticApiModelOutline6;->m(Landroid/graphics/RenderNode;)Landroid/graphics/RecordingCanvas;
    ...
    .line 345
    iget-object v12, v0, Lorg/telegram/ui/Components/ProfileGooeyView$GPUImpl;->this$0:Lorg/telegram/ui/Components/ProfileGooeyView;

    invoke-static {v12}, Lorg/telegram/ui/Components/ProfileGooeyView;->access$500(Lorg/telegram/ui/Components/ProfileGooeyView;)F
    ...
    invoke-static {v12, v13, v14}, Lorg/telegram/messenger/AndroidUtilities;->ilerp(FFF)F
    ...
    .line 346
    invoke-static {v15, v3, v12}, Landroidx/core/math/MathUtils;->clamp(III)I
    ...
    .line 347
    invoke-interface {v3, v9}, Lorg/telegram/ui/Components/ProfileGooeyView$Drawer;->draw(Landroid/graphics/Canvas;)V

    .line 348
    iget-object v3, v0, Lorg/telegram/ui/Components/ProfileGooeyView$GPUImpl;->node:Landroid/graphics/RenderNode;

    invoke-static {v3}, Lorg/telegram/messenger/BotFullscreenButtons$$ExternalSyntheticApiModelOutline8;->m(Landroid/graphics/RenderNode;)V
    ...
    invoke-static {v9}, Lorg/telegram/ui/Components/ProfileGooeyView;->access$200(Lorg/telegram/ui/Components/ProfileGooeyView;)F

    move-result v9

    mul-float v9, v9, v13

    iget v13, v0, Lorg/telegram/ui/Components/ProfileGooeyView$GPUImpl;->factorMult:F
    ...
    .line 352
    iget-object v13, v0, Lorg/telegram/ui/Components/ProfileGooeyView$GPUImpl;->blurNode:Landroid/graphics/RenderNode;

    invoke-static {v13}, Lorg/telegram/messenger/BotFullscreenButtons$$ExternalSyntheticApiModelOutline6;->m(Landroid/graphics/RenderNode;)Landroid/graphics/RecordingCanvas;
    ...
    .line 353
    invoke-virtual {v13, v12, v12, v5, v5}, Landroid/graphics/Canvas;->scale(FFFF)V

    .line 354
    iget-object v12, v0, Lorg/telegram/ui/Components/ProfileGooeyView$GPUImpl;->node:Landroid/graphics/RenderNode;

    invoke-static {v13, v12}, Lorg/telegram/messenger/BotFullscreenButtons$$ExternalSyntheticApiModelOutline7;->m(Landroid/graphics/Canvas;Landroid/graphics/RenderNode;)V

    .line 355
    iget-object v12, v0, Lorg/telegram/ui/Components/ProfileGooeyView$GPUImpl;->blurNode:Landroid/graphics/RenderNode;

    invoke-static {v12}, Lorg/telegram/messenger/BotFullscreenButtons$$ExternalSyntheticApiModelOutline8;->m(Landroid/graphics/RenderNode;)V
    ...
    invoke-static {v12}, Lorg/telegram/messenger/BotFullscreenButtons$$ExternalSyntheticApiModelOutline6;->m(Landroid/graphics/RenderNode;)Landroid/graphics/RecordingCanvas;
    ...
    invoke-virtual {v12, v5, v9}, Landroid/graphics/Canvas;->saveLayer(Landroid/graphics/RectF;Landroid/graphics/Paint;)I

    .line 363
    iget-object v5, v0, Lorg/telegram/ui/Components/ProfileGooeyView$GPUImpl;->node:Landroid/graphics/RenderNode;

    invoke-static {v12, v5}, Lorg/telegram/messenger/BotFullscreenButtons$$ExternalSyntheticApiModelOutline7;->m(Landroid/graphics/Canvas;Landroid/graphics/RenderNode;)V

    .line 364
    iget-object v5, v0, Lorg/telegram/ui/Components/ProfileGooeyView$GPUImpl;->wholeOptimized:Landroid/graphics/RectF;

    iget-object v9, v0, Lorg/telegram/ui/Components/ProfileGooeyView$GPUImpl;->blackNodePaint:Landroid/graphics/Paint;

    invoke-virtual {v12, v5, v9}, Landroid/graphics/Canvas;->drawRect(Landroid/graphics/RectF;Landroid/graphics/Paint;)V
    ...
    invoke-static {v9}, Lorg/telegram/ui/Components/ProfileGooeyView;->access$500(Lorg/telegram/ui/Components/ProfileGooeyView;)F
    ...
    invoke-static {v13, v5, v13, v15, v9}, Lorg/telegram/messenger/AndroidUtilities;->lerp(FFFFF)F
    ...
    invoke-static {v4}, Lorg/telegram/ui/Components/ProfileGooeyView;->access$600(Lorg/telegram/ui/Components/ProfileGooeyView;)Landroid/graphics/Path;
    ...
    invoke-virtual {v4, v9, v7}, Landroid/graphics/Path;->moveTo(FF)V
    ...
    invoke-virtual {v4, v13, v7}, Landroid/graphics/Path;->lineTo(FF)V
    ...
    invoke-virtual {v4, v13, v15}, Landroid/graphics/Path;->lineTo(FF)V
    ...
    invoke-virtual {v12, v3, v4}, Landroid/graphics/Canvas;->drawPath(Landroid/graphics/Path;Landroid/graphics/Paint;)V
    ...
    invoke-virtual {v12, v4, v6}, Landroid/graphics/Canvas;->saveLayerAlpha(Landroid/graphics/RectF;I)I

    .line 385
    :cond_5
    iget-object v4, v0, Lorg/telegram/ui/Components/ProfileGooeyView$GPUImpl;->node:Landroid/graphics/RenderNode;

    invoke-static {v12, v4}, Lorg/telegram/messenger/BotFullscreenButtons$$ExternalSyntheticApiModelOutline7;->m(Landroid/graphics/Canvas;Landroid/graphics/RenderNode;)V
    ...
    .line 393
    invoke-virtual {v4, v14, v14, v6, v6}, Landroid/graphics/Canvas;->scale(FFFF)V
    ...
    iget-object v7, v6, Lorg/telegram/ui/Components/ProfileGooeyView;->notchInfo:Lorg/telegram/messenger/NotchInfoUtils$NotchInfo;

    iget-boolean v8, v7, Lorg/telegram/messenger/NotchInfoUtils$NotchInfo;->isLikelyCircle:Z

    if-eqz v8, :cond_7

    .line 398
    iget-object v6, v7, Lorg/telegram/messenger/NotchInfoUtils$NotchInfo;->bounds:Landroid/graphics/RectF;
    ...
    .line 399
    iget-object v8, v0, Lorg/telegram/ui/Components/ProfileGooeyView$GPUImpl;->this$0:Lorg/telegram/ui/Components/ProfileGooeyView;

    iget-object v8, v8, Lorg/telegram/ui/Components/ProfileGooeyView;->notchInfo:Lorg/telegram/messenger/NotchInfoUtils$NotchInfo;

    iget-object v8, v8, Lorg/telegram/messenger/NotchInfoUtils$NotchInfo;->bounds:Landroid/graphics/RectF;
    ...
    invoke-static {v8}, Lorg/telegram/ui/Components/ProfileGooeyView;->access$300(Lorg/telegram/ui/Components/ProfileGooeyView;)Landroid/graphics/Paint;

    move-result-object v8

    invoke-virtual {v4, v7, v9, v6, v8}, Landroid/graphics/Canvas;->drawCircle(FFFLandroid/graphics/Paint;)V
    ...
    .line 408
    :cond_7
    iget-boolean v8, v7, Lorg/telegram/messenger/NotchInfoUtils$NotchInfo;->isAccurate:Z

    if-eqz v8, :cond_8

    .line 409
    iget-object v5, v7, Lorg/telegram/messenger/NotchInfoUtils$NotchInfo;->path:Landroid/graphics/Path;
    ...
    invoke-virtual {v4, v7, v6, v6, v8}, Landroid/graphics/Canvas;->drawRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/Paint;)V

    .line 415
    iget-object v6, v0, Lorg/telegram/ui/Components/ProfileGooeyView$GPUImpl;->this$0:Lorg/telegram/ui/Components/ProfileGooeyView;

    invoke-static {v6}, Lorg/telegram/ui/Components/ProfileGooeyView;->access$600(Lorg/telegram/ui/Components/ProfileGooeyView;)Landroid/graphics/Path;
    ...
    iget-object v9, v0, Lorg/telegram/ui/Components/ProfileGooeyView$GPUImpl;->temp:Landroid/graphics/RectF;
    ...
    invoke-static {v8}, Lorg/telegram/ui/Components/ProfileGooeyView;->access$600(Lorg/telegram/ui/Components/ProfileGooeyView;)Landroid/graphics/Path;
    ...
    invoke-virtual {v4, v5, v8}, Landroid/graphics/Canvas;->drawPath(Landroid/graphics/Path;Landroid/graphics/Paint;)V
    ...
    invoke-virtual {v1, v5, v4, v2, v8}, Landroid/graphics/Canvas;->clipRect(FFFF)Z

    .line 443
    :cond_a
    iget-object v2, v0, Lorg/telegram/ui/Components/ProfileGooeyView$GPUImpl;->wholeOptimized:Landroid/graphics/RectF;

    iget-object v4, v0, Lorg/telegram/ui/Components/ProfileGooeyView$GPUImpl;->filter:Landroid/graphics/Paint;

    invoke-virtual {v1, v2, v4}, Landroid/graphics/Canvas;->saveLayer(Landroid/graphics/RectF;Landroid/graphics/Paint;)I
    ...
    invoke-static {v15, v2, v3}, Landroidx/core/math/MathUtils;->clamp(III)I
    ...
    invoke-static {v1, v5}, Lorg/telegram/messenger/BotFullscreenButtons$$ExternalSyntheticApiModelOutline7;->m(Landroid/graphics/Canvas;Landroid/graphics/RenderNode;)V
    ...
    .line 472
    iget-object v4, v0, Lorg/telegram/ui/Components/ProfileGooeyView$GPUImpl;->blurNode:Landroid/graphics/RenderNode;

    invoke-static {v1, v4}, Lorg/telegram/messenger/BotFullscreenButtons$$ExternalSyntheticApiModelOutline7;->m(Landroid/graphics/Canvas;Landroid/graphics/RenderNode;)V
...
.method public synthetic onSizeChanged(II)V
    .locals 0

    .line 0
    invoke-static {p0, p1, p2}, Lorg/telegram/ui/Components/ProfileGooeyView$Impl$-CC;->$default$onSizeChanged(Lorg/telegram/ui/Components/ProfileGooeyView$Impl;II)V
...
.method public setBlurIntensity(F)V
    ...
    invoke-static {v1, p1, v2}, Lorg/telegram/messenger/BotFullscreenButtons$$ExternalSyntheticApiModelOutline0;->m(FFLandroid/graphics/Shader$TileMode;)Landroid/graphics/RenderEffect;
...
.method public setIntensity(F)V
    ...
    invoke-static {v0, v2}, Lorg/telegram/messenger/BotFullscreenButtons$$ExternalSyntheticApiModelOutline1;->m(Landroid/graphics/RenderNode;Landroid/graphics/RenderEffect;)Z
