...
.method private static synthetic lambda$openStickerPickerDialog$10(Lorg/telegram/ui/ActionBar/AlertDialog;ILorg/telegram/tgnet/TLRPC$Document;Ljava/lang/Object;Lorg/telegram/tgnet/TLRPC$TL_stickers_addStickerToSet;Lorg/telegram/tgnet/TLObject;Lorg/telegram/tgnet/TLRPC$TL_error;)V
    ...
    .line 204
    new-instance v8, Lorg/telegram/ui/Components/StickersDialogs$$ExternalSyntheticLambda11;
...
.method private static synthetic lambda$openStickerPickerDialog$11(ILandroid/content/Context;Lorg/telegram/tgnet/TLRPC$TL_messages_stickerSet;Ljava/lang/Object;Lorg/telegram/tgnet/TLRPC$Document;Ljava/lang/Boolean;)Ljava/lang/Boolean;
    ...
    invoke-direct {p5, p1, v1}, Lorg/telegram/ui/ActionBar/AlertDialog;-><init>(Landroid/content/Context;I)V

    .line 201
    new-instance p1, Lorg/telegram/tgnet/TLRPC$TL_stickers_addStickerToSet;

    invoke-direct {p1}, Lorg/telegram/tgnet/TLRPC$TL_stickers_addStickerToSet;-><init>()V
    ...
    iput-object p2, p1, Lorg/telegram/tgnet/TLRPC$TL_stickers_addStickerToSet;->stickerset:Lorg/telegram/tgnet/TLRPC$InputStickerSet;
    ...
    iput-object p2, p1, Lorg/telegram/tgnet/TLRPC$TL_stickers_addStickerToSet;->sticker:Lorg/telegram/tgnet/TLRPC$TL_inputStickerSetItem;
    ...
    new-instance v0, Lorg/telegram/ui/Components/StickersDialogs$$ExternalSyntheticLambda9;
    ...
    invoke-direct/range {v1 .. v6}, Lorg/telegram/ui/Components/StickersDialogs$$ExternalSyntheticLambda9;-><init>(Lorg/telegram/ui/ActionBar/AlertDialog;ILorg/telegram/tgnet/TLRPC$Document;Ljava/lang/Object;Lorg/telegram/tgnet/TLRPC$TL_stickers_addStickerToSet;)V
    ...
    .line 222
    :try_start_0
    invoke-virtual {p5, p0, p1}, Lorg/telegram/ui/ActionBar/AlertDialog;->showDelayed(J)V
    :try_end_0
...
.method private static synthetic lambda$openStickerPickerDialog$9(Lorg/telegram/ui/ActionBar/AlertDialog;Lorg/telegram/tgnet/TLObject;ILorg/telegram/tgnet/TLRPC$Document;Lorg/telegram/tgnet/TLRPC$TL_error;Ljava/lang/Object;Lorg/telegram/tgnet/TLRPC$TL_stickers_addStickerToSet;)V
    ...
    invoke-direct {p0, p1, p3}, Lorg/telegram/ui/Components/StickersDialogs$$ExternalSyntheticLambda12;-><init>(Lorg/telegram/tgnet/TLObject;Lorg/telegram/tgnet/TLRPC$Document;)V
...
.method private static synthetic lambda$showNameEditorDialog$2(Lorg/telegram/ui/Components/EditTextBoldCursor;Lorg/telegram/messenger/Utilities$Callback2;Landroid/content/Context;ZLorg/telegram/ui/ActionBar/AlertDialog;I)V
    ...
    .line 128
    new-instance p2, Lorg/telegram/ui/Components/StickersDialogs$$ExternalSyntheticLambda6;

    invoke-direct {p2, v0, p4, p0}, Lorg/telegram/ui/Components/StickersDialogs$$ExternalSyntheticLambda6;-><init>(Lorg/telegram/ui/ActionBar/AlertDialog;Lorg/telegram/ui/ActionBar/AlertDialog;Lorg/telegram/ui/Components/EditTextBoldCursor;)V
...
.method public static showAddStickerDialog(Lorg/telegram/tgnet/TLRPC$TL_messages_stickerSet;Landroid/view/View;Lorg/telegram/ui/ActionBar/BaseFragment;Lorg/telegram/ui/ActionBar/Theme$ResourcesProvider;)V
    ...
    .line 236
    instance-of v2, v5, Lorg/telegram/ui/ChatActivity;
    ...
    .line 237
    invoke-static {p0, v5, v7}, Lorg/telegram/ui/Components/StickersDialogs;->openStickerPickerDialog(Lorg/telegram/tgnet/TLRPC$TL_messages_stickerSet;Lorg/telegram/ui/ActionBar/BaseFragment;Lorg/telegram/ui/ActionBar/Theme$ResourcesProvider;)V
    ...
    invoke-direct {v8, v1, v2, v7, v9}, Lorg/telegram/ui/ActionBar/ActionBarPopupWindow$ActionBarPopupWindowLayout;-><init>(Landroid/content/Context;ILorg/telegram/ui/ActionBar/Theme$ResourcesProvider;I)V
    ...
    .line 245
    sget v1, Lorg/telegram/messenger/R$string;->StickersCreateNewSticker:I
    ...
    .line 249
    sget v1, Lorg/telegram/messenger/R$string;->StickersAddAnExistingSticker:I
    ...
    .line 250
    sget v1, Lorg/telegram/messenger/R$drawable;->menu_sticker_select:I
    ...
    .line 253
    new-instance v13, Lorg/telegram/ui/ActionBar/ActionBarPopupWindow;

    const/4 v1, -0x2

    invoke-direct {v13, v8, v1, v1}, Lorg/telegram/ui/ActionBar/ActionBarPopupWindow;-><init>(Landroid/view/View;II)V

    .line 254
    new-instance v14, Lorg/telegram/ui/Components/StickersDialogs$$ExternalSyntheticLambda4;
    ...
    invoke-direct/range {v1 .. v6}, Lorg/telegram/ui/Components/StickersDialogs$$ExternalSyntheticLambda4;-><init>(Lorg/telegram/ui/ActionBar/ActionBarPopupWindow;Ljava/util/ArrayList;Lorg/telegram/tgnet/TLRPC$TL_messages_stickerSet;Lorg/telegram/ui/ActionBar/BaseFragment;Lorg/telegram/ui/ActionBar/Theme$ResourcesProvider;)V
    ...
    invoke-static {v8, v2, v3, v9, v7}, Lorg/telegram/ui/ActionBar/ActionBarMenuItem;->addItem(Landroid/view/ViewGroup;ILjava/lang/CharSequence;ZLorg/telegram/ui/ActionBar/Theme$ResourcesProvider;)Lorg/telegram/ui/ActionBar/ActionBarMenuSubItem;
    ...
    .line 271
    invoke-virtual {v13, v1}, Lorg/telegram/ui/ActionBar/ActionBarPopupWindow;->setDismissAnimationDuration(I)V

    .line 272
    invoke-virtual {v13, v12}, Lorg/telegram/ui/ActionBar/ActionBarPopupWindow;->setScaleOut(Z)V

    .line 273
    invoke-virtual {v13, v12}, Landroid/widget/PopupWindow;->setOutsideTouchable(Z)V

    .line 274
    invoke-virtual {v13, v12}, Landroid/widget/PopupWindow;->setClippingEnabled(Z)V
    ...
    invoke-virtual {v13, v0, v9, v3, v2}, Lorg/telegram/ui/ActionBar/ActionBarPopupWindow;->showAtLocation(Landroid/view/View;III)V

    .line 283
    invoke-virtual {v13}, Lorg/telegram/ui/ActionBar/ActionBarPopupWindow;->dimBehind()V
...
.method public static showDeleteForEveryOneDialog(Lorg/telegram/tgnet/TLRPC$StickerSet;Lorg/telegram/ui/ActionBar/Theme$ResourcesProvider;Landroid/content/Context;Ljava/lang/Runnable;)V
    ...
    new-instance v1, Lorg/telegram/ui/Components/StickersDialogs$$ExternalSyntheticLambda5;

    invoke-direct {v1, p3, p0}, Lorg/telegram/ui/Components/StickersDialogs$$ExternalSyntheticLambda5;-><init>(Ljava/lang/Runnable;Lorg/telegram/tgnet/TLRPC$StickerSet;)V
...
.method public static showNameEditorDialog(Lorg/telegram/tgnet/TLRPC$StickerSet;Lorg/telegram/ui/ActionBar/Theme$ResourcesProvider;Landroid/content/Context;Lorg/telegram/messenger/Utilities$Callback2;)V
    ...
    invoke-direct {v4, v2, v1}, Lorg/telegram/ui/ActionBar/AlertDialog$Builder;-><init>(Landroid/content/Context;Lorg/telegram/ui/ActionBar/Theme$ResourcesProvider;)V
    ...
    .line 51
    sget v8, Lorg/telegram/messenger/R$string;->EditStickerPack:I

    goto :goto_1

    :cond_1
    sget v8, Lorg/telegram/messenger/R$string;->NewStickerPack:I
    ...
    invoke-virtual {v4, v8}, Lorg/telegram/ui/ActionBar/AlertDialog$Builder;->setTitle(Ljava/lang/CharSequence;)Lorg/telegram/ui/ActionBar/AlertDialog$Builder;

    .line 52
    sget v8, Lorg/telegram/messenger/R$string;->StickersChooseNameForStickerPack:I

    invoke-static {v8}, Lorg/telegram/messenger/LocaleController;->getString(I)Ljava/lang/String;

    move-result-object v8

    invoke-virtual {v4, v8}, Lorg/telegram/ui/ActionBar/AlertDialog$Builder;->setMessage(Ljava/lang/CharSequence;)Lorg/telegram/ui/ActionBar/AlertDialog$Builder;
    ...
    invoke-virtual {v8, v9, v6, v10, v6}, Landroid/view/View;->setPadding(IIII)V

    .line 55
    new-instance v9, Lorg/telegram/ui/Components/StickersDialogs$1;

    invoke-direct {v9, v2}, Lorg/telegram/ui/Components/StickersDialogs$1;-><init>(Landroid/content/Context;)V

    .line 61
    sget v10, Lorg/telegram/ui/ActionBar/Theme;->key_dialogTextBlack:I

    invoke-static {v10, v1}, Lorg/telegram/ui/Components/StickersDialogs;->getThemedColor(ILorg/telegram/ui/ActionBar/Theme$ResourcesProvider;)I
    ...
    .line 63
    invoke-virtual {v9, v5, v11}, Lorg/telegram/ui/Components/EditTextBoldCursor;->setTextSize(IF)V
    ...
    .line 65
    sget v10, Lorg/telegram/ui/ActionBar/Theme;->key_chat_TextSelectionCursor:I

    invoke-static {v10, v1}, Lorg/telegram/ui/Components/StickersDialogs;->getThemedColor(ILorg/telegram/ui/ActionBar/Theme$ResourcesProvider;)I

    move-result v10

    invoke-virtual {v9, v10}, Lorg/telegram/ui/Components/EditTextBoldCursor;->setHandlesColor(I)V
    ...
    .line 72
    new-instance v12, Lorg/telegram/ui/Components/StickersDialogs$$ExternalSyntheticLambda0;

    invoke-direct {v12, v9}, Lorg/telegram/ui/Components/StickersDialogs$$ExternalSyntheticLambda0;-><init>(Lorg/telegram/ui/Components/EditTextBoldCursor;)V
    ...
    .line 78
    invoke-virtual {v9, v13}, Landroid/widget/TextView;->setFilters([Landroid/text/InputFilter;)V
    ...
    invoke-static {v12, v1}, Lorg/telegram/ui/Components/StickersDialogs;->getThemedColor(ILorg/telegram/ui/ActionBar/Theme$ResourcesProvider;)I
    ...
    invoke-virtual {v9, v10, v12, v1}, Lorg/telegram/ui/Components/EditTextBoldCursor;->setLineColors(III)V
    ...
    invoke-virtual {v9, v1, v6, v10, v6}, Landroid/view/View;->setPadding(IIII)V
    ...
    .line 87
    invoke-virtual {v1, v5}, Lorg/telegram/ui/Components/NumberTextView;->setCenterAlign(Z)V

    const/16 v5, 0xf

    .line 88
    invoke-virtual {v1, v5}, Lorg/telegram/ui/Components/NumberTextView;->setTextSize(I)V

    .line 89
    invoke-virtual {v1, v11, v6}, Lorg/telegram/ui/Components/NumberTextView;->setNumber(IZ)V
    ...
    invoke-virtual {v1, v5}, Lorg/telegram/ui/Components/NumberTextView;->setTextColor(I)V
    ...
    .line 93
    new-instance v3, Lorg/telegram/ui/Components/StickersDialogs$2;

    invoke-direct {v3, v1, v9}, Lorg/telegram/ui/Components/StickersDialogs$2;-><init>(Lorg/telegram/ui/Components/NumberTextView;Lorg/telegram/ui/Components/EditTextBoldCursor;)V

    invoke-virtual {v9, v3}, Lorg/telegram/ui/Components/EditTextBoldCursor;->addTextChangedListener(Landroid/text/TextWatcher;)V
    ...
    .line 114
    :cond_5
    invoke-virtual {v4, v8}, Lorg/telegram/ui/ActionBar/AlertDialog$Builder;->setView(Landroid/view/View;)Lorg/telegram/ui/ActionBar/AlertDialog$Builder;

    const/4 v0, 0x4

    .line 115
    invoke-virtual {v4, v0}, Lorg/telegram/ui/ActionBar/AlertDialog$Builder;->setCustomViewOffset(I)Lorg/telegram/ui/ActionBar/AlertDialog$Builder;
    ...
    invoke-direct {v1, v9, v3, v2, v7}, Lorg/telegram/ui/Components/StickersDialogs$$ExternalSyntheticLambda1;-><init>(Lorg/telegram/ui/Components/EditTextBoldCursor;Lorg/telegram/messenger/Utilities$Callback2;Landroid/content/Context;Z)V
    ...
    invoke-direct {v1, v9}, Lorg/telegram/ui/Components/StickersDialogs$$ExternalSyntheticLambda2;-><init>(Lorg/telegram/ui/Components/EditTextBoldCursor;)V
    ...
    .line 146
    invoke-virtual {v0, v6}, Lorg/telegram/ui/ActionBar/AlertDialog;->setDismissDialogByButtons(Z)V
