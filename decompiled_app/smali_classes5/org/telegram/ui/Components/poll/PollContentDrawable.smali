...
.method private setMediaImpl(Lorg/telegram/tgnet/TLRPC$MessageMedia;Ljava/lang/Object;ILjava/lang/String;)Z
    ...
    .line 200
    instance-of v6, v1, Lorg/telegram/tgnet/TLRPC$TL_messageMediaEmpty;
    ...
    .line 204
    :cond_0
    instance-of v6, v1, Lorg/telegram/tgnet/TLRPC$TL_messageMediaPhoto;
    ...
    invoke-static {v7, v8, v4, v6, v4}, Lorg/telegram/messenger/FileLoader;->getClosestPhotoSizeWithSize(Ljava/util/ArrayList;IZLorg/telegram/tgnet/TLRPC$PhotoSize;Z)Lorg/telegram/tgnet/TLRPC$PhotoSize;
    ...
    .line 215
    :cond_1
    iget v8, v7, Lorg/telegram/tgnet/TLRPC$PhotoSize;->w:I

    iput v8, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->mediaWidth:I

    .line 216
    iget v9, v7, Lorg/telegram/tgnet/TLRPC$PhotoSize;->h:I

    iput v9, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->mediaHeight:I
    ...
    .line 222
    iget-object v11, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->imageReceiver:Lorg/telegram/messenger/ImageReceiver;
    ...
    .line 233
    :cond_3
    instance-of v6, v1, Lorg/telegram/tgnet/TLRPC$TL_messageMediaGeo;

    if-nez v6, :cond_f

    instance-of v6, v1, Lorg/telegram/tgnet/TLRPC$TL_messageMediaVenue;
    ...
    invoke-direct {v6, v7, v8, v3, v9}, Lorg/telegram/ui/Components/poll/FileState;-><init>(ILorg/telegram/messenger/MessageObject;Lorg/telegram/tgnet/TLRPC$Document;Ljava/lang/String;)V
    ...
    .line 264
    invoke-static {v3}, Lorg/telegram/messenger/MessageObject;->isMusicDocument(Lorg/telegram/tgnet/TLRPC$Document;)Z
    ...
    .line 265
    iput-boolean v4, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->isMusic:Z

    .line 266
    invoke-static {v3, v4}, Lorg/telegram/messenger/MessageObject;->getMusicTitle(Lorg/telegram/tgnet/TLRPC$Document;Z)Ljava/lang/String;
    ...
    .line 267
    invoke-static {v3, v4}, Lorg/telegram/messenger/MessageObject;->getMusicAuthor(Lorg/telegram/tgnet/TLRPC$Document;Z)Ljava/lang/String;
    ...
    .line 270
    :goto_2
    iget-object v2, v3, Lorg/telegram/tgnet/TLRPC$Document;->attributes:Ljava/util/ArrayList;
    ...
    .line 278
    :goto_3
    invoke-static {v3}, Lorg/telegram/messenger/MessageObject;->isDocumentHasThumb(Lorg/telegram/tgnet/TLRPC$Document;)Z
    ...
    .line 279
    iget-object v7, v3, Lorg/telegram/tgnet/TLRPC$Document;->thumbs:Ljava/util/ArrayList;
    ...
    invoke-static {v7, v8, v4, v6, v5}, Lorg/telegram/messenger/FileLoader;->getClosestPhotoSizeWithSize(Ljava/util/ArrayList;IZLorg/telegram/tgnet/TLRPC$PhotoSize;Z)Lorg/telegram/tgnet/TLRPC$PhotoSize;

    move-result-object v5

    .line 280
    iget-object v6, v3, Lorg/telegram/tgnet/TLRPC$Document;->thumbs:Ljava/util/ArrayList;
    ...
    invoke-static {v6, v7, v4, v5, v4}, Lorg/telegram/messenger/FileLoader;->getClosestPhotoSizeWithSize(Ljava/util/ArrayList;IZLorg/telegram/tgnet/TLRPC$PhotoSize;Z)Lorg/telegram/tgnet/TLRPC$PhotoSize;
    ...
    invoke-virtual {v7, v6, v5, v3, v8}, Lorg/telegram/ui/Components/RadialProgress2;->setImageOverlay(Lorg/telegram/tgnet/TLRPC$PhotoSize;Lorg/telegram/tgnet/TLRPC$PhotoSize;Lorg/telegram/tgnet/TLRPC$Document;Ljava/lang/Object;)V

    goto :goto_4

    .line 283
    :cond_9
    invoke-static {v3, v4}, Lorg/telegram/messenger/MessageObject;->getArtworkUrl(Lorg/telegram/tgnet/TLRPC$Document;Z)Ljava/lang/String;
    ...
    .line 285
    iget-object v5, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->radialProgress:Lorg/telegram/ui/Components/RadialProgress2;

    invoke-virtual {v5, v3}, Lorg/telegram/ui/Components/RadialProgress2;->setImageOverlay(Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v6, v6, v6}, Lorg/telegram/ui/Components/RadialProgress2;->setImageOverlay(Lorg/telegram/tgnet/TLRPC$PhotoSize;Lorg/telegram/tgnet/TLRPC$Document;Ljava/lang/Object;)V
    ...
    .line 292
    invoke-direct/range {p0 .. p0}, Lorg/telegram/ui/Components/poll/PollContentDrawable;->getCurrentPlayingProgress()I
    ...
    .line 295
    iput-boolean v4, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->isVideo:Z
    ...
    invoke-static {v1, v7, v4, v6, v4}, Lorg/telegram/messenger/FileLoader;->getClosestPhotoSizeWithSize(Ljava/util/ArrayList;IZLorg/telegram/tgnet/TLRPC$PhotoSize;Z)Lorg/telegram/tgnet/TLRPC$PhotoSize;
    ...
    invoke-static {v6, v7, v5, v1, v5}, Lorg/telegram/messenger/FileLoader;->getClosestPhotoSizeWithSize(Ljava/util/ArrayList;IZLorg/telegram/tgnet/TLRPC$PhotoSize;Z)Lorg/telegram/tgnet/TLRPC$PhotoSize;
    ...
    .line 311
    iget v1, v5, Lorg/telegram/tgnet/TLRPC$PhotoSize;->w:I

    iput v1, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->mediaWidth:I

    .line 312
    iget v3, v5, Lorg/telegram/tgnet/TLRPC$PhotoSize;->h:I
    ...
    .line 319
    iget-object v6, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->imageReceiver:Lorg/telegram/messenger/ImageReceiver;
    ...
    invoke-virtual/range {v6 .. v18}, Lorg/telegram/messenger/ImageReceiver;->setImage(Lorg/telegram/messenger/ImageLocation;Ljava/lang/String;Lorg/telegram/messenger/ImageLocation;Ljava/lang/String;Lorg/telegram/messenger/ImageLocation;Ljava/lang/String;Landroid/graphics/drawable/Drawable;JLjava/lang/String;Ljava/lang/Object;I)V

    goto :goto_6

    .line 326
    :cond_e
    iput-boolean v4, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->isFile:Z
    ...
    invoke-static {v3}, Lorg/telegram/messenger/FileLoader;->getDocumentExtension(Lorg/telegram/tgnet/TLRPC$Document;)Ljava/lang/String;
    ...
    .line 331
    :goto_6
    invoke-direct {v0, v4}, Lorg/telegram/ui/Components/poll/PollContentDrawable;->checkFileTexts(Z)V
    ...
    :cond_f
    :goto_7
    iget-object v6, v1, Lorg/telegram/tgnet/TLRPC$MessageMedia;->geo:Lorg/telegram/tgnet/TLRPC$GeoPoint;

    if-eqz v6, :cond_13

    .line 235
    iget-object v5, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->locationSvgThumb:Lorg/telegram/messenger/SvgHelper$SvgDrawable;
    ...
    sget v6, Lorg/telegram/ui/ActionBar/Theme;->key_chat_outLocationIcon:I
    ...
    invoke-static {v5, v6, v7}, Lorg/telegram/messenger/DocumentObject;->getSvgThumb(IIF)Lorg/telegram/messenger/SvgHelper$SvgDrawable;

    move-result-object v5

    iput-object v5, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->locationSvgThumb:Lorg/telegram/messenger/SvgHelper$SvgDrawable;

    .line 237
    invoke-virtual {v5, v4}, Lorg/telegram/messenger/SvgHelper$SvgDrawable;->setAspectCenter(Z)V

    .line 238
    new-instance v5, Lorg/telegram/ui/Components/ClipRoundedDrawable;

    iget-object v6, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->locationSvgThumb:Lorg/telegram/messenger/SvgHelper$SvgDrawable;

    invoke-direct {v5, v6}, Lorg/telegram/ui/Components/ClipRoundedDrawable;-><init>(Landroid/graphics/drawable/Drawable;)V

    iput-object v5, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->locationLoadingThumb:Lorg/telegram/ui/Components/ClipRoundedDrawable;

    .line 240
    :cond_11
    iget-object v5, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->redLocationIcon:Landroid/graphics/drawable/Drawable;

    if-nez v5, :cond_12

    .line 241
    iget-object v5, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->parent:Landroid/view/ViewGroup;
    ...
    sget v6, Lorg/telegram/messenger/R$drawable;->map_pin:I
    ...
    iput-object v5, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->redLocationIcon:Landroid/graphics/drawable/Drawable;

    .line 244
    :cond_12
    iput-boolean v4, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->isLocation:Z
    ...
    iput v5, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->mediaHeight:I
    ...
    .line 247
    invoke-static {v1, v2, v5, v6, v3}, Lorg/telegram/messenger/WebFile;->createWithGeoPoint(Lorg/telegram/tgnet/TLRPC$GeoPoint;IIII)Lorg/telegram/messenger/WebFile;
    ...
    iget-object v10, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->locationLoadingThumb:Lorg/telegram/ui/Components/ClipRoundedDrawable;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 425
    iget v1, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->alpha:I
    ...
    .line 429
    invoke-direct {v0, v1}, Lorg/telegram/ui/Components/poll/PollContentDrawable;->checkFileTexts(Z)V

    .line 430
    iget-boolean v2, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->isFile:Z
    ...
    invoke-virtual {v1, v10}, Lorg/telegram/messenger/ImageReceiver;->setImageCoords(Landroid/graphics/Rect;)V
    ...
    .line 466
    iget-boolean v1, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->isLocation:Z

    if-eqz v1, :cond_2

    iget-object v1, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->redLocationIcon:Landroid/graphics/drawable/Drawable;
    ...
    .line 468
    iget-object v6, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->redLocationIcon:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v8}, Lorg/telegram/messenger/ImageReceiver;->getCurrentAlpha()F
    ...
    iget-object v4, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->imageReceiver:Lorg/telegram/messenger/ImageReceiver;

    invoke-virtual {v4}, Lorg/telegram/messenger/ImageReceiver;->getAlpha()F
    ...
    invoke-virtual {v3, v6, v5, v1, v2}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V
    ...
    .line 476
    :cond_2
    iget-object v1, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->radialProgress:Lorg/telegram/ui/Components/RadialProgress2;
    ...
    .line 476
    invoke-virtual {v1, v2, v4, v5, v6}, Lorg/telegram/ui/Components/RadialProgress2;->setProgressRect(IIII)V

    .line 479
    iget-boolean v1, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->isVideo:Z

    if-eqz v1, :cond_c

    iget-object v1, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->videoDurationText:Lorg/telegram/ui/Components/Text;
    ...
    iget-object v14, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->durationBackgroundPaint:Landroid/graphics/Paint;
    ...
    invoke-virtual {v1, v9, v2, v3}, Lorg/telegram/ui/Components/Text;->draw(Landroid/graphics/Canvas;FF)V
    ...
    iget-boolean v6, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->isExplanation:Z
    ...
    .line 433
    iget-boolean v7, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->isMusic:Z
    ...
    .line 435
    :cond_6
    iget-object v7, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->fileNameText:Lorg/telegram/ui/Components/Text;
    ...
    invoke-virtual {v7, v9, v14, v12}, Lorg/telegram/ui/Components/Text;->draw(Landroid/graphics/Canvas;FF)V
    ...
    .line 439
    iget-object v7, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->animatorIsPlaying:Lme/vkryl/android/animator/BoolAnimator;
    ...
    .line 440
    iget-object v12, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->authorInfoText:Lorg/telegram/ui/Components/Text;
    ...
    invoke-virtual {v9, v12, v12, v14, v11}, Landroid/graphics/Canvas;->scale(FFFF)V
    ...
    invoke-virtual {v11, v4}, Lorg/telegram/ui/Components/Text;->setAlpha(I)Lorg/telegram/ui/Components/Text;
    ...
    invoke-virtual {v4, v9, v11, v12}, Lorg/telegram/ui/Components/Text;->draw(Landroid/graphics/Canvas;FF)V
    ...
    invoke-virtual {v4, v7}, Lorg/telegram/ui/Components/SeekBar;->setAlpha(F)V
    ...
    invoke-virtual {v4, v7, v10}, Lorg/telegram/ui/Components/SeekBar;->setSize(II)V
    ...
    iput v7, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->seekBarY:F

    invoke-virtual {v9, v4, v7}, Landroid/graphics/Canvas;->translate(FF)V

    .line 452
    iget-object v4, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->seekBar:Lorg/telegram/ui/Components/SeekBar;

    invoke-virtual {v4, v9}, Lorg/telegram/ui/Components/SeekBar;->draw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v4, v9, v7, v1}, Lorg/telegram/ui/Components/Text;->draw(Landroid/graphics/Canvas;FF)V
    ...
    iput v7, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->fileButtonY:I
    ...
    .line 459
    invoke-virtual {v1, v4, v7, v2, v6}, Lorg/telegram/ui/Components/RadialProgress2;->setProgressRect(IIII)V
    ...
    .line 493
    iget-object v1, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->messageObject:Lorg/telegram/messenger/MessageObject;
    ...
    iget-object v3, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->attachPath:Ljava/lang/String;

    invoke-virtual {v1, v3}, Lorg/telegram/messenger/ImageLoader;->getFileProgressSizes(Ljava/lang/String;)[J
    ...
    invoke-virtual {v1, v13, v2}, Lorg/telegram/ui/Components/RadialProgress2;->setProgress(FZ)V

    .line 497
    iget-boolean v1, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->isMusic:Z
    ...
    .line 498
    invoke-direct {v0, v3, v2}, Lorg/telegram/ui/Components/poll/PollContentDrawable;->setIconMini(IZ)V

    goto :goto_6

    .line 500
    :cond_d
    invoke-direct {v0, v3, v2}, Lorg/telegram/ui/Components/poll/PollContentDrawable;->setIcon(IZ)V

    goto :goto_6

    .line 503
    :cond_e
    iget-object v1, v0, Lorg/telegram/ui/Components/poll/PollContentDrawable;->fileState:Lorg/telegram/ui/Components/poll/FileState;

    if-eqz v1, :cond_10

    invoke-virtual {v1}, Lorg/telegram/ui/Components/poll/FileState;->isLoading()Z
    ...
    invoke-virtual {v1}, Lorg/telegram/ui/Components/poll/FileState;->isExists()Z
    ...
    :goto_5
    invoke-direct {v0, v11, v2}, Lorg/telegram/ui/Components/poll/PollContentDrawable;->setIconMini(IZ)V

    goto :goto_6

    .line 513
    :cond_12
    invoke-direct/range {p0 .. p0}, Lorg/telegram/ui/Components/poll/PollContentDrawable;->getDefaultIcon()I

    move-result v1

    invoke-direct {v0, v1, v2}, Lorg/telegram/ui/Components/poll/PollContentDrawable;->setIcon(IZ)V
    ...
    invoke-virtual {v1, v9}, Lorg/telegram/ui/Components/RadialProgress2;->draw(Landroid/graphics/Canvas;)V
