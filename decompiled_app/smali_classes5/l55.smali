...
.method public static ˊ(Ljava/util/HashSet;Li55;Ljava/util/List;)V
    .locals 6
    ...
    :try_start_0
    invoke-interface {v2, p1}, Llg7;->ॱ(Lft6;)Ljava/util/Collection;
    ...
    :try_start_1
    invoke-static {p1, v2}, Li55;->ˊ(Li55;Ljava/security/cert/CertStore;)Ljava/util/Collection;
...
.method public static ॱ(Li55;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lｿ;
    ...
    :try_start_0
    invoke-static {v0, p0, p3}, Ll55;->ˊ(Ljava/util/HashSet;Li55;Ljava/util/List;)V

    invoke-static {v0, p0, p2}, Ll55;->ˊ(Ljava/util/HashSet;Li55;Ljava/util/List;)V
    :try_end_0
    ...
    :cond_1
    invoke-virtual {p0}, Li55;->ˋ()Ljava/security/cert/X509Certificate;
