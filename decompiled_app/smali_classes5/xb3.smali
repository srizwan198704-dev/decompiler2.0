...
.method public static ˊ([Ljava/lang/String;)V
    ...
    sget-object p0, Lac3;->ˋ:Lzb3;

    invoke-virtual {p0}, Lzb3;->ˊ()Ljava/math/BigInteger;

    move-result-object v0

    invoke-virtual {p0}, Lzb3;->ˋ()Ljava/math/BigInteger;

    move-result-object v1

    invoke-virtual {p0}, Lzb3;->ॱ()Ljava/math/BigInteger;
    ...
    invoke-virtual {v11}, Lyb3;->ˊ()Lbc3;

    move-result-object p0

    invoke-virtual {v12}, Lyb3;->ˊ()Lbc3;
    ...
    invoke-virtual {p0}, Lbc3;->ॱ()Ljava/math/BigInteger;
    ...
    invoke-virtual {p0}, Lbc3;->ˊ()Ljava/math/BigInteger;
    ...
    invoke-virtual {p0}, Lbc3;->ˋ()[Ljava/math/BigInteger;
    ...
    invoke-virtual {p0}, Lbc3;->ˎ()[Ljava/math/BigInteger;
    ...
    invoke-virtual {v0}, Lbc3;->ॱ()Ljava/math/BigInteger;
    ...
    invoke-virtual {v0}, Lbc3;->ˊ()Ljava/math/BigInteger;
    ...
    invoke-virtual {v0}, Lbc3;->ˋ()[Ljava/math/BigInteger;
    ...
    invoke-virtual {v0}, Lbc3;->ˎ()[Ljava/math/BigInteger;
    ...
    invoke-virtual {v11, v0}, Lyb3;->ॱॱ(Lbc3;)V
    ...
    invoke-virtual {v12, p0}, Lyb3;->ॱॱ(Lbc3;)V
    ...
    invoke-virtual {v11}, Lyb3;->ˋ()Lcc3;

    move-result-object p0

    invoke-virtual {v12}, Lyb3;->ˋ()Lcc3;
    ...
    invoke-virtual {p0}, Lcc3;->ॱ()Ljava/math/BigInteger;
    ...
    invoke-virtual {p0}, Lcc3;->ˊ()[Ljava/math/BigInteger;
    ...
    invoke-virtual {v0}, Lcc3;->ॱ()Ljava/math/BigInteger;
    ...
    invoke-virtual {v0}, Lcc3;->ˊ()[Ljava/math/BigInteger;
    ...
    invoke-virtual {v11, v0}, Lyb3;->ᐝ(Lcc3;)V
    ...
    invoke-virtual {v12, p0}, Lyb3;->ᐝ(Lcc3;)V
    ...
    invoke-virtual {v11}, Lyb3;->ॱ()Ljava/math/BigInteger;

    move-result-object p0

    invoke-virtual {v12}, Lyb3;->ॱ()Ljava/math/BigInteger;
    ...
    invoke-static {p0}, Lxb3;->ॱ(Ljava/math/BigInteger;)Ljava/math/BigInteger;

    invoke-static {v0}, Lxb3;->ॱ(Ljava/math/BigInteger;)Ljava/math/BigInteger;

    invoke-virtual {v11, p0}, Lyb3;->ˎ(Ljava/math/BigInteger;)Ldc3;

    move-result-object v1

    invoke-virtual {v12, v0}, Lyb3;->ˎ(Ljava/math/BigInteger;)Ldc3;
    ...
    invoke-virtual {v1}, Ldc3;->ॱ()Ljava/math/BigInteger;
    ...
    invoke-virtual {v4}, Ldc3;->ॱ()Ljava/math/BigInteger;
    ...
    invoke-virtual {v11, v4, p0}, Lyb3;->ʻ(Ldc3;Ljava/math/BigInteger;)V
    ...
    invoke-virtual {v12, v1, v0}, Lyb3;->ʻ(Ldc3;Ljava/math/BigInteger;)V
...
.method public static ॱ(Ljava/math/BigInteger;)Ljava/math/BigInteger;
    .locals 4
    ...
    invoke-virtual {v0, p0, v3, v2}, Lod2;->update([BII)V

    invoke-virtual {v0, v1, v3}, Lph6;->ˋ([BI)I
