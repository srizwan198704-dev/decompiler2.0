...
.method public constructor <init>(Lux;)V
    ...
    iput-boolean v0, p0, Ltu8;->ˏ:Z

    iput-object p1, p0, Ltu8;->ॱ:Lux;

    :try_start_0
    invoke-virtual {p1}, Lux;->ˉ()Lᵍ;
    ...
    iput-object v0, p0, Ltu8;->ˊ:Ljava/lang/String;
    ...
    :goto_0
    invoke-static {p0}, Ltu8;->ˋ(Ljava/security/cert/X509CRL;)Z

    move-result p1

    iput-boolean p1, p0, Ltu8;->ˎ:Z
    :try_end_0
...
.method public static ˋ(Ljava/security/cert/X509CRL;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CRLException;
    ...
    invoke-direct {v0, v1, p0}, Lcv1;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-boolean v0, p0, Ltu8;->ˏ:Z

    if-eqz v0, :cond_2

    iget-boolean v0, p1, Ltu8;->ˏ:Z

    if-eqz v0, :cond_2

    iget v0, p1, Ltu8;->ॱॱ:I

    iget v2, p0, Ltu8;->ॱॱ:I
    ...
    :cond_2
    iget-object v0, p0, Ltu8;->ॱ:Lux;

    iget-object p1, p1, Ltu8;->ॱ:Lux;
...
.method public getCriticalExtensionOIDs()Ljava/util/Set;
    ...
    invoke-virtual {p0, v0}, Ltu8;->ˊ(Z)Ljava/util/Set;
...
.method public getRevokedCertificate(Ljava/math/BigInteger;)Ljava/security/cert/X509CRLEntry;
    ...
    iget-boolean v0, p0, Ltu8;->ˎ:Z

    invoke-direct {p1, v3, v0, v2}, Lnu8;-><init>(Llm7$ﹳ;ZLzt8;)V

    return-object p1

    :cond_1
    iget-boolean v4, p0, Ltu8;->ˎ:Z
...
.method public getRevokedCertificates()Ljava/util/Set;
    ...
    invoke-virtual {p0}, Ltu8;->ˎ()Ljava/util/Set;
...
.method public getSigAlgName()Ljava/lang/String;
    ...
    iget-object v0, p0, Ltu8;->ˊ:Ljava/lang/String;
...
.method public hasUnsupportedCriticalExtension()Z
    ...
    invoke-virtual {p0}, Ltu8;->getCriticalExtensionOIDs()Ljava/util/Set;
    ...
    :cond_0
    sget-object v1, Ldu5;->ˏ:Ljava/lang/String;

    invoke-interface {v0, v1}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    sget-object v1, Ldu5;->ᐝ:Ljava/lang/String;
...
.method public hashCode()I
    ...
    iput v0, p0, Ltu8;->ॱॱ:I

    :cond_0
    iget v0, p0, Ltu8;->ॱॱ:I
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Ltu8;->getVersion()I
    ...
    invoke-virtual {p0}, Ltu8;->getIssuerDN()Ljava/security/Principal;
    ...
    invoke-virtual {p0}, Ltu8;->getThisUpdate()Ljava/util/Date;
    ...
    invoke-virtual {p0}, Ltu8;->getNextUpdate()Ljava/util/Date;
    ...
    invoke-virtual {p0}, Ltu8;->getSigAlgName()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Ltu8;->getSignature()[B
    ...
    :cond_9
    invoke-virtual {p0}, Ltu8;->getRevokedCertificates()Ljava/util/Set;
...
.method public verify(Ljava/security/PublicKey;)V
    ...
    :goto_0
    invoke-virtual {p0, p1, v0}, Ltu8;->ॱ(Ljava/security/PublicKey;Ljava/security/Signature;)V
...
.method public verify(Ljava/security/PublicKey;Ljava/lang/String;)V
    ...
    :goto_0
    invoke-virtual {p0, p1, p2}, Ltu8;->ॱ(Ljava/security/PublicKey;Ljava/security/Signature;)V
...
.method public final ˎ()Ljava/util/Set;
    ...
    iget-boolean v5, p0, Ltu8;->ˎ:Z

    invoke-direct {v4, v3, v5, v2}, Lnu8;-><init>(Llm7$ﹳ;ZLzt8;)V
...
.method public final ॱ(Ljava/security/PublicKey;Ljava/security/Signature;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CRLException;,
    ...
    invoke-virtual {p0}, Ltu8;->getTBSCertList()[B
