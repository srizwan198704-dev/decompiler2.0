...
# instance fields
.field public ॱ:Ljava/security/spec/DSAParameterSpec;
...
.method public engineGetEncoded()[B
    ...
    iget-object v1, p0, Lノ;->ॱ:Ljava/security/spec/DSAParameterSpec;

    invoke-virtual {v1}, Ljava/security/spec/DSAParameterSpec;->getP()Ljava/math/BigInteger;

    move-result-object v1

    iget-object v2, p0, Lノ;->ॱ:Ljava/security/spec/DSAParameterSpec;

    invoke-virtual {v2}, Ljava/security/spec/DSAParameterSpec;->getQ()Ljava/math/BigInteger;

    move-result-object v2

    iget-object v3, p0, Lノ;->ॱ:Ljava/security/spec/DSAParameterSpec;

    invoke-virtual {v3}, Ljava/security/spec/DSAParameterSpec;->getG()Ljava/math/BigInteger;

    move-result-object v3

    invoke-direct {v0, v1, v2, v3}, Lvp0;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
...
.method public engineGetEncoded(Ljava/lang/String;)[B
    ...
    invoke-virtual {p0, p1}, Lノ;->ॱ(Ljava/lang/String;)Z

    move-result p1

    if-eqz p1, :cond_0

    invoke-virtual {p0}, Lノ;->engineGetEncoded()[B
...
.method public engineGetParameterSpec(Ljava/lang/Class;)Ljava/security/spec/AlgorithmParameterSpec;
    ...
    invoke-virtual {p0, p1}, Lノ;->ˊ(Ljava/lang/Class;)Ljava/security/spec/AlgorithmParameterSpec;
...
.method public engineInit(Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    iput-object p1, p0, Lノ;->ॱ:Ljava/security/spec/DSAParameterSpec;
...
.method public engineInit([B)V
    ...
    iput-object v1, p0, Lノ;->ॱ:Ljava/security/spec/DSAParameterSpec;
    :try_end_0
...
.method public engineInit([BLjava/lang/String;)V
    ...
    invoke-virtual {p0, p2}, Lノ;->ॱ(Ljava/lang/String;)Z
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0, p1}, Lノ;->engineInit([B)V
...
.method public ˊ(Ljava/lang/Class;)Ljava/security/spec/AlgorithmParameterSpec;
    ...
    :cond_1
    :goto_0
    iget-object p1, p0, Lノ;->ॱ:Ljava/security/spec/DSAParameterSpec;
