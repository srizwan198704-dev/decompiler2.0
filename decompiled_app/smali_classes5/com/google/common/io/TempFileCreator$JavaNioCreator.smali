...
.method static constructor <clinit>()V
    ...
    invoke-static {}, Les/n86;->a()Ljava/nio/file/FileSystem;

    move-result-object v0

    invoke-static {v0}, Les/o86;->a(Ljava/nio/file/FileSystem;)Ljava/util/Set;
...
.method private static synthetic lambda$static$0()Ljava/nio/file/attribute/FileAttribute;
    ...
    invoke-static {v0}, Les/l86;->a(Ljava/lang/String;)Ljava/util/Set;

    move-result-object v0

    invoke-static {v0}, Les/m86;->a(Ljava/util/Set;)Ljava/nio/file/attribute/FileAttribute;
...
.method private static userPermissions()Lcom/google/common/io/TempFileCreator$JavaNioCreator$PermissionSupplier;
    ...
    invoke-static {v0}, Les/b86;->a(Ljava/nio/file/FileSystem;)Ljava/nio/file/attribute/UserPrincipalLookupService;
    ...
    invoke-static {v0, v1}, Les/c86;->a(Ljava/nio/file/attribute/UserPrincipalLookupService;Ljava/lang/String;)Ljava/nio/file/attribute/UserPrincipal;

    move-result-object v0

    invoke-static {}, Les/d86;->a()Ljava/nio/file/attribute/AclEntry$Builder;

    move-result-object v1

    invoke-static {}, Les/e86;->a()Ljava/nio/file/attribute/AclEntryType;

    move-result-object v2

    invoke-static {v1, v2}, Les/f86;->a(Ljava/nio/file/attribute/AclEntry$Builder;Ljava/nio/file/attribute/AclEntryType;)Ljava/nio/file/attribute/AclEntry$Builder;

    move-result-object v1

    invoke-static {v1, v0}, Les/g86;->a(Ljava/nio/file/attribute/AclEntry$Builder;Ljava/nio/file/attribute/UserPrincipal;)Ljava/nio/file/attribute/AclEntry$Builder;

    move-result-object v0

    invoke-static {}, Les/h86;->a()Ljava/lang/Class;
    ...
    invoke-static {v0, v1}, Les/i86;->a(Ljava/nio/file/attribute/AclEntry$Builder;Ljava/util/Set;)Ljava/nio/file/attribute/AclEntry$Builder;
    ...
    invoke-static {}, Les/j86;->a()Ljava/nio/file/attribute/AclEntryFlag;
    ...
    invoke-static {}, Les/q86;->a()Ljava/nio/file/attribute/AclEntryFlag;
    ...
    invoke-static {v0, v1}, Les/r86;->a(Ljava/nio/file/attribute/AclEntry$Builder;[Ljava/nio/file/attribute/AclEntryFlag;)Ljava/nio/file/attribute/AclEntry$Builder;

    move-result-object v0

    invoke-static {v0}, Les/s86;->a(Ljava/nio/file/attribute/AclEntry$Builder;)Ljava/nio/file/attribute/AclEntry;
...
.method public createTempDir()Ljava/io/File;
    ...
    invoke-static {v0, v2}, Les/t31;->a(Ljava/lang/String;[Ljava/lang/String;)Ljava/nio/file/Path;
    ...
    invoke-static {v0, v1, v2}, Les/a86;->a(Ljava/nio/file/Path;Ljava/lang/String;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;

    move-result-object v0

    invoke-static {v0}, Les/k86;->a(Ljava/nio/file/Path;)Ljava/io/File;
...
.method public createTempFile(Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {v0, p1, v1, v2}, Les/p86;->a(Ljava/nio/file/Path;Ljava/lang/String;Ljava/lang/String;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;

    move-result-object p1

    invoke-static {p1}, Les/k86;->a(Ljava/nio/file/Path;)Ljava/io/File;
