...
.method public Code(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-virtual {v3, v4}, Lcom/huawei/hms/ads/gk;->I(Ljava/lang/String;)Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-virtual {p0, p1, v1, v2, p2}, Lcom/huawei/hms/ads/gf;->Code(Landroid/content/Context;Lcom/huawei/openalliance/ad/inter/data/AppInfo;Lcom/huawei/openalliance/ad/inter/data/AdContentData;I)V
    ...
    invoke-virtual {p1, p2}, Lcom/huawei/hms/ads/gk;->V(Ljava/lang/String;)V
