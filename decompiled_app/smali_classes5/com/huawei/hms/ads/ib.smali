.class public Lcom/huawei/hms/ads/ib;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/huawei/hms/ads/lo;)V
    .locals 1
    ...
    iput-boolean v0, p0, Lcom/huawei/hms/ads/ib;->e:Z
    ...
    :goto_0
    iput-object p1, p0, Lcom/huawei/hms/ads/ib;->S:Landroid/content/Context;
...
.method private Code(Lcom/huawei/openalliance/ad/inter/data/ImageInfo;)Lcom/huawei/openalliance/ad/beans/inner/SourceParam;
    ...
    :cond_0
    iget-object v0, p0, Lcom/huawei/hms/ads/ib;->S:Landroid/content/Context;
    ...
    :cond_1
    invoke-virtual {v0}, Lcom/huawei/hms/ads/ej;->s()I
...
.method public static synthetic Code(Lcom/huawei/hms/ads/ib;Lcom/huawei/openalliance/ad/inter/data/g;)Lcom/huawei/openalliance/ad/inter/data/g;
    .locals 0

    iput-object p1, p0, Lcom/huawei/hms/ads/ib;->F:Lcom/huawei/openalliance/ad/inter/data/g;

    return-object p1
.end method

.method public static synthetic Code(Lcom/huawei/hms/ads/ib;Ljava/util/Map;)Lcom/huawei/openalliance/ad/inter/data/g;
    .locals 0

    invoke-direct {p0, p1}, Lcom/huawei/hms/ads/ib;->Code(Ljava/util/Map;)Lcom/huawei/openalliance/ad/inter/data/g;
...
.method private Code(I)V
    ...
    new-instance v0, Lcom/huawei/hms/ads/ib$5;

    invoke-direct {v0, p0, p1}, Lcom/huawei/hms/ads/ib$5;-><init>(Lcom/huawei/hms/ads/ib;I)V
...
.method public static synthetic Code(Lcom/huawei/hms/ads/ib;)V
    .locals 0

    invoke-direct {p0}, Lcom/huawei/hms/ads/ib;->D()V

    return-void
.end method

.method public static synthetic Code(Lcom/huawei/hms/ads/ib;I)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/huawei/hms/ads/ib;->Code(I)V

    return-void
.end method

.method public static synthetic Code(Lcom/huawei/hms/ads/ib;Landroid/content/Context;Landroid/widget/ImageView;Landroid/graphics/drawable/Drawable;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/huawei/hms/ads/ib;->V(Landroid/content/Context;Landroid/widget/ImageView;Landroid/graphics/drawable/Drawable;)V
...
.method private Code(Lcom/huawei/openalliance/ad/inter/data/g;)V
    ...
    invoke-interface {p1}, Lcom/huawei/openalliance/ad/inter/data/g;->b_()Z

    move-result p1

    iput-boolean p1, p0, Lcom/huawei/hms/ads/ib;->e:Z
...
.method private D()V
    ...
    iget-object v0, p0, Lcom/huawei/hms/ads/ib;->F:Lcom/huawei/openalliance/ad/inter/data/g;
    ...
    invoke-direct {p0, v1}, Lcom/huawei/hms/ads/ib;->Code(I)V
    ...
    iget-object v1, p0, Lcom/huawei/hms/ads/ib;->F:Lcom/huawei/openalliance/ad/inter/data/g;

    invoke-direct {p0, v1}, Lcom/huawei/hms/ads/ib;->Code(Lcom/huawei/openalliance/ad/inter/data/g;)V

    invoke-direct {p0, v0}, Lcom/huawei/hms/ads/ib;->Code(Lcom/huawei/openalliance/ad/inter/data/ImageInfo;)Lcom/huawei/openalliance/ad/beans/inner/SourceParam;
    ...
    iget-object v2, p0, Lcom/huawei/hms/ads/ib;->S:Landroid/content/Context;

    iget-object v3, p0, Lcom/huawei/hms/ads/ib;->F:Lcom/huawei/openalliance/ad/inter/data/g;

    invoke-interface {v3}, Lcom/huawei/openalliance/ad/inter/data/d;->d()Ljava/lang/String;

    move-result-object v3

    iget-object v4, p0, Lcom/huawei/hms/ads/ib;->F:Lcom/huawei/openalliance/ad/inter/data/g;

    invoke-interface {v4}, Lcom/huawei/openalliance/ad/inter/data/d;->r()Ljava/lang/String;

    move-result-object v4

    new-instance v5, Lcom/huawei/hms/ads/ib$4;

    invoke-direct {v5, p0, v0}, Lcom/huawei/hms/ads/ib$4;-><init>(Lcom/huawei/hms/ads/ib;Lcom/huawei/openalliance/ad/inter/data/ImageInfo;)V

    invoke-static {v2, v1, v3, v4, v5}, Lcom/huawei/openalliance/ad/utils/ac;->Code(Landroid/content/Context;Lcom/huawei/openalliance/ad/beans/inner/SourceParam;Ljava/lang/String;Ljava/lang/String;Lcom/huawei/openalliance/ad/utils/aq;)V
...
.method private F()V
    ...
    iget v0, p0, Lcom/huawei/hms/ads/ib;->B:I
    ...
    invoke-virtual {v0}, Lcom/huawei/openalliance/ad/inter/data/l;->aA()Ljava/lang/String;
    ...
    const-string v3, "setBannerRefresh: %s"
    ...
    invoke-virtual {v0}, Lcom/huawei/hms/ads/ej;->q()J
    ...
    :goto_1
    new-instance v2, Lcom/huawei/hms/ads/ib$3;

    invoke-direct {v2, p0, v0, v1}, Lcom/huawei/hms/ads/ib$3;-><init>(Lcom/huawei/hms/ads/ib;J)V
    ...
    const-string v3, "parseIntOrDefault exception: "
...
.method public static synthetic I(Lcom/huawei/hms/ads/ib;)Lcom/huawei/openalliance/ad/inter/data/g;
    .locals 0

    iget-object p0, p0, Lcom/huawei/hms/ads/ib;->F:Lcom/huawei/openalliance/ad/inter/data/g;
...
.method private V(Landroid/content/Context;Landroid/widget/ImageView;Landroid/graphics/drawable/Drawable;)V
    ...
    new-instance v0, Lcom/huawei/hms/ads/ib$7;

    invoke-direct {v0, p0, p1, p3, p2}, Lcom/huawei/hms/ads/ib$7;-><init>(Lcom/huawei/hms/ads/ib;Landroid/content/Context;Landroid/graphics/drawable/Drawable;Landroid/widget/ImageView;)V
...
.method public static synthetic V(Lcom/huawei/hms/ads/ib;)V
    .locals 0

    invoke-direct {p0}, Lcom/huawei/hms/ads/ib;->F()V
...
.method public Code(Landroid/content/Context;Landroid/widget/ImageView;Landroid/graphics/drawable/Drawable;)V
    ...
    iget-boolean v0, p0, Lcom/huawei/hms/ads/ib;->e:Z
    ...
    invoke-static {p1, p3, v0, v1}, Lcom/huawei/openalliance/ad/utils/aa;->Code(Landroid/content/Context;Landroid/graphics/drawable/Drawable;FF)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    instance-of v0, p3, Lcom/huawei/hms/ads/dy;

    if-eqz v0, :cond_1

    check-cast p3, Lcom/huawei/hms/ads/dy;

    new-instance v0, Lcom/huawei/hms/ads/ib$6;

    invoke-direct {v0, p0, p1, p2}, Lcom/huawei/hms/ads/ib$6;-><init>(Lcom/huawei/hms/ads/ib;Landroid/content/Context;Landroid/widget/ImageView;)V

    invoke-virtual {p3, v0}, Lcom/huawei/hms/ads/dy;->Code(Lcom/huawei/hms/ads/dy$a;)V
    :try_end_0
...
.method public Code(Landroid/location/Location;)V
    ...
    iput-object p1, p0, Lcom/huawei/hms/ads/ib;->L:Landroid/location/Location;
...
.method public Code(Lcom/huawei/hms/ads/RequestOptions;)V
    ...
    iput-object p1, p0, Lcom/huawei/hms/ads/ib;->D:Lcom/huawei/hms/ads/RequestOptions;
...
.method public Code(Lcom/huawei/openalliance/ad/inter/data/r;)V
    ...
    iput-object p1, p0, Lcom/huawei/hms/ads/ib;->a:Lcom/huawei/openalliance/ad/inter/data/r;
...
.method public Code(Ljava/lang/Integer;)V
    ...
    iput-object p1, p0, Lcom/huawei/hms/ads/ib;->b:Ljava/lang/Integer;
...
.method public Code(Ljava/lang/String;ILjava/util/List;I)V
    ...
    iput p4, p0, Lcom/huawei/hms/ads/ib;->B:I

    new-instance p4, Lcom/huawei/openalliance/ad/inter/n;

    iget-object v0, p0, Lcom/huawei/hms/ads/ib;->S:Landroid/content/Context;

    invoke-direct {p4, v0, p1, p2, p3}, Lcom/huawei/openalliance/ad/inter/n;-><init>(Landroid/content/Context;[Ljava/lang/String;ILjava/util/List;)V

    iput-object p4, p0, Lcom/huawei/hms/ads/ib;->C:Lcom/huawei/openalliance/ad/inter/i;

    instance-of p1, p4, Lcom/huawei/openalliance/ad/inter/n;

    if-eqz p1, :cond_1

    iget-object p1, p0, Lcom/huawei/hms/ads/ib;->L:Landroid/location/Location;

    invoke-virtual {p4, p1}, Lcom/huawei/openalliance/ad/inter/n;->Code(Landroid/location/Location;)V

    iget-object p1, p0, Lcom/huawei/hms/ads/ib;->C:Lcom/huawei/openalliance/ad/inter/i;

    check-cast p1, Lcom/huawei/openalliance/ad/inter/n;

    iget p2, p0, Lcom/huawei/hms/ads/ib;->B:I
    ...
    iget-object p2, p0, Lcom/huawei/hms/ads/ib;->D:Lcom/huawei/hms/ads/RequestOptions;
    ...
    iget-object p2, p0, Lcom/huawei/hms/ads/ib;->b:Ljava/lang/Integer;
    ...
    iget-object p3, p0, Lcom/huawei/hms/ads/ib;->C:Lcom/huawei/openalliance/ad/inter/i;
    ...
    iget-object p3, p0, Lcom/huawei/hms/ads/ib;->c:Ljava/lang/Integer;

    invoke-interface {p1, p3}, Lcom/huawei/openalliance/ad/inter/i;->V(Ljava/lang/Integer;)V

    iget-object p1, p0, Lcom/huawei/hms/ads/ib;->C:Lcom/huawei/openalliance/ad/inter/i;

    iget-object p3, p0, Lcom/huawei/hms/ads/ib;->d:Ljava/lang/Integer;

    invoke-interface {p1, p3}, Lcom/huawei/openalliance/ad/inter/i;->I(Ljava/lang/Integer;)V

    :goto_1
    iget-object p1, p0, Lcom/huawei/hms/ads/ib;->f:Ljava/lang/String;
    ...
    :cond_4
    iget-object p1, p0, Lcom/huawei/hms/ads/ib;->a:Lcom/huawei/openalliance/ad/inter/data/r;
    ...
    iget-object p3, p0, Lcom/huawei/hms/ads/ib;->a:Lcom/huawei/openalliance/ad/inter/data/r;
    ...
    new-instance p3, Lcom/huawei/hms/ads/ib$2;

    invoke-direct {p3, p0}, Lcom/huawei/hms/ads/ib$2;-><init>(Lcom/huawei/hms/ads/ib;)V

    invoke-interface {p1, p3}, Lcom/huawei/openalliance/ad/inter/i;->Code(Lcom/huawei/openalliance/ad/inter/listeners/n;)V

    iget-object p1, p0, Lcom/huawei/hms/ads/ib;->C:Lcom/huawei/openalliance/ad/inter/i;

    new-instance p3, Lcom/huawei/hms/ads/ib$a;

    invoke-direct {p3, p0}, Lcom/huawei/hms/ads/ib$a;-><init>(Lcom/huawei/hms/ads/ib;)V

    invoke-interface {p1, p3}, Lcom/huawei/openalliance/ad/inter/i;->Code(Lcom/huawei/openalliance/ad/inter/listeners/e;)V

    iget-object p1, p0, Lcom/huawei/hms/ads/ib;->S:Landroid/content/Context;
    ...
    invoke-interface {p3, p1, p2, v2}, Lcom/huawei/openalliance/ad/inter/i;->Code(ILjava/lang/String;Z)V
    ...
    new-instance p1, Lcom/huawei/hms/ads/ib$1;

    invoke-direct {p1, p0}, Lcom/huawei/hms/ads/ib$1;-><init>(Lcom/huawei/hms/ads/ib;)V
...
.method public Code(Lcom/huawei/openalliance/ad/inter/data/b;F)Z
    ...
    invoke-static {v7, v8, v4}, Lcom/huawei/hms/ads/fh;->Code(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    :cond_1
    iget-object v4, p0, Lcom/huawei/hms/ads/ib;->S:Landroid/content/Context;

    invoke-static {v4}, Lcom/huawei/openalliance/ad/utils/d;->C(Landroid/content/Context;)Landroid/util/DisplayMetrics;
    ...
    invoke-static {v7, p1, v8}, Lcom/huawei/hms/ads/fh;->I(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v7, p1}, Lcom/huawei/hms/ads/fh;->I(Ljava/lang/String;Ljava/lang/String;)V
...
.method public I(Ljava/lang/Integer;)V
    ...
    iput-object p1, p0, Lcom/huawei/hms/ads/ib;->d:Ljava/lang/Integer;
...
.method public V(Ljava/lang/Integer;)V
    ...
    iput-object p1, p0, Lcom/huawei/hms/ads/ib;->c:Ljava/lang/Integer;
...
.method public V(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/huawei/hms/ads/ib;->f:Ljava/lang/String;
