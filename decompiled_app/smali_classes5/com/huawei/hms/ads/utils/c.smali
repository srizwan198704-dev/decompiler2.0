.class public Lcom/huawei/hms/ads/utils/c;
...
.method public static Code(Lcom/huawei/hms/ads/RequestOptions;)Lcom/huawei/hms/ads/RequestOptions;
    ...
    invoke-virtual {p0}, Lcom/huawei/hms/ads/RequestOptions;->C()Ljava/lang/String;
    ...
    :cond_4
    invoke-virtual {p0}, Lcom/huawei/hms/ads/RequestOptions;->getIsQueryUseEnabled()Ljava/lang/Integer;

    move-result-object v2

    if-nez v2, :cond_5

    invoke-virtual {v0}, Lcom/huawei/hms/ads/RequestOptions;->getIsQueryUseEnabled()Ljava/lang/Integer;

    move-result-object v2

    invoke-virtual {v1, v2}, Lcom/huawei/hms/ads/RequestOptions$Builder;->setIsQueryUseEnabled(Ljava/lang/Integer;)Lcom/huawei/hms/ads/RequestOptions$Builder;

    :cond_5
    invoke-virtual {p0}, Lcom/huawei/hms/ads/RequestOptions;->Code()Ljava/lang/Integer;

    move-result-object v2

    if-nez v2, :cond_6

    invoke-virtual {v0}, Lcom/huawei/hms/ads/RequestOptions;->Code()Ljava/lang/Integer;

    move-result-object v2

    invoke-virtual {v1, v2}, Lcom/huawei/hms/ads/RequestOptions$Builder;->setHwNonPersonalizedAd(Ljava/lang/Integer;)Lcom/huawei/hms/ads/RequestOptions$Builder;

    :cond_6
    invoke-virtual {p0}, Lcom/huawei/hms/ads/RequestOptions;->V()Ljava/lang/Integer;

    move-result-object v2

    if-nez v2, :cond_7

    invoke-virtual {v0}, Lcom/huawei/hms/ads/RequestOptions;->V()Ljava/lang/Integer;

    move-result-object v2

    invoke-virtual {v1, v2}, Lcom/huawei/hms/ads/RequestOptions$Builder;->setThirdNonPersonalizedAd(Ljava/lang/Integer;)Lcom/huawei/hms/ads/RequestOptions$Builder;
    ...
    invoke-virtual {v1, v2}, Lcom/huawei/hms/ads/RequestOptions$Builder;->setConsent(Ljava/lang/String;)Lcom/huawei/hms/ads/RequestOptions$Builder;
    ...
    invoke-virtual {v0}, Lcom/huawei/hms/ads/RequestOptions;->B()Ljava/lang/Boolean;
    ...
    :cond_c
    invoke-virtual {p0}, Lcom/huawei/hms/ads/RequestOptions;->F()Lcom/huawei/hms/ads/data/SearchInfo;

    move-result-object v2

    if-nez v2, :cond_d

    invoke-virtual {v0}, Lcom/huawei/hms/ads/RequestOptions;->F()Lcom/huawei/hms/ads/data/SearchInfo;

    move-result-object v2

    invoke-virtual {v1, v2}, Lcom/huawei/hms/ads/RequestOptions$Builder;->setSearchInfo(Lcom/huawei/hms/ads/data/SearchInfo;)Lcom/huawei/hms/ads/RequestOptions$Builder;

    :cond_d
    invoke-virtual {p0}, Lcom/huawei/hms/ads/RequestOptions;->a()Ljava/lang/Boolean;

    move-result-object p0

    if-nez p0, :cond_e

    invoke-virtual {v0}, Lcom/huawei/hms/ads/RequestOptions;->a()Ljava/lang/Boolean;

    move-result-object p0

    invoke-virtual {v1, p0}, Lcom/huawei/hms/ads/RequestOptions$Builder;->setSupportFa(Ljava/lang/Boolean;)Lcom/huawei/hms/ads/RequestOptions$Builder;
