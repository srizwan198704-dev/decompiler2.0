...
.method private Code(Lcom/huawei/openalliance/ad/inter/data/g;Ljava/lang/String;Lcom/huawei/hms/ads/unity/UnityImageType;)Lcom/huawei/openalliance/ad/inter/data/ImageInfo;
    .locals 2
    ...
    :cond_0
    invoke-interface {p1}, Lcom/huawei/openalliance/ad/inter/data/g;->B()Ljava/util/List;
    ...
    check-cast p3, Lcom/huawei/openalliance/ad/inter/data/ImageInfo;

    invoke-virtual {p3}, Lcom/huawei/openalliance/ad/inter/data/ImageInfo;->Z()Ljava/lang/String;
    ...
    :cond_3
    invoke-interface {p1}, Lcom/huawei/openalliance/ad/inter/data/g;->Z()Lcom/huawei/openalliance/ad/inter/data/ImageInfo;
...
.method public unityLoadImage(Lcom/huawei/hms/ads/unity/UnityImageDelegate;Landroid/content/Context;Lcom/huawei/hms/ads/nativead/NativeAd;Lcom/huawei/hms/ads/unity/UnityImageType;)V
    ...
    instance-of v2, p3, Lcom/huawei/hms/ads/cd;

    if-eqz v2, :cond_2

    check-cast p3, Lcom/huawei/hms/ads/cd;

    invoke-virtual {p3}, Lcom/huawei/hms/ads/cd;->Code()Lcom/huawei/openalliance/ad/inter/data/l;
    ...
    invoke-direct {p0, p3, v0, p4}, Lcom/huawei/hms/ads/unity/UnityImageUtil;->Code(Lcom/huawei/openalliance/ad/inter/data/g;Ljava/lang/String;Lcom/huawei/hms/ads/unity/UnityImageType;)Lcom/huawei/openalliance/ad/inter/data/ImageInfo;
    ...
    :cond_1
    invoke-virtual {p4}, Lcom/huawei/openalliance/ad/inter/data/ImageInfo;->I()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v1, v0}, Lcom/huawei/openalliance/ad/beans/inner/SourceParam;->V(Ljava/lang/String;)V

    invoke-virtual {p4}, Lcom/huawei/openalliance/ad/inter/data/ImageInfo;->S()Z
    ...
    invoke-interface {p3}, Lcom/huawei/openalliance/ad/inter/data/d;->d()Ljava/lang/String;

    move-result-object v0

    invoke-interface {p3}, Lcom/huawei/openalliance/ad/inter/data/d;->r()Ljava/lang/String;

    move-result-object p3

    new-instance v2, Lcom/huawei/hms/ads/unity/UnityImageUtil$1;

    invoke-direct {v2, p0, p4, p1}, Lcom/huawei/hms/ads/unity/UnityImageUtil$1;-><init>(Lcom/huawei/hms/ads/unity/UnityImageUtil;Lcom/huawei/openalliance/ad/inter/data/ImageInfo;Lcom/huawei/hms/ads/unity/UnityImageDelegate;)V

    invoke-static {p2, v1, v0, p3, v2}, Lcom/huawei/openalliance/ad/utils/ac;->Code(Landroid/content/Context;Lcom/huawei/openalliance/ad/beans/inner/SourceParam;Ljava/lang/String;Ljava/lang/String;Lcom/huawei/openalliance/ad/utils/aq;)V
