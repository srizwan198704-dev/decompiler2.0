...
# static fields
.field public static final ˋ:Ljava/lang/String; = "BC JKS store is read-only and only supports certificate entries"


# instance fields
.field public final ˊ:Lmd3;

.field public final ॱ:Ljava/util/Hashtable;
...
.method public constructor <init>(Lmd3;)V
    ...
    iput-object v0, p0, Lwb3;->ॱ:Ljava/util/Hashtable;

    iput-object p1, p0, Lwb3;->ˊ:Lmd3;
...
.method public engineAliases()Ljava/util/Enumeration;
    ...
    iget-object v0, p0, Lwb3;->ॱ:Ljava/util/Hashtable;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lwb3;->ॱ:Ljava/util/Hashtable;
...
.method public engineGetCertificate(Ljava/lang/String;)Ljava/security/cert/Certificate;
    ...
    check-cast p1, Lwb3$ᐨ;

    if-eqz p1, :cond_0

    iget-object p1, p1, Lwb3$ᐨ;->ˊ:Ljava/security/cert/Certificate;
...
.method public engineGetCertificateAlias(Ljava/security/cert/Certificate;)Ljava/lang/String;
    ...
    check-cast v3, Lwb3$ᐨ;

    iget-object v3, v3, Lwb3$ᐨ;->ˊ:Ljava/security/cert/Certificate;
...
.method public engineGetCreationDate(Ljava/lang/String;)Ljava/util/Date;
    ...
    iget-object p1, p1, Lwb3$ᐨ;->ॱ:Ljava/util/Date;
...
.method public engineLoad(Ljava/io/InputStream;[C)V
    ...
    :cond_0
    invoke-virtual/range {p0 .. p2}, Lwb3;->ˋ(Ljava/io/InputStream;[C)Lwb3$ﹳ;

    move-result-object v2

    iget-object v3, v1, Lwb3;->ॱ:Ljava/util/Hashtable;
    ...
    invoke-virtual {v1, v8}, Lwb3;->ˊ(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
    ...
    :cond_3
    invoke-virtual {v1, v4}, Lwb3;->ˊ(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
    ...
    new-instance v6, Lwb3$ﹳ;

    invoke-direct {v6, v15, v10, v14}, Lwb3$ﹳ;-><init>([BII)V
    :try_end_0
    ...
    :try_start_2
    invoke-virtual {v6}, Lwb3$ﹳ;->ॱ()V

    iget-object v6, v1, Lwb3;->ॱ:Ljava/util/Hashtable;

    new-instance v15, Lwb3$ᐨ;

    invoke-direct {v15, v13, v14}, Lwb3$ᐨ;-><init>(Ljava/util/Date;Ljava/security/cert/Certificate;)V
...
.method public engineLoad(Ljava/security/KeyStore$LoadStoreParameter;)V
    ...
    invoke-virtual {p0, p1, p1}, Lwb3;->engineLoad(Ljava/io/InputStream;[C)V
    ...
    invoke-virtual {p0, v0, p1}, Lwb3;->engineLoad(Ljava/io/InputStream;[C)V
...
.method public final ˊ(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertificateException;
    ...
    iget-object v0, p0, Lwb3;->ˊ:Lmd3;

    if-eqz v0, :cond_0

    :try_start_0
    invoke-interface {v0, p1}, Lmd3;->ˋॱ(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
...
.method public final ˋ(Ljava/io/InputStream;[C)Lwb3$ﹳ;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p0, v0, p2}, Lwb3;->ॱ(Lr51;[C)V
    ...
    invoke-interface {v0, p1, v1, p2}, Lr51;->update([BII)V
    ...
    new-instance v0, Lwb3$ﹳ;

    array-length v2, p1

    sub-int/2addr v2, p2

    invoke-direct {v0, p1, v1, v2}, Lwb3$ﹳ;-><init>([BII)V
    ...
    invoke-direct {p2, p1, v1, v2}, Lwb3$ﹳ;-><init>([BII)V

    return-object p2
.end method

.method public final ॱ(Lr51;[C)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p1, v2}, Lr51;->update(B)V
    ...
    invoke-interface {p1, p2, v0, v1}, Lr51;->update([BII)V
