...
# static fields
.field public static final ˊ:Ljava/security/Permission;

.field public static final ˋ:Ljava/security/Permission;
...
.field public static final ॱ:Ljava/security/Permission;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lfk0;-><init>(Ljava/lang/String;)V

    sput-object v0, Lgk0;->ॱ:Ljava/security/Permission;
    ...
    sput-object v0, Lgk0;->ˊ:Ljava/security/Permission;
    ...
    sput-object v0, Lgk0;->ˋ:Ljava/security/Permission;

    new-instance v0, Ljava/lang/ThreadLocal;

    invoke-direct {v0}, Ljava/lang/ThreadLocal;-><init>()V

    sput-object v0, Lgk0;->ˎ:Ljava/lang/ThreadLocal;
    ...
    sput-object v0, Lgk0;->ˏ:Ljava/util/Map;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lgk0;->ॱॱ:Ljava/lang/Object;
    ...
    invoke-static {v6}, Lpo2;->ˎ(Ljava/lang/String;)[B

    move-result-object v6

    const/16 v7, 0x7b

    invoke-direct {v5, v6, v7}, Leq0;-><init>([BI)V

    invoke-direct {v0, v1, v2, v4, v5}, Lxp0;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Leq0;)V
    ...
    invoke-static {v7}, Lpo2;->ˎ(Ljava/lang/String;)[B

    move-result-object v7

    const/16 v8, 0x107

    invoke-direct {v6, v7, v8}, Leq0;-><init>([BI)V

    invoke-direct {v1, v2, v4, v5, v6}, Lxp0;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Leq0;)V
    ...
    invoke-static {v8}, Lpo2;->ˎ(Ljava/lang/String;)[B

    move-result-object v8

    const/16 v9, 0x5c

    invoke-direct {v7, v8, v9}, Leq0;-><init>([BI)V

    invoke-direct {v2, v4, v5, v6, v7}, Lxp0;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Leq0;)V
    ...
    invoke-direct {v3, v8, v9}, Leq0;-><init>([BI)V

    invoke-direct {v4, v5, v6, v7, v3}, Lxp0;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Leq0;)V

    sget-object v3, Lgk0$ﹳ;->ˏ:Lgk0$ﹳ;

    const/4 v5, 0x4

    new-array v6, v5, [Lxp0;
    ...
    invoke-static {v3, v6}, Lgk0;->ˊॱ(Lgk0$ﹳ;[Ljava/lang/Object;)V

    sget-object v3, Lgk0$ﹳ;->ˎ:Lgk0$ﹳ;

    new-array v5, v5, [Lho0;

    invoke-static {v0}, Lgk0;->ॱˎ(Lxp0;)Lho0;

    move-result-object v0

    aput-object v0, v5, v7

    invoke-static {v1}, Lgk0;->ॱˎ(Lxp0;)Lho0;

    move-result-object v0

    aput-object v0, v5, v8

    invoke-static {v2}, Lgk0;->ॱˎ(Lxp0;)Lho0;

    move-result-object v0

    aput-object v0, v5, v9

    invoke-static {v4}, Lgk0;->ॱˎ(Lxp0;)Lho0;

    move-result-object v0

    aput-object v0, v5, v10

    invoke-static {v3, v5}, Lgk0;->ˊॱ(Lgk0$ﹳ;[Ljava/lang/Object;)V
...
.method public static ʻ(Lgk0$ﹳ;I)Ljava/lang/Object;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0}, Lgk0;->ˏॱ(Lgk0$ﹳ;)[Ljava/lang/Object;
    ...
    :cond_0
    invoke-static {p0}, Lgk0$ﹳ;->ˊ(Lgk0$ﹳ;)Ljava/lang/Class;
    ...
    invoke-virtual {p0}, Lxp0;->ˊ()Ljava/math/BigInteger;
...
.method public static ʼ(Lgk0$ﹳ;)[Ljava/lang/Object;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static ʽ(Lgk0$ﹳ;)[Ljava/lang/Object;
    .locals 2

    sget-object v0, Lgk0;->ˎ:Ljava/lang/ThreadLocal;
    ...
    :cond_0
    invoke-static {p0}, Lgk0$ﹳ;->ॱ(Lgk0$ﹳ;)Ljava/lang/String;
...
.method public static varargs ˊॱ(Lgk0$ﹳ;[Ljava/lang/Object;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0, p1}, Lgk0;->ˋॱ(Lgk0$ﹳ;[Ljava/lang/Object;)V

    sget-object v0, Lgk0;->ˏ:Ljava/util/Map;
...
.method public static ˋ(Lgk0$ﹳ;)[Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    sget-object v0, Lgk0;->ॱ:Ljava/security/Permission;

    invoke-static {v0}, Lgk0;->ॱ(Ljava/security/Permission;)V

    invoke-static {p0}, Lgk0;->ʽ(Lgk0$ﹳ;)[Ljava/lang/Object;
...
.method public static ˋॱ(Lgk0$ﹳ;[Ljava/lang/Object;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static ˎ(Lgk0$ﹳ;)[Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    sget-object v0, Lgk0;->ˊ:Ljava/security/Permission;
...
.method public static ˏ(Lgk0$ﹳ;)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static ˏॱ(Lgk0$ﹳ;)[Ljava/lang/Object;
    .locals 2
...
.method public static varargs ͺ(Lgk0$ﹳ;[Ljava/lang/Object;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0, p1}, Lgk0;->ˊॱ(Lgk0$ﹳ;[Ljava/lang/Object;)V

    return-void
.end method

.method public static ॱ(Ljava/security/Permission;)V
    .locals 2
    ...
    new-instance v1, Lgk0$ᐨ;

    invoke-direct {v1, v0, p0}, Lgk0$ᐨ;-><init>(Ljava/lang/SecurityManager;Ljava/security/Permission;)V
...
.method public static ॱˊ(Ljava/security/SecureRandom;)V
    .locals 1

    sget-object v0, Lgk0;->ˋ:Ljava/security/Permission;

    invoke-static {v0}, Lgk0;->ॱ(Ljava/security/Permission;)V

    sget-object v0, Lgk0;->ॱॱ:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sput-object p0, Lgk0;->ᐝ:Ljava/security/SecureRandom;
...
.method public static varargs ॱˋ(Lgk0$ﹳ;[Ljava/lang/Object;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static ॱˎ(Lxp0;)Lho0;
    .locals 9
    ...
    invoke-virtual {p0}, Lxp0;->ॱ()Ljava/math/BigInteger;

    move-result-object v3

    invoke-virtual {p0}, Lxp0;->ˋ()Ljava/math/BigInteger;

    move-result-object v4

    new-instance v8, Lvo0;

    invoke-virtual {p0}, Lxp0;->ˎ()Leq0;

    move-result-object v1

    invoke-virtual {v1}, Leq0;->ˊ()[B
    ...
    invoke-virtual {p0}, Leq0;->ॱ()I

    move-result p0

    invoke-direct {v8, v1, p0}, Lvo0;-><init>([BI)V
    ...
    invoke-direct/range {v1 .. v8}, Lho0;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;IILjava/math/BigInteger;Lvo0;)V
...
.method public static ॱॱ()Ljava/security/SecureRandom;
    ...
    :try_start_0
    sget-object v1, Lgk0;->ᐝ:Ljava/security/SecureRandom;
    ...
    :try_start_1
    sget-object v2, Lgk0;->ᐝ:Ljava/security/SecureRandom;

    if-nez v2, :cond_1

    sput-object v1, Lgk0;->ᐝ:Ljava/security/SecureRandom;
...
.method public static ᐝ(Ljava/security/SecureRandom;)Ljava/security/SecureRandom;
    .locals 0
