...
.field public static final ˋॱ:Ljava/lang/String; = "2.5.29.32.0"
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Ltw;->ॱ:Ljava/lang/String;
    ...
    sput-object v0, Ltw;->ˊ:Ljava/lang/String;
    ...
    sput-object v0, Ltw;->ˋ:Ljava/lang/String;
    ...
    sput-object v0, Ltw;->ˎ:Ljava/lang/String;
    ...
    sput-object v0, Ltw;->ˏ:Ljava/lang/String;
    ...
    sput-object v0, Ltw;->ॱॱ:Ljava/lang/String;
    ...
    sput-object v0, Ltw;->ᐝ:Ljava/lang/String;
    ...
    sput-object v0, Ltw;->ʻ:Ljava/lang/String;
    ...
    sput-object v0, Ltw;->ʼ:Ljava/lang/String;
    ...
    sput-object v0, Ltw;->ʽ:Ljava/lang/String;
    ...
    sput-object v0, Ltw;->ˊॱ:Ljava/lang/String;
    ...
    sput-object v0, Ltw;->ॱˊ:[Ljava/lang/String;
...
.method public static ʻ(Ljava/security/cert/X509CRL;)Ljavax/security/auth/x500/X500Principal;
    .locals 0
...
.method public static ʻॱ(I[Ljava/util/List;Lﹲ;Ljava/util/Set;)Z
    .locals 12
    ...
    invoke-virtual {v3}, Lc65;->getExpectedPolicies()Ljava/util/Set;
    ...
    invoke-direct/range {v4 .. v11}, Lc65;-><init>(Ljava/util/List;ILjava/util/Set;Ljava/security/cert/PolicyNode;Ljava/util/Set;Ljava/lang/String;Z)V

    invoke-virtual {v3, v0}, Lc65;->ॱ(Lc65;)V
...
.method public static ʼ(Ljava/util/List;I)Ljava/security/PublicKey;
    .locals 4
...
.method public static ʼॱ(I[Ljava/util/List;Lﹲ;Ljava/util/Set;)V
    .locals 11
    ...
    invoke-direct/range {v3 .. v10}, Lc65;-><init>(Ljava/util/List;ILjava/util/Set;Ljava/security/cert/PolicyNode;Ljava/util/Set;Ljava/lang/String;Z)V

    invoke-virtual {v2, v0}, Lc65;->ॱ(Lc65;)V
...
.method public static ʽ(Ljava/lang/String;[B)Lﻧ;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lｿ;
    ...
    invoke-direct {v0, p0, p1}, Lｿ;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

    throw v0
.end method

.method public static ʽॱ(Lc65;[Ljava/util/List;Lc65;)Lc65;
    .locals 2

    invoke-virtual {p2}, Lc65;->getParent()Ljava/security/cert/PolicyNode;
    ...
    :cond_2
    invoke-virtual {v0, p2}, Lc65;->ˎ(Lc65;)V

    invoke-static {p1, p2}, Ltw;->ʾ([Ljava/util/List;Lc65;)V

    return-object p0
.end method

.method public static ʾ([Ljava/util/List;Lc65;)V
    .locals 1

    invoke-virtual {p1}, Lc65;->getDepth()I
    ...
    invoke-virtual {p1}, Lc65;->ˋ()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p1}, Lc65;->getChildren()Ljava/util/Iterator;
    ...
    invoke-static {p0, v0}, Ltw;->ʾ([Ljava/util/List;Lc65;)V
...
.method public static ʿ(Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/lang/String;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public static ˊ(Lgu8;Ljava/util/List;)Ljava/util/Collection;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lｿ;
    ...
    :try_start_0
    invoke-virtual {v1, p0}, Lcw8;->ॱ(Lft6;)Ljava/util/Collection;
...
.method public static final ˊॱ(LӀ;)Ljava/util/Set;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    invoke-static {v1}, Lﹼ;->ˊ(Ljava/io/OutputStream;)Lﹼ;
    ...
    invoke-virtual {v2, v3}, Lﹼ;->ʽॱ(Lᒻ;)V
    ...
    invoke-direct {v0, v1, p0}, Lfv1;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static ˋ(Lzu8;Ljava/util/List;)Ljava/util/Collection;
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lｿ;
    ...
    :try_start_0
    invoke-interface {v3, p0}, Llg7;->ॱ(Lft6;)Ljava/util/Collection;
    ...
    invoke-interface {v4}, Lho1;->getEncoded()[B

    move-result-object v4

    invoke-direct {v5, v4}, Ljava/io/ByteArrayInputStream;-><init>([B)V

    invoke-virtual {v2, v5}, Lqx;->engineGenerateCertificate(Ljava/io/InputStream;)Ljava/security/cert/Certificate;
    ...
    throw p0
    :try_end_0
    .catch Lmg7; {:try_start_0 .. :try_end_0} :catch_2
...
.method public static ˋॱ(Ljava/lang/Object;)Ljava/math/BigInteger;
    .locals 1
    ...
    invoke-interface {p0}, Lhu8;->getSerialNumber()Ljava/math/BigInteger;
...
.method public static ˎ(Ljava/security/PublicKey;)Lᵍ;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
...
.method public static ˏ(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lfx;)V
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lｿ;
    ...
    :try_start_0
    invoke-static {p1}, Ltw;->ॱˋ(Ljava/security/cert/X509CRL;)Z
    ...
    invoke-static {p2}, Ltw;->ˋॱ(Ljava/lang/Object;)Ljava/math/BigInteger;
    ...
    invoke-static {p1}, Ltw;->ʻ(Ljava/security/cert/X509CRL;)Ljavax/security/auth/x500/X500Principal;

    move-result-object v1

    :cond_1
    invoke-static {p2}, Ltw;->ॱॱ(Ljava/lang/Object;)Ljavax/security/auth/x500/X500Principal;
    ...
    :try_start_1
    sget-object p1, Llv8;->ˊॱ:Lﹲ;

    invoke-virtual {p1}, Lﹲ;->ˎˎ()Ljava/lang/String;

    move-result-object p1

    invoke-static {v0, p1}, Ltw;->ᐝ(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lﻧ;
    ...
    :cond_7
    invoke-virtual {p3, p1}, Lfx;->ˋ(I)V

    invoke-virtual {v0}, Ljava/security/cert/X509CRLEntry;->getRevocationDate()Ljava/util/Date;

    move-result-object p0

    invoke-virtual {p3, p0}, Lfx;->ˎ(Ljava/util/Date;)V
...
.method public static ˏॱ(Ljava/security/cert/X509Certificate;)Ljavax/security/auth/x500/X500Principal;
    .locals 0
...
.method public static ͺ(Ljava/security/cert/PKIXParameters;Ljava/util/Date;)Ljava/util/Date;
    .locals 0
...
.method public static ॱ(Lv55;Ljava/util/List;)Ljava/util/Collection;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lｿ;
    ...
    :try_start_0
    invoke-interface {v1, p0}, Llg7;->ॱ(Lft6;)Ljava/util/Collection;
    ...
    :try_start_1
    invoke-static {p0, v1}, Lv55;->ˋ(Lv55;Ljava/security/cert/CertStore;)Ljava/util/Collection;
...
.method public static ॱˊ(Ljava/util/Set;)Z
    .locals 1
...
.method public static ॱˎ(Ljava/security/cert/X509Certificate;)Z
    .locals 1
...
.method public static ॱॱ(Ljava/lang/Object;)Ljavax/security/auth/x500/X500Principal;
    .locals 1
...
.method public static ॱᐝ(I[Ljava/util/List;Ljava/lang/String;Ljava/util/Map;Ljava/security/cert/X509Certificate;)V
    .locals 9
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lｿ;,
    ...
    invoke-virtual {v1, v3}, Lc65;->ॱॱ(Ljava/util/Set;)V
    ...
    invoke-static {p4, v3}, Ltw;->ᐝ(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lﻧ;
    ...
    invoke-static {v5}, Lcg5;->ˊॱ(Ljava/lang/Object;)Lcg5;

    move-result-object v5
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_1

    invoke-virtual {v5}, Lcg5;->ᐝॱ()Lﹲ;
    ...
    invoke-direct {p1, p2, p0}, Lfv1;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    sget-object v0, Ltw;->ॱ:Ljava/lang/String;
    ...
    :goto_2
    invoke-virtual {v1}, Lc65;->getParent()Ljava/security/cert/PolicyNode;

    move-result-object p4

    check-cast p4, Lc65;

    invoke-virtual {p4}, Lc65;->getValidPolicy()Ljava/lang/String;
    ...
    invoke-virtual {p4, v8}, Lc65;->ॱ(Lc65;)V
...
.method public static ᐝ(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lﻧ;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lｿ;
    ...
    :cond_0
    invoke-static {p1, p0}, Ltw;->ʽ(Ljava/lang/String;[B)Lﻧ;
...
.method public static ᐝॱ(I[Ljava/util/List;Ljava/lang/String;Lc65;)Lc65;
    .locals 6
    ...
    invoke-virtual {v2, v1}, Lc65;->ˎ(Lc65;)V
    ...
    invoke-virtual {v4}, Lc65;->ˋ()Z

    move-result v5

    if-nez v5, :cond_1

    invoke-static {p3, p1, v4}, Ltw;->ʽॱ(Lc65;[Ljava/util/List;Lc65;)Lc65;
