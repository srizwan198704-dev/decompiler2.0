...
.method public static checkKeyReady(Z)V
    ...
    new-instance v1, Lorg/telegram/messenger/FingerprintController$$ExternalSyntheticLambda3;

    invoke-direct {v1, p0}, Lorg/telegram/messenger/FingerprintController$$ExternalSyntheticLambda3;-><init>(Z)V
...
.method private static generateNewKey(Z)V
    ...
    .line 66
    invoke-static {}, Lorg/telegram/messenger/FingerprintController$$ExternalSyntheticApiModelOutline2;->m()V

    const-string v2, "tmessages_passcode"

    const/4 v3, 0x3

    invoke-static {v2, v3}, Lorg/telegram/messenger/DataCollector$$ExternalSyntheticApiModelOutline20;->m(Ljava/lang/String;I)Landroid/security/keystore/KeyGenParameterSpec$Builder;
    ...
    .line 68
    invoke-static {v2, v3}, Lorg/telegram/messenger/FingerprintController$$ExternalSyntheticApiModelOutline0;->m(Landroid/security/keystore/KeyGenParameterSpec$Builder;[Ljava/lang/String;)Landroid/security/keystore/KeyGenParameterSpec$Builder;
    ...
    .line 69
    invoke-static {v2, v3}, Lorg/telegram/messenger/DataCollector$$ExternalSyntheticApiModelOutline17;->m(Landroid/security/keystore/KeyGenParameterSpec$Builder;[Ljava/lang/String;)Landroid/security/keystore/KeyGenParameterSpec$Builder;
    ...
    .line 70
    invoke-static {v2, v3}, Lorg/telegram/messenger/FingerprintController$$ExternalSyntheticApiModelOutline1;->m(Landroid/security/keystore/KeyGenParameterSpec$Builder;Z)Landroid/security/keystore/KeyGenParameterSpec$Builder;

    move-result-object v2

    .line 71
    invoke-static {v2}, Lorg/telegram/messenger/DataCollector$$ExternalSyntheticApiModelOutline19;->m(Landroid/security/keystore/KeyGenParameterSpec$Builder;)Landroid/security/keystore/KeyGenParameterSpec;
    ...
    .line 75
    new-instance v0, Lorg/telegram/messenger/FingerprintController$$ExternalSyntheticLambda4;

    invoke-direct {v0, p0}, Lorg/telegram/messenger/FingerprintController$$ExternalSyntheticLambda4;-><init>(Z)V
