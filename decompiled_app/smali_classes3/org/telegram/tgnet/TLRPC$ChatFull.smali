...
.method public static TLdeserialize(Lorg/telegram/tgnet/InputSerializedData;IZ)Lorg/telegram/tgnet/TLRPC$ChatFull;
    ...
    .line 11338
    :sswitch_3
    new-instance v0, Lorg/telegram/tgnet/TLRPC$TL_channelFull_layer176;

    invoke-direct {v0}, Lorg/telegram/tgnet/TLRPC$TL_channelFull_layer176;-><init>()V
    ...
    .line 11323
    :sswitch_7
    new-instance v0, Lorg/telegram/tgnet/TLRPC$TL_channelFull_layer204;

    invoke-direct {v0}, Lorg/telegram/tgnet/TLRPC$TL_channelFull_layer204;-><init>()V
    ...
    .line 11335
    :sswitch_b
    new-instance v0, Lorg/telegram/tgnet/TLRPC$TL_channelFull_layer177;

    invoke-direct {v0}, Lorg/telegram/tgnet/TLRPC$TL_channelFull_layer177;-><init>()V
    ...
    .line 11320
    :sswitch_24
    new-instance v0, Lorg/telegram/tgnet/TLRPC$TL_channelFull_layer212;

    invoke-direct {v0}, Lorg/telegram/tgnet/TLRPC$TL_channelFull_layer212;-><init>()V
    ...
    .line 11332
    :sswitch_27
    new-instance v0, Lorg/telegram/tgnet/TLRPC$TL_chatFull_layer177;

    invoke-direct {v0}, Lorg/telegram/tgnet/TLRPC$TL_chatFull_layer177;-><init>()V
    ...
    .line 11329
    :sswitch_29
    new-instance v0, Lorg/telegram/tgnet/TLRPC$TL_channelFull_layer195;

    invoke-direct {v0}, Lorg/telegram/tgnet/TLRPC$TL_channelFull_layer195;-><init>()V

    goto :goto_0

    .line 11326
    :sswitch_2a
    new-instance v0, Lorg/telegram/tgnet/TLRPC$TL_channelFull_layer197;

    invoke-direct {v0}, Lorg/telegram/tgnet/TLRPC$TL_channelFull_layer197;-><init>()V
    ...
    .line 11458
    :goto_0
    const-class v1, Lorg/telegram/tgnet/TLRPC$ChatFull;
    ...
    :sswitch_data_0
    .sparse-switch
        -0x75e1d67d -> :sswitch_2f
        -0x6a34a0a9 -> :sswitch_2e
        -0x68411a9e -> :sswitch_2d
        -0x677d1aea -> :sswitch_2c
        -0x61cbe221 -> :sswitch_2b
        -0x600c47a8 -> :sswitch_2a
        -0x4454cb73 -> :sswitch_29
        -0x3c2aaed1 -> :sswitch_28
        -0x362ceec8 -> :sswitch_27
        -0x3449d770 -> :sswitch_26
