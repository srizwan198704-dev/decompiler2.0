...
.method private GetPlayoutUnderrunCount()I
    ...
    .line 418
    invoke-static {v0}, Lorg/webrtc/audio/LowLatencyAudioBufferManager$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/AudioTrack;)I
...
.method private static applyAttributesOnQOrHigher(Landroid/media/AudioAttributes$Builder;Landroid/media/AudioAttributes;)Landroid/media/AudioAttributes$Builder;
    ...
    .line 519
    invoke-static {p1}, Lorg/webrtc/audio/WebRtcAudioTrack$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/AudioAttributes;)I

    move-result p1

    invoke-static {p0, p1}, Lcom/google/android/exoplayer2/audio/AudioAttributes$Api29$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/AudioAttributes$Builder;I)Landroid/media/AudioAttributes$Builder;
...
.method private static createAudioTrackOnOreoOrHigher(IIILandroid/media/AudioAttributes;)Landroid/media/AudioTrack;
    ...
    .line 502
    invoke-static {}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline0;->m()Landroid/media/AudioTrack$Builder;
    ...
    invoke-static {v0, p3}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline1;->m(Landroid/media/AudioTrack$Builder;Landroid/media/AudioAttributes;)Landroid/media/AudioTrack$Builder;
    ...
    .line 504
    invoke-static {p3, p0}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline2;->m(Landroid/media/AudioTrack$Builder;Landroid/media/AudioFormat;)Landroid/media/AudioTrack$Builder;

    move-result-object p0

    .line 509
    invoke-static {p0, p2}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline4;->m(Landroid/media/AudioTrack$Builder;I)Landroid/media/AudioTrack$Builder;
    ...
    .line 510
    invoke-static {p0, p1}, Lorg/webrtc/audio/WebRtcAudioTrack$$ExternalSyntheticApiModelOutline2;->m(Landroid/media/AudioTrack$Builder;I)Landroid/media/AudioTrack$Builder;

    move-result-object p0

    .line 511
    invoke-static {p0, p1}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline3;->m(Landroid/media/AudioTrack$Builder;I)Landroid/media/AudioTrack$Builder;
    ...
    .line 512
    invoke-static {p0, p1}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline5;->m(Landroid/media/AudioTrack$Builder;I)Landroid/media/AudioTrack$Builder;

    move-result-object p0

    .line 513
    invoke-static {p0}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline7;->m(Landroid/media/AudioTrack$Builder;)Landroid/media/AudioTrack;
