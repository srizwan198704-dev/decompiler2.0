...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "boundaryByteString",
        "<init>",
        "(Ljk;Lokhttp3/MediaType;Ljava/util/List;)V",
        "Companion",
        "Builder",
        "Part",
        "okhttp"
...
# instance fields
.field private final boundaryByteString:Ljk;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/MultipartBody$Companion;-><init>(Lrw0;)V
...
.method public constructor <init>(Ljk;Lokhttp3/MediaType;Ljava/util/List;)V
    .locals 1
    .param p1    # Ljk;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    iput-object p1, p0, Lokhttp3/MultipartBody;->boundaryByteString:Ljk;
...
.method private final writeOrCountBytes(Lte;Z)J
    .locals 12
    ...
    invoke-interface {p1, v8}, Lte;->write([B)Lte;

    iget-object v8, p0, Lokhttp3/MultipartBody;->boundaryByteString:Ljk;

    invoke-interface {p1, v8}, Lte;->ꜞ(Ljk;)Lte;
    ...
    invoke-interface {p1, v10}, Lte;->ᐝˊ(Ljava/lang/String;)Lte;

    move-result-object v10

    sget-object v11, Lokhttp3/MultipartBody;->COLONSPACE:[B

    invoke-interface {v10, v11}, Lte;->write([B)Lte;
    ...
    invoke-interface {v10, v11}, Lte;->ᐝˊ(Ljava/lang/String;)Lte;
    ...
    invoke-interface {p1, v8}, Lte;->ᐝˊ(Ljava/lang/String;)Lte;
    ...
    invoke-interface {v8, v7}, Lte;->ᐝˊ(Ljava/lang/String;)Lte;

    move-result-object v7

    sget-object v8, Lokhttp3/MultipartBody;->CRLF:[B

    invoke-interface {v7, v8}, Lte;->write([B)Lte;
    ...
    invoke-interface {p1, v9}, Lte;->ᐝˊ(Ljava/lang/String;)Lte;

    move-result-object v9

    invoke-interface {v9, v7, v8}, Lte;->ˑॱ(J)Lte;

    move-result-object v9

    sget-object v10, Lokhttp3/MultipartBody;->CRLF:[B

    invoke-interface {v9, v10}, Lte;->write([B)Lte;
    ...
    invoke-interface {p1, v9}, Lte;->write([B)Lte;
    ...
    :cond_5
    invoke-virtual {v6, p1}, Lokhttp3/RequestBody;->writeTo(Lte;)V
    ...
    invoke-interface {p1, v1}, Lte;->write([B)Lte;

    iget-object v2, p0, Lokhttp3/MultipartBody;->boundaryByteString:Ljk;

    invoke-interface {p1, v2}, Lte;->ꜞ(Ljk;)Lte;
...
.method public final boundary()Ljava/lang/String;
    ...
    iget-object v0, p0, Lokhttp3/MultipartBody;->boundaryByteString:Ljk;

    invoke-virtual {v0}, Ljk;->ॱᐧ()Ljava/lang/String;
...
.method public contentLength()J
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/MultipartBody;->writeOrCountBytes(Lte;Z)J
...
.method public writeTo(Lte;)V
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/MultipartBody;->writeOrCountBytes(Lte;Z)J
