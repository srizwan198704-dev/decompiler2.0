...
.field private sink:Lte;

.field private socket:Ljava/net/Socket;

.field private source:Lue;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/connection/RealConnection$Companion;-><init>(Lrw0;)V
...
.method private final connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    :try_start_1
    invoke-static {v1}, Lbt4;->ʻॱ(Ljava/net/Socket;)Lta7;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lue;

    invoke-static {v1}, Lbt4;->ॱˊ(Ljava/net/Socket;)Lg57;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lte;
    :try_end_1
...
.method private final connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    invoke-static {p1, v2, v6, v2}, Lri7;->ॱᐝ(Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
    ...
    invoke-direct {v5, v6, v7, v8, v9}, Lokhttp3/Handshake;-><init>(Lokhttp3/TlsVersion;Lokhttp3/CipherSuite;Ljava/util/List;Lq72;)V
    ...
    invoke-virtual {v3, v0, v4}, Lokhttp3/CertificatePinner;->check$okhttp(Ljava/lang/String;Lq72;)V
...
.method private final connectTunnel(IIILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lte;

    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Lue;
...
.method private final createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    :goto_0
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:Lue;

    invoke-static {v0}, Lq93;->ˏॱ(Ljava/lang/Object;)V

    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lte;
    ...
    invoke-direct {v3, v4, p0, v0, v2}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lue;Lte;)V
    ...
    invoke-virtual {v5, v6, v7, v8}, Lmt7;->timeout(JLjava/util/concurrent/TimeUnit;)Lmt7;

    invoke-interface {v2}, Lg57;->timeout()Lmt7;
    ...
    invoke-static {v2, p3, v1}, Lyi7;->ʼʼ(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p1}, Lje;->ॱﾞ()Z

    move-result p1

    if-eqz p1, :cond_4

    invoke-interface {v2}, Lte;->getBuffer()Lje;
...
.method private final startHttp2(I)V
    ...
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lue;
    ...
    invoke-virtual {v4, v0, v5, v1, v2}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Lue;Lte;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public final connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    iput-object v12, v7, Lokhttp3/internal/connection/RealConnection;->source:Lue;

    iput-object v12, v7, Lokhttp3/internal/connection/RealConnection;->sink:Lte;
...
.method public final isHealthy(Z)Z
    ...
    iget-object v4, p0, Lokhttp3/internal/connection/RealConnection;->source:Lue;
    ...
    invoke-static {v3, v4}, Lokhttp3/internal/Util;->isHealthy(Ljava/net/Socket;Lue;)Z
...
.method public final newCodec$okhttp(Lokhttp3/OkHttpClient;Lokhttp3/internal/http/RealInterceptorChain;)Lokhttp3/internal/http/ExchangeCodec;
    ...
    invoke-interface {v1}, Lta7;->timeout()Lmt7;
    ...
    invoke-virtual {v0, v3, v4, v5}, Lmt7;->timeout(JLjava/util/concurrent/TimeUnit;)Lmt7;
    ...
    invoke-direct {v0, p1, p0, v1, v2}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lue;Lte;)V
...
.method public final newWebSocketStreams$okhttp(Lokhttp3/internal/connection/Exchange;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    iget-object v6, p0, Lokhttp3/internal/connection/RealConnection;->source:Lue;

    invoke-static {v6}, Lq93;->ˏॱ(Ljava/lang/Object;)V

    iget-object v7, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lte;
    ...
    invoke-direct/range {v1 .. v7}, Lokhttp3/internal/connection/RealConnection$newWebSocketStreams$1;-><init>(Lokhttp3/internal/connection/Exchange;Lue;Lte;ZLue;Lte;)V
