...
.method private final addCode(III)V
    ...
    invoke-static {p1, v0, p2, p3}, Lব;->ˊꜟ([Ljava/lang/Object;Ljava/lang/Object;II)V
...
# virtual methods
.method public final decode(Lue;JLte;)V
    .locals 8
    .param p1    # Lue;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-interface {p1}, Lue;->readByte()B
    ...
    invoke-interface {p4, v6}, Lte;->writeByte(I)Lte;
    ...
    invoke-interface {p4, p2}, Lte;->writeByte(I)Lte;
...
.method public final encode(Ljk;Lte;)V
    .locals 8
    .param p1    # Ljk;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-interface {p2, v6}, Lte;->writeByte(I)Lte;
    ...
    invoke-interface {p2, p1}, Lte;->writeByte(I)Lte;

    :cond_2
    return-void
.end method

.method public final encodedLength(Ljk;)I
    .locals 6
    .param p1    # Ljk;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {p1, v3}, Ljk;->ˊˋ(I)B
