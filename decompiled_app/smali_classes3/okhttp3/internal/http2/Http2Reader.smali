...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Http2Reader$Companion;-><init>(Lrw0;)V
...
.method public constructor <init>(Lue;Z)V
    .locals 7
    .param p1    # Lue;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lue;

    iput-boolean p2, p0, Lokhttp3/internal/http2/Http2Reader;->client:Z

    new-instance v2, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;

    invoke-direct {v2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lue;)V
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lta7;IIILrw0;)V
...
.method private final readData(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lue;

    invoke-interface {v1}, Lue;->readByte()B
    ...
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lue;

    invoke-interface {p1, v0, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILue;I)V

    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lue;

    int-to-long p2, v1

    invoke-interface {p1, p2, p3}, Lue;->skip(J)V
...
.method private final readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lue;

    invoke-interface {p4}, Lue;->readInt()I

    move-result p4

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lue;

    invoke-interface {v0}, Lue;->readInt()I
    ...
    invoke-interface {v0, v1, v2}, Lue;->ߵ(J)Ljk;

    move-result-object v0

    :cond_0
    invoke-interface {p1, p4, p3, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;Ljk;)V
...
.method private final readPing(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lue;

    invoke-interface {p2}, Lue;->readInt()I
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lue;

    invoke-interface {v3}, Lue;->readByte()B
...
.method private final readPushPromise(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-interface {v1}, Lue;->readInt()I
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {v0, p2}, Luw5;->ˆ(II)Lf83;

    move-result-object p2

    const/4 v1, 0x6

    invoke-static {p2, v1}, Luw5;->ﹺ(Ld83;I)Ld83;

    move-result-object p2

    invoke-virtual {p2}, Ld83;->ˎ()I

    move-result v1

    invoke-virtual {p2}, Ld83;->ˏ()I

    move-result v2

    invoke-virtual {p2}, Ld83;->ॱॱ()I
    ...
    invoke-interface {v3}, Lue;->readShort()S
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lue;

    invoke-interface {v4}, Lue;->readInt()I
...
.method public final nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-static {v0}, Lokhttp3/internal/Util;->readMedium(Lue;)I
    ...
    invoke-interface {p1, v0, v1}, Lue;->skip(J)V
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Ljk;
    ...
    invoke-interface {p1, v2, v3}, Lue;->ߵ(J)Ljk;
    ...
    invoke-virtual {p1}, Ljk;->ˍ()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Ljk;->ॱᐧ()Ljava/lang/String;
