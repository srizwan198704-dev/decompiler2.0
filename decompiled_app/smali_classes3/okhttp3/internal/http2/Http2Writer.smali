...
.field private final hpackBuffer:Lje;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Http2Writer$Companion;-><init>(Lrw0;)V
...
.method public constructor <init>(Lte;Z)V
    .locals 7
    .param p1    # Lte;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lte;
    ...
    iput-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lje;
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLje;ILrw0;)V
...
.method private final writeContinuationFrames(IJ)V
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lte;

    iget-object v1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lje;

    invoke-interface {v0, v1, v2, v3}, Lg57;->write(Lje;J)V
...
.method public final declared-synchronized applyAndAckSettings(Lokhttp3/internal/http2/Settings;)V
    ...
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lte;
...
.method public final declared-synchronized connectionPreface()V
    ...
    sget-object v2, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Ljk;

    invoke-virtual {v2}, Ljk;->ˍ()Ljava/lang/String;
    ...
    sget-object v1, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Ljk;

    invoke-interface {v0, v1}, Lte;->ꜞ(Ljk;)Lte;
...
.method public final declared-synchronized data(ZILje;I)V
    .locals 1
    .param p3    # Lje;
    ...
    invoke-virtual {p0, p2, p1, p3, p4}, Lokhttp3/internal/http2/Http2Writer;->dataFrame(IILje;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final dataFrame(IILje;I)V
    .locals 2
    .param p3    # Lje;
        .annotation build Lorg/jetbrains/annotations/Nullable;
        .end annotation
    ...
    invoke-interface {p1, p3, v0, v1}, Lg57;->write(Lje;J)V
...
.method public final frameHeader(IIII)V
    ...
    invoke-static {v0, p2}, Lokhttp3/internal/Util;->writeMedium(Lte;I)V

    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lte;

    and-int/lit16 p3, p3, 0xff

    invoke-interface {p2, p3}, Lte;->writeByte(I)Lte;
    ...
    invoke-interface {p2, p1}, Lte;->writeInt(I)Lte;
...
.method public final declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, Lte;->writeInt(I)Lte;
    ...
    invoke-interface {p1, p2}, Lte;->writeInt(I)Lte;
    ...
    invoke-interface {p1, p3}, Lte;->write([B)Lte;
...
.method public final declared-synchronized headers(ZILjava/util/List;)V
    ...
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lje;
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lje;

    invoke-interface {p1, v4, v2, v3}, Lg57;->write(Lje;J)V
...
.method public final declared-synchronized ping(ZII)V
    ...
    invoke-interface {p1, p3}, Lte;->writeInt(I)Lte;
...
.method public final declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lte;

    const v3, 0x7fffffff

    and-int/2addr p2, v3

    invoke-interface {v2, p2}, Lte;->writeInt(I)Lte;

    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lte;

    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lje;

    invoke-interface {p2, v2, v4, v5}, Lg57;->write(Lje;J)V
...
.method public final declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    :goto_1
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lte;

    invoke-interface {v4, v3}, Lte;->writeShort(I)Lte;

    iget-object v3, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lte;

    invoke-virtual {p1, v2}, Lokhttp3/internal/http2/Settings;->get(I)I

    move-result v4

    invoke-interface {v3, v4}, Lte;->writeInt(I)Lte;
