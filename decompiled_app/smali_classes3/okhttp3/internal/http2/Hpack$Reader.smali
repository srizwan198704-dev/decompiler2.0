...
.method public constructor <init>(Lta7;I)V
    ...
    invoke-direct/range {v0 .. v5}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lta7;IIILrw0;)V

    return-void
.end method

.method public constructor <init>(Lta7;II)V
    .locals 1
    .param p1    # Lta7;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lue;
...
.method public synthetic constructor <init>(Lta7;IIILrw0;)V
    .locals 0
    ...
    :cond_0
    invoke-direct {p0, p1, p2, p3}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lta7;II)V
...
.method private final getName(I)Ljk;
    .locals 3
    ...
    iget-object p1, p1, Lokhttp3/internal/http2/Header;->name:Ljk;
...
.method private final readByte()I
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lue;
...
.method private final readLiteralHeaderWithIncrementalIndexingIndexedName(I)V
    ...
    invoke-direct {p0, p1}, Lokhttp3/internal/http2/Hpack$Reader;->getName(I)Ljk;

    move-result-object p1

    invoke-virtual {p0}, Lokhttp3/internal/http2/Hpack$Reader;->readByteString()Ljk;

    move-result-object v0

    new-instance v1, Lokhttp3/internal/http2/Header;

    invoke-direct {v1, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Ljk;Ljk;)V
...
.method private final readLiteralHeaderWithIncrementalIndexingNewName()V
    ...
    invoke-virtual {v0, v1}, Lokhttp3/internal/http2/Hpack;->checkLowercase(Ljk;)Ljk;
    ...
    invoke-direct {v2, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Ljk;Ljk;)V
...
.method private final readLiteralHeaderWithoutIndexingIndexedName(I)V
    ...
    invoke-direct {v2, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Ljk;Ljk;)V
...
.method private final readLiteralHeaderWithoutIndexingNewName()V
    ...
    invoke-direct {v3, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Ljk;Ljk;)V
...
.method public final readByteString()Ljk;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lue;

    invoke-virtual {v1, v4, v2, v3, v0}, Lokhttp3/internal/http2/Huffman;->decode(Lue;JLte;)V
    ...
    invoke-interface {v0, v2, v3}, Lue;->ߵ(J)Ljk;
