...
.field private final readBuffer:Lje;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field

.field private final receiveBuffer:Lje;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.method public constructor <init>(Lokhttp3/internal/http2/Http2Stream;JZ)V
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lje;

    new-instance p1, Lje;

    invoke-direct {p1}, Lje;-><init>()V

    iput-object p1, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lje;
...
.method public close()V
    ...
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lje;

    invoke-virtual {v1}, Lje;->size()J

    move-result-wide v1

    iget-object v3, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lje;

    invoke-virtual {v3}, Lje;->ॱॱ()V
...
.method public final getReadBuffer()Lje;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lje;

    return-object v0
.end method

.method public final getReceiveBuffer()Lje;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lje;
...
.method public read(Lje;J)J
    ...
    iget-object v10, v1, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lje;

    invoke-virtual {v10}, Lje;->size()J
    ...
    invoke-virtual {v10, v0, v14, v15}, Lje;->read(Lje;J)J
...
.method public final receive$okhttp(Lue;J)V
    .locals 11
    .param p1    # Lue;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lje;
    ...
    :cond_4
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lje;

    invoke-interface {p1, v2, p2, p3}, Lta7;->read(Lje;J)J
    ...
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lje;

    invoke-virtual {v3}, Lje;->size()J

    move-result-wide v3

    iget-object v5, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lje;

    invoke-virtual {v5}, Lje;->ॱॱ()V
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lje;

    invoke-virtual {v3, v4}, Lje;->ᐝʻ(Lta7;)J
