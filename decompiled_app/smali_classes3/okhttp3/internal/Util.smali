...
.field private static final UNICODE_BOMS:Lsz4;
...
.field private static final VERIFY_AS_IP_ADDRESS:Lf26;
...
.method public static constructor <clinit>()V
    ...
    sget-object v1, Lsz4;->ˎ:Lsz4$ᐨ;

    const/4 v2, 0x5

    new-array v2, v2, [Ljk;

    sget-object v3, Ljk;->ˏ:Ljk$ᐨ;

    const-string v4, "efbbbf"

    invoke-virtual {v3, v4}, Ljk$ᐨ;->ʼ(Ljava/lang/String;)Ljk;
    ...
    invoke-virtual {v1, v2}, Lsz4$ᐨ;->ˎ([Ljk;)Lsz4;

    move-result-object v1

    sput-object v1, Lokhttp3/internal/Util;->UNICODE_BOMS:Lsz4;
    ...
    sput-object v1, Lokhttp3/internal/Util;->VERIFY_AS_IP_ADDRESS:Lf26;
    ...
    invoke-static {v0, v1}, Lzi7;->ᐩ(Ljava/lang/String;Ljava/lang/CharSequence;)Ljava/lang/String;

    move-result-object v0

    const-string v1, "Client"

    invoke-static {v0, v1}, Lzi7;->ᵕ(Ljava/lang/String;Ljava/lang/CharSequence;)Ljava/lang/String;
...
.method public static final canParseAsIpAddress(Ljava/lang/String;)Z
    ...
    sget-object v0, Lokhttp3/internal/Util;->VERIFY_AS_IP_ADDRESS:Lf26;

    invoke-virtual {v0, p0}, Lf26;->ˊॱ(Ljava/lang/CharSequence;)Z
...
.method public static final delimiterOffset(Ljava/lang/String;Ljava/lang/String;II)I
    ...
    invoke-static {p1, v0, v1, v2, v3}, Lzi7;->ˑˊ(Ljava/lang/CharSequence;CZILjava/lang/Object;)Z
...
.method public static final discard(Lta7;ILjava/util/concurrent/TimeUnit;)Z
    .locals 1
    .param p0    # Lta7;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    :try_start_0
    invoke-static {p0, p1, p2}, Lokhttp3/internal/Util;->skipAll(Lta7;ILjava/util/concurrent/TimeUnit;)Z
...
.method public static final filterList(Ljava/lang/Iterable;Lb82;)Ljava/util/List;
    .locals 3
...
.method public static final ignoreIoExceptions(Lq72;)V
    .locals 1
    .param p0    # Lq72;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
...
.method public static final varargs immutableListOf([Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-static {p0}, Ls70;->ˏˏ([Ljava/lang/Object;)Ljava/util/List;
...
.method public static final indexOfControlOrNonAscii(Ljava/lang/String;)I
    ...
    invoke-static {v2, v3}, Lq93;->ʻॱ(II)I
...
.method public static final isCivilized(Lokhttp3/internal/io/FileSystem;Ljava/io/File;)Z
    ...
    invoke-interface {p0, p1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)Lg57;
...
.method public static final isHealthy(Ljava/net/Socket;Lue;)Z
    .locals 2
    .param p0    # Ljava/net/Socket;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
...
.method public static final readBomAsCharset(Lue;Ljava/nio/charset/Charset;)Ljava/nio/charset/Charset;
    .locals 1
    .param p0    # Lue;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    sget-object v0, Lokhttp3/internal/Util;->UNICODE_BOMS:Lsz4;

    invoke-interface {p0, v0}, Lue;->ॱˑ(Lsz4;)I
    ...
    sget-object p0, Lb20;->ॱ:Lb20;

    invoke-virtual {p0}, Lb20;->ˋ()Ljava/nio/charset/Charset;
    ...
    invoke-virtual {p0}, Lb20;->ˊ()Ljava/nio/charset/Charset;
...
.method public static final readMedium(Lue;)I
    .locals 3
    .param p0    # Lue;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-interface {p0}, Lue;->readByte()B
...
.method public static final skipAll(Lje;B)I
    .locals 3
    .param p0    # Lje;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {p0, v1, v2}, Lje;->ˍ(J)B
...
.method public static final skipAll(Lta7;ILjava/util/concurrent/TimeUnit;)Z
    .locals 11
    .param p0    # Lta7;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {v2, p1, p2}, Lmt7;->deadlineNanoTime(J)Lmt7;
    ...
    invoke-interface {p0, p1, v7, v8}, Lta7;->read(Lje;J)J
...
.method public static final threadName(Ljava/lang/String;Lq72;)V
    .locals 2
    .param p0    # Ljava/lang/String;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-static {p0}, Lx63;->ˎ(I)V

    invoke-virtual {v0, v1}, Ljava/lang/Thread;->setName(Ljava/lang/String;)V

    invoke-static {p0}, Lx63;->ˋ(I)V
...
.method public static final toHeaders(Ljava/util/List;)Lokhttp3/Headers;
    ...
    invoke-virtual {v1}, Lokhttp3/internal/http2/Header;->component1()Ljk;

    move-result-object v2

    invoke-virtual {v1}, Lokhttp3/internal/http2/Header;->component2()Ljk;

    move-result-object v1

    invoke-virtual {v2}, Ljk;->ॱᐧ()Ljava/lang/String;
...
.method public static final toImmutableList(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {p0}, La80;->ʽˑ(Ljava/util/Collection;)Ljava/util/List;
...
.method public static final toImmutableMap(Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {}, Lf34;->ˉ()Ljava/util/Map;
...
.method public static final withSuppressed(Ljava/lang/Exception;Ljava/util/List;)Ljava/lang/Throwable;
    ...
    invoke-static {p0, v0}, Lmt1;->ॱ(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
...
.method public static final writeMedium(Lte;I)V
    .locals 1
    .param p0    # Lte;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-interface {p0, v0}, Lte;->writeByte(I)Lte;
    ...
    invoke-interface {p0, p1}, Lte;->writeByte(I)Lte;
