...
# instance fields
.field public final synthetic $cacheBody:Lte;

.field public final synthetic $cacheRequest:Lokhttp3/internal/cache/CacheRequest;

.field public final synthetic $source:Lue;

.field private cacheRequestClosed:Z


# direct methods
.method public constructor <init>(Lue;Lokhttp3/internal/cache/CacheRequest;Lte;)V
    .locals 0

    iput-object p1, p0, Lokhttp3/internal/cache/CacheInterceptor$cacheWritingResponse$cacheWritingSource$1;->$source:Lue;
    ...
    iput-object p3, p0, Lokhttp3/internal/cache/CacheInterceptor$cacheWritingResponse$cacheWritingSource$1;->$cacheBody:Lte;
...
.method public close()V
    ...
    invoke-static {p0, v0, v1}, Lokhttp3/internal/Util;->discard(Lta7;ILjava/util/concurrent/TimeUnit;)Z
    ...
    :cond_0
    iget-object v0, p0, Lokhttp3/internal/cache/CacheInterceptor$cacheWritingResponse$cacheWritingSource$1;->$source:Lue;
...
.method public read(Lje;J)J
    ...
    :try_start_0
    iget-object v1, p0, Lokhttp3/internal/cache/CacheInterceptor$cacheWritingResponse$cacheWritingSource$1;->$source:Lue;
    ...
    iget-object p1, p0, Lokhttp3/internal/cache/CacheInterceptor$cacheWritingResponse$cacheWritingSource$1;->$cacheBody:Lte;

    invoke-interface {p1}, Lg57;->close()V

    :cond_0
    return-wide v1

    :cond_1
    iget-object v0, p0, Lokhttp3/internal/cache/CacheInterceptor$cacheWritingResponse$cacheWritingSource$1;->$cacheBody:Lte;
    ...
    invoke-interface {p1}, Lte;->ˋˋ()Lte;
