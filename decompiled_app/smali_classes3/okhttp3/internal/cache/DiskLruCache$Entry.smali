...
.method private final newSource(I)Lta7;
    .locals 2
    ...
    invoke-interface {v0, p1}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lta7;
    ...
    invoke-direct {v0, p0, p1, p1}, Lokhttp3/internal/cache/DiskLruCache$Entry$newSource$1;-><init>(Lokhttp3/internal/cache/DiskLruCache$Entry;Lta7;Lta7;)V
...
.method public final snapshot$okhttp()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    invoke-direct {p0, v2}, Lokhttp3/internal/cache/DiskLruCache$Entry;->newSource(I)Lta7;
...
.method public final writeLengths$okhttp(Lte;)V
    .locals 6
    .param p1    # Lte;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-interface {p1, v5}, Lte;->writeByte(I)Lte;

    move-result-object v5

    invoke-interface {v5, v3, v4}, Lte;->ˑॱ(J)Lte;
