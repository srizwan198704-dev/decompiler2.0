...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/CertificatePinner$Companion;-><init>(Lrw0;)V
...
.method public synthetic constructor <init>(Ljava/util/Set;Lokhttp3/internal/tls/CertificateChainCleaner;ILrw0;)V
    .locals 0
...
.method public static final sha1Hash(Ljava/security/cert/X509Certificate;)Ljk;
    .locals 1
    ...
    invoke-virtual {v0, p0}, Lokhttp3/CertificatePinner$Companion;->sha1Hash(Ljava/security/cert/X509Certificate;)Ljk;
...
.method public static final sha256Hash(Ljava/security/cert/X509Certificate;)Ljk;
    .locals 1
    .param p0    # Ljava/security/cert/X509Certificate;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {v0, p0}, Lokhttp3/CertificatePinner$Companion;->sha256Hash(Ljava/security/cert/X509Certificate;)Ljk;
...
.method public final check(Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-virtual {p0, p1, v0}, Lokhttp3/CertificatePinner;->check$okhttp(Ljava/lang/String;Lq72;)V
...
.method public final varargs check(Ljava/lang/String;[Ljava/security/cert/Certificate;)V
    ...
    invoke-static {p2}, Lশ;->ॱᵞ([Ljava/lang/Object;)Ljava/util/List;
...
.method public final check$okhttp(Ljava/lang/String;Lq72;)V
    .locals 10
    .param p1    # Ljava/lang/String;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {v5, v2}, Lokhttp3/CertificatePinner$Companion;->sha1Hash(Ljava/security/cert/X509Certificate;)Ljk;

    move-result-object v5

    :cond_3
    invoke-virtual {v6}, Lokhttp3/CertificatePinner$Pin;->getHash()Ljk;
    ...
    invoke-virtual {v4, v2}, Lokhttp3/CertificatePinner$Companion;->sha256Hash(Ljava/security/cert/X509Certificate;)Ljk;
    ...
    invoke-static {v6, v4}, Lq93;->ᐝ(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method public final findMatchingPins(Ljava/lang/String;)Ljava/util/List;
    ...
    :cond_1
    invoke-static {v1}, Lkx7;->ᐝ(Ljava/lang/Object;)Ljava/util/List;
