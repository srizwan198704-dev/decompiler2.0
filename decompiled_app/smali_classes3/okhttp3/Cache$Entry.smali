...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/Cache$Entry$Companion;-><init>(Lrw0;)V
...
.method public constructor <init>(Lta7;)V
    ...
    invoke-interface {v0}, Lue;->ʼᐝ()Ljava/lang/String;
    ...
    invoke-virtual {v2, v0}, Lokhttp3/Cache$Companion;->readInt$okhttp(Lue;)I
    ...
    invoke-direct {p0, v0}, Lokhttp3/Cache$Entry;->readCertificateList(Lue;)Ljava/util/List;
    ...
    invoke-static {p1, v2}, Lm50;->ॱ(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method private final readCertificateList(Lue;)Ljava/util/List;
    .locals 7
    ...
    invoke-virtual {v0, p1}, Lokhttp3/Cache$Companion;->readInt$okhttp(Lue;)I
    ...
    invoke-interface {p1}, Lue;->ʼᐝ()Ljava/lang/String;
    ...
    sget-object v6, Ljk;->ˏ:Ljk$ᐨ;

    invoke-virtual {v6, v4}, Ljk$ᐨ;->ʻ(Ljava/lang/String;)Ljk;

    move-result-object v4

    invoke-static {v4}, Lq93;->ˏॱ(Ljava/lang/Object;)V

    invoke-virtual {v5, v4}, Lje;->ˏͺ(Ljk;)Lje;

    invoke-virtual {v5}, Lje;->ˋﾞ()Ljava/io/InputStream;
...
.method private final writeCertList(Lte;Ljava/util/List;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0, v1}, Lte;->ˑॱ(J)Lte;
    ...
    invoke-static/range {v2 .. v7}, Ljk$ᐨ;->ॱˋ(Ljk$ᐨ;[BIIILjava/lang/Object;)Ljk;
...
.method public final writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    invoke-virtual {p1, v0}, Lokhttp3/internal/cache/DiskLruCache$Editor;->newSink(I)Lg57;
    ...
    invoke-interface {p1, v3, v4}, Lte;->ˑॱ(J)Lte;
    ...
    invoke-interface {p1, v5}, Lte;->ᐝˊ(Ljava/lang/String;)Lte;

    move-result-object v5

    invoke-interface {v5, v4}, Lte;->ᐝˊ(Ljava/lang/String;)Lte;
    ...
    invoke-interface {v4, v5}, Lte;->ᐝˊ(Ljava/lang/String;)Lte;

    move-result-object v4

    invoke-interface {v4, v2}, Lte;->writeByte(I)Lte;
    ...
    invoke-interface {p1, v5, v6}, Lte;->ˑॱ(J)Lte;
    ...
    invoke-interface {p1, v3}, Lte;->ᐝˊ(Ljava/lang/String;)Lte;
    ...
    invoke-interface {v3, v5}, Lte;->ᐝˊ(Ljava/lang/String;)Lte;

    move-result-object v3

    invoke-interface {v3, v2}, Lte;->writeByte(I)Lte;
    ...
    invoke-interface {v0, v5, v6}, Lte;->ˑॱ(J)Lte;
    ...
    invoke-interface {v0, v3, v4}, Lte;->ˑॱ(J)Lte;
    ...
    invoke-interface {p1, v2}, Lte;->writeByte(I)Lte;
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/Cache$Entry;->writeCertList(Lte;Ljava/util/List;)V
