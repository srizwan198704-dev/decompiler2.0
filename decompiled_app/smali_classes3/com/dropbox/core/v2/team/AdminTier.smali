...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lcom/dropbox/core/v2/team/AdminTier;

    const-string v3, "USER_MANAGEMENT_ADMIN"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/dropbox/core/v2/team/AdminTier;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/dropbox/core/v2/team/AdminTier;->USER_MANAGEMENT_ADMIN:Lcom/dropbox/core/v2/team/AdminTier;

    new-instance v3, Lcom/dropbox/core/v2/team/AdminTier;

    const-string v5, "SUPPORT_ADMIN"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/dropbox/core/v2/team/AdminTier;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/dropbox/core/v2/team/AdminTier;->SUPPORT_ADMIN:Lcom/dropbox/core/v2/team/AdminTier;

    new-instance v5, Lcom/dropbox/core/v2/team/AdminTier;

    const-string v7, "MEMBER_ONLY"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/dropbox/core/v2/team/AdminTier;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/dropbox/core/v2/team/AdminTier;->MEMBER_ONLY:Lcom/dropbox/core/v2/team/AdminTier;

    const/4 v7, 0x4

    new-array v7, v7, [Lcom/dropbox/core/v2/team/AdminTier;
    ...
    sput-object v7, Lcom/dropbox/core/v2/team/AdminTier;->$VALUES:[Lcom/dropbox/core/v2/team/AdminTier;
