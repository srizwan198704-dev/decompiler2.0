...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lcom/dropbox/core/v2/team/FeatureValue$Tag;

    const-string v3, "HAS_TEAM_SHARED_DROPBOX"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/dropbox/core/v2/team/FeatureValue$Tag;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/dropbox/core/v2/team/FeatureValue$Tag;->HAS_TEAM_SHARED_DROPBOX:Lcom/dropbox/core/v2/team/FeatureValue$Tag;

    new-instance v3, Lcom/dropbox/core/v2/team/FeatureValue$Tag;

    const-string v5, "HAS_TEAM_FILE_EVENTS"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/dropbox/core/v2/team/FeatureValue$Tag;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/dropbox/core/v2/team/FeatureValue$Tag;->HAS_TEAM_FILE_EVENTS:Lcom/dropbox/core/v2/team/FeatureValue$Tag;

    new-instance v5, Lcom/dropbox/core/v2/team/FeatureValue$Tag;

    const-string v7, "HAS_TEAM_SELECTIVE_SYNC"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/dropbox/core/v2/team/FeatureValue$Tag;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/dropbox/core/v2/team/FeatureValue$Tag;->HAS_TEAM_SELECTIVE_SYNC:Lcom/dropbox/core/v2/team/FeatureValue$Tag;

    new-instance v7, Lcom/dropbox/core/v2/team/FeatureValue$Tag;

    const-string v9, "OTHER"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/dropbox/core/v2/team/FeatureValue$Tag;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/dropbox/core/v2/team/FeatureValue$Tag;->OTHER:Lcom/dropbox/core/v2/team/FeatureValue$Tag;

    const/4 v9, 0x5

    new-array v9, v9, [Lcom/dropbox/core/v2/team/FeatureValue$Tag;
    ...
    sput-object v9, Lcom/dropbox/core/v2/team/FeatureValue$Tag;->$VALUES:[Lcom/dropbox/core/v2/team/FeatureValue$Tag;
