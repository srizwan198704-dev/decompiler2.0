...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lcom/dropbox/core/v2/team/GroupCreateError;

    const-string v3, "GROUP_NAME_INVALID"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/dropbox/core/v2/team/GroupCreateError;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/dropbox/core/v2/team/GroupCreateError;->GROUP_NAME_INVALID:Lcom/dropbox/core/v2/team/GroupCreateError;

    new-instance v3, Lcom/dropbox/core/v2/team/GroupCreateError;

    const-string v5, "EXTERNAL_ID_ALREADY_IN_USE"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/dropbox/core/v2/team/GroupCreateError;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/dropbox/core/v2/team/GroupCreateError;->EXTERNAL_ID_ALREADY_IN_USE:Lcom/dropbox/core/v2/team/GroupCreateError;

    new-instance v5, Lcom/dropbox/core/v2/team/GroupCreateError;

    const-string v7, "SYSTEM_MANAGED_GROUP_DISALLOWED"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/dropbox/core/v2/team/GroupCreateError;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/dropbox/core/v2/team/GroupCreateError;->SYSTEM_MANAGED_GROUP_DISALLOWED:Lcom/dropbox/core/v2/team/GroupCreateError;

    new-instance v7, Lcom/dropbox/core/v2/team/GroupCreateError;

    const-string v9, "OTHER"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/dropbox/core/v2/team/GroupCreateError;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/dropbox/core/v2/team/GroupCreateError;->OTHER:Lcom/dropbox/core/v2/team/GroupCreateError;

    const/4 v9, 0x5

    new-array v9, v9, [Lcom/dropbox/core/v2/team/GroupCreateError;
    ...
    sput-object v9, Lcom/dropbox/core/v2/team/GroupCreateError;->$VALUES:[Lcom/dropbox/core/v2/team/GroupCreateError;
