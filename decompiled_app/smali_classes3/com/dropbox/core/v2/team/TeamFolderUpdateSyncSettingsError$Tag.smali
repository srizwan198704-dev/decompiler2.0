...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lcom/dropbox/core/v2/team/TeamFolderUpdateSyncSettingsError$Tag;

    const-string v3, "STATUS_ERROR"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/dropbox/core/v2/team/TeamFolderUpdateSyncSettingsError$Tag;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/dropbox/core/v2/team/TeamFolderUpdateSyncSettingsError$Tag;->STATUS_ERROR:Lcom/dropbox/core/v2/team/TeamFolderUpdateSyncSettingsError$Tag;

    new-instance v3, Lcom/dropbox/core/v2/team/TeamFolderUpdateSyncSettingsError$Tag;

    const-string v5, "TEAM_SHARED_DROPBOX_ERROR"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/dropbox/core/v2/team/TeamFolderUpdateSyncSettingsError$Tag;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/dropbox/core/v2/team/TeamFolderUpdateSyncSettingsError$Tag;->TEAM_SHARED_DROPBOX_ERROR:Lcom/dropbox/core/v2/team/TeamFolderUpdateSyncSettingsError$Tag;

    new-instance v5, Lcom/dropbox/core/v2/team/TeamFolderUpdateSyncSettingsError$Tag;

    const-string v7, "OTHER"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/dropbox/core/v2/team/TeamFolderUpdateSyncSettingsError$Tag;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/dropbox/core/v2/team/TeamFolderUpdateSyncSettingsError$Tag;->OTHER:Lcom/dropbox/core/v2/team/TeamFolderUpdateSyncSettingsError$Tag;

    new-instance v7, Lcom/dropbox/core/v2/team/TeamFolderUpdateSyncSettingsError$Tag;

    const-string v9, "SYNC_SETTINGS_ERROR"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/dropbox/core/v2/team/TeamFolderUpdateSyncSettingsError$Tag;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/dropbox/core/v2/team/TeamFolderUpdateSyncSettingsError$Tag;->SYNC_SETTINGS_ERROR:Lcom/dropbox/core/v2/team/TeamFolderUpdateSyncSettingsError$Tag;

    const/4 v9, 0x5

    new-array v9, v9, [Lcom/dropbox/core/v2/team/TeamFolderUpdateSyncSettingsError$Tag;
    ...
    sput-object v9, Lcom/dropbox/core/v2/team/TeamFolderUpdateSyncSettingsError$Tag;->$VALUES:[Lcom/dropbox/core/v2/team/TeamFolderUpdateSyncSettingsError$Tag;
