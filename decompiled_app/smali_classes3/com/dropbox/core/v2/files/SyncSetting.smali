...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lcom/dropbox/core/v2/files/SyncSetting;

    const-string v3, "NOT_SYNCED"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/dropbox/core/v2/files/SyncSetting;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/dropbox/core/v2/files/SyncSetting;->NOT_SYNCED:Lcom/dropbox/core/v2/files/SyncSetting;

    new-instance v3, Lcom/dropbox/core/v2/files/SyncSetting;

    const-string v5, "NOT_SYNCED_INACTIVE"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/dropbox/core/v2/files/SyncSetting;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/dropbox/core/v2/files/SyncSetting;->NOT_SYNCED_INACTIVE:Lcom/dropbox/core/v2/files/SyncSetting;

    new-instance v5, Lcom/dropbox/core/v2/files/SyncSetting;

    const-string v7, "OTHER"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/dropbox/core/v2/files/SyncSetting;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/dropbox/core/v2/files/SyncSetting;->OTHER:Lcom/dropbox/core/v2/files/SyncSetting;

    const/4 v7, 0x4

    new-array v7, v7, [Lcom/dropbox/core/v2/files/SyncSetting;
    ...
    sput-object v7, Lcom/dropbox/core/v2/files/SyncSetting;->$VALUES:[Lcom/dropbox/core/v2/files/SyncSetting;
