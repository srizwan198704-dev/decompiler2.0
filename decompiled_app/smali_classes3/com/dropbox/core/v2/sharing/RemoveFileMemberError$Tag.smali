...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lcom/dropbox/core/v2/sharing/RemoveFileMemberError$Tag;

    const-string v3, "ACCESS_ERROR"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/dropbox/core/v2/sharing/RemoveFileMemberError$Tag;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/dropbox/core/v2/sharing/RemoveFileMemberError$Tag;->ACCESS_ERROR:Lcom/dropbox/core/v2/sharing/RemoveFileMemberError$Tag;

    new-instance v3, Lcom/dropbox/core/v2/sharing/RemoveFileMemberError$Tag;

    const-string v5, "NO_EXPLICIT_ACCESS"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/dropbox/core/v2/sharing/RemoveFileMemberError$Tag;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/dropbox/core/v2/sharing/RemoveFileMemberError$Tag;->NO_EXPLICIT_ACCESS:Lcom/dropbox/core/v2/sharing/RemoveFileMemberError$Tag;

    new-instance v5, Lcom/dropbox/core/v2/sharing/RemoveFileMemberError$Tag;

    const-string v7, "OTHER"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/dropbox/core/v2/sharing/RemoveFileMemberError$Tag;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/dropbox/core/v2/sharing/RemoveFileMemberError$Tag;->OTHER:Lcom/dropbox/core/v2/sharing/RemoveFileMemberError$Tag;

    const/4 v7, 0x4

    new-array v7, v7, [Lcom/dropbox/core/v2/sharing/RemoveFileMemberError$Tag;
    ...
    sput-object v7, Lcom/dropbox/core/v2/sharing/RemoveFileMemberError$Tag;->$VALUES:[Lcom/dropbox/core/v2/sharing/RemoveFileMemberError$Tag;
