...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lcom/dropbox/core/v2/sharing/FileMemberActionError$Tag;

    const-string v3, "NO_PERMISSION"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/dropbox/core/v2/sharing/FileMemberActionError$Tag;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/dropbox/core/v2/sharing/FileMemberActionError$Tag;->NO_PERMISSION:Lcom/dropbox/core/v2/sharing/FileMemberActionError$Tag;

    new-instance v3, Lcom/dropbox/core/v2/sharing/FileMemberActionError$Tag;

    const-string v5, "ACCESS_ERROR"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/dropbox/core/v2/sharing/FileMemberActionError$Tag;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/dropbox/core/v2/sharing/FileMemberActionError$Tag;->ACCESS_ERROR:Lcom/dropbox/core/v2/sharing/FileMemberActionError$Tag;

    new-instance v5, Lcom/dropbox/core/v2/sharing/FileMemberActionError$Tag;

    const-string v7, "NO_EXPLICIT_ACCESS"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/dropbox/core/v2/sharing/FileMemberActionError$Tag;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/dropbox/core/v2/sharing/FileMemberActionError$Tag;->NO_EXPLICIT_ACCESS:Lcom/dropbox/core/v2/sharing/FileMemberActionError$Tag;

    new-instance v7, Lcom/dropbox/core/v2/sharing/FileMemberActionError$Tag;

    const-string v9, "OTHER"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/dropbox/core/v2/sharing/FileMemberActionError$Tag;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/dropbox/core/v2/sharing/FileMemberActionError$Tag;->OTHER:Lcom/dropbox/core/v2/sharing/FileMemberActionError$Tag;

    const/4 v9, 0x5

    new-array v9, v9, [Lcom/dropbox/core/v2/sharing/FileMemberActionError$Tag;
    ...
    sput-object v9, Lcom/dropbox/core/v2/sharing/FileMemberActionError$Tag;->$VALUES:[Lcom/dropbox/core/v2/sharing/FileMemberActionError$Tag;
