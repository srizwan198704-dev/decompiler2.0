...
.method private c()V
    ...
    invoke-direct {v1, v2}, Lel1;-><init>(Ljava/lang/String;)V

    const-string v2, "fps"

    invoke-virtual {v1, v2, v0}, Lɹ;->ͺ(Ljava/lang/String;Ljava/lang/Object;)V

    invoke-static {}, Lcom/umeng/pagesdk/PageManger;->getReporter()Lfl1;

    move-result-object v0

    if-eqz v0, :cond_5

    invoke-virtual {v0, v1}, Lfl1;->ʽ(Lfz2;)V
    :try_end_1
