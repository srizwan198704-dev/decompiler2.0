...
.method public synthetic a(Lcom/umeng/analytics/pro/cp;Lcom/umeng/analytics/pro/bq;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/umeng/commonsdk/statistics/proto/c$a;->b(Lcom/umeng/analytics/pro/cp;Lcom/umeng/commonsdk/statistics/proto/c;)V

    return-void
.end method

.method public a(Lcom/umeng/analytics/pro/cp;Lcom/umeng/commonsdk/statistics/proto/c;)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/umeng/analytics/pro/bw;
    ...
    iget v3, v0, Lcom/umeng/analytics/pro/cl;->b:I
    ...
    :goto_1
    iget v1, v0, Lcom/umeng/analytics/pro/cl;->b:I
    ...
    invoke-virtual {v1, p1}, Lcom/umeng/commonsdk/statistics/proto/a;->read(Lcom/umeng/analytics/pro/cp;)V
    ...
    :cond_4
    invoke-virtual {p1}, Lcom/umeng/analytics/pro/cp;->q()V
    ...
    iget v5, v0, Lcom/umeng/analytics/pro/cm;->c:I
    ...
    :goto_2
    iget v1, v0, Lcom/umeng/analytics/pro/cm;->c:I
    ...
    invoke-virtual {v3, p1}, Lcom/umeng/commonsdk/statistics/proto/b;->read(Lcom/umeng/analytics/pro/cp;)V
    ...
    :cond_7
    invoke-virtual {p1}, Lcom/umeng/analytics/pro/cp;->o()V
...
.method public synthetic b(Lcom/umeng/analytics/pro/cp;Lcom/umeng/analytics/pro/bq;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/umeng/commonsdk/statistics/proto/c$a;->a(Lcom/umeng/analytics/pro/cp;Lcom/umeng/commonsdk/statistics/proto/c;)V

    return-void
.end method

.method public b(Lcom/umeng/analytics/pro/cp;Lcom/umeng/commonsdk/statistics/proto/c;)V
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/umeng/analytics/pro/bw;
    ...
    invoke-static {}, Lcom/umeng/commonsdk/statistics/proto/c;->o()Lcom/umeng/analytics/pro/cu;
    ...
    invoke-static {}, Lcom/umeng/commonsdk/statistics/proto/c;->p()Lcom/umeng/analytics/pro/ck;
    ...
    invoke-direct {v0, v2, v1, v3}, Lcom/umeng/analytics/pro/cm;-><init>(BBI)V

    invoke-virtual {p1, v0}, Lcom/umeng/analytics/pro/cp;->a(Lcom/umeng/analytics/pro/cm;)V
    ...
    invoke-virtual {p1, v3}, Lcom/umeng/analytics/pro/cp;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, p1}, Lcom/umeng/commonsdk/statistics/proto/b;->write(Lcom/umeng/analytics/pro/cp;)V

    goto :goto_0

    :cond_0
    invoke-virtual {p1}, Lcom/umeng/analytics/pro/cp;->e()V
    ...
    invoke-static {}, Lcom/umeng/commonsdk/statistics/proto/c;->q()Lcom/umeng/analytics/pro/ck;
    ...
    invoke-virtual {p1, v0}, Lcom/umeng/analytics/pro/cp;->a(Lcom/umeng/analytics/pro/cl;)V
    ...
    invoke-virtual {v1, p1}, Lcom/umeng/commonsdk/statistics/proto/a;->write(Lcom/umeng/analytics/pro/cp;)V

    goto :goto_1

    :cond_2
    invoke-virtual {p1}, Lcom/umeng/analytics/pro/cp;->f()V
    ...
    invoke-static {}, Lcom/umeng/commonsdk/statistics/proto/c;->r()Lcom/umeng/analytics/pro/ck;
    ...
    invoke-virtual {p1, p2}, Lcom/umeng/analytics/pro/cp;->a(Ljava/lang/String;)V
