...
.field private static crashSdkVersion:Ljava/lang/String; = "1.9.0"
...
.field public static sReporter:Lfl1;
...
.method public static synthetic access$1008()I
    .locals 2
...
.method public static synthetic access$1010()I
    .locals 2
...
.method public static synthetic access$1300(Landroid/content/Context;Ljava/util/Map;)V
    .locals 0
...
.method public static synthetic access$1400(Landroid/content/Context;Ljava/util/Map;)V
    .locals 0
...
.method public static synthetic access$500(Landroid/content/Context;)Ljava/lang/String;
    .locals 0
...
.method public static synthetic access$600()Lcom/umeng/umcrash/UMCrashCallback;
    .locals 1
...
.method public static synthetic access$700(Landroid/content/Context;)Ljava/lang/String;
    .locals 0
...
.method public static enableJavaScriptBridge(Landroid/view/View;)V
    ...
    :try_start_0
    invoke-static {p0}, Lul2;->ˎ(Landroid/view/View;)V
    :try_end_0
...
.method public static enableMemoryMonitor(Z)V
    ...
    invoke-interface {v0, p0}, Lqz7;->ॱ(Z)V
...
.method public static init(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v0}, Ltz6;->ˎ(Landroid/content/Context;Ljava/lang/String;)Landroid/content/SharedPreferences;
    ...
    :cond_c
    :try_start_8
    invoke-static/range {p0 .. p0}, Lgl4;->ˏ(Landroid/content/Context;)I
    ...
    invoke-direct {v3, v2, v10}, Lcom/umeng/umcrash/UMCrash$2;-><init>(Ljava/lang/String;Landroid/content/SharedPreferences;)V
    ...
    invoke-interface {v10, v0, v7}, Landroid/content/SharedPreferences;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, v0}, Lir3;->ˏ(Landroid/content/Context;Lfl1;)V
    :try_end_12
    ...
    sget-object v2, Lcom/umeng/umcrash/UMCrash;->sReporter:Lfl1;

    invoke-interface {v0, v1, v2}, Lqz7;->ˎ(Landroid/content/Context;Lfl1;)V
    ...
    invoke-static {v1, v0}, Lsj4;->ˎ(Landroid/content/Context;Lfl1;)V
    :try_end_16
    ...
    invoke-static {v1, v0}, Lul2;->ˋ(Landroid/content/Context;Lfl1;)V
    ...
    invoke-static {v0, v2}, Lcom/umeng/pagesdk/PageManger;->init(Landroid/content/Context;Lfl1;)V
    :try_end_1a
    ...
    const-string v1, "apm_power_state"
    ...
    const-string v2, "inner config : power rate is "
    ...
    sget-object v1, Lcom/umeng/umcrash/UMCrash;->sReporter:Lfl1;

    invoke-static {v0, v1}, Lcom/umeng/powersdk/PowerManager;->init(Landroid/content/Context;Lfl1;)V
    :try_end_1d
...
.method private static initReporter(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v1, p1, v3}, Lfl1$ﹳ;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V

    sget-boolean p1, Lcom/umeng/umcrash/UMCrash;->isDebug:Z

    invoke-virtual {v0, p1}, Lfl1$ﹳ;->ᐝ(Z)Lfl1$ﹳ;

    move-result-object p1

    const-string v0, "UApm"

    invoke-virtual {p1, v0}, Lfl1$ﹳ;->ʻ(Ljava/lang/String;)Lfl1$ﹳ;

    move-result-object p1

    sget-boolean v0, Lcom/umeng/umcrash/UMCrash;->isDebug:Z

    invoke-virtual {p1, v0}, Lfl1$ﹳ;->ॱˊ(Z)Lfl1$ﹳ;

    move-result-object p1

    sget-boolean v0, Lcom/umeng/umcrash/UMCrash;->isIntl:Z

    invoke-virtual {p1, v0}, Lfl1$ﹳ;->ˋॱ(Z)Lfl1$ﹳ;

    move-result-object p1

    invoke-virtual {p1, p2}, Lfl1$ﹳ;->ʽ(Z)Lfl1$ﹳ;

    move-result-object p1

    invoke-virtual {p1}, Lfl1$ﹳ;->ˊ()Lfl1;

    move-result-object p1

    sput-object p1, Lcom/umeng/umcrash/UMCrash;->sReporter:Lfl1;

    invoke-virtual {p1, v2}, Lfl1;->ˊ(Ljava/util/Map;)V

    :try_start_3
    sget-object p1, Lcom/umeng/umcrash/UMCrash;->sReporter:Lfl1;

    const-string v0, "apm_power_state"

    const-string v1, "apm_page_state"

    const-string v2, "apm_net_state"

    const-string v3, "apm_native_h5_state"

    const-string v4, "apm_crash_java_sampling_rate"

    const-string v5, "apm_crash_native_sampling_rate"

    const-string v6, "apm_crash_anr_sampling_rate"

    const-string v7, "apm_crash_user_sampling_rate"

    const-string v8, "apm_crash_user_max_count"

    const-string v9, "apm_crash_user_upload_type"
    ...
    invoke-virtual {p1, p2, v0}, Lfl1;->ॱॱ([Ljava/lang/String;Lfx2;)V
    :try_end_3
...
.method public static setAppVersion(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, p0}, Lfl1;->ˊ(Ljava/util/Map;)V
...
.method public static setDebug(Z)V
    ...
    sput-boolean p0, Lir3;->ॱ:Z

    sput-boolean p0, Lul2;->ˊ:Z
