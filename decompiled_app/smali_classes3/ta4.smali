...
.field public ˏ:Lta4$ﹳ;

.field public ॱ:Landroid/app/Activity;


# direct methods
.method public constructor <init>(Landroid/app/Activity;Lta4$ﹳ;)V
    .locals 4

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lta4;->ॱ:Landroid/app/Activity;

    iput-object p2, p0, Lta4;->ˏ:Lta4$ﹳ;
    ...
    iget-object v0, p0, Lta4;->ॱ:Landroid/app/Activity;
    ...
    iput-object p2, p0, Lta4;->ˊ:Landroid/app/Dialog;
    ...
    iput-object p2, p0, Lta4;->ˋ:Landroid/widget/EditText;
    ...
    iput-object p2, p0, Lta4;->ˎ:Landroid/widget/TextView;

    iget-object p2, p0, Lta4;->ˋ:Landroid/widget/EditText;
    ...
    new-instance v0, Lta4$ᐨ;

    invoke-direct {v0, p0}, Lta4$ᐨ;-><init>(Lta4;)V
...
.method public static ˊ(Landroid/app/Activity;Lta4$ﹳ;)Lta4;
    .locals 1

    new-instance v0, Lta4;

    invoke-direct {v0, p0, p1}, Lta4;-><init>(Landroid/app/Activity;Lta4$ﹳ;)V

    return-object v0
.end method

.method public static synthetic ॱ(Lta4;)Landroid/widget/TextView;
    .locals 0

    iget-object p0, p0, Lta4;->ˎ:Landroid/widget/TextView;
...
.method public onClick(Landroid/view/View;)V
    ...
    :cond_0
    :try_start_0
    iget-object p1, p0, Lta4;->ˋ:Landroid/widget/EditText;
    ...
    :cond_1
    iget-object v0, p0, Lta4;->ˏ:Lta4$ﹳ;

    invoke-interface {v0, p1}, Lta4$ﹳ;->ॱ(I)V

    iget-object p1, p0, Lta4;->ˊ:Landroid/app/Dialog;
    ...
    :cond_2
    :goto_0
    iget-object p1, p0, Lta4;->ˎ:Landroid/widget/TextView;
...
.method public ˋ()V
    ...
    iget-object v0, p0, Lta4;->ˊ:Landroid/app/Dialog;
