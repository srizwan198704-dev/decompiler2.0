.class public final synthetic Les/bv0;
...
.method public synthetic constructor <init>(Landroid/media/AudioTrack;Landroidx/media3/exoplayer/audio/AudioSink$Listener;Landroid/os/Handler;Landroidx/media3/exoplayer/audio/AudioSink$AudioTrackConfig;Landroidx/media3/common/util/ConditionVariable;)V
    ...
    iput-object p1, p0, Les/bv0;->a:Landroid/media/AudioTrack;

    iput-object p2, p0, Les/bv0;->b:Landroidx/media3/exoplayer/audio/AudioSink$Listener;

    iput-object p3, p0, Les/bv0;->c:Landroid/os/Handler;

    iput-object p4, p0, Les/bv0;->d:Landroidx/media3/exoplayer/audio/AudioSink$AudioTrackConfig;

    iput-object p5, p0, Les/bv0;->e:Landroidx/media3/common/util/ConditionVariable;
...
.method public final run()V
    ...
    iget-object v0, p0, Les/bv0;->a:Landroid/media/AudioTrack;

    iget-object v1, p0, Les/bv0;->b:Landroidx/media3/exoplayer/audio/AudioSink$Listener;

    iget-object v2, p0, Les/bv0;->c:Landroid/os/Handler;

    iget-object v3, p0, Les/bv0;->d:Landroidx/media3/exoplayer/audio/AudioSink$AudioTrackConfig;

    iget-object v4, p0, Les/bv0;->e:Landroidx/media3/common/util/ConditionVariable;
