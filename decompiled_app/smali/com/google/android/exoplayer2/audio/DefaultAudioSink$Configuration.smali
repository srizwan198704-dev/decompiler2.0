...
.method private createAudioTrackV29(ZLcom/google/android/exoplayer2/audio/AudioAttributes;I)Landroid/media/AudioTrack;
    ...
    .line 2179
    invoke-static {p2, p1}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline1;->m(Landroid/media/AudioTrack$Builder;Landroid/media/AudioAttributes;)Landroid/media/AudioTrack$Builder;

    move-result-object p1

    .line 2180
    invoke-static {p1, v0}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline2;->m(Landroid/media/AudioTrack$Builder;Landroid/media/AudioFormat;)Landroid/media/AudioTrack$Builder;
    ...
    .line 2181
    invoke-static {p1, p2}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline3;->m(Landroid/media/AudioTrack$Builder;I)Landroid/media/AudioTrack$Builder;
    ...
    .line 2182
    invoke-static {p1, v0}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline4;->m(Landroid/media/AudioTrack$Builder;I)Landroid/media/AudioTrack$Builder;

    move-result-object p1

    .line 2183
    invoke-static {p1, p3}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline5;->m(Landroid/media/AudioTrack$Builder;I)Landroid/media/AudioTrack$Builder;
    ...
    .line 2184
    :goto_0
    invoke-static {p1, p2}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline6;->m(Landroid/media/AudioTrack$Builder;Z)Landroid/media/AudioTrack$Builder;

    move-result-object p1

    .line 2185
    invoke-static {p1}, Lcom/google/android/exoplayer2/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline7;->m(Landroid/media/AudioTrack$Builder;)Landroid/media/AudioTrack;
