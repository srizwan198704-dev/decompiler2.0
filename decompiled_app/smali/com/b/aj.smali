.class public final Lcom/b/aj;
.super Ljava/lang/Object;
.source "ProGuard"


# static fields
.field private static gb:Ljava/util/List;
...
.field private static hl:Lorg/json/JSONArray;

.field static hm:Lcom/amap/api/location/AMapLocation;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/b/aj;->gb:Ljava/util/List;

    const/4 v0, 0x0

    sput-object v0, Lcom/b/aj;->hl:Lorg/json/JSONArray;

    sput-object v0, Lcom/b/aj;->hm:Lcom/amap/api/location/AMapLocation;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/b/aj;->a:Landroid/util/SparseArray;

    const/4 v0, -0x1

    iput v0, p0, Lcom/b/aj;->b:I

    const-wide/16 v1, 0x0

    iput-wide v1, p0, Lcom/b/aj;->c:J
    ...
    iput-object v1, p0, Lcom/b/aj;->d:[Ljava/lang/String;

    iput v0, p0, Lcom/b/aj;->e:I

    const-wide/16 v0, -0x1

    iput-wide v0, p0, Lcom/b/aj;->f:J
...
.method public static a(Landroid/content/Context;)V
    ...
    :cond_0
    sget-object v0, Lcom/b/aj;->gb:Ljava/util/List;
    ...
    sget-object v1, Lcom/b/aj;->gb:Ljava/util/List;

    invoke-interface {v0, v1}, Ljava/util/List;->addAll(Ljava/util/Collection;)Z

    invoke-static {v0, p0}, Lcom/b/fb;->a(Ljava/util/List;Landroid/content/Context;)V
    ...
    :cond_1
    invoke-static {p0}, Lcom/b/aj;->f(Landroid/content/Context;)V
    :try_end_0
...
.method public static a(Landroid/content/Context;IIJJ)V
    ...
    invoke-static {p0, v0, v1}, Lcom/b/aj;->a(Landroid/content/Context;Ljava/lang/String;Lorg/json/JSONObject;)V
    :try_end_1
...
.method public static a(Landroid/content/Context;JZ)V
    ...
    invoke-static/range {v0 .. v5}, Lcom/b/aj;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;II)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static a(Landroid/content/Context;Lcom/amap/api/location/AMapLocation;)V
    ...
    invoke-static {p1}, Lcom/b/aj;->a(Lcom/amap/api/location/AMapLocation;)Z
...
.method public static a(Landroid/content/Context;Lcom/b/d;)V
    .locals 9
    ...
    .line 1000
    :cond_0
    iget-object v0, p1, Lcom/b/d;->gh:Lcom/autonavi/aps/amapapi/model/AMapLocationServer;
    ...
    .line 2000
    :cond_2
    iget-wide v3, p1, Lcom/b/d;->a:J

    .line 3000
    iget-wide v5, p1, Lcom/b/d;->b:J
    ...
    .line 4000
    iget-wide v3, v0, Lcom/autonavi/aps/amapapi/model/AMapLocationServer;->o:J
    ...
    invoke-static {v0}, Lcom/b/aj;->a(Lcom/amap/api/location/AMapLocation;)Z
    ...
    invoke-static/range {v3 .. v8}, Lcom/b/aj;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;II)V
...
.method public static a(Landroid/content/Context;Ljava/lang/String;I)V
    ...
    invoke-static {p0, v0, p2, p1}, Lcom/b/aj;->a(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method private static a(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;)V
    ...
    :cond_2
    invoke-static {p0, p1, v0}, Lcom/b/aj;->a(Landroid/content/Context;Ljava/lang/String;Lorg/json/JSONObject;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method private static a(Landroid/content/Context;Ljava/lang/String;Lorg/json/JSONObject;)V
    ...
    invoke-direct {v0, p0, v1, v2, p1}, Lcom/b/ep;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p2}, Lorg/json/JSONObject;->toString()Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v0, p1}, Lcom/b/ep;->a(Ljava/lang/String;)V

    sget-object p1, Lcom/b/aj;->gb:Ljava/util/List;
    ...
    sget-object p2, Lcom/b/aj;->gb:Ljava/util/List;

    invoke-interface {p1, p2}, Ljava/util/List;->addAll(Ljava/util/Collection;)Z

    invoke-static {p1, p0}, Lcom/b/fb;->a(Ljava/util/List;Landroid/content/Context;)V

    sget-object p0, Lcom/b/aj;->gb:Ljava/util/List;
...
.method public static a(Lcom/amap/api/location/AMapLocation;Lcom/amap/api/location/AMapLocation;)V
    ...
    :try_start_0
    sget-object v0, Lcom/b/aj;->hm:Lcom/amap/api/location/AMapLocation;

    if-nez v0, :cond_1

    invoke-static {p0}, Lcom/b/es;->a(Lcom/amap/api/location/AMapLocation;)Z

    move-result v0

    if-nez v0, :cond_0

    sput-object p1, Lcom/b/aj;->hm:Lcom/amap/api/location/AMapLocation;
    ...
    sget-object v3, Lcom/b/aj;->hm:Lcom/amap/api/location/AMapLocation;
    ...
    sget-object v2, Lcom/b/aj;->hm:Lcom/amap/api/location/AMapLocation;
    ...
    sget-object v4, Lcom/b/aj;->hm:Lcom/amap/api/location/AMapLocation;

    invoke-static {v4, p1}, Lcom/b/es;->c(Lcom/amap/api/location/AMapLocation;Lcom/amap/api/location/AMapLocation;)F
    ...
    sget-object v1, Lcom/b/aj;->hm:Lcom/amap/api/location/AMapLocation;
    ...
    sget-object p0, Lcom/b/aj;->hm:Lcom/amap/api/location/AMapLocation;
    ...
    invoke-static {v4, v5, p0}, Lcom/b/es;->b(JLjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, v2, p0}, Lcom/b/es;->b(JLjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v1}, Lcom/b/aj;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static a(Ljava/lang/String;I)V
    ...
    :goto_0
    invoke-static {p0, v0, v1}, Lcom/b/aj;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public static a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, p1, p0}, Lcom/b/eg;->b(Lcom/b/al;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v1, p2, p0, p1}, Lcom/b/eg;->a(Lcom/b/al;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static a(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    check-cast p1, Lcom/b/ba;

    invoke-static {v0, p0, p1}, Lcom/b/eg;->a(Lcom/b/al;Ljava/lang/String;Lcom/b/ba;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method private static a(Lcom/amap/api/location/AMapLocation;)Z
    ...
    invoke-static {v3, v4, v5, v6}, Lcom/b/bo;->a(DD)Z
...
.method public static b(Landroid/content/Context;Lcom/amap/api/location/AMapLocation;)V
    ...
    sget-object v0, Lcom/b/aj;->hl:Lorg/json/JSONArray;
    ...
    invoke-static {v3, v4}, Lcom/b/es;->d(D)D
    ...
    invoke-static {v3, v4}, Lcom/b/es;->c(D)D
    ...
    :cond_2
    sget-object p1, Lcom/b/aj;->hl:Lorg/json/JSONArray;

    invoke-virtual {p1, v0}, Lorg/json/JSONArray;->put(Ljava/lang/Object;)Lorg/json/JSONArray;

    move-result-object p1

    sput-object p1, Lcom/b/aj;->hl:Lorg/json/JSONArray;

    invoke-virtual {p1}, Lorg/json/JSONArray;->length()I

    move-result p1

    invoke-static {}, Lcom/b/u;->p()I
...
.method public static b(Landroid/content/Context;Lcom/b/al;)Z
    .locals 0
...
.method private static f(Landroid/content/Context;)V
    ...
    new-instance v1, Lcom/b/co;

    sget-object v2, Lcom/b/aj;->hl:Lorg/json/JSONArray;

    invoke-virtual {v2}, Lorg/json/JSONArray;->toString()Ljava/lang/String;

    move-result-object v2

    invoke-direct {v1, p0, v0, v2}, Lcom/b/co;-><init>(Landroid/content/Context;Lcom/b/al;Ljava/lang/String;)V

    invoke-static {v1, p0}, Lcom/b/el;->a(Lcom/b/co;Landroid/content/Context;)V

    const/4 p0, 0x0

    sput-object p0, Lcom/b/aj;->hl:Lorg/json/JSONArray;
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final S(Landroid/content/Context;)I
    ...
    iget-object v2, p0, Lcom/b/aj;->d:[Ljava/lang/String;
    ...
    invoke-static {p1, v1, v2, v4, v5}, Lcom/b/j;->b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;J)J

    move-result-wide v1

    const-string v6, "pref"

    iget-object v7, p0, Lcom/b/aj;->d:[Ljava/lang/String;

    const/4 v8, 0x0

    aget-object v7, v7, v8

    invoke-static {p1, v6, v7, v4, v5}, Lcom/b/j;->b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;J)J

    move-result-wide v6

    const-string v9, "pref"

    iget-object v10, p0, Lcom/b/aj;->d:[Ljava/lang/String;

    const/4 v11, 0x1

    aget-object v10, v10, v11

    invoke-static {p1, v9, v10, v4, v5}, Lcom/b/j;->b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;J)J
...
.method public final a(Landroid/content/Context;I)V
    ...
    iget-wide v4, p0, Lcom/b/aj;->c:J

    const/4 v6, 0x0

    sub-long/2addr v0, v4

    iget-object v4, p0, Lcom/b/aj;->a:Landroid/util/SparseArray;

    iget v5, p0, Lcom/b/aj;->b:I
    ...
    iget-object v6, p0, Lcom/b/aj;->a:Landroid/util/SparseArray;

    iget v7, p0, Lcom/b/aj;->b:I
    ...
    iget-object v1, p0, Lcom/b/aj;->d:[Ljava/lang/String;
    ...
    iput-wide v2, p0, Lcom/b/aj;->c:J

    iput p2, p0, Lcom/b/aj;->b:I
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
