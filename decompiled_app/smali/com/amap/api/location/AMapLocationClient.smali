...
.method private static a(Landroid/content/Context;Landroid/content/Intent;)Lcom/amap/api/location/LocationManagerBase;
    ...
    invoke-static {p0, v1}, Lcom/b/o;->a(Landroid/content/Context;Lcom/b/al;)V

    invoke-static {p0}, Lcom/b/o;->c(Landroid/content/Context;)Z

    move-result v0

    invoke-static {p0}, Lcom/b/o;->a(Landroid/content/Context;)V
    ...
    invoke-static/range {v0 .. v5}, Lcom/b/cm;->a(Landroid/content/Context;Lcom/b/al;Ljava/lang/String;Ljava/lang/Class;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_0
    new-instance v0, Lcom/b/ge;

    invoke-direct {v0, p0, p1}, Lcom/b/ge;-><init>(Landroid/content/Context;Landroid/content/Intent;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
