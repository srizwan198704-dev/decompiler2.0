...
.field private d:Lwy/c;

.field private e:Lwy/a;

.field private f:Lty/b;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lnet/lucode/hackware/magicindicator/buildins/commonnavigator/CommonNavigator;->f:Lty/b;

    invoke-virtual {p1, p0}, Lty/b;->k(Lty/b$a;)V

    return-void
.end method

.method static synthetic a(Lnet/lucode/hackware/magicindicator/buildins/commonnavigator/CommonNavigator;)Lwy/a;
    .locals 0

    iget-object p0, p0, Lnet/lucode/hackware/magicindicator/buildins/commonnavigator/CommonNavigator;->e:Lwy/a;

    return-object p0
.end method

.method static synthetic b(Lnet/lucode/hackware/magicindicator/buildins/commonnavigator/CommonNavigator;)Lty/b;
    .locals 0

    iget-object p0, p0, Lnet/lucode/hackware/magicindicator/buildins/commonnavigator/CommonNavigator;->f:Lty/b;
...
.method private e()V
    ...
    iget-object v0, p0, Lnet/lucode/hackware/magicindicator/buildins/commonnavigator/CommonNavigator;->f:Lty/b;

    invoke-virtual {v0}, Lty/b;->g()I
    ...
    iget-object v4, p0, Lnet/lucode/hackware/magicindicator/buildins/commonnavigator/CommonNavigator;->e:Lwy/a;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v5

    invoke-virtual {v4, v5, v2}, Lwy/a;->c(Landroid/content/Context;I)Lwy/d;
    ...
    iget-object v3, p0, Lnet/lucode/hackware/magicindicator/buildins/commonnavigator/CommonNavigator;->e:Lwy/a;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v6

    invoke-virtual {v3, v6, v2}, Lwy/a;->d(Landroid/content/Context;I)F
    ...
    :cond_2
    iget-object v0, p0, Lnet/lucode/hackware/magicindicator/buildins/commonnavigator/CommonNavigator;->e:Lwy/a;
    ...
    invoke-virtual {v0, v1}, Lwy/a;->b(Landroid/content/Context;)Lwy/c;

    move-result-object v0

    iput-object v0, p0, Lnet/lucode/hackware/magicindicator/buildins/commonnavigator/CommonNavigator;->d:Lwy/c;
    ...
    iget-object v2, p0, Lnet/lucode/hackware/magicindicator/buildins/commonnavigator/CommonNavigator;->d:Lwy/c;
...
.method private f()V
    ...
    iput v4, v2, Lxy/a;->a:I

    invoke-virtual {v3}, Landroid/view/View;->getTop()I

    move-result v4

    iput v4, v2, Lxy/a;->b:I

    invoke-virtual {v3}, Landroid/view/View;->getRight()I

    move-result v4

    iput v4, v2, Lxy/a;->c:I

    invoke-virtual {v3}, Landroid/view/View;->getBottom()I

    move-result v4

    iput v4, v2, Lxy/a;->d:I

    instance-of v5, v3, Lwy/b;

    if-eqz v5, :cond_0

    check-cast v3, Lwy/b;

    invoke-interface {v3}, Lwy/b;->getContentLeft()I

    move-result v4

    iput v4, v2, Lxy/a;->e:I

    invoke-interface {v3}, Lwy/b;->getContentTop()I

    move-result v4

    iput v4, v2, Lxy/a;->f:I

    invoke-interface {v3}, Lwy/b;->getContentRight()I

    move-result v4

    iput v4, v2, Lxy/a;->g:I

    invoke-interface {v3}, Lwy/b;->getContentBottom()I

    move-result v3

    iput v3, v2, Lxy/a;->h:I

    goto :goto_1

    :cond_0
    iget v3, v2, Lxy/a;->a:I

    iput v3, v2, Lxy/a;->e:I

    iget v3, v2, Lxy/a;->b:I

    iput v3, v2, Lxy/a;->f:I

    iget v3, v2, Lxy/a;->c:I

    iput v3, v2, Lxy/a;->g:I

    iput v4, v2, Lxy/a;->h:I
...
# virtual methods
.method public getAdapter()Lwy/a;
    .locals 1
...
.method public getPagerIndicator()Lwy/c;
    .locals 1

    iget-object v0, p0, Lnet/lucode/hackware/magicindicator/buildins/commonnavigator/CommonNavigator;->d:Lwy/c;

    return-object v0
.end method

.method public getPagerTitleView(I)Lwy/d;
    .locals 1
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p1, p0, Lnet/lucode/hackware/magicindicator/buildins/commonnavigator/CommonNavigator;->e:Lwy/a;

    if-eqz p1, :cond_1

    invoke-direct {p0}, Lnet/lucode/hackware/magicindicator/buildins/commonnavigator/CommonNavigator;->f()V

    iget-object p1, p0, Lnet/lucode/hackware/magicindicator/buildins/commonnavigator/CommonNavigator;->d:Lwy/c;

    if-eqz p1, :cond_0

    iget-object p2, p0, Lnet/lucode/hackware/magicindicator/buildins/commonnavigator/CommonNavigator;->q:Ljava/util/List;

    invoke-interface {p1, p2}, Lwy/c;->onPositionDataProvide(Ljava/util/List;)V
    ...
    iget-object p1, p0, Lnet/lucode/hackware/magicindicator/buildins/commonnavigator/CommonNavigator;->f:Lty/b;

    invoke-virtual {p1}, Lty/b;->f()I
...
.method public onPageScrollStateChanged(I)V
    ...
    invoke-virtual {v0, p1}, Lty/b;->h(I)V

    iget-object v0, p0, Lnet/lucode/hackware/magicindicator/buildins/commonnavigator/CommonNavigator;->d:Lwy/c;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1}, Lwy/c;->onPageScrollStateChanged(I)V
...
.method public onPageScrolled(IFI)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lty/b;->i(IFI)V

    iget-object v0, p0, Lnet/lucode/hackware/magicindicator/buildins/commonnavigator/CommonNavigator;->d:Lwy/c;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1, p2, p3}, Lwy/c;->onPageScrolled(IFI)V
...
.method public onPageSelected(I)V
    ...
    invoke-virtual {v0, p1}, Lty/b;->j(I)V

    iget-object v0, p0, Lnet/lucode/hackware/magicindicator/buildins/commonnavigator/CommonNavigator;->d:Lwy/c;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1}, Lwy/c;->onPageSelected(I)V
...
.method public setAdapter(Lwy/a;)V
    .locals 2
    ...
    invoke-virtual {v0, v1}, Lwy/a;->g(Landroid/database/DataSetObserver;)V

    :cond_1
    iput-object p1, p0, Lnet/lucode/hackware/magicindicator/buildins/commonnavigator/CommonNavigator;->e:Lwy/a;
    ...
    invoke-virtual {p1, v0}, Lwy/a;->f(Landroid/database/DataSetObserver;)V

    iget-object p1, p0, Lnet/lucode/hackware/magicindicator/buildins/commonnavigator/CommonNavigator;->f:Lty/b;

    iget-object v0, p0, Lnet/lucode/hackware/magicindicator/buildins/commonnavigator/CommonNavigator;->e:Lwy/a;

    invoke-virtual {v0}, Lwy/a;->a()I

    move-result v0

    invoke-virtual {p1, v0}, Lty/b;->m(I)V
...
.method public setSkimOver(Z)V
    ...
    invoke-virtual {v0, p1}, Lty/b;->l(Z)V
