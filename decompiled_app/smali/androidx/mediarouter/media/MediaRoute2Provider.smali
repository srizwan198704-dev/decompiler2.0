...
.method public constructor <init>(Landroid/content/Context;Landroidx/mediarouter/media/MediaRoute2Provider$Callback;)V
    ...
    invoke-static {p1}, Les/xy3;->a(Landroid/content/Context;)Landroid/media/MediaRouter2;
    ...
    new-instance p2, Les/sg0;

    invoke-direct {p2, p1}, Les/sg0;-><init>(Landroid/os/Handler;)V
...
.method public static getMessengerFromRoutingController(Landroid/media/MediaRouter2$RoutingController;)Landroid/os/Messenger;
    ...
    :cond_0
    invoke-static {p0}, Les/ry3;->a(Landroid/media/MediaRouter2$RoutingController;)Landroid/os/Bundle;
...
.method public static getSessionIdForRouteController(Landroidx/mediarouter/media/MediaRouteProvider$RouteController;)Ljava/lang/String;
    ...
    :cond_1
    invoke-static {p0}, Les/dy3;->a(Landroid/media/MediaRouter2$RoutingController;)Ljava/lang/String;
...
.method public getRouteById(Ljava/lang/String;)Landroid/media/MediaRoute2Info;
    ...
    invoke-static {v2}, Les/qy3;->a(Ljava/lang/Object;)Landroid/media/MediaRoute2Info;

    move-result-object v2

    invoke-static {v2}, Les/py3;->a(Landroid/media/MediaRoute2Info;)Ljava/lang/String;
...
.method public onDiscoveryRequestChanged(Landroidx/mediarouter/media/MediaRouteDiscoveryRequest;)V
    ...
    invoke-static {v0, v1, v2, p1}, Les/fy3;->a(Landroid/media/MediaRouter2;Ljava/util/concurrent/Executor;Landroid/media/MediaRouter2$RouteCallback;Landroid/media/RouteDiscoveryPreference;)V
    ...
    invoke-static {p1, v0, v1}, Les/gy3;->a(Landroid/media/MediaRouter2;Ljava/util/concurrent/Executor;Landroid/media/MediaRouter2$TransferCallback;)V
    ...
    invoke-static {p1, v0, v1}, Les/hy3;->a(Landroid/media/MediaRouter2;Ljava/util/concurrent/Executor;Landroid/media/MediaRouter2$ControllerCallback;)V
    ...
    invoke-static {p1, v0}, Les/iy3;->a(Landroid/media/MediaRouter2;Landroid/media/MediaRouter2$RouteCallback;)V
    ...
    invoke-static {p1, v0}, Les/jy3;->a(Landroid/media/MediaRouter2;Landroid/media/MediaRouter2$TransferCallback;)V
    ...
    invoke-static {p1, v0}, Les/ky3;->a(Landroid/media/MediaRouter2;Landroid/media/MediaRouter2$ControllerCallback;)V
...
.method public refreshRoutes()V
    ...
    invoke-static {v2}, Les/ly3;->a(Landroid/media/MediaRouter2;)Ljava/util/List;
    ...
    invoke-static {v3}, Les/qy3;->a(Ljava/lang/Object;)Landroid/media/MediaRoute2Info;
    ...
    invoke-static {v3}, Les/my3;->a(Landroid/media/MediaRoute2Info;)Z
    ...
    invoke-static {v1}, Les/ny3;->a(Landroid/media/MediaRoute2Info;)Landroid/os/Bundle;
...
.method public setDynamicRouteDescriptors(Landroid/media/MediaRouter2$RoutingController;)V
    ...
    :cond_0
    invoke-static {p1}, Les/oy3;->a(Landroid/media/MediaRouter2$RoutingController;)Ljava/util/List;
    ...
    invoke-static {p1}, Les/ry3;->a(Landroid/media/MediaRouter2$RoutingController;)Landroid/os/Bundle;
    ...
    invoke-static {p1}, Les/dy3;->a(Landroid/media/MediaRouter2$RoutingController;)Ljava/lang/String;
    ...
    invoke-static {p1}, Les/sy3;->a(Landroid/media/MediaRouter2$RoutingController;)I
    ...
    invoke-static {p1}, Les/ty3;->a(Landroid/media/MediaRouter2$RoutingController;)I
    ...
    invoke-static {p1}, Les/uy3;->a(Landroid/media/MediaRouter2$RoutingController;)I
    ...
    :cond_4
    invoke-static {p1}, Les/vy3;->a(Landroid/media/MediaRouter2$RoutingController;)Ljava/util/List;
    ...
    invoke-static {p1}, Les/wy3;->a(Landroid/media/MediaRouter2$RoutingController;)Ljava/util/List;
...
.method public transferTo(Ljava/lang/String;)V
    ...
    invoke-static {p1, v0}, Les/ey3;->a(Landroid/media/MediaRouter2;Landroid/media/MediaRoute2Info;)V
