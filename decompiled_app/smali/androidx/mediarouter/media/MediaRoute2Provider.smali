...
.method constructor <init>(Landroid/content/Context;Landroidx/mediarouter/media/MediaRoute2Provider$Callback;)V
    ...
    new-instance p2, Landroidx/mediarouter/media/MediaRoute2Provider$$ExternalSyntheticLambda22;

    invoke-direct {p2, p1}, Landroidx/mediarouter/media/MediaRoute2Provider$$ExternalSyntheticLambda22;-><init>(Landroid/os/Handler;)V
...
.method static getMessengerFromRoutingController(Landroid/media/MediaRouter2$RoutingController;)Landroid/os/Messenger;
    ...
    .line 228
    :cond_0
    invoke-static {p0}, Landroidx/mediarouter/media/MediaRoute2Provider$$ExternalSyntheticApiModelOutline16;->m(Landroid/media/MediaRouter2$RoutingController;)Landroid/os/Bundle;
...
.method getRouteById(Ljava/lang/String;)Landroid/media/MediaRoute2Info;
    ...
    invoke-static {v2}, Landroidx/mediarouter/media/MediaRoute2Provider$$ExternalSyntheticApiModelOutline11;->m(Ljava/lang/Object;)Landroid/media/MediaRoute2Info;

    move-result-object v2

    .line 214
    invoke-static {v2}, Landroidx/mediarouter/media/MediaRoute2Provider$$ExternalSyntheticApiModelOutline14;->m(Landroid/media/MediaRoute2Info;)Ljava/lang/String;
...
.method protected refreshRoutes()V
    ...
    .line 165
    invoke-static {}, Landroidx/mediarouter/media/MediaRoute2Provider$$ExternalSyntheticApiModelOutline9;->m()Landroid/util/ArraySet;
    ...
    invoke-static {v2}, Landroidx/mediarouter/media/MediaRoute2Provider$$ExternalSyntheticApiModelOutline10;->m(Landroid/media/MediaRouter2;)Ljava/util/List;
    ...
    invoke-static {v3}, Landroidx/mediarouter/media/MediaRoute2Provider$$ExternalSyntheticApiModelOutline11;->m(Ljava/lang/Object;)Landroid/media/MediaRoute2Info;
    ...
    invoke-static {v3}, Landroidx/mediarouter/media/MediaRoute2Provider$$ExternalSyntheticApiModelOutline12;->m(Landroid/media/MediaRoute2Info;)Z
    ...
    .line 184
    invoke-static {v1}, Landroidx/mediarouter/media/MediaRoute2Provider$$ExternalSyntheticApiModelOutline13;->m(Landroid/media/MediaRoute2Info;)Landroid/os/Bundle;
...
.method setDynamicRouteDescriptors(Landroid/media/MediaRouter2$RoutingController;)V
    ...
    .line 251
    :cond_0
    invoke-static {p1}, Landroidx/mediarouter/media/MediaRoute2Provider$$ExternalSyntheticApiModelOutline15;->m(Landroid/media/MediaRouter2$RoutingController;)Ljava/util/List;
    ...
    .line 264
    invoke-static {p1}, Landroidx/mediarouter/media/MediaRoute2Provider$$ExternalSyntheticApiModelOutline16;->m(Landroid/media/MediaRouter2$RoutingController;)Landroid/os/Bundle;
    ...
    .line 294
    invoke-static {p1}, Landroidx/mediarouter/media/MediaRoute2Provider$$ExternalSyntheticApiModelOutline19;->m(Landroid/media/MediaRouter2$RoutingController;)I
    ...
    .line 305
    invoke-static {p1}, Landroidx/mediarouter/media/MediaRoute2Provider$$ExternalSyntheticApiModelOutline21;->m(Landroid/media/MediaRouter2$RoutingController;)Ljava/util/List;
