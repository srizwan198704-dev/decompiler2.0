...
.field public mSurfaceReleaseFuture:Lnu3;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lnu3<",
...
.method private synthetic lambda$onSurfaceRequested$0(Landroidx/camera/core/SurfaceRequest;)V
    ...
    iput-object p1, p0, Landroidx/camera/view/TextureViewImplementation;->mSurfaceReleaseFuture:Lnu3;
...
.method private synthetic lambda$tryToProvidePreviewSurface$1(Landroid/view/Surface;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    ...
    invoke-direct {v2, p2}, Lgq7;-><init>(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
...
.method private synthetic lambda$tryToProvidePreviewSurface$2(Landroid/view/Surface;Lnu3;Landroidx/camera/core/SurfaceRequest;)V
    .locals 2
    ...
    iget-object p1, p0, Landroidx/camera/view/TextureViewImplementation;->mSurfaceReleaseFuture:Lnu3;

    const/4 v0, 0x0

    if-ne p1, p2, :cond_0

    iput-object v0, p0, Landroidx/camera/view/TextureViewImplementation;->mSurfaceReleaseFuture:Lnu3;
...
.method public static synthetic ˊ(Landroidx/camera/view/TextureViewImplementation;Landroidx/camera/core/SurfaceRequest;)V
    .locals 0
...
.method public static synthetic ˋ(Landroidx/camera/view/TextureViewImplementation;Landroid/view/Surface;Lnu3;Landroidx/camera/core/SurfaceRequest;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Landroidx/camera/view/TextureViewImplementation;->lambda$tryToProvidePreviewSurface$2(Landroid/view/Surface;Lnu3;Landroidx/camera/core/SurfaceRequest;)V

    return-void
.end method

.method public static synthetic ˎ(Landroidx/camera/view/TextureViewImplementation;Landroid/view/Surface;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 0
...
.method public static synthetic ॱ(Landroidx/camera/view/TextureViewImplementation;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 0
...
.method public onSurfaceRequested(Landroidx/camera/core/SurfaceRequest;Landroidx/camera/view/PreviewViewImplementation$OnSurfaceNotInUseListener;)V
    ...
    new-instance v0, Landroidx/camera/view/ʳ;

    invoke-direct {v0, p0, p1}, Landroidx/camera/view/ʳ;-><init>(Landroidx/camera/view/TextureViewImplementation;Landroidx/camera/core/SurfaceRequest;)V
...
.method public tryToProvidePreviewSurface()V
    ...
    new-instance v2, Landroidx/camera/view/ﹺ;

    invoke-direct {v2, p0, v0}, Landroidx/camera/view/ﹺ;-><init>(Landroidx/camera/view/TextureViewImplementation;Landroid/view/Surface;)V
    ...
    iput-object v2, p0, Landroidx/camera/view/TextureViewImplementation;->mSurfaceReleaseFuture:Lnu3;

    new-instance v3, Landroidx/camera/view/ｰ;

    invoke-direct {v3, p0, v0, v2, v1}, Landroidx/camera/view/ｰ;-><init>(Landroidx/camera/view/TextureViewImplementation;Landroid/view/Surface;Lnu3;Landroidx/camera/core/SurfaceRequest;)V
    ...
    invoke-interface {v2, v3, v0}, Lnu3;->addListener(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
...
.method public waitForNextFrame()Lnu3;
    ...
    new-instance v0, Landroidx/camera/view/ﹶ;

    invoke-direct {v0, p0}, Landroidx/camera/view/ﹶ;-><init>(Landroidx/camera/view/TextureViewImplementation;)V
