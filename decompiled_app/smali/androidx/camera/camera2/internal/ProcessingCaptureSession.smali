...
.method private synthetic lambda$open$2(Landroidx/camera/core/impl/SessionConfig;Landroid/hardware/camera2/CameraDevice;Landroidx/camera/camera2/internal/SynchronizedCaptureSessionOpener;Ljava/util/List;)Lnu3;
    .locals 10
    ...
    invoke-virtual {v6}, Landroidx/camera/core/impl/DeferrableSurface;->getSurface()Lnu3;
    ...
    invoke-virtual {p4}, Landroidx/camera/core/impl/DeferrableSurface;->getTerminationFuture()Lnu3;

    move-result-object p4

    new-instance v0, Landroidx/camera/camera2/internal/ᒡ;

    invoke-direct {v0, p0}, Landroidx/camera/camera2/internal/ᒡ;-><init>(Landroidx/camera/camera2/internal/ProcessingCaptureSession;)V

    invoke-static {}, Landroidx/camera/core/impl/utils/executor/CameraXExecutors;->directExecutor()Ljava/util/concurrent/Executor;

    move-result-object v1

    invoke-interface {p4, v0, v1}, Lnu3;->addListener(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
    ...
    new-instance v2, Landroidx/camera/camera2/internal/ᒢ;

    invoke-direct {v2, v0}, Landroidx/camera/camera2/internal/ᒢ;-><init>(Landroidx/camera/core/impl/DeferrableSurface;)V

    iget-object v0, p0, Landroidx/camera/camera2/internal/ProcessingCaptureSession;->mExecutor:Ljava/util/concurrent/Executor;

    invoke-interface {v1, v2, v0}, Lnu3;->addListener(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
    ...
    invoke-virtual {p4, p1, p2, p3}, Landroidx/camera/camera2/internal/CaptureSession;->open(Landroidx/camera/core/impl/SessionConfig;Landroid/hardware/camera2/CameraDevice;Landroidx/camera/camera2/internal/SynchronizedCaptureSessionOpener;)Lnu3;
...
.method public static synthetic ˊ(Landroidx/camera/camera2/internal/ProcessingCaptureSession;)V
    .locals 0
...
.method public static synthetic ˋ(Landroidx/camera/core/impl/DeferrableSurface;)V
    .locals 0
...
.method public static synthetic ˎ(Landroidx/camera/camera2/internal/ProcessingCaptureSession;Ljava/lang/Void;)Ljava/lang/Void;
    .locals 0
...
.method public static synthetic ॱ(Landroidx/camera/camera2/internal/ProcessingCaptureSession;Landroidx/camera/core/impl/SessionConfig;Landroid/hardware/camera2/CameraDevice;Landroidx/camera/camera2/internal/SynchronizedCaptureSessionOpener;Ljava/util/List;)Lnu3;
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/camera/camera2/internal/ProcessingCaptureSession;->lambda$open$2(Landroidx/camera/core/impl/SessionConfig;Landroid/hardware/camera2/CameraDevice;Landroidx/camera/camera2/internal/SynchronizedCaptureSessionOpener;Ljava/util/List;)Lnu3;
...
.method public open(Landroidx/camera/core/impl/SessionConfig;Landroid/hardware/camera2/CameraDevice;Landroidx/camera/camera2/internal/SynchronizedCaptureSessionOpener;)Lnu3;
    ...
    invoke-static/range {v2 .. v7}, Landroidx/camera/core/impl/DeferrableSurfaces;->surfaceListWithTimeout(Ljava/util/Collection;ZJLjava/util/concurrent/Executor;Ljava/util/concurrent/ScheduledExecutorService;)Lnu3;
    ...
    new-instance v1, Landroidx/camera/camera2/internal/ᐤ;

    invoke-direct {v1, p0, p1, p2, p3}, Landroidx/camera/camera2/internal/ᐤ;-><init>(Landroidx/camera/camera2/internal/ProcessingCaptureSession;Landroidx/camera/core/impl/SessionConfig;Landroid/hardware/camera2/CameraDevice;Landroidx/camera/camera2/internal/SynchronizedCaptureSessionOpener;)V
    ...
    new-instance p2, Landroidx/camera/camera2/internal/Ꭵ;

    invoke-direct {p2, p0}, Landroidx/camera/camera2/internal/Ꭵ;-><init>(Landroidx/camera/camera2/internal/ProcessingCaptureSession;)V
...
.method public release(Z)Lnu3;
    ...
    invoke-virtual {v0, p1}, Landroidx/camera/camera2/internal/CaptureSession;->release(Z)Lnu3;
