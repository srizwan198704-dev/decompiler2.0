...
.field private final mStartStreamingFuture:Lnu3;
...
.method public constructor <init>(Landroidx/camera/core/impl/Quirks;)V
    ...
    invoke-direct {p1, p0}, Lyn8;-><init>(Landroidx/camera/camera2/internal/compat/workaround/WaitForRepeatingRequestStart;)V
    ...
    iput-object p1, p0, Landroidx/camera/camera2/internal/compat/workaround/WaitForRepeatingRequestStart;->mStartStreamingFuture:Lnu3;
...
.method private static synthetic lambda$openCaptureSession$1(Landroidx/camera/camera2/internal/compat/workaround/WaitForRepeatingRequestStart$OpenCaptureSession;Landroid/hardware/camera2/CameraDevice;Landroidx/camera/camera2/internal/compat/params/SessionConfigurationCompat;Ljava/util/List;Ljava/util/List;)Lnu3;
    ...
    invoke-interface {p0, p1, p2, p3}, Landroidx/camera/camera2/internal/compat/workaround/WaitForRepeatingRequestStart$OpenCaptureSession;->run(Landroid/hardware/camera2/CameraDevice;Landroidx/camera/camera2/internal/compat/params/SessionConfigurationCompat;Ljava/util/List;)Lnu3;
...
.method public static synthetic ˊ(Landroidx/camera/camera2/internal/compat/workaround/WaitForRepeatingRequestStart$OpenCaptureSession;Landroid/hardware/camera2/CameraDevice;Landroidx/camera/camera2/internal/compat/params/SessionConfigurationCompat;Ljava/util/List;Ljava/util/List;)Lnu3;
    .locals 0
...
.method public static synthetic ॱ(Landroidx/camera/camera2/internal/compat/workaround/WaitForRepeatingRequestStart;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 0
...
# virtual methods
.method public getStartStreamFuture()Lnu3;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
    ...
    iget-object v0, p0, Landroidx/camera/camera2/internal/compat/workaround/WaitForRepeatingRequestStart;->mStartStreamingFuture:Lnu3;
...
.method public onSessionEnd()V
    ...
    iget-object v1, p0, Landroidx/camera/camera2/internal/compat/workaround/WaitForRepeatingRequestStart;->mStartStreamingFuture:Lnu3;
...
.method public openCaptureSession(Landroid/hardware/camera2/CameraDevice;Landroidx/camera/camera2/internal/compat/params/SessionConfigurationCompat;Ljava/util/List;Ljava/util/List;Landroidx/camera/camera2/internal/compat/workaround/WaitForRepeatingRequestStart$OpenCaptureSession;)Lnu3;
    .locals 2
    ...
    invoke-interface {v1}, Landroidx/camera/camera2/internal/SynchronizedCaptureSession;->getOpeningBlocker()Lnu3;
    ...
    :cond_0
    invoke-static {v0}, Landroidx/camera/core/impl/utils/futures/Futures;->successfulAsList(Ljava/util/Collection;)Lnu3;

    move-result-object p4

    invoke-static {p4}, Landroidx/camera/core/impl/utils/futures/FutureChain;->from(Lnu3;)Landroidx/camera/core/impl/utils/futures/FutureChain;

    move-result-object p4

    new-instance v0, Lxn8;

    invoke-direct {v0, p5, p1, p2, p3}, Lxn8;-><init>(Landroidx/camera/camera2/internal/compat/workaround/WaitForRepeatingRequestStart$OpenCaptureSession;Landroid/hardware/camera2/CameraDevice;Landroidx/camera/camera2/internal/compat/params/SessionConfigurationCompat;Ljava/util/List;)V
