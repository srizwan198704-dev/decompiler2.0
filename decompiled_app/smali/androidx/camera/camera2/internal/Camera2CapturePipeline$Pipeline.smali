...
.method private synthetic lambda$executeCapture$0(ILandroid/hardware/camera2/TotalCaptureResult;)Lnu3;
    .locals 2
    ...
    invoke-interface {p1, p2}, Landroidx/camera/camera2/internal/Camera2CapturePipeline$PipelineTask;->preCapture(Landroid/hardware/camera2/TotalCaptureResult;)Lnu3;
...
.method private synthetic lambda$executeCapture$2(Ljava/lang/Boolean;)Lnu3;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    sget-object v2, Landroidx/camera/camera2/internal/ᑊ;->ॱ:Landroidx/camera/camera2/internal/ᑊ;

    invoke-static {v0, v1, p1, v2}, Landroidx/camera/camera2/internal/Camera2CapturePipeline;->waitForResult(JLandroidx/camera/camera2/internal/Camera2CameraControlImpl;Landroidx/camera/camera2/internal/Camera2CapturePipeline$ResultListener$Checker;)Lnu3;
...
.method private synthetic lambda$executeCapture$3(Ljava/util/List;ILandroid/hardware/camera2/TotalCaptureResult;)Lnu3;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;->submitConfigsInternal(Ljava/util/List;I)Lnu3;
...
.method public static synthetic ˊ(Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;Ljava/util/List;ILandroid/hardware/camera2/TotalCaptureResult;)Lnu3;
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;->lambda$executeCapture$3(Ljava/util/List;ILandroid/hardware/camera2/TotalCaptureResult;)Lnu3;
...
.method public static synthetic ˋ(Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;Landroidx/camera/core/impl/CaptureConfig$Builder;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 0
...
.method public static synthetic ˎ(Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;ILandroid/hardware/camera2/TotalCaptureResult;)Lnu3;
    .locals 0

    invoke-direct {p0, p1, p2}, Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;->lambda$executeCapture$0(ILandroid/hardware/camera2/TotalCaptureResult;)Lnu3;
...
.method public static synthetic ˏ(Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;)V
    .locals 0
...
.method public static synthetic ॱ(Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;Ljava/lang/Boolean;)Lnu3;
    .locals 0

    invoke-direct {p0, p1}, Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;->lambda$executeCapture$2(Ljava/lang/Boolean;)Lnu3;
...
.method public static synthetic ॱॱ(Landroid/hardware/camera2/TotalCaptureResult;)Z
    .locals 0
...
.method public executeCapture(Ljava/util/List;I)Lnu3;
    .locals 4
    ...
    invoke-static {v1, v2, v3, v0}, Landroidx/camera/camera2/internal/Camera2CapturePipeline;->waitForResult(JLandroidx/camera/camera2/internal/Camera2CameraControlImpl;Landroidx/camera/camera2/internal/Camera2CapturePipeline$ResultListener$Checker;)Lnu3;
    ...
    new-instance v1, Landroidx/camera/camera2/internal/ᵕ;

    invoke-direct {v1, p0, p2}, Landroidx/camera/camera2/internal/ᵕ;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;I)V
    ...
    new-instance v1, Landroidx/camera/camera2/internal/ᕀ;

    invoke-direct {v1, p0}, Landroidx/camera/camera2/internal/ᕀ;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;)V
    ...
    new-instance v1, Landroidx/camera/camera2/internal/ᵣ;

    invoke-direct {v1, p0, p1, p2}, Landroidx/camera/camera2/internal/ᵣ;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;Ljava/util/List;I)V
    ...
    new-instance p2, Landroidx/camera/camera2/internal/ᐡ;

    invoke-direct {p2, p0}, Landroidx/camera/camera2/internal/ᐡ;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;)V
    ...
    invoke-interface {p1, p2, v0}, Lnu3;->addListener(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V

    return-object p1
.end method

.method public submitConfigsInternal(Ljava/util/List;I)Lnu3;
    .locals 7
    .param p1    # Ljava/util/List;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    :cond_3
    new-instance v2, Landroidx/camera/camera2/internal/ᐟ;

    invoke-direct {v2, p0, v3}, Landroidx/camera/camera2/internal/ᐟ;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;Landroidx/camera/core/impl/CaptureConfig$Builder;)V

    invoke-static {v2}, Landroidx/concurrent/futures/CallbackToFutureAdapter;->getFuture(Landroidx/concurrent/futures/CallbackToFutureAdapter$Resolver;)Lnu3;
