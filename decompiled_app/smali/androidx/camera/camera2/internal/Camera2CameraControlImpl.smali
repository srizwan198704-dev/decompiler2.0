...
.field private volatile mFlashModeChangeSessionUpdateFuture:Lnu3;
...
.method public constructor <init>(Landroidx/camera/camera2/internal/compat/CameraCharacteristicsCompat;Ljava/util/concurrent/ScheduledExecutorService;Ljava/util/concurrent/Executor;Landroidx/camera/core/impl/CameraControlInternal$ControlUpdateCallback;Landroidx/camera/core/impl/Quirks;)V
    ...
    iput-object v1, p0, Landroidx/camera/camera2/internal/Camera2CameraControlImpl;->mFlashModeChangeSessionUpdateFuture:Lnu3;
    ...
    invoke-direct {p1, p0}, Lps;-><init>(Landroidx/camera/camera2/internal/Camera2CameraControlImpl;)V
...
.method private synthetic lambda$submitStillCaptureRequests$5(Ljava/util/List;IIILjava/lang/Void;)Lnu3;
    .locals 0
    ...
    invoke-virtual {p5, p1, p2, p3, p4}, Landroidx/camera/camera2/internal/Camera2CapturePipeline;->submitStillCaptures(Ljava/util/List;III)Lnu3;
...
.method private synthetic lambda$updateSessionConfigAsync$6(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
    ...
    invoke-direct {p0, v0, v1}, Landroidx/camera/camera2/internal/Camera2CameraControlImpl;->waitForSessionUpdateId(J)Lnu3;
...
.method private synthetic lambda$updateSessionConfigAsync$7(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    ...
    invoke-direct {v1, p0, p1}, Lrs;-><init>(Landroidx/camera/camera2/internal/Camera2CameraControlImpl;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
...
.method private synthetic lambda$waitForSessionUpdateId$4(JLandroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p1, p2, p3}, Ljs;-><init>(JLandroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
...
.method private waitForSessionUpdateId(J)Lnu3;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
    ...
    invoke-direct {v0, p0, p1, p2}, Lns;-><init>(Landroidx/camera/camera2/internal/Camera2CameraControlImpl;J)V
...
.method public static synthetic ʻ(Landroidx/camera/camera2/internal/Camera2CameraControlImpl;JLandroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 0
...
.method public static synthetic ˊ(Landroidx/camera/camera2/internal/Camera2CameraControlImpl;Landroidx/camera/core/impl/CameraCaptureCallback;)V
    .locals 0
...
.method public static synthetic ˋ(Landroidx/camera/camera2/internal/Camera2CameraControlImpl;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 0
...
.method public static synthetic ˎ(JLandroidx/concurrent/futures/CallbackToFutureAdapter$Completer;Landroid/hardware/camera2/TotalCaptureResult;)Z
    .locals 0
...
.method public static synthetic ˏ(Landroidx/camera/camera2/internal/Camera2CameraControlImpl;)V
    .locals 0
...
.method public static synthetic ॱ(Landroidx/camera/camera2/internal/Camera2CameraControlImpl;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
    .locals 0
...
.method public static synthetic ॱॱ(Landroidx/camera/camera2/internal/Camera2CameraControlImpl;Ljava/util/concurrent/Executor;Landroidx/camera/core/impl/CameraCaptureCallback;)V
    .locals 0
...
.method public static synthetic ᐝ(Landroidx/camera/camera2/internal/Camera2CameraControlImpl;Ljava/util/List;IIILjava/lang/Void;)Lnu3;
    .locals 0

    invoke-direct/range {p0 .. p5}, Landroidx/camera/camera2/internal/Camera2CameraControlImpl;->lambda$submitStillCaptureRequests$5(Ljava/util/List;IIILjava/lang/Void;)Lnu3;
...
.method public addInteropConfig(Landroidx/camera/core/impl/Config;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/camera/camera2/interop/Camera2CameraControl;->addCaptureRequestOptions(Landroidx/camera/camera2/interop/CaptureRequestOptions;)Lnu3;

    move-result-object p1

    sget-object v0, Lks;->ॱ:Lks;

    invoke-static {}, Landroidx/camera/core/impl/utils/executor/CameraXExecutors;->directExecutor()Ljava/util/concurrent/Executor;

    move-result-object v1

    invoke-interface {p1, v0, v1}, Lnu3;->addListener(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
...
.method public addSessionCameraCaptureCallback(Ljava/util/concurrent/Executor;Landroidx/camera/core/impl/CameraCaptureCallback;)V
    ...
    invoke-direct {v1, p0, p1, p2}, Lss;-><init>(Landroidx/camera/camera2/internal/Camera2CameraControlImpl;Ljava/util/concurrent/Executor;Landroidx/camera/core/impl/CameraCaptureCallback;)V
...
.method public cancelFocusAndMetering()Lnu3;
    .locals 2
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
    ...
    invoke-static {v0}, Landroidx/camera/core/impl/utils/futures/Futures;->immediateFailedFuture(Ljava/lang/Throwable;)Lnu3;
    ...
    invoke-virtual {v0}, Landroidx/camera/camera2/internal/FocusMeteringControl;->cancelFocusAndMetering()Lnu3;
...
.method public clearInteropConfig()V
    ...
    invoke-virtual {v0}, Landroidx/camera/camera2/interop/Camera2CameraControl;->clearCaptureRequestOptions()Lnu3;

    move-result-object v0

    sget-object v1, Lts;->ॱ:Lts;
...
.method public enableTorch(Z)Lnu3;
    ...
    invoke-virtual {v0, p1}, Landroidx/camera/camera2/internal/TorchControl;->enableTorch(Z)Lnu3;
...
.method public removeSessionCameraCaptureCallback(Landroidx/camera/core/impl/CameraCaptureCallback;)V
    ...
    invoke-direct {v1, p0, p1}, Lqs;-><init>(Landroidx/camera/camera2/internal/Camera2CameraControlImpl;Landroidx/camera/core/impl/CameraCaptureCallback;)V
...
.method public setExposureCompensationIndex(I)Lnu3;
    ...
    invoke-virtual {v0, p1}, Landroidx/camera/camera2/internal/ExposureControl;->setExposureCompensationIndex(I)Lnu3;
...
.method public setFlashMode(I)V
    ...
    invoke-virtual {p0}, Landroidx/camera/camera2/internal/Camera2CameraControlImpl;->updateSessionConfigAsync()Lnu3;

    move-result-object p1

    iput-object p1, p0, Landroidx/camera/camera2/internal/Camera2CameraControlImpl;->mFlashModeChangeSessionUpdateFuture:Lnu3;

    return-void
.end method

.method public setLinearZoom(F)Lnu3;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
    ...
    invoke-virtual {v0, p1}, Landroidx/camera/camera2/internal/ZoomControl;->setLinearZoom(F)Lnu3;
...
.method public setZoomRatio(F)Lnu3;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
    ...
    invoke-virtual {v0, p1}, Landroidx/camera/camera2/internal/ZoomControl;->setZoomRatio(F)Lnu3;
...
.method public startFocusAndMetering(Landroidx/camera/core/FocusMeteringAction;)Lnu3;
    .locals 1
    ...
    invoke-virtual {v0, p1}, Landroidx/camera/camera2/internal/FocusMeteringControl;->startFocusAndMetering(Landroidx/camera/core/FocusMeteringAction;)Lnu3;
...
.method public submitStillCaptureRequests(Ljava/util/List;II)Lnu3;
    .locals 8
    ...
    iget-object v0, p0, Landroidx/camera/camera2/internal/Camera2CameraControlImpl;->mFlashModeChangeSessionUpdateFuture:Lnu3;

    invoke-static {v0}, Landroidx/camera/core/impl/utils/futures/FutureChain;->from(Lnu3;)Landroidx/camera/core/impl/utils/futures/FutureChain;
    ...
    invoke-direct/range {v0 .. v5}, Lls;-><init>(Landroidx/camera/camera2/internal/Camera2CameraControlImpl;Ljava/util/List;III)V
...
.method public updateSessionConfig()V
    ...
    invoke-direct {v1, p0}, Los;-><init>(Landroidx/camera/camera2/internal/Camera2CameraControlImpl;)V
...
.method public updateSessionConfigAsync()Lnu3;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
    ...
    invoke-direct {v0, p0}, Lms;-><init>(Landroidx/camera/camera2/internal/Camera2CameraControlImpl;)V
