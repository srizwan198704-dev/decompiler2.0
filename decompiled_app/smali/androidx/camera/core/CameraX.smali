...
.field private final mInitInternalFuture:Lnu3;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lnu3<",
            "Ljava/lang/Void;",
...
.field private mShutdownInternalFuture:Lnu3;
    .annotation build Landroidx/annotation/GuardedBy;
        value = "mInitializeLock"
    .end annotation
...
.method public constructor <init>(Landroid/content/Context;Landroidx/camera/core/CameraXConfig$Provider;)V
    ...
    iput-object v1, p0, Landroidx/camera/core/CameraX;->mShutdownInternalFuture:Lnu3;
    ...
    invoke-direct {p0, p1}, Landroidx/camera/core/CameraX;->initInternal(Landroid/content/Context;)Lnu3;

    move-result-object p1

    iput-object p1, p0, Landroidx/camera/core/CameraX;->mInitInternalFuture:Lnu3;
...
.method private initAndRetryRecursively(Ljava/util/concurrent/Executor;JLandroid/content/Context;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
    ...
    invoke-direct/range {v0 .. v6}, Lmu;-><init>(Landroidx/camera/core/CameraX;Landroid/content/Context;Ljava/util/concurrent/Executor;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;J)V
...
.method private initInternal(Landroid/content/Context;)Lnu3;
    .locals 3
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-direct {v1, p0, p1}, Llu;-><init>(Landroidx/camera/core/CameraX;Landroid/content/Context;)V
...
.method private synthetic lambda$initAndRetryRecursively$2(Landroid/content/Context;Ljava/util/concurrent/Executor;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;J)V
    ...
    invoke-direct/range {v0 .. v5}, Lou;-><init>(Landroidx/camera/core/CameraX;Ljava/util/concurrent/Executor;JLandroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
...
.method private synthetic lambda$shutdownInternal$4(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Landroidx/camera/core/impl/CameraRepository;->deinit()Lnu3;

    move-result-object v0

    new-instance v1, Lnu;

    invoke-direct {v1, p0, p1}, Lnu;-><init>(Landroidx/camera/core/CameraX;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
...
.method private shutdownInternal()Lnu3;
    .locals 3
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
    ...
    invoke-direct {v1, p0}, Lku;-><init>(Landroidx/camera/core/CameraX;)V
    ...
    :goto_0
    iget-object v1, p0, Landroidx/camera/core/CameraX;->mShutdownInternalFuture:Lnu3;
...
.method public static synthetic ˊ(Landroidx/camera/core/CameraX;Landroid/content/Context;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 0
...
.method public static synthetic ˋ(Landroidx/camera/core/CameraX;Landroid/content/Context;Ljava/util/concurrent/Executor;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;J)V
    .locals 0
...
.method public static synthetic ˎ(Landroidx/camera/core/CameraX;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
    .locals 0
...
.method public static synthetic ˏ(Landroidx/camera/core/CameraX;Ljava/util/concurrent/Executor;JLandroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
    .locals 0
...
.method public static synthetic ॱ(Landroidx/camera/core/CameraX;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 0
...
.method public getInitializeFuture()Lnu3;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
    ...
    iget-object v0, p0, Landroidx/camera/core/CameraX;->mInitInternalFuture:Lnu3;
...
.method public shutdown()Lnu3;
    ...
    invoke-direct {p0}, Landroidx/camera/core/CameraX;->shutdownInternal()Lnu3;
