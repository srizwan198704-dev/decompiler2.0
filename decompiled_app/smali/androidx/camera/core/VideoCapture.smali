...
.field private mRecordingFuture:Lnu3;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
...
.method public constructor <init>(Landroidx/camera/core/impl/VideoCaptureConfig;)V
    ...
    iput-object p1, p0, Landroidx/camera/core/VideoCapture;->mRecordingFuture:Lnu3;
...
.method private synthetic lambda$startRecording$2()V
    ...
    iput-object v0, p0, Landroidx/camera/core/VideoCapture;->mRecordingFuture:Lnu3;
...
.method private releaseCameraSurface(Z)V
    ...
    invoke-direct {v2, p1, v1}, Lae8;-><init>(ZLandroid/media/MediaCodec;)V
...
.method public static synthetic ʻ(Landroidx/camera/core/VideoCapture;)V
    .locals 0
...
.method public static synthetic ˊ(Landroidx/camera/core/VideoCapture;Landroidx/camera/core/VideoCapture$OnVideoSavedCallback;)V
    .locals 0
...
.method public static synthetic ˋ(ZLandroid/media/MediaCodec;)V
    .locals 0
...
.method public static synthetic ˎ(Landroidx/camera/core/VideoCapture;)V
    .locals 0
...
.method public static synthetic ˏ(Landroidx/camera/core/VideoCapture;Landroidx/camera/core/VideoCapture$OnVideoSavedCallback;Ljava/lang/String;Landroid/util/Size;Landroidx/camera/core/VideoCapture$OutputFileOptions;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
    .locals 0
...
.method public static synthetic ॱ(Landroidx/camera/core/VideoCapture;Landroidx/camera/core/VideoCapture$OutputFileOptions;Ljava/util/concurrent/Executor;Landroidx/camera/core/VideoCapture$OnVideoSavedCallback;)V
    .locals 0
...
.method public static synthetic ॱॱ(Ljava/util/concurrent/atomic/AtomicReference;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 0
...
.method public static synthetic ᐝ(Landroidx/camera/core/VideoCapture;)V
    .locals 0
...
.method public onDetached()V
    ...
    iget-object v0, p0, Landroidx/camera/core/VideoCapture;->mRecordingFuture:Lnu3;

    if-eqz v0, :cond_0

    new-instance v1, Lwd8;

    invoke-direct {v1, p0}, Lwd8;-><init>(Landroidx/camera/core/VideoCapture;)V
...
.method public setupEncoder(Ljava/lang/String;Landroid/util/Size;)V
    ...
    invoke-virtual {v5}, Landroidx/camera/core/impl/DeferrableSurface;->getTerminationFuture()Lnu3;
    ...
    invoke-direct {v6, v1}, Ltd8;-><init>(Landroid/view/Surface;)V

    invoke-static {}, Landroidx/camera/core/impl/utils/executor/CameraXExecutors;->mainThreadExecutor()Ljava/util/concurrent/ScheduledExecutorService;

    move-result-object v1

    invoke-interface {v5, v6, v1}, Lnu3;->addListener(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
...
.method public startRecording(Landroidx/camera/core/VideoCapture$OutputFileOptions;Ljava/util/concurrent/Executor;Landroidx/camera/core/VideoCapture$OnVideoSavedCallback;)V
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Lzd8;-><init>(Landroidx/camera/core/VideoCapture;Landroidx/camera/core/VideoCapture$OutputFileOptions;Ljava/util/concurrent/Executor;Landroidx/camera/core/VideoCapture$OnVideoSavedCallback;)V
    ...
    invoke-direct {v2, v0}, Lsd8;-><init>(Ljava/util/concurrent/atomic/AtomicReference;)V
    ...
    iput-object v2, p0, Landroidx/camera/core/VideoCapture;->mRecordingFuture:Lnu3;
    ...
    invoke-direct {v2, p0}, Lud8;-><init>(Landroidx/camera/core/VideoCapture;)V

    invoke-static {}, Landroidx/camera/core/impl/utils/executor/CameraXExecutors;->mainThreadExecutor()Ljava/util/concurrent/ScheduledExecutorService;

    move-result-object v5

    invoke-interface {v0, v2, v5}, Lnu3;->addListener(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
    ...
    new-instance p3, Lxd8;

    invoke-direct {p3, p0, v4}, Lxd8;-><init>(Landroidx/camera/core/VideoCapture;Landroidx/camera/core/VideoCapture$OnVideoSavedCallback;)V
    ...
    invoke-direct/range {v2 .. v8}, Lyd8;-><init>(Landroidx/camera/core/VideoCapture;Landroidx/camera/core/VideoCapture$OnVideoSavedCallback;Ljava/lang/String;Landroid/util/Size;Landroidx/camera/core/VideoCapture$OutputFileOptions;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
...
.method public stopRecording()V
    ...
    invoke-direct {v1, p0}, Lvd8;-><init>(Landroidx/camera/core/VideoCapture;)V
