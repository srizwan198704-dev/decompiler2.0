...
.method public static fromTreeUri(Landroid/content/Context;Landroid/net/Uri;)Landroidx/documentfile/provider/DocumentFile;
    ...
    invoke-static {p1}, Landroidx/lifecycle/ReportFragment$$ExternalSyntheticApiModelOutline0;->m(Landroid/net/Uri;)Ljava/lang/String;

    move-result-object v0

    invoke-static {p0, p1}, Landroidx/lifecycle/ReportFragment$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/Context;Landroid/net/Uri;)Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-static {p1}, Landroidx/lifecycle/ReportFragment$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-static {p1, v0}, Landroidx/lifecycle/ReportFragment$$ExternalSyntheticApiModelOutline0;->m(Landroid/net/Uri;Ljava/lang/String;)Landroid/net/Uri;
