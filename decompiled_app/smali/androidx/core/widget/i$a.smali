...
.method private a(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    .line 658
    invoke-direct {p0, v0, p1}, Landroidx/core/widget/i$a;->a(Landroid/content/pm/ResolveInfo;Landroid/content/Context;)Z
...
.method private a(Landroid/view/Menu;)V
    ...
    .line 600
    iget-boolean v0, p0, Landroidx/core/widget/i$a;->f:Z

    if-nez v0, :cond_0

    .line 601
    iput-boolean v8, p0, Landroidx/core/widget/i$a;->f:Z
    ...
    iput-object v0, p0, Landroidx/core/widget/i$a;->c:Ljava/lang/Class;

    .line 605
    iget-object v0, p0, Landroidx/core/widget/i$a;->c:Ljava/lang/Class;
    ...
    iput-object v0, p0, Landroidx/core/widget/i$a;->d:Ljava/lang/reflect/Method;

    .line 607
    const/4 v0, 0x1

    iput-boolean v0, p0, Landroidx/core/widget/i$a;->e:Z
    :try_end_0
    ...
    :goto_0
    :try_start_1
    iget-boolean v0, p0, Landroidx/core/widget/i$a;->e:Z
    ...
    .line 618
    iget-object v0, p0, Landroidx/core/widget/i$a;->d:Ljava/lang/reflect/Method;
    ...
    .line 609
    :goto_3
    iput-object v9, p0, Landroidx/core/widget/i$a;->c:Ljava/lang/Class;

    .line 610
    iput-object v9, p0, Landroidx/core/widget/i$a;->d:Ljava/lang/reflect/Method;

    .line 611
    iput-boolean v2, p0, Landroidx/core/widget/i$a;->e:Z
    ...
    .line 637
    :cond_3
    invoke-direct {p0, v3, v4}, Landroidx/core/widget/i$a;->a(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    iget-object v6, p0, Landroidx/core/widget/i$a;->b:Landroid/widget/TextView;

    .line 643
    invoke-direct {p0, v0, v6}, Landroidx/core/widget/i$a;->a(Landroid/content/pm/ResolveInfo;Landroid/widget/TextView;)Landroid/content/Intent;
