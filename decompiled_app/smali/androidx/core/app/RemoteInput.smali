...
.method public static addDataResultToIntent(Landroidx/core/app/RemoteInput;Landroid/content/Intent;Ljava/util/Map;)V
    ...
    invoke-static {p0, v0}, Landroidx/core/app/Person$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/CharSequence;Landroid/content/Intent;)Landroid/content/ClipData;

    move-result-object p0

    invoke-static {p1, p0}, Landroidx/core/app/Person$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/Intent;Landroid/content/ClipData;)V
...
.method public static addResultsToIntent([Landroidx/core/app/RemoteInput;Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    invoke-static {p0, p1, p2}, Landroidx/core/app/Person$$ExternalSyntheticApiModelOutline0;->m([Landroid/app/RemoteInput;Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    invoke-static {v6, p1, p2}, Landroidx/core/app/Person$$ExternalSyntheticApiModelOutline0;->m([Landroid/app/RemoteInput;Landroid/content/Intent;Landroid/os/Bundle;)V
...
.method static fromCompat(Landroidx/core/app/RemoteInput;)Landroid/app/RemoteInput;
    ...
    invoke-static {v0, v1}, Landroidx/core/app/NotificationCompat$Style$$ExternalSyntheticApiModelOutline0;->m(Landroid/app/RemoteInput$Builder;Ljava/lang/CharSequence;)Landroid/app/RemoteInput$Builder;
    ...
    invoke-static {v0, v1}, Landroidx/core/app/NotificationCompat$Style$$ExternalSyntheticApiModelOutline0;->m(Landroid/app/RemoteInput$Builder;Z)Landroid/app/RemoteInput$Builder;
    ...
    invoke-static {v0, v1}, Landroidx/core/app/NotificationCompat$Style$$ExternalSyntheticApiModelOutline0;->m(Landroid/app/RemoteInput$Builder;Landroid/os/Bundle;)Landroid/app/RemoteInput$Builder;
    ...
    invoke-static {v0, p0}, Landroidx/core/app/Person$$ExternalSyntheticApiModelOutline0;->m(Landroid/app/RemoteInput$Builder;I)Landroid/app/RemoteInput$Builder;

    :cond_0
    invoke-static {v0}, Landroidx/core/app/NotificationCompat$Style$$ExternalSyntheticApiModelOutline0;->m(Landroid/app/RemoteInput$Builder;)Landroid/app/RemoteInput;
...
.method private static getClipDataIntentFromIntent(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    invoke-static {p0}, Landroidx/core/app/Person$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/Intent;)Landroid/content/ClipData;
    ...
    :cond_0
    invoke-static {p0}, Landroidx/core/app/Person$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/ClipData;)Landroid/content/ClipDescription;

    move-result-object v1

    const-string v2, "text/vnd.android.intent"

    invoke-static {v1, v2}, Landroidx/core/app/Person$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/ClipDescription;Ljava/lang/String;)Z
    ...
    :cond_1
    invoke-static {v1}, Landroidx/core/app/Person$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/ClipDescription;)Ljava/lang/CharSequence;
    ...
    invoke-static {p0, v0}, Landroidx/core/app/Person$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/ClipData;I)Landroid/content/ClipData$Item;

    move-result-object p0

    invoke-static {p0}, Landroidx/core/app/Person$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/ClipData$Item;)Landroid/content/Intent;
...
.method public static getResultsFromIntent(Landroid/content/Intent;)Landroid/os/Bundle;
    ...
    invoke-static {p0}, Landroidx/core/app/Person$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/Intent;)Landroid/os/Bundle;
...
.method public static setResultsSource(Landroid/content/Intent;I)V
    ...
    invoke-static {p1, v0}, Landroidx/core/app/Person$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/CharSequence;Landroid/content/Intent;)Landroid/content/ClipData;

    move-result-object p1

    invoke-static {p0, p1}, Landroidx/core/app/Person$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/Intent;Landroid/content/ClipData;)V
