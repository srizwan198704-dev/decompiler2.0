...
.method public setSound(Landroid/net/Uri;)Landroidx/core/app/NotificationCompat$Builder;
    ...
    invoke-static {v0, v1}, Landroidx/core/app/NotificationCompat$Style$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/AudioAttributes$Builder;I)Landroid/media/AudioAttributes$Builder;

    move-result-object v0

    const/4 v1, 0x5

    invoke-static {v0, v1}, Landroidx/core/app/NotificationCompat$Style$$ExternalSyntheticApiModelOutline0;->m$2(Landroid/media/AudioAttributes$Builder;I)Landroid/media/AudioAttributes$Builder;

    move-result-object v0

    invoke-static {v0}, Landroidx/core/app/NotificationCompat$Style$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/AudioAttributes$Builder;)Landroid/media/AudioAttributes;

    move-result-object v0

    invoke-static {p1, v0}, Landroidx/core/app/NotificationCompat$Style$$ExternalSyntheticApiModelOutline0;->m(Landroid/app/Notification;Landroid/media/AudioAttributes;)V
...
.method public setSound(Landroid/net/Uri;I)Landroidx/core/app/NotificationCompat$Builder;
    ...
    invoke-static {v0, p2}, Landroidx/core/app/NotificationCompat$Style$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/media/AudioAttributes$Builder;I)Landroid/media/AudioAttributes$Builder;

    move-result-object p2

    invoke-static {p2}, Landroidx/core/app/NotificationCompat$Style$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/AudioAttributes$Builder;)Landroid/media/AudioAttributes;

    move-result-object p2

    invoke-static {p1, p2}, Landroidx/core/app/NotificationCompat$Style$$ExternalSyntheticApiModelOutline0;->m(Landroid/app/Notification;Landroid/media/AudioAttributes;)V
