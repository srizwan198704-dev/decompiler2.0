...
.method public static synthetic ˊ(Landroidx/core/location/LocationManagerCompat$PreRGnssStatusTransport;Ljava/util/concurrent/Executor;Landroid/location/GnssStatus;)V
    .locals 0
...
.method public static synthetic ˋ(Landroidx/core/location/LocationManagerCompat$PreRGnssStatusTransport;Ljava/util/concurrent/Executor;I)V
    .locals 0
...
.method public static synthetic ˎ(Landroidx/core/location/LocationManagerCompat$PreRGnssStatusTransport;Ljava/util/concurrent/Executor;)V
    .locals 0
...
.method public static synthetic ॱ(Landroidx/core/location/LocationManagerCompat$PreRGnssStatusTransport;Ljava/util/concurrent/Executor;)V
    .locals 0
...
.method public onFirstFix(I)V
    ...
    :cond_0
    new-instance v1, Landroidx/core/location/ʴ;

    invoke-direct {v1, p0, v0, p1}, Landroidx/core/location/ʴ;-><init>(Landroidx/core/location/LocationManagerCompat$PreRGnssStatusTransport;Ljava/util/concurrent/Executor;I)V
...
.method public onSatelliteStatusChanged(Landroid/location/GnssStatus;)V
    ...
    :cond_0
    new-instance v1, Landroidx/core/location/ˆ;

    invoke-direct {v1, p0, v0, p1}, Landroidx/core/location/ˆ;-><init>(Landroidx/core/location/LocationManagerCompat$PreRGnssStatusTransport;Ljava/util/concurrent/Executor;Landroid/location/GnssStatus;)V
...
.method public onStarted()V
    ...
    :cond_0
    new-instance v1, Landroidx/core/location/ʳ;

    invoke-direct {v1, p0, v0}, Landroidx/core/location/ʳ;-><init>(Landroidx/core/location/LocationManagerCompat$PreRGnssStatusTransport;Ljava/util/concurrent/Executor;)V
...
.method public onStopped()V
    ...
    :cond_0
    new-instance v1, Landroidx/core/location/ｰ;

    invoke-direct {v1, p0, v0}, Landroidx/core/location/ｰ;-><init>(Landroidx/core/location/LocationManagerCompat$PreRGnssStatusTransport;Ljava/util/concurrent/Executor;)V
