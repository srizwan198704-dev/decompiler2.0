...
.method public constructor <init>()V
    ...
    .line 2
    invoke-static {}, Landroid/support/v4/media/session/v;->f()Landroid/view/WindowInsets$Builder;
...
.method public constructor <init>(Landroidx/core/view/WindowInsetsCompat;)V
    ...
    .line 5
    invoke-static {p1}, Landroid/support/v4/media/session/v;->g(Landroid/view/WindowInsets;)Landroid/view/WindowInsets$Builder;
...
.method public build()Landroidx/core/view/WindowInsetsCompat;
    ...
    .line 5
    .line 6
    invoke-static {v0}, Landroid/support/v4/media/session/v;->h(Landroid/view/WindowInsets$Builder;)Landroid/view/WindowInsets;
...
.method public setDisplayCutout(Landroidx/core/view/DisplayCutoutCompat;)V
    ...
    .line 11
    :goto_0
    invoke-static {v0, p1}, Landroid/support/v4/media/session/v;->p(Landroid/view/WindowInsets$Builder;Landroid/view/DisplayCutout;)V
...
.method public setMandatorySystemGestureInsets(Landroidx/core/graphics/Insets;)V
    ...
    .line 7
    invoke-static {v0, p1}, Landroid/support/v4/media/session/v;->C(Landroid/view/WindowInsets$Builder;Landroid/graphics/Insets;)V
...
.method public setStableInsets(Landroidx/core/graphics/Insets;)V
    ...
    .line 7
    invoke-static {v0, p1}, Landroid/support/v4/media/session/v;->w(Landroid/view/WindowInsets$Builder;Landroid/graphics/Insets;)V
...
.method public setSystemGestureInsets(Landroidx/core/graphics/Insets;)V
    ...
    .line 7
    invoke-static {v0, p1}, Landroid/support/v4/media/session/v;->A(Landroid/view/WindowInsets$Builder;Landroid/graphics/Insets;)V
...
.method public setSystemWindowInsets(Landroidx/core/graphics/Insets;)V
    ...
    .line 7
    invoke-static {v0, p1}, Landroid/support/v4/media/session/v;->o(Landroid/view/WindowInsets$Builder;Landroid/graphics/Insets;)V
...
.method public setTappableElementInsets(Landroidx/core/graphics/Insets;)V
    ...
    .line 7
    invoke-static {v0, p1}, Landroid/support/v4/media/session/v;->D(Landroid/view/WindowInsets$Builder;Landroid/graphics/Insets;)V
