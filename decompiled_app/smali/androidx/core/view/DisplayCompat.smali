...
.method private static getPhysicalDisplaySize(Landroid/content/Context;Landroid/view/Display;)Landroid/graphics/Point;
    ...
    invoke-static {p1}, Landroidx/core/text/ICUCompat$$ExternalSyntheticApiModelOutline1;->m(Landroid/view/Display;)Landroid/view/Display$Mode;

    move-result-object p1

    invoke-static {p1}, Landroidx/core/text/ICUCompat$$ExternalSyntheticApiModelOutline1;->m(Landroid/view/Display$Mode;)I

    move-result v0

    iput v0, p0, Landroid/graphics/Point;->x:I

    invoke-static {p1}, Landroidx/core/text/ICUCompat$$ExternalSyntheticApiModelOutline1;->m$1(Landroid/view/Display$Mode;)I
    ...
    invoke-static {p1, p0}, Landroidx/appcompat/widget/SearchView$$ExternalSyntheticApiModelOutline0;->m(Landroid/view/Display;Landroid/graphics/Point;)V

    return-object p0

    :cond_4
    invoke-static {p1, p0}, Landroidx/appcompat/widget/SearchView$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/view/Display;Landroid/graphics/Point;)V
...
.method private static physicalSizeEquals(Landroid/view/Display$Mode;Landroid/graphics/Point;)Z
    ...
    invoke-static {p0}, Landroidx/core/text/ICUCompat$$ExternalSyntheticApiModelOutline1;->m(Landroid/view/Display$Mode;)I
    ...
    invoke-static {p0}, Landroidx/core/text/ICUCompat$$ExternalSyntheticApiModelOutline1;->m$1(Landroid/view/Display$Mode;)I
