...
.method public static compositeColors(Landroid/graphics/Color;Landroid/graphics/Color;)Landroid/graphics/Color;
    ...
    invoke-static {p0}, Landroidx/core/graphics/ColorUtils$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Color;)Landroid/graphics/ColorSpace$Model;

    move-result-object v0

    invoke-static {p1}, Landroidx/core/graphics/ColorUtils$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Color;)Landroid/graphics/ColorSpace$Model;

    move-result-object v1

    invoke-static {v0, v1}, Landroidx/core/graphics/ColorUtils$$ExternalSyntheticBackport7;->m(Ljava/lang/Object;Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_3

    invoke-static {p1}, Landroidx/core/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Color;)Landroid/graphics/ColorSpace;

    move-result-object v0

    invoke-static {p0}, Landroidx/core/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Color;)Landroid/graphics/ColorSpace;
    ...
    invoke-static {p0, v0}, Landroidx/core/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Color;Landroid/graphics/ColorSpace;)Landroid/graphics/Color;

    move-result-object p0

    :goto_0
    invoke-static {p0}, Landroidx/core/graphics/ColorUtils$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Color;)[F

    move-result-object v0

    invoke-static {p1}, Landroidx/core/graphics/ColorUtils$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Color;)[F
    ...
    invoke-static {p1}, Landroidx/core/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Color;)I
    ...
    invoke-static {v1, p0}, Landroidx/core/os/TraceCompat$$ExternalSyntheticApiModelOutline0;->m([FLandroid/graphics/ColorSpace;)Landroid/graphics/Color;
