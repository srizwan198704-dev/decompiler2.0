...
.method private buildLegacyExtrasBundle()Landroid/os/PersistableBundle;
    ...
    invoke-static {v1, v2, v0}, Les/ps5;->a(Landroid/os/PersistableBundle;Ljava/lang/String;I)V
    ...
    invoke-static {v1, v2, v0}, Les/qs5;->a(Landroid/os/PersistableBundle;Ljava/lang/String;Landroid/os/PersistableBundle;)V
    ...
    invoke-static {v1, v2, v0}, Les/rs5;->a(Landroid/os/PersistableBundle;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v1, v2}, Les/ss5;->a(Landroid/os/PersistableBundle;Ljava/lang/String;Z)V
...
.method public static fromShortcuts(Landroid/content/Context;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {v1}, Les/vs5;->a(Ljava/lang/Object;)Landroid/content/pm/ShortcutInfo;
...
.method public static getLocusId(Landroid/content/pm/ShortcutInfo;)Landroidx/core/content/LocusIdCompat;
    ...
    invoke-static {p0}, Les/cs5;->a(Landroid/content/pm/ShortcutInfo;)Landroid/content/LocusId;
    ...
    :cond_1
    invoke-static {p0}, Les/ns5;->a(Landroid/content/pm/ShortcutInfo;)Landroid/os/PersistableBundle;
...
.method private static getLocusIdFromExtra(Landroid/os/PersistableBundle;)Landroidx/core/content/LocusIdCompat;
    ...
    invoke-static {p0, v1}, Les/ws5;->a(Landroid/os/PersistableBundle;Ljava/lang/String;)Ljava/lang/String;
...
.method public static getLongLivedFromExtra(Landroid/os/PersistableBundle;)Z
    ...
    invoke-static {p0, v0}, Les/ts5;->a(Landroid/os/PersistableBundle;Ljava/lang/String;)Z
    ...
    :cond_0
    invoke-static {p0, v0}, Les/us5;->a(Landroid/os/PersistableBundle;Ljava/lang/String;)Z
...
.method public static getPersonsFromExtra(Landroid/os/PersistableBundle;)[Landroidx/core/app/Person;
    ...
    :cond_0
    invoke-static {p0, v0}, Les/ms5;->a(Landroid/os/PersistableBundle;Ljava/lang/String;)I
    ...
    invoke-static {p0, v3}, Les/os5;->a(Landroid/os/PersistableBundle;Ljava/lang/String;)Landroid/os/PersistableBundle;
...
.method public toShortcutInfo()Landroid/content/pm/ShortcutInfo;
    ...
    invoke-static {v0, v1}, Les/xs5;->a(Landroid/content/pm/ShortcutInfo$Builder;Ljava/lang/CharSequence;)Landroid/content/pm/ShortcutInfo$Builder;

    move-result-object v0

    iget-object v1, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mIntents:[Landroid/content/Intent;

    invoke-static {v0, v1}, Les/es5;->a(Landroid/content/pm/ShortcutInfo$Builder;[Landroid/content/Intent;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    invoke-static {v0, v1}, Les/fs5;->a(Landroid/content/pm/ShortcutInfo$Builder;Landroid/graphics/drawable/Icon;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    invoke-static {v0, v1}, Les/gs5;->a(Landroid/content/pm/ShortcutInfo$Builder;Ljava/lang/CharSequence;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    invoke-static {v0, v1}, Les/hs5;->a(Landroid/content/pm/ShortcutInfo$Builder;Ljava/lang/CharSequence;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    invoke-static {v0, v1}, Les/is5;->a(Landroid/content/pm/ShortcutInfo$Builder;Landroid/content/ComponentName;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    invoke-static {v0, v1}, Les/js5;->a(Landroid/content/pm/ShortcutInfo$Builder;Ljava/util/Set;)Landroid/content/pm/ShortcutInfo$Builder;

    :cond_4
    iget v1, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mRank:I

    invoke-static {v0, v1}, Les/ks5;->a(Landroid/content/pm/ShortcutInfo$Builder;I)Landroid/content/pm/ShortcutInfo$Builder;

    iget-object v1, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mExtras:Landroid/os/PersistableBundle;

    if-eqz v1, :cond_5

    invoke-static {v0, v1}, Les/at5;->a(Landroid/content/pm/ShortcutInfo$Builder;Landroid/os/PersistableBundle;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    :cond_6
    invoke-static {v0, v2}, Les/ls5;->a(Landroid/content/pm/ShortcutInfo$Builder;[Landroid/app/Person;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    invoke-static {v0, v1}, Les/ys5;->a(Landroid/content/pm/ShortcutInfo$Builder;Landroid/content/LocusId;)Landroid/content/pm/ShortcutInfo$Builder;

    :cond_8
    iget-boolean v1, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mIsLongLived:Z

    invoke-static {v0, v1}, Les/zs5;->a(Landroid/content/pm/ShortcutInfo$Builder;Z)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    :cond_a
    invoke-static {v0}, Les/ds5;->a(Landroid/content/pm/ShortcutInfo$Builder;)Landroid/content/pm/ShortcutInfo;
