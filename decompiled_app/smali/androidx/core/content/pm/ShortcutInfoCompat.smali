...
.method private buildLegacyExtrasBundle()Landroid/os/PersistableBundle;
    ...
    invoke-static {v0, v2, v1}, Landroidx/core/graphics/ColorUtils$$ExternalSyntheticApiModelOutline0;->m(Landroid/os/PersistableBundle;Ljava/lang/String;I)V
    ...
    invoke-static {v0, v2, v1}, Landroidx/core/graphics/ColorUtils$$ExternalSyntheticApiModelOutline0;->m(Landroid/os/PersistableBundle;Ljava/lang/String;Landroid/os/PersistableBundle;)V
...
.method static getLongLivedFromExtra(Landroid/os/PersistableBundle;)Z
    ...
    invoke-static {p0, v0}, Landroidx/core/graphics/ColorUtils$$ExternalSyntheticApiModelOutline0;->m(Landroid/os/PersistableBundle;Ljava/lang/String;)Z
...
.method static getPersonsFromExtra(Landroid/os/PersistableBundle;)[Landroidx/core/app/Person;
    ...
    :cond_0
    invoke-static {p0, v0}, Landroidx/core/graphics/ColorUtils$$ExternalSyntheticApiModelOutline0;->m(Landroid/os/PersistableBundle;Ljava/lang/String;)I
    ...
    invoke-static {p0, v3}, Landroidx/core/graphics/ColorUtils$$ExternalSyntheticApiModelOutline0;->m(Landroid/os/PersistableBundle;Ljava/lang/String;)Landroid/os/PersistableBundle;
...
.method public toShortcutInfo()Landroid/content/pm/ShortcutInfo;
    ...
    invoke-static {v0, v1}, Landroidx/core/graphics/ColorUtils$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutInfo$Builder;Ljava/lang/CharSequence;)Landroid/content/pm/ShortcutInfo$Builder;

    move-result-object v0

    iget-object v1, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mIntents:[Landroid/content/Intent;

    invoke-static {v0, v1}, Landroidx/core/graphics/ColorUtils$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutInfo$Builder;[Landroid/content/Intent;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    invoke-static {v0, v1}, Landroidx/core/graphics/ColorUtils$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutInfo$Builder;Landroid/graphics/drawable/Icon;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    invoke-static {v0, v1}, Landroidx/core/graphics/ColorUtils$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/content/pm/ShortcutInfo$Builder;Ljava/lang/CharSequence;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    invoke-static {v0, v1}, Landroidx/core/graphics/ColorUtils$$ExternalSyntheticApiModelOutline0;->m$2(Landroid/content/pm/ShortcutInfo$Builder;Ljava/lang/CharSequence;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    invoke-static {v0, v1}, Landroidx/core/graphics/ColorUtils$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutInfo$Builder;Landroid/content/ComponentName;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    invoke-static {v0, v1}, Landroidx/core/graphics/ColorUtils$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutInfo$Builder;Ljava/util/Set;)Landroid/content/pm/ShortcutInfo$Builder;

    :cond_4
    iget v1, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mRank:I

    invoke-static {v0, v1}, Landroidx/core/graphics/ColorUtils$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutInfo$Builder;I)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    :cond_5
    invoke-static {v0, v2}, Landroidx/core/graphics/ColorUtils$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutInfo$Builder;[Landroid/app/Person;)Landroid/content/pm/ShortcutInfo$Builder;

    :cond_6
    iget-boolean v1, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mIsLongLived:Z

    invoke-static {v0, v1}, Landroidx/core/graphics/ColorUtils$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutInfo$Builder;Z)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    invoke-static {v0, v1}, Landroidx/core/graphics/ColorUtils$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutInfo$Builder;Landroid/os/PersistableBundle;)Landroid/content/pm/ShortcutInfo$Builder;

    :goto_1
    invoke-static {v0}, Landroidx/core/graphics/ColorUtils$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutInfo$Builder;)Landroid/content/pm/ShortcutInfo;
