...
.method public static fromMediaDescription(Ljava/lang/Object;)Landroidx/media3/session/legacy/MediaDescriptionCompat;
    ...
    new-instance v2, Landroidx/media3/session/legacy/MediaDescriptionCompat$Builder;

    invoke-direct {v2}, Landroidx/media3/session/legacy/MediaDescriptionCompat$Builder;-><init>()V

    invoke-static {p0}, Les/kt3;->a(Ljava/lang/Object;)Landroid/media/MediaDescription;
    ...
    invoke-virtual {v2, v3}, Landroidx/media3/session/legacy/MediaDescriptionCompat$Builder;->setMediaId(Ljava/lang/String;)Landroidx/media3/session/legacy/MediaDescriptionCompat$Builder;
    ...
    invoke-virtual {v2, v3}, Landroidx/media3/session/legacy/MediaDescriptionCompat$Builder;->setTitle(Ljava/lang/CharSequence;)Landroidx/media3/session/legacy/MediaDescriptionCompat$Builder;
    ...
    invoke-virtual {v2, v3}, Landroidx/media3/session/legacy/MediaDescriptionCompat$Builder;->setSubtitle(Ljava/lang/CharSequence;)Landroidx/media3/session/legacy/MediaDescriptionCompat$Builder;
    ...
    invoke-virtual {v2, v3}, Landroidx/media3/session/legacy/MediaDescriptionCompat$Builder;->setDescription(Ljava/lang/CharSequence;)Landroidx/media3/session/legacy/MediaDescriptionCompat$Builder;
    ...
    invoke-virtual {v2, v3}, Landroidx/media3/session/legacy/MediaDescriptionCompat$Builder;->setIconBitmap(Landroid/graphics/Bitmap;)Landroidx/media3/session/legacy/MediaDescriptionCompat$Builder;
    ...
    invoke-virtual {v2, v3}, Landroidx/media3/session/legacy/MediaDescriptionCompat$Builder;->setIconUri(Landroid/net/Uri;)Landroidx/media3/session/legacy/MediaDescriptionCompat$Builder;
    ...
    invoke-static {v3}, Landroidx/media3/session/legacy/MediaSessionCompat;->unparcelWithClassLoader(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    :goto_1
    invoke-virtual {v2, v0}, Landroidx/media3/session/legacy/MediaDescriptionCompat$Builder;->setExtras(Landroid/os/Bundle;)Landroidx/media3/session/legacy/MediaDescriptionCompat$Builder;

    if-eqz v5, :cond_4

    invoke-virtual {v2, v5}, Landroidx/media3/session/legacy/MediaDescriptionCompat$Builder;->setMediaUri(Landroid/net/Uri;)Landroidx/media3/session/legacy/MediaDescriptionCompat$Builder;
    ...
    invoke-virtual {v2, v0}, Landroidx/media3/session/legacy/MediaDescriptionCompat$Builder;->setMediaUri(Landroid/net/Uri;)Landroidx/media3/session/legacy/MediaDescriptionCompat$Builder;

    :cond_5
    :goto_2
    invoke-virtual {v2}, Landroidx/media3/session/legacy/MediaDescriptionCompat$Builder;->build()Landroidx/media3/session/legacy/MediaDescriptionCompat;
...
.method public getMediaDescription()Ljava/lang/Object;
    ...
    iget-object v3, p0, Landroidx/media3/session/legacy/MediaDescriptionCompat;->mMediaUri:Landroid/net/Uri;
    ...
    iget-object v4, p0, Landroidx/media3/session/legacy/MediaDescriptionCompat;->mExtras:Landroid/os/Bundle;
    ...
    iget-object v5, p0, Landroidx/media3/session/legacy/MediaDescriptionCompat;->mMediaUri:Landroid/net/Uri;

    invoke-virtual {v3, v4, v5}, Landroid/os/Bundle;->putParcelable(Ljava/lang/String;Landroid/os/Parcelable;)V

    invoke-static {v0, v3}, Landroidx/media3/session/legacy/MediaDescriptionCompat$Api21Impl;->setExtras(Landroid/media/MediaDescription$Builder;Landroid/os/Bundle;)V
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-static {v0, p1, p2}, Les/lt3;->a(Landroid/media/MediaDescription;Landroid/os/Parcel;I)V
