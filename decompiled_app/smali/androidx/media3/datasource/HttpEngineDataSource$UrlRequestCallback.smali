...
.method public declared-synchronized onFailed(Landroid/net/http/UrlRequest;Landroid/net/http/UrlResponseInfo;Landroid/net/http/HttpException;)V
    ...
    :cond_0
    :try_start_1
    invoke-static {p3}, Les/ji2;->a(Ljava/lang/Object;)Z

    move-result p1

    if-eqz p1, :cond_1

    invoke-static {p3}, Les/ki2;->a(Ljava/lang/Object;)Landroid/net/http/NetworkException;

    move-result-object p1

    invoke-static {p1}, Les/li2;->a(Landroid/net/http/NetworkException;)I
...
.method public declared-synchronized onRedirectReceived(Landroid/net/http/UrlRequest;Landroid/net/http/UrlResponseInfo;Ljava/lang/String;)V
    ...
    invoke-static {p2}, Les/gi2;->a(Landroid/net/http/UrlResponseInfo;)I
    ...
    invoke-static {p2}, Les/vh2;->a(Landroid/net/http/UrlResponseInfo;)Ljava/lang/String;

    move-result-object v3

    const/4 v4, 0x0

    invoke-static {p2}, Les/hi2;->a(Landroid/net/http/UrlResponseInfo;)Landroid/net/http/HeaderBlock;

    move-result-object p2

    invoke-static {p2}, Les/ii2;->a(Landroid/net/http/HeaderBlock;)Ljava/util/Map;
    ...
    invoke-static {p1}, Les/mi2;->a(Landroid/net/http/UrlRequest;)V
    :try_end_2
    ...
    :cond_6
    :try_start_4
    invoke-static {p1}, Les/ni2;->a(Landroid/net/http/UrlRequest;)V
