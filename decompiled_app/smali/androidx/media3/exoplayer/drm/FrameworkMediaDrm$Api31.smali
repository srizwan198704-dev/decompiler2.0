...
.method public static requiresSecureDecoder(Landroid/media/MediaDrm;Ljava/lang/String;)Z
    ...
    invoke-static {p0, p1}, Les/k32;->a(Landroid/media/MediaDrm;Ljava/lang/String;)Z
...
.method public static setLogSessionIdOnMediaDrmSession(Landroid/media/MediaDrm;[BLandroidx/media3/exoplayer/analytics/PlayerId;)V
    ...
    invoke-static {p2, v0}, Les/ev0;->a(Landroid/media/metrics/LogSessionId;Ljava/lang/Object;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {p0, p1}, Les/h32;->a(Landroid/media/MediaDrm;[B)Landroid/media/MediaDrm$PlaybackComponent;
    ...
    invoke-static {p0}, Les/i32;->a(Ljava/lang/Object;)Landroid/media/MediaDrm$PlaybackComponent;

    move-result-object p0

    invoke-static {p0, p2}, Les/j32;->a(Landroid/media/MediaDrm$PlaybackComponent;Landroid/media/metrics/LogSessionId;)V
