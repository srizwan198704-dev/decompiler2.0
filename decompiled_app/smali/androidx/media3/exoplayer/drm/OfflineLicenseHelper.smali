...
.method public static synthetic a(Landroidx/media3/exoplayer/drm/DrmSession;Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/google/common/util/concurrent/f0;)V
    .locals 0

    .line 1
    invoke-direct {p1, p0, p2}, Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;->lambda$acquireFirstSessionOnHandlerThread$3(Landroidx/media3/exoplayer/drm/DrmSession;Lcom/google/common/util/concurrent/f0;)V
...
.method private acquireFirstSessionOnHandlerThread(I[BLandroidx/media3/common/Format;)Landroidx/media3/exoplayer/drm/DrmSession;
    ...
    .line 24
    invoke-direct/range {v1 .. v7}, Landroidx/media3/exoplayer/drm/k;-><init>(IILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    .line 30
    :try_start_0
    invoke-virtual {v6}, Lcom/google/common/util/concurrent/a;->get()Ljava/lang/Object;
    ...
    .line 35
    .line 36
    iget-object p2, v4, Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;->drmListenerConditionVariable:Landroid/os/ConditionVariable;
    ...
    .line 45
    iget-object p3, v4, Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;->handler:Landroid/os/Handler;
    ...
    .line 48
    .line 49
    invoke-direct {v0, p1, p0, p2}, Landroidx/media3/exoplayer/drm/j;-><init>(Landroidx/media3/exoplayer/drm/DrmSession;Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/google/common/util/concurrent/f0;)V
    ...
    .line 55
    :try_start_1
    invoke-virtual {p2}, Lcom/google/common/util/concurrent/a;->get()Ljava/lang/Object;
...
.method private acquireSessionAndGetOfflineLicenseKeySetIdOnHandlerThread(I[BLandroidx/media3/common/Format;)[B
    ...
    .line 14
    invoke-direct {v0, p0, p2, p1, v1}, Landroidx/media3/exoplayer/drm/j;-><init>(Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/google/common/util/concurrent/f0;Landroidx/media3/exoplayer/drm/DrmSession;I)V
...
.method public static synthetic b(Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/google/common/util/concurrent/f0;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;->lambda$releaseManagerOnHandlerThread$4(Lcom/google/common/util/concurrent/f0;)V
...
.method public static synthetic c(Landroidx/media3/exoplayer/drm/DrmSession;Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/google/common/util/concurrent/f0;)V
    .locals 0

    .line 1
    invoke-direct {p1, p2, p0}, Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;->lambda$acquireSessionAndGetOfflineLicenseKeySetIdOnHandlerThread$1(Lcom/google/common/util/concurrent/f0;Landroidx/media3/exoplayer/drm/DrmSession;)V
...
.method public static synthetic d(Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;I[BLcom/google/common/util/concurrent/f0;Landroidx/media3/common/Format;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;->lambda$acquireFirstSessionOnHandlerThread$2(I[BLcom/google/common/util/concurrent/f0;Landroidx/media3/common/Format;)V
...
.method public static synthetic e(Landroidx/media3/exoplayer/drm/DrmSession;Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/google/common/util/concurrent/f0;)V
    .locals 0

    .line 1
    invoke-direct {p1, p2, p0}, Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;->lambda$getLicenseDurationRemainingSec$0(Lcom/google/common/util/concurrent/f0;Landroidx/media3/exoplayer/drm/DrmSession;)V
...
.method private synthetic lambda$acquireFirstSessionOnHandlerThread$2(I[BLcom/google/common/util/concurrent/f0;Landroidx/media3/common/Format;)V
    .locals 3
    ...
    .line 41
    .line 42
    invoke-virtual {p3, p1}, Lcom/google/common/util/concurrent/f0;->m(Ljava/lang/Object;)Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .line 54
    invoke-virtual {p3, p1}, Lcom/google/common/util/concurrent/a;->k(Ljava/lang/Throwable;)Z
...
.method private synthetic lambda$acquireFirstSessionOnHandlerThread$3(Landroidx/media3/exoplayer/drm/DrmSession;Lcom/google/common/util/concurrent/f0;)V
    .locals 3
    ...
    :cond_0
    :goto_0
    invoke-virtual {p2, v0}, Lcom/google/common/util/concurrent/f0;->m(Ljava/lang/Object;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 29
    :goto_1
    invoke-virtual {p2, v0}, Lcom/google/common/util/concurrent/a;->k(Ljava/lang/Throwable;)Z
...
.method private synthetic lambda$acquireSessionAndGetOfflineLicenseKeySetIdOnHandlerThread$1(Lcom/google/common/util/concurrent/f0;Landroidx/media3/exoplayer/drm/DrmSession;)V
    .locals 1
    ...
    .line 5
    invoke-virtual {p1, v0}, Lcom/google/common/util/concurrent/f0;->m(Ljava/lang/Object;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 15
    :try_start_1
    invoke-virtual {p1, v0}, Lcom/google/common/util/concurrent/a;->k(Ljava/lang/Throwable;)Z
    :try_end_1
...
.method private synthetic lambda$getLicenseDurationRemainingSec$0(Lcom/google/common/util/concurrent/f0;Landroidx/media3/exoplayer/drm/DrmSession;)V
    .locals 1
...
.method private synthetic lambda$releaseManagerOnHandlerThread$4(Lcom/google/common/util/concurrent/f0;)V
    .locals 1
...
.method private releaseManagerOnHandlerThread()V
    ...
    .line 16
    :try_start_0
    invoke-virtual {v0}, Lcom/google/common/util/concurrent/a;->get()Ljava/lang/Object;
    :try_end_0
...
.method public declared-synchronized getLicenseDurationRemainingSec([B)Landroid/util/Pair;
    ...
    .line 27
    invoke-direct {v2, p0, v0, p1, v3}, Landroidx/media3/exoplayer/drm/j;-><init>(Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/google/common/util/concurrent/f0;Landroidx/media3/exoplayer/drm/DrmSession;I)V
