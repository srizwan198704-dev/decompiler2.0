...
.method private static getFlag(Landroid/media/MediaFormat;Ljava/lang/String;I)I
    ...
    invoke-static {p0, p1, v0}, Les/lm4;->a(Landroid/media/MediaFormat;Ljava/lang/String;I)I
...
.method private static toExoPlayerDrmInitData(Ljava/lang/String;Landroid/media/DrmInitData;)Landroidx/media3/common/DrmInitData;
    ...
    :cond_0
    invoke-static {p1}, Les/gm4;->a(Landroid/media/DrmInitData;)I
    ...
    invoke-static {p1, v2}, Les/hm4;->a(Landroid/media/DrmInitData;I)Landroid/media/DrmInitData$SchemeInitData;

    move-result-object v3

    new-instance v4, Landroidx/media3/common/DrmInitData$SchemeData;

    invoke-static {v3}, Les/im4;->a(Landroid/media/DrmInitData$SchemeInitData;)Ljava/util/UUID;

    move-result-object v5

    invoke-static {v3}, Les/jm4;->a(Landroid/media/DrmInitData$SchemeInitData;)Ljava/lang/String;

    move-result-object v6

    invoke-static {v3}, Les/km4;->a(Landroid/media/DrmInitData$SchemeInitData;)[B
...
.method private toExoPlayerFormat(Landroid/media/MediaParser$TrackData;)Landroidx/media3/common/Format;
    ...
    invoke-static {p1}, Les/mm4;->a(Landroid/media/MediaParser$TrackData;)Landroid/media/MediaFormat;
    ...
    invoke-static {v0, v2, v3}, Les/lm4;->a(Landroid/media/MediaFormat;Ljava/lang/String;I)I
    ...
    invoke-static {p1}, Les/em4;->a(Landroid/media/MediaParser$TrackData;)Landroid/media/DrmInitData;
    ...
    invoke-static {v0, v4, v3}, Les/lm4;->a(Landroid/media/MediaFormat;Ljava/lang/String;I)I
    ...
    invoke-static {v0, v4, v5}, Les/nm4;->a(Landroid/media/MediaFormat;Ljava/lang/String;F)F
    ...
    invoke-static {v0, v4, v5}, Les/lm4;->a(Landroid/media/MediaFormat;Ljava/lang/String;I)I
    ...
    invoke-static {v0, v3, v5}, Les/lm4;->a(Landroid/media/MediaFormat;Ljava/lang/String;I)I
    ...
    invoke-static {v0, v3, v4}, Les/nm4;->a(Landroid/media/MediaFormat;Ljava/lang/String;F)F
    ...
    invoke-static {v0, v3, v6, v7}, Les/om4;->a(Landroid/media/MediaFormat;Ljava/lang/String;J)J
...
.method public getSeekPoints(J)Landroid/util/Pair;
    ...
    invoke-static {v0, p1, p2}, Les/bx3;->a(Landroid/media/MediaParser$SeekMap;J)Landroid/util/Pair;
...
.method public onSampleDataFound(ILandroid/media/MediaParser$InputReader;)V
    ...
    invoke-static {p2}, Les/dm4;->a(Landroid/media/MediaParser$InputReader;)J
...
.method public onSeekMapFound(Landroid/media/MediaParser$SeekMap;)V
    ...
    invoke-static {p1}, Les/fm4;->a(Landroid/media/MediaParser$SeekMap;)J
...
.method public onTrackDataFound(ILandroid/media/MediaParser$TrackData;)V
    ...
    invoke-static {p2}, Les/mm4;->a(Landroid/media/MediaParser$TrackData;)Landroid/media/MediaFormat;
