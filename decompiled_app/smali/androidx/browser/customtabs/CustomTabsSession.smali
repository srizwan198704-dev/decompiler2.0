...
# instance fields
.field private final mCallback:Landroid/support/customtabs/d;
...
.field private final mService:Landroid/support/customtabs/h;


# direct methods
.method public constructor <init>(Landroid/support/customtabs/h;Landroid/support/customtabs/d;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
    .locals 1
    ...
    .line 10
    .line 11
    iput-object p1, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:Landroid/support/customtabs/h;

    .line 12
    .line 13
    iput-object p2, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Landroid/support/customtabs/d;
...
.method private createEngagementSignalsCallbackWrapper(Landroidx/browser/customtabs/EngagementSignalsCallback;)Landroid/support/customtabs/j;
    .locals 1
...
.method private createEngagementSignalsCallbackWrapper(Landroidx/browser/customtabs/EngagementSignalsCallback;Ljava/util/concurrent/Executor;)Landroid/support/customtabs/j;
    .locals 1
    .param p1    # Landroidx/browser/customtabs/EngagementSignalsCallback;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public static createMockSessionForTesting(Landroid/content/ComponentName;)Landroidx/browser/customtabs/CustomTabsSession;
    ...
    .line 14
    invoke-direct {v0, v1, v2, p0, v3}, Landroidx/browser/customtabs/CustomTabsSession;-><init>(Landroid/support/customtabs/h;Landroid/support/customtabs/d;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
...
.method public getBinder()Landroid/os/IBinder;
    ...
    .line 1
    iget-object v0, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Landroid/support/customtabs/d;
...
.method public isEngagementSignalsApiAvailable(Landroid/os/Bundle;)Z
    ...
    .line 5
    :try_start_0
    iget-object v0, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:Landroid/support/customtabs/h;

    .line 6
    .line 7
    iget-object v1, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Landroid/support/customtabs/d;

    .line 8
    .line 9
    invoke-interface {v0, v1, p1}, Landroid/support/customtabs/h;->isEngagementSignalsApiAvailable(Landroid/support/customtabs/d;Landroid/os/Bundle;)Z
...
.method public mayLaunchUrl(Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
    ...
    .line 8
    .line 9
    invoke-interface {v0, v1, p1, p2, p3}, Landroid/support/customtabs/h;->mayLaunchUrl(Landroid/support/customtabs/d;Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
...
.method public postMessage(Ljava/lang/String;Landroid/os/Bundle;)I
    ...
    .line 8
    :try_start_0
    iget-object v1, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:Landroid/support/customtabs/h;

    .line 9
    .line 10
    iget-object v2, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Landroid/support/customtabs/d;

    .line 11
    .line 12
    invoke-interface {v1, v2, p1, p2}, Landroid/support/customtabs/h;->postMessage(Landroid/support/customtabs/d;Ljava/lang/String;Landroid/os/Bundle;)I
...
.method public receiveFile(Landroid/net/Uri;ILandroid/os/Bundle;)Z
    ...
    .line 8
    .line 9
    invoke-interface {v0, v1, p1, p2, p3}, Landroid/support/customtabs/h;->receiveFile(Landroid/support/customtabs/d;Landroid/net/Uri;ILandroid/os/Bundle;)Z
...
.method public requestPostMessageChannel(Landroid/net/Uri;Landroid/net/Uri;Landroid/os/Bundle;)Z
    ...
    .line 4
    iget-object p2, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:Landroid/support/customtabs/h;

    iget-object v0, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Landroid/support/customtabs/d;

    invoke-interface {p2, v0, p1, p3}, Landroid/support/customtabs/h;->requestPostMessageChannelWithExtras(Landroid/support/customtabs/d;Landroid/net/Uri;Landroid/os/Bundle;)Z
    ...
    iget-object p3, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Landroid/support/customtabs/d;

    invoke-interface {p2, p3, p1}, Landroid/support/customtabs/h;->requestPostMessageChannel(Landroid/support/customtabs/d;Landroid/net/Uri;)Z
...
.method public setActionButton(Landroid/graphics/Bitmap;Ljava/lang/String;)Z
    ...
    .line 32
    .line 33
    invoke-interface {p2, v0, p1}, Landroid/support/customtabs/h;->updateVisuals(Landroid/support/customtabs/d;Landroid/os/Bundle;)Z
...
.method public setEngagementSignalsCallback(Landroidx/browser/customtabs/EngagementSignalsCallback;Landroid/os/Bundle;)Z
    ...
    .line 2
    invoke-direct {p0, p1}, Landroidx/browser/customtabs/CustomTabsSession;->createEngagementSignalsCallbackWrapper(Landroidx/browser/customtabs/EngagementSignalsCallback;)Landroid/support/customtabs/j;
    ...
    invoke-interface {v0, v1, p1, p2}, Landroid/support/customtabs/h;->setEngagementSignalsCallback(Landroid/support/customtabs/d;Landroid/os/IBinder;Landroid/os/Bundle;)Z
...
.method public setEngagementSignalsCallback(Ljava/util/concurrent/Executor;Landroidx/browser/customtabs/EngagementSignalsCallback;Landroid/os/Bundle;)Z
    ...
    .line 6
    invoke-direct {p0, p2, p1}, Landroidx/browser/customtabs/CustomTabsSession;->createEngagementSignalsCallbackWrapper(Landroidx/browser/customtabs/EngagementSignalsCallback;Ljava/util/concurrent/Executor;)Landroid/support/customtabs/j;
    ...
    invoke-interface {p2, v0, p1, p3}, Landroid/support/customtabs/h;->setEngagementSignalsCallback(Landroid/support/customtabs/d;Landroid/os/IBinder;Landroid/os/Bundle;)Z
...
.method public setSecondaryToolbarSwipeUpGesture(Landroid/app/PendingIntent;)Z
    ...
    .line 14
    :try_start_0
    iget-object p1, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:Landroid/support/customtabs/h;
    ...
    .line 17
    .line 18
    invoke-interface {p1, v1, v0}, Landroid/support/customtabs/h;->updateVisuals(Landroid/support/customtabs/d;Landroid/os/Bundle;)Z
...
.method public setSecondaryToolbarViews(Landroid/widget/RemoteViews;[ILandroid/app/PendingIntent;)Z
    ...
    .line 25
    .line 26
    iget-object p2, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Landroid/support/customtabs/d;

    .line 27
    .line 28
    invoke-interface {p1, p2, v0}, Landroid/support/customtabs/h;->updateVisuals(Landroid/support/customtabs/d;Landroid/os/Bundle;)Z
...
.method public setToolbarItem(ILandroid/graphics/Bitmap;Ljava/lang/String;)Z
    ...
    .line 37
    .line 38
    invoke-interface {p2, p3, p1}, Landroid/support/customtabs/h;->updateVisuals(Landroid/support/customtabs/d;Landroid/os/Bundle;)Z
...
.method public validateRelationship(ILandroid/net/Uri;Landroid/os/Bundle;)Z
    ...
    .line 16
    .line 17
    invoke-interface {v0, v2, p1, p2, p3}, Landroid/support/customtabs/h;->validateRelationship(Landroid/support/customtabs/d;ILandroid/net/Uri;Landroid/os/Bundle;)Z
