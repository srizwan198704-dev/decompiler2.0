...
.super Landroid/support/customtabs/f;
.source "ProGuard"
...
.method public constructor <init>(Landroidx/browser/customtabs/CustomTabsService;)V
    ...
    .line 2
    .line 3
    invoke-direct {p0}, Landroid/support/customtabs/f;-><init>()V
...
.method public static synthetic f0(Landroidx/browser/customtabs/CustomTabsService$1;Landroidx/browser/customtabs/CustomTabsSessionToken;)V
    .locals 0
...
.method private newSessionInternal(Landroid/support/customtabs/d;Landroid/app/PendingIntent;)Z
    .locals 4
    .param p1    # Landroid/support/customtabs/d;
    ...
    .line 2
    .line 3
    invoke-direct {v0, p1, p2}, Landroidx/browser/customtabs/CustomTabsSessionToken;-><init>(Landroid/support/customtabs/d;Landroid/app/PendingIntent;)V
...
.method public isEngagementSignalsApiAvailable(Landroid/support/customtabs/d;Landroid/os/Bundle;)Z
    .locals 3
    .param p2    # Landroid/os/Bundle;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 9
    invoke-direct {v1, p1, v2}, Landroidx/browser/customtabs/CustomTabsSessionToken;-><init>(Landroid/support/customtabs/d;Landroid/app/PendingIntent;)V
...
.method public mayLaunchUrl(Landroid/support/customtabs/d;Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
    .locals 3
    .param p1    # Landroid/support/customtabs/d;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
...
.method public newSession(Landroid/support/customtabs/d;)Z
    .locals 1
    .param p1    # Landroid/support/customtabs/d;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 2
    invoke-direct {p0, p1, v0}, Landroidx/browser/customtabs/CustomTabsService$1;->newSessionInternal(Landroid/support/customtabs/d;Landroid/app/PendingIntent;)Z
...
.method public newSessionWithExtras(Landroid/support/customtabs/d;Landroid/os/Bundle;)Z
    .locals 0
    .param p1    # Landroid/support/customtabs/d;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 5
    invoke-direct {p0, p1, p2}, Landroidx/browser/customtabs/CustomTabsService$1;->newSessionInternal(Landroid/support/customtabs/d;Landroid/app/PendingIntent;)Z
...
.method public postMessage(Landroid/support/customtabs/d;Ljava/lang/String;Landroid/os/Bundle;)I
    .locals 3
    .param p1    # Landroid/support/customtabs/d;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public receiveFile(Landroid/support/customtabs/d;Landroid/net/Uri;ILandroid/os/Bundle;)Z
    .locals 3
    .param p1    # Landroid/support/customtabs/d;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public requestPostMessageChannel(Landroid/support/customtabs/d;Landroid/net/Uri;)Z
    .locals 3
    .param p1    # Landroid/support/customtabs/d;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public requestPostMessageChannelWithExtras(Landroid/support/customtabs/d;Landroid/net/Uri;Landroid/os/Bundle;)Z
    .locals 3
    .param p1    # Landroid/support/customtabs/d;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public setEngagementSignalsCallback(Landroid/support/customtabs/d;Landroid/os/IBinder;Landroid/os/Bundle;)Z
    .locals 3
    .param p1    # Landroid/support/customtabs/d;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public updateVisuals(Landroid/support/customtabs/d;Landroid/os/Bundle;)Z
    .locals 3
    .param p1    # Landroid/support/customtabs/d;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public validateRelationship(Landroid/support/customtabs/d;ILandroid/net/Uri;Landroid/os/Bundle;)Z
    .locals 3
    .param p1    # Landroid/support/customtabs/d;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
