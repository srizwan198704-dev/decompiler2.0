...
.field public f:Les/ie;


# direct methods
.method public constructor <init>(IILes/k52;Les/rx4;Les/bs4;Les/ie;)V
    .locals 0

    invoke-direct {p0}, Les/q0;-><init>()V

    iput p1, p0, Les/nn3;->a:I

    iput p2, p0, Les/nn3;->b:I

    invoke-virtual {p3}, Les/k52;->e()[B

    move-result-object p1

    iput-object p1, p0, Les/nn3;->c:[B

    invoke-virtual {p4}, Les/rx4;->h()[B

    move-result-object p1

    iput-object p1, p0, Les/nn3;->d:[B

    invoke-virtual {p5}, Les/bs4;->a()[B

    move-result-object p1

    iput-object p1, p0, Les/nn3;->e:[B

    iput-object p6, p0, Les/nn3;->f:Les/ie;
...
.method public constructor <init>(Les/d1;)V
    ...
    iput-object p1, p0, Les/nn3;->f:Les/ie;

    return-void
.end method

.method public static j(Ljava/lang/Object;)Les/nn3;
    .locals 1

    instance-of v0, p0, Les/nn3;

    if-eqz v0, :cond_0

    check-cast p0, Les/nn3;
    ...
    new-instance v0, Les/nn3;

    invoke-static {p0}, Les/d1;->o(Ljava/lang/Object;)Les/d1;

    move-result-object p0

    invoke-direct {v0, p0}, Les/nn3;-><init>(Les/d1;)V
...
.method public c()Les/a1;
    ...
    iget-object v2, p0, Les/nn3;->e:[B

    invoke-direct {v1, v2}, Les/kn0;-><init>([B)V

    invoke-virtual {v0, v1}, Les/e0;->a(Les/d0;)V

    iget-object v1, p0, Les/nn3;->f:Les/ie;
...
.method public g()Les/ie;
    ...
    iget-object v0, p0, Les/nn3;->f:Les/ie;

    return-object v0
.end method

.method public h()Les/k52;
    .locals 2

    new-instance v0, Les/k52;

    iget-object v1, p0, Les/nn3;->c:[B
...
.method public i()Les/rx4;
    ...
    invoke-virtual {p0}, Les/nn3;->h()Les/k52;
