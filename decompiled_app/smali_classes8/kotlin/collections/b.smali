...
.method public static h(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1}, Les/nf3;->a(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static final i(Ljava/util/Map;)Ljava/util/Map;
    ...
    :cond_0
    invoke-static {p0}, Les/of3;->f(Ljava/util/Map;)Ljava/util/Map;
...
.method public static j(Ljava/util/Map;Lkotlin/Pair;)Ljava/util/Map;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    invoke-static {p1}, Les/of3;->e(Lkotlin/Pair;)Ljava/util/Map;
...
.method public static l(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lkotlin/collections/b;->m(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    :goto_1
    invoke-static {p0}, Les/of3;->e(Lkotlin/Pair;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lkotlin/collections/b;->m(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    move-result-object p0

    invoke-static {p0}, Lkotlin/collections/b;->i(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final m(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p1, p0}, Lkotlin/collections/b;->k(Ljava/util/Map;Ljava/lang/Iterable;)V
