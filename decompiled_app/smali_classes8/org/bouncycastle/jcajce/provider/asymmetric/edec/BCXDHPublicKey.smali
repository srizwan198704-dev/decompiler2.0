...
# instance fields
.field private transient xdhPublicKey:Les/km;
...
.method public constructor <init>(Les/km;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCXDHPublicKey;->xdhPublicKey:Les/km;
...
.method public constructor <init>(Les/r56;)V
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCXDHPublicKey;->populateFromPubKeyInfo(Les/r56;)V
...
.method public constructor <init>([B[B)V
    ...
    new-instance p1, Les/xv6;

    invoke-direct {p1, p2, v0}, Les/xv6;-><init>([BI)V
    ...
    new-instance p1, Les/tv6;

    invoke-direct {p1, p2, v0}, Les/tv6;-><init>([BI)V
...
.method private populateFromPubKeyInfo(Les/r56;)V
    ...
    sget-object v0, Les/dg1;->c:Les/t0;
    ...
    invoke-direct {v0, p1, v1}, Les/xv6;-><init>([BI)V

    :goto_0
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCXDHPublicKey;->xdhPublicKey:Les/km;

    goto :goto_1

    :cond_0
    new-instance v0, Les/tv6;
    ...
    invoke-direct {v0, p1, v1}, Les/tv6;-><init>([BI)V
...
.method public engineGetKeyParameters()Les/km;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCXDHPublicKey;->xdhPublicKey:Les/km;
...
.method public getEncoded()[B
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCXDHPublicKey;->xdhPublicKey:Les/km;

    check-cast v1, Les/xv6;

    array-length v0, v0

    invoke-virtual {v1, v2, v0}, Les/xv6;->b([BI)V

    return-object v2

    :cond_0
    sget-object v0, Les/k13;->b:[B
    ...
    check-cast v1, Les/tv6;

    array-length v0, v0

    invoke-virtual {v1, v2, v0}, Les/tv6;->b([BI)V
