...
.field private final helper:Les/dy2;
...
.method public constructor <init>(Ljava/io/InputStream;Ljava/lang/String;)V
    ...
    new-instance v1, Les/br;

    invoke-direct {v1}, Les/br;-><init>()V

    iput-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->helper:Les/dy2;
    ...
    new-instance p2, Les/l0;

    invoke-direct {p2, p1}, Les/l0;-><init>(Ljava/io/InputStream;)V

    invoke-virtual {p2}, Les/l0;->r()Les/a1;

    move-result-object p1

    instance-of p2, p1, Les/d1;
    ...
    invoke-interface {v1, v0}, Les/dy2;->a(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
...
.method public constructor <init>(Ljava/util/List;)V
    ...
    new-instance v0, Les/br;

    invoke-direct {v0}, Les/br;-><init>()V

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->helper:Les/dy2;
...
.method private toASN1Object(Ljava/security/cert/X509Certificate;)Les/a1;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-direct {v0, p1}, Les/l0;-><init>([B)V
...
.method private toDEREncoded(Les/d0;)[B
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertificateEncodingException;
...
.method public getEncoded(Ljava/lang/String;)[B
    ...
    invoke-direct {p0, v1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->toASN1Object(Ljava/security/cert/X509Certificate;)Les/a1;
    ...
    invoke-direct {v0, p1}, Les/on0;-><init>(Les/e0;)V

    invoke-direct {p0, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->toDEREncoded(Les/d0;)[B
    ...
    new-instance v5, Les/wh0;

    sget-object p1, Les/kn4;->g1:Les/t0;

    const/4 v0, 0x0

    invoke-direct {v5, p1, v0}, Les/wh0;-><init>(Les/t0;Les/d0;)V
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->toASN1Object(Ljava/security/cert/X509Certificate;)Les/a1;

    move-result-object v0

    invoke-virtual {p1, v0}, Les/e0;->a(Les/d0;)V
    ...
    :cond_2
    new-instance v0, Les/jv5;

    new-instance v3, Les/n0;

    const-wide/16 v1, 0x1

    invoke-direct {v3, v1, v2}, Les/n0;-><init>(J)V

    new-instance v4, Les/qn0;

    invoke-direct {v4}, Les/qn0;-><init>()V

    new-instance v6, Les/qn0;

    invoke-direct {v6, p1}, Les/qn0;-><init>(Les/e0;)V

    const/4 v7, 0x0

    new-instance v8, Les/qn0;

    invoke-direct {v8}, Les/qn0;-><init>()V

    move-object v2, v0

    invoke-direct/range {v2 .. v8}, Les/jv5;-><init>(Les/n0;Les/h1;Les/wh0;Les/h1;Les/h1;Les/h1;)V

    new-instance p1, Les/wh0;

    sget-object v1, Les/kn4;->i1:Les/t0;

    invoke-direct {p1, v1, v0}, Les/wh0;-><init>(Les/t0;Les/d0;)V

    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->toDEREncoded(Les/d0;)[B
    ...
    new-instance v0, Les/or4;

    new-instance v2, Ljava/io/OutputStreamWriter;

    invoke-direct {v2, p1}, Ljava/io/OutputStreamWriter;-><init>(Ljava/io/OutputStream;)V

    invoke-direct {v0, v2}, Les/or4;-><init>(Ljava/io/Writer;)V
    ...
    invoke-direct {v2, v3, v4}, Les/mr4;-><init>(Ljava/lang/String;[B)V

    invoke-virtual {v0, v2}, Les/or4;->b(Les/nr4;)V
