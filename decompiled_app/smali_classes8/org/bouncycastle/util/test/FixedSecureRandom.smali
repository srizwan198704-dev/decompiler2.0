...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lorg/bouncycastle/util/test/FixedSecureRandom$c;
    }
.end annotation
...
.method public constructor <init>([Lorg/bouncycastle/util/test/FixedSecureRandom$c;)V
    .locals 9
    ...
    instance-of v5, v1, Lorg/bouncycastle/util/test/FixedSecureRandom$a;

    if-eqz v5, :cond_1

    iget-object v1, v1, Lorg/bouncycastle/util/test/FixedSecureRandom$c;->a:[B
    ...
    instance-of v6, v5, Lorg/bouncycastle/util/test/FixedSecureRandom$a;

    if-eqz v6, :cond_7

    iget-object v5, v5, Lorg/bouncycastle/util/test/FixedSecureRandom$c;->a:[B
...
.method public constructor <init>([[B)V
    ...
    invoke-static {p1}, Lorg/bouncycastle/util/test/FixedSecureRandom;->buildDataArray([[B)[Lorg/bouncycastle/util/test/FixedSecureRandom$b;
...
.method private static buildDataArray([[B)[Lorg/bouncycastle/util/test/FixedSecureRandom$b;
    .locals 4

    array-length v0, p0

    new-array v0, v0, [Lorg/bouncycastle/util/test/FixedSecureRandom$b;
    ...
    invoke-direct {v2, v3}, Lorg/bouncycastle/util/test/FixedSecureRandom$b;-><init>([B)V
...
.method private static expandToBitLength(I[B)[B
    ...
    invoke-static {v1, v2}, Les/nn4;->a([BI)I
    ...
    invoke-static {p0, v1, v2}, Les/nn4;->d(I[BI)V
    ...
    invoke-static {p1, v2}, Les/nn4;->a([BI)I
    ...
    invoke-static {p0, p1, v2}, Les/nn4;->d(I[BI)V
