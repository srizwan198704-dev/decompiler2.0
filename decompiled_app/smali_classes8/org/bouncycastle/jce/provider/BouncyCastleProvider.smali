...
.field public static final CONFIGURATION:Les/m45;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Les/xz;

    invoke-direct {v0}, Les/xz;-><init>()V

    sput-object v0, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->CONFIGURATION:Les/m45;
...
.method public constructor <init>()V
    ...
    const-wide v0, 0x3ff9c28f5c28f5c3L    # 1.61
...
.method private static getAsymmetricKeyInfoConverter(Les/t0;)Les/jm;
    .locals 1
...
.method public static getPrivateKey(Les/g25;)Ljava/security/PrivateKey;
    .locals 1
    ...
    invoke-static {v0}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->getAsymmetricKeyInfoConverter(Les/t0;)Les/jm;
    ...
    :cond_0
    invoke-interface {v0, p0}, Les/jm;->b(Les/g25;)Ljava/security/PrivateKey;
...
.method public static getPublicKey(Les/r56;)Ljava/security/PublicKey;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_0
    invoke-interface {v0, p0}, Les/jm;->a(Les/r56;)Ljava/security/PublicKey;
...
.method private loadAlgorithms(Ljava/lang/String;[Ljava/lang/String;)V
    ...
    invoke-static {v2, v1}, Les/a70;->a(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Class;
    ...
    check-cast v1, Les/je;

    invoke-virtual {v1, p0}, Les/je;->a(Les/ah0;)V
    :try_end_0
...
.method private loadPQCKeys()V
    ...
    new-instance v1, Les/b26;

    invoke-direct {v1}, Les/b26;-><init>()V

    invoke-virtual {p0, v0, v1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->addKeyInfoConverter(Les/t0;Les/jm;)V

    sget-object v0, Les/mn4;->v:Les/t0;

    new-instance v1, Les/f94;

    invoke-direct {v1}, Les/f94;-><init>()V

    invoke-virtual {p0, v0, v1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->addKeyInfoConverter(Les/t0;Les/jm;)V

    sget-object v0, Les/mn4;->w:Les/t0;

    new-instance v1, Les/pw6;

    invoke-direct {v1}, Les/pw6;-><init>()V

    invoke-virtual {p0, v0, v1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->addKeyInfoConverter(Les/t0;Les/jm;)V

    sget-object v0, Les/mn4;->F:Les/t0;

    new-instance v1, Les/sw6;

    invoke-direct {v1}, Les/sw6;-><init>()V

    invoke-virtual {p0, v0, v1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->addKeyInfoConverter(Les/t0;Les/jm;)V

    sget-object v0, Les/mn4;->m:Les/t0;

    new-instance v1, Les/rn3;

    invoke-direct {v1}, Les/rn3;-><init>()V

    invoke-virtual {p0, v0, v1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->addKeyInfoConverter(Les/t0;Les/jm;)V

    sget-object v0, Les/mn4;->n:Les/t0;

    new-instance v1, Les/ln3;

    invoke-direct {v1}, Les/ln3;-><init>()V

    invoke-virtual {p0, v0, v1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->addKeyInfoConverter(Les/t0;Les/jm;)V

    sget-object v0, Les/mn4;->a:Les/t0;

    new-instance v1, Les/o55;

    invoke-direct {v1}, Les/o55;-><init>()V

    invoke-virtual {p0, v0, v1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->addKeyInfoConverter(Les/t0;Les/jm;)V

    sget-object v0, Les/mn4;->X:Les/t0;

    new-instance v1, Les/z45;

    invoke-direct {v1}, Les/z45;-><init>()V

    invoke-virtual {p0, v0, v1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->addKeyInfoConverter(Les/t0;Les/jm;)V

    sget-object v0, Les/mn4;->Y:Les/t0;
    ...
    sget-object v0, Les/mn4;->Z:Les/t0;
    ...
    sget-object v0, Les/mn4;->a0:Les/t0;
    ...
    sget-object v0, Les/mn4;->b0:Les/t0;
...
# virtual methods
.method public addAlgorithm(Ljava/lang/String;Les/t0;Ljava/lang/String;)V
    .locals 2
...
.method public addKeyInfoConverter(Les/t0;Les/jm;)V
    .locals 1
...
.method public setParameter(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    check-cast v1, Les/xz;

    invoke-virtual {v1, p1, p2}, Les/xz;->d(Ljava/lang/String;Ljava/lang/Object;)V
