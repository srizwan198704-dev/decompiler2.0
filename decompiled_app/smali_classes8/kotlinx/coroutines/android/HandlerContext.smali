...
.method public synthetic constructor <init>(Landroid/os/Handler;Ljava/lang/String;ILes/wv0;)V
    .locals 0
...
.method public constructor <init>(Landroid/os/Handler;Ljava/lang/String;Z)V
    ...
    invoke-direct {p0, v0}, Les/tf2;-><init>(Les/wv0;)V
...
.method public static synthetic E(Lkotlinx/coroutines/android/HandlerContext;Ljava/lang/Runnable;)V
    ...
    invoke-static {p0, p1}, Lkotlinx/coroutines/android/HandlerContext;->J(Lkotlinx/coroutines/android/HandlerContext;Ljava/lang/Runnable;)V
...
.method public static final J(Lkotlinx/coroutines/android/HandlerContext;Ljava/lang/Runnable;)V
    .locals 0
...
.method public final H(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Runnable;)V
    ...
    invoke-static {p1, v0}, Les/ty2;->c(Lkotlin/coroutines/CoroutineContext;Ljava/util/concurrent/CancellationException;)V

    invoke-static {}, Les/y11;->b()Lkotlinx/coroutines/CoroutineDispatcher;
...
.method public I()Lkotlinx/coroutines/android/HandlerContext;
    .locals 1
...
.method public dispatch(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p1, p2}, Lkotlinx/coroutines/android/HandlerContext;->H(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Runnable;)V
...
.method public g(JLes/e20;)V
    ...
    invoke-direct {v0, p3, p0}, Lkotlinx/coroutines/android/HandlerContext$a;-><init>(Les/e20;Lkotlinx/coroutines/android/HandlerContext;)V

    iget-object v1, p0, Lkotlinx/coroutines/android/HandlerContext;->a:Landroid/os/Handler;

    const-wide v2, 0x3fffffffffffffffL    # 1.9999999999999998

    invoke-static {p1, p2, v2, v3}, Les/j65;->d(JJ)J
    ...
    invoke-interface {p3, p1}, Les/e20;->s(Lkotlin/jvm/functions/Function1;)V

    goto :goto_0

    :cond_0
    invoke-interface {p3}, Les/e20;->getContext()Lkotlin/coroutines/CoroutineContext;

    move-result-object p1

    invoke-virtual {p0, p1, v0}, Lkotlinx/coroutines/android/HandlerContext;->H(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Runnable;)V
...
.method public i(JLjava/lang/Runnable;Lkotlin/coroutines/CoroutineContext;)Les/p21;
    ...
    invoke-static {p1, p2, v1, v2}, Les/j65;->d(JJ)J
    ...
    new-instance p1, Les/sf2;

    invoke-direct {p1, p0, p3}, Les/sf2;-><init>(Lkotlinx/coroutines/android/HandlerContext;Ljava/lang/Runnable;)V

    return-object p1

    :cond_0
    invoke-virtual {p0, p4, p3}, Lkotlinx/coroutines/android/HandlerContext;->H(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Runnable;)V
...
.method public bridge synthetic r()Les/ye3;
    .locals 1

    invoke-virtual {p0}, Lkotlinx/coroutines/android/HandlerContext;->I()Lkotlinx/coroutines/android/HandlerContext;
