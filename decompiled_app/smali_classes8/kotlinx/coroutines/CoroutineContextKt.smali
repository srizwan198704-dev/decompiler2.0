...
.method public static final d(Les/ek0;Lkotlin/coroutines/CoroutineContext;)Lkotlin/coroutines/CoroutineContext;
    .locals 1

    invoke-interface {p0}, Les/ek0;->getCoroutineContext()Lkotlin/coroutines/CoroutineContext;
    ...
    invoke-static {}, Les/y11;->a()Lkotlinx/coroutines/CoroutineDispatcher;

    move-result-object p1

    if-eq p0, p1, :cond_0

    sget-object p1, Les/nj0;->l0:Les/nj0$b;
...
.method public static final f(Les/gk0;)Les/ng6;
    .locals 2
    ...
    :cond_1
    invoke-interface {p0}, Les/gk0;->getCallerFrame()Les/gk0;
    ...
    :cond_2
    instance-of v0, p0, Les/ng6;

    if-eqz v0, :cond_0

    check-cast p0, Les/ng6;

    return-object p0
.end method

.method public static final g(Les/mj0;Lkotlin/coroutines/CoroutineContext;Ljava/lang/Object;)Les/ng6;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    check-cast p0, Les/gk0;

    invoke-static {p0}, Lkotlinx/coroutines/CoroutineContextKt;->f(Les/gk0;)Les/ng6;
