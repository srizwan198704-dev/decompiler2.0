...
.field public final collector:Les/sy1;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Les/sy1<",
            "TT;>;"
...
.field private completion:Les/mj0;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Les/mj0<",
            "-",
...
.method public constructor <init>(Les/sy1;Lkotlin/coroutines/CoroutineContext;)V
    ...
    sget-object v0, Les/qf4;->a:Les/qf4;

    sget-object v1, Lkotlin/coroutines/EmptyCoroutineContext;->INSTANCE:Lkotlin/coroutines/EmptyCoroutineContext;

    invoke-direct {p0, v0, v1}, Lkotlin/coroutines/jvm/internal/ContinuationImpl;-><init>(Les/mj0;Lkotlin/coroutines/CoroutineContext;)V

    iput-object p1, p0, Lkotlinx/coroutines/flow/internal/SafeCollector;->collector:Les/sy1;
...
.method private final checkContext(Lkotlin/coroutines/CoroutineContext;Lkotlin/coroutines/CoroutineContext;Ljava/lang/Object;)V
    ...
    instance-of v0, p2, Les/t51;

    if-eqz v0, :cond_0

    check-cast p2, Les/t51;

    invoke-direct {p0, p2, p3}, Lkotlinx/coroutines/flow/internal/SafeCollector;->exceptionTransparencyViolated(Les/t51;Ljava/lang/Object;)V
...
.method private final emit(Les/mj0;Ljava/lang/Object;)Ljava/lang/Object;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    iput-object p1, p0, Lkotlinx/coroutines/flow/internal/SafeCollector;->completion:Les/mj0;

    invoke-static {}, Lkotlinx/coroutines/flow/internal/SafeCollectorKt;->a()Lkotlin/jvm/functions/Function3;

    move-result-object p1

    iget-object v0, p0, Lkotlinx/coroutines/flow/internal/SafeCollector;->collector:Les/sy1;
    ...
    iput-object p2, p0, Lkotlinx/coroutines/flow/internal/SafeCollector;->completion:Les/mj0;

    :cond_1
    return-object p1
.end method

.method private final exceptionTransparencyViolated(Les/t51;Ljava/lang/Object;)V
    .locals 3
    ...
    iget-object p1, p1, Les/t51;->a:Ljava/lang/Throwable;
    ...
    invoke-static {p1}, Les/v46;->e(Ljava/lang/String;)Ljava/lang/String;
...
.method public emit(Ljava/lang/Object;Les/mj0;)Ljava/lang/Object;
    ...
    :try_start_0
    invoke-direct {p0, p2, p1}, Lkotlinx/coroutines/flow/internal/SafeCollector;->emit(Les/mj0;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    new-instance v0, Les/t51;

    invoke-interface {p2}, Les/mj0;->getContext()Lkotlin/coroutines/CoroutineContext;

    move-result-object p2

    invoke-direct {v0, p1, p2}, Les/t51;-><init>(Ljava/lang/Throwable;Lkotlin/coroutines/CoroutineContext;)V
...
.method public getCallerFrame()Les/gk0;
    ...
    iget-object v0, p0, Lkotlinx/coroutines/flow/internal/SafeCollector;->completion:Les/mj0;
...
.method public invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    new-instance v1, Les/t51;

    invoke-virtual {p0}, Lkotlinx/coroutines/flow/internal/SafeCollector;->getContext()Lkotlin/coroutines/CoroutineContext;

    move-result-object v2

    invoke-direct {v1, v0, v2}, Les/t51;-><init>(Ljava/lang/Throwable;Lkotlin/coroutines/CoroutineContext;)V
