...
.method static constructor <clinit>()V
    ...
    invoke-static {v0, v3, v1, v2}, Les/yj1;->G(Les/yj1;ZILjava/lang/Object;)V
    ...
    sput-wide v0, Lkotlinx/coroutines/b;->g:J
...
.method public K()Ljava/lang/Thread;
    ...
    invoke-virtual {p0}, Lkotlinx/coroutines/b;->c0()Ljava/lang/Thread;
...
.method public L(JLkotlinx/coroutines/c$c;)V
    ...
    invoke-virtual {p0}, Lkotlinx/coroutines/b;->g0()V
...
.method public Q(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0}, Lkotlinx/coroutines/b;->d0()Z
    ...
    :cond_0
    invoke-super {p0, p1}, Lkotlinx/coroutines/c;->Q(Ljava/lang/Runnable;)V
...
.method public final declared-synchronized b0()V
    ...
    :try_start_0
    invoke-virtual {p0}, Lkotlinx/coroutines/b;->e0()Z
    ...
    invoke-virtual {p0}, Lkotlinx/coroutines/c;->V()V
...
.method public i(JLjava/lang/Runnable;Lkotlin/coroutines/CoroutineContext;)Les/p21;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lkotlinx/coroutines/c;->Y(JLjava/lang/Runnable;)Les/p21;
...
.method public run()V
    ...
    invoke-virtual {v0, p0}, Les/ga6;->c(Les/yj1;)V
    ...
    :try_start_0
    invoke-virtual {p0}, Lkotlinx/coroutines/b;->f0()Z
    ...
    invoke-virtual {p0}, Lkotlinx/coroutines/b;->b0()V

    invoke-static {}, Les/s3;->a()Les/r3;

    invoke-virtual {p0}, Lkotlinx/coroutines/c;->S()Z

    move-result v0

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lkotlinx/coroutines/b;->K()Ljava/lang/Thread;
    ...
    sget-wide v3, Lkotlinx/coroutines/b;->g:J
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    :cond_5
    :try_start_2
    invoke-static {v5, v6, v9, v10}, Les/j65;->d(JJ)J
