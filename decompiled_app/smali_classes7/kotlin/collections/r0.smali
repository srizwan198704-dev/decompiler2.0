...
.method public static emptyMap()Ljava/util/Map;
    ...
    .line 1
    sget-object v0, Lkotlin/collections/f0;->n:Lkotlin/collections/f0;
...
.method public static getValue(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 5
    .line 6
    invoke-static {p0, p1}, Lkotlin/collections/p0;->getOrImplicitDefaultNullable(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static varargs hashMapOf([Lkotlin/Pair;)Ljava/util/HashMap;
    ...
    .line 15
    .line 16
    invoke-static {v0, p0}, Lkotlin/collections/r0;->putAll(Ljava/util/Map;[Lkotlin/Pair;)V
...
.method public static final varargs linkedMapOf([Lkotlin/Pair;)Ljava/util/LinkedHashMap;
    ...
    .line 15
    .line 16
    invoke-static {p0, v0}, Lkotlin/collections/r0;->toMap([Lkotlin/Pair;Ljava/util/Map;)Ljava/util/Map;
...
.method public static final minus(Ljava/util/Map;Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {v0, p1}, Lkotlin/collections/y;->removeAll(Ljava/util/Collection;Ljava/lang/Iterable;)Z

    invoke-static {p0}, Lkotlin/collections/r0;->optimizeReadOnlyMap(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final minus(Ljava/util/Map;Lkotlin/sequences/Sequence;)Ljava/util/Map;
    ...
    invoke-static {v0, p1}, Lkotlin/collections/y;->removeAll(Ljava/util/Collection;Lkotlin/sequences/Sequence;)Z
...
.method public static final minus(Ljava/util/Map;[Ljava/lang/Object;)Ljava/util/Map;
    ...
    invoke-static {v0, p1}, Lkotlin/collections/y;->removeAll(Ljava/util/Collection;[Ljava/lang/Object;)Z
...
.method public static final optimizeReadOnlyMap(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 16
    :cond_0
    invoke-static {p0}, Lkotlin/collections/q0;->toSingletonMap(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final plus(Ljava/util/Map;Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {v0, p1}, Lkotlin/collections/r0;->putAll(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static final plus(Ljava/util/Map;Lkotlin/sequences/Sequence;)Ljava/util/Map;
    ...
    invoke-static {v0, p1}, Lkotlin/collections/r0;->putAll(Ljava/util/Map;Lkotlin/sequences/Sequence;)V

    invoke-static {v0}, Lkotlin/collections/r0;->optimizeReadOnlyMap(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final plus(Ljava/util/Map;[Lkotlin/Pair;)Ljava/util/Map;
    ...
    invoke-static {p1}, Lkotlin/collections/r0;->toMap([Lkotlin/Pair;)Ljava/util/Map;
    ...
    invoke-static {v0, p1}, Lkotlin/collections/r0;->putAll(Ljava/util/Map;[Lkotlin/Pair;)V
...
.method public static toMap(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lkotlin/collections/r0;->toMap(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lkotlin/collections/r0;->toMap(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
...
.method public static final toMap(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 7
    invoke-static {p1, p0}, Lkotlin/collections/r0;->putAll(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static final toMap(Lkotlin/sequences/Sequence;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lkotlin/collections/r0;->toMap(Lkotlin/sequences/Sequence;Ljava/util/Map;)Ljava/util/Map;
...
.method public static final toMap(Lkotlin/sequences/Sequence;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 14
    invoke-static {p1, p0}, Lkotlin/collections/r0;->putAll(Ljava/util/Map;Lkotlin/sequences/Sequence;)V
...
.method public static final toMap([Lkotlin/Pair;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 12
    invoke-static {p1, p0}, Lkotlin/collections/r0;->putAll(Ljava/util/Map;[Lkotlin/Pair;)V
