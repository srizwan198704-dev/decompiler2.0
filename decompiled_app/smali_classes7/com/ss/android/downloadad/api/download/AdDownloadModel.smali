...
.field protected mQuickAppModel:Lcom/ss/android/download/api/model/ak;
...
.method private static appendQuickAppUrlFromJson(Lorg/json/JSONObject;Lcom/ss/android/downloadad/api/download/AdDownloadModel$Builder;)V
    ...
    new-instance v0, Lcom/ss/android/download/api/model/ak$k;

    invoke-direct {v0}, Lcom/ss/android/download/api/model/ak$k;-><init>()V

    invoke-virtual {v0, p0}, Lcom/ss/android/download/api/model/ak$k;->k(Ljava/lang/String;)Lcom/ss/android/download/api/model/ak$k;

    move-result-object p0

    invoke-virtual {p0}, Lcom/ss/android/download/api/model/ak$k;->k()Lcom/ss/android/download/api/model/ak;

    move-result-object p0

    invoke-virtual {p1, p0}, Lcom/ss/android/downloadad/api/download/AdDownloadModel$Builder;->setQuickAppModel(Lcom/ss/android/download/api/model/ak;)Lcom/ss/android/downloadad/api/download/AdDownloadModel$Builder;
...
.method public static fromJson(Lorg/json/JSONObject;)Lcom/ss/android/downloadad/api/download/AdDownloadModel;
    ...
    invoke-static {p0, v2}, Lcom/ss/android/download/api/q/p;->k(Lorg/json/JSONObject;Ljava/lang/String;)J
...
.method public getQuickAppModel()Lcom/ss/android/download/api/model/ak;
    .locals 1

    iget-object v0, p0, Lcom/ss/android/downloadad/api/download/AdDownloadModel;->mQuickAppModel:Lcom/ss/android/download/api/model/ak;
...
.method public setQuickAppModel(Lcom/ss/android/download/api/model/ak;)Lcom/ss/android/downloadad/api/download/AdDownloadModel;
    .locals 0

    iput-object p1, p0, Lcom/ss/android/downloadad/api/download/AdDownloadModel;->mQuickAppModel:Lcom/ss/android/download/api/model/ak;
...
.method public shouldDownloadWithPatchApply()Z
    ...
    invoke-static {v0, v1}, Lcom/ss/android/download/api/q/p;->k(Lcom/ss/android/socialbase/downloader/yz/k;Ljava/lang/String;)Z
...
.method public toJson()Lorg/json/JSONObject;
    ...
    :cond_5
    iget-object v1, p0, Lcom/ss/android/downloadad/api/download/AdDownloadModel;->mQuickAppModel:Lcom/ss/android/download/api/model/ak;

    if-eqz v1, :cond_6

    const-string v2, "quick_app_url"

    invoke-virtual {v1}, Lcom/ss/android/download/api/model/ak;->k()Ljava/lang/String;
