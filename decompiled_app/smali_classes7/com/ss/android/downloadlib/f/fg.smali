.class public Lcom/ss/android/downloadlib/f/fg;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/ss/android/downloadlib/f/fg;->p:[Ljava/lang/Object;

    const/16 v0, 0x49

    new-array v0, v0, [Ljava/lang/Object;

    sput-object v0, Lcom/ss/android/downloadlib/f/fg;->q:[Ljava/lang/Object;
    ...
    sput-object v0, Lcom/ss/android/downloadlib/f/fg;->k:[C

    const/4 v0, 0x0

    sput-object v0, Lcom/ss/android/downloadlib/f/fg;->ak:Ljava/lang/String;
...
.method public static ak(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    .locals 1
...
.method public static by(Landroid/content/Context;Ljava/lang/String;)Ljava/io/File;
    .locals 2
...
.method public static de(Landroid/content/Context;Ljava/lang/String;)Z
    .locals 2
...
.method public static k(Ljava/io/File;J)J
    .locals 0
...
.method public static k(Lorg/json/JSONObject;Ljava/lang/String;)J
    ...
    invoke-static {p0, p1}, Lcom/ss/android/download/api/q/p;->k(Lorg/json/JSONObject;Ljava/lang/String;)J
...
.method public static k(Lcom/ss/android/downloadad/api/k/p;)Landroid/content/pm/PackageInfo;
    .locals 4
    ...
    invoke-static {v1, p0, v2, v3}, Lcom/ss/android/socialbase/appdownloader/q;->k(Landroid/content/Context;Lcom/ss/android/socialbase/downloader/model/DownloadInfo;Ljava/lang/String;Ljava/lang/String;)Landroid/content/pm/PackageInfo;
...
.method public static k(Ljava/lang/String;ILjava/lang/String;)Lcom/ss/android/downloadlib/addownload/p/q;
    .locals 3

    new-instance v0, Lcom/ss/android/downloadlib/addownload/p/q;

    invoke-direct {v0}, Lcom/ss/android/downloadlib/addownload/p/q;-><init>()V
    ...
    invoke-virtual {v0, v1}, Lcom/ss/android/downloadlib/addownload/p/q;->p(I)Lcom/ss/android/downloadlib/addownload/p/q;

    sget v1, Lcom/ss/android/downloadlib/addownload/p/q;->p:I

    invoke-virtual {v0, v1}, Lcom/ss/android/downloadlib/addownload/p/q;->k(I)Lcom/ss/android/downloadlib/addownload/p/q;

    invoke-static {}, Lcom/ss/android/downloadlib/addownload/e;->f()Lcom/ss/android/download/api/config/hu;

    move-result-object v1

    if-eqz v1, :cond_1

    invoke-interface {v1}, Lcom/ss/android/download/api/config/hu;->k()Z
    ...
    invoke-static {v1, p1, p0, p2}, Lcom/ss/android/downloadlib/f/fg;->k(IILjava/lang/String;Ljava/lang/String;)Z

    move-result p0

    if-nez p0, :cond_1

    sget p0, Lcom/ss/android/downloadlib/addownload/p/q;->q:I

    invoke-virtual {v0, p0}, Lcom/ss/android/downloadlib/addownload/p/q;->k(I)Lcom/ss/android/downloadlib/addownload/p/q;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {p1, p0}, Lcom/ss/android/socialbase/downloader/q/k;->i(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static k(Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    invoke-static {p0}, Lcom/ss/android/download/api/q/p;->k(Lorg/json/JSONObject;)Lorg/json/JSONObject;
...
.method public static k(Lorg/json/JSONObject;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    invoke-static {p0, p1}, Lcom/ss/android/download/api/q/p;->k(Lorg/json/JSONObject;Lorg/json/JSONObject;)Lorg/json/JSONObject;
...
.method private static k(IILjava/lang/String;Ljava/lang/String;)Z
    .locals 2
    ...
    :cond_1
    invoke-static {p2, p3}, Lcom/ss/android/downloadlib/f/fg;->k(Ljava/lang/String;Ljava/lang/String;)I
...
.method public static k(Lcom/ss/android/download/api/download/DownloadModel;)Z
    ...
    invoke-static {v0, v1, p0}, Lcom/ss/android/downloadlib/f/fg;->k(Ljava/lang/String;ILjava/lang/String;)Lcom/ss/android/downloadlib/addownload/p/q;

    move-result-object p0

    invoke-virtual {p0}, Lcom/ss/android/downloadlib/addownload/p/q;->k()Z
...
.method public static p(J)J
    ...
    invoke-static {v0, p0, p1}, Lcom/ss/android/downloadlib/f/fg;->k(Ljava/io/File;J)J
...
.method public static p(Lcom/ss/android/downloadad/api/k/p;)Z
    ...
    invoke-virtual {p0}, Lcom/ss/android/downloadad/api/k/p;->xm()I

    move-result v1

    invoke-virtual {p0}, Lcom/ss/android/downloadad/api/k/p;->mg()Ljava/lang/String;
...
.method public static q()V
    ...
    invoke-interface {v0, v1, v2}, Lcom/ss/android/download/api/config/x;->k(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static q(Ljava/lang/String;)Z
    ...
    :cond_0
    invoke-static {v0, p0}, Lcom/ss/android/downloadlib/f/fg;->i(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {v0, p0}, Lcom/ss/android/downloadlib/f/fg;->by(Landroid/content/Context;Ljava/lang/String;)Ljava/io/File;
    ...
    :cond_6
    invoke-static {v1}, Lcom/ss/android/downloadlib/f/f;->k(Ljava/io/File;)J
...
.method public static x(Landroid/content/Context;Ljava/lang/String;)[Landroid/content/pm/Signature;
    .locals 1
...
.method public static yz(Landroid/content/Context;Ljava/lang/String;)[Landroid/content/pm/Signature;
    .locals 1
