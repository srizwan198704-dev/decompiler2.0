...
# direct methods
.method public constructor <init>(Les/ln7;Lcom/bytedance/msdk/adapter/gdt/GdtNativeLoader;Ljava/util/function/Function;Lcom/qq/e/ads/nativ/NativeExpressADView;Z)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Les/ln7;",
            "Lcom/bytedance/msdk/adapter/gdt/GdtNativeLoader;",
    ...
    iput-boolean p2, p0, Les/qd7;->e:Z

    new-instance p2, Les/qd7$f;

    invoke-direct {p2, p0}, Les/qd7$f;-><init>(Les/qd7;)V

    iput-object p2, p0, Les/qd7;->h:Lcom/qq/e/ads/nativ/NativeExpressMediaListener;

    iput-object p4, p0, Les/qd7;->d:Lcom/qq/e/ads/nativ/NativeExpressADView;

    iput-object p1, p0, Les/qd7;->f:Les/ln7;

    iput-boolean p5, p0, Les/qd7;->g:Z

    invoke-direct {p0}, Les/qd7;->e()V

    return-void
.end method

.method public static synthetic b(Les/qd7;)Ljava/lang/String;
    .locals 0

    invoke-direct {p0}, Les/qd7;->h()Ljava/lang/String;
...
.method private c(Ljava/lang/Object;)V
    ...
    :cond_0
    iget-boolean v0, p0, Les/qd7;->g:Z

    if-eqz v0, :cond_1

    new-instance v0, Les/qd7$e;

    invoke-direct {v0, p0, p1}, Les/qd7$e;-><init>(Les/qd7;I)V
    ...
    :cond_1
    iget-object v0, p0, Les/qd7;->d:Lcom/qq/e/ads/nativ/NativeExpressADView;
...
.method public static synthetic d(Les/qd7;)Lcom/qq/e/ads/nativ/NativeExpressADView;
    .locals 0

    iget-object p0, p0, Les/qd7;->d:Lcom/qq/e/ads/nativ/NativeExpressADView;
...
.method private e()V
    ...
    iget-object v1, p0, Les/qd7;->d:Lcom/qq/e/ads/nativ/NativeExpressADView;
    ...
    iget-object v2, p0, Les/qd7;->d:Lcom/qq/e/ads/nativ/NativeExpressADView;

    iget-object v3, p0, Les/qd7;->h:Lcom/qq/e/ads/nativ/NativeExpressMediaListener;
...
.method private f()Ljava/lang/String;
    ...
    invoke-direct {p0}, Les/qd7;->g()Ljava/lang/String;
...
.method private g()Ljava/lang/String;
    ...
    new-instance v0, Les/qd7$a;

    invoke-direct {v0, p0}, Les/qd7$a;-><init>(Les/qd7;)V
...
.method public applyFunction(ILandroid/util/SparseArray;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    iget-boolean p1, p0, Les/qd7;->g:Z

    if-eqz p1, :cond_0

    new-instance p1, Les/qd7$b;

    invoke-direct {p1, p0}, Les/qd7$b;-><init>(Les/qd7;)V
    ...
    :cond_0
    iget-object p1, p0, Les/qd7;->d:Lcom/qq/e/ads/nativ/NativeExpressADView;
    ...
    iput-boolean p1, p0, Les/qd7;->e:Z

    iget-object p1, p0, Les/qd7;->f:Les/ln7;

    invoke-virtual {p1}, Les/ln7;->c()Ljava/util/Map;
    ...
    iget-object p2, p0, Les/qd7;->d:Lcom/qq/e/ads/nativ/NativeExpressADView;
    ...
    new-instance p2, Les/qd7$c;

    invoke-direct {p2, p0}, Les/qd7$c;-><init>(Les/qd7;)V
    ...
    iget-boolean p1, p0, Les/qd7;->e:Z
    ...
    :try_start_0
    iget-boolean p2, p0, Les/qd7;->g:Z

    if-eqz p2, :cond_8

    new-instance p1, Les/qd7$d;

    invoke-direct {p1, p0}, Les/qd7$d;-><init>(Les/qd7;)V
    ...
    invoke-direct {p0, p1}, Les/qd7;->c(Ljava/lang/Object;)V
    :try_end_1
    ...
    invoke-direct {p0}, Les/qd7;->f()Ljava/lang/String;
...
.method public call(ILcom/bykv/vk/openvk/api/proto/ValueSet;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2, p3}, Les/qd7;->applyFunction(ILandroid/util/SparseArray;Ljava/lang/Class;)Ljava/lang/Object;
