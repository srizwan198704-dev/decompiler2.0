...
.method constructor <init>(Lh00/c;Lio/reactivex/rxjava3/core/Scheduler$Worker;ZI)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->downstream:Lh00/c;
...
.method public onSubscribe(Lh00/d;)V
    ...
    iget-object p1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->downstream:Lh00/c;
    ...
    iget-object v0, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->downstream:Lh00/c;
...
.method runAsync()V
    ...
    :goto_2
    invoke-virtual {p0, v9, v11, v0}, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLh00/c;)Z
    ...
    :cond_4
    invoke-interface {v0, v10}, Lh00/c;->onNext(Ljava/lang/Object;)V
    ...
    :cond_5
    iget-object v8, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lh00/d;

    invoke-interface {v8, v2, v3}, Lh00/d;->request(J)V
    ...
    invoke-interface {v0, v2}, Lh00/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0, v6, v7, v0}, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLh00/c;)Z
...
.method runBackfused()V
    ...
    iget-object v3, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->downstream:Lh00/c;

    const/4 v4, 0x0

    invoke-interface {v3, v4}, Lh00/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->downstream:Lh00/c;
...
.method runSync()V
    ...
    :cond_2
    invoke-interface {v0, v8}, Lh00/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v2, p0, Lio/reactivex/rxjava3/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lh00/d;
