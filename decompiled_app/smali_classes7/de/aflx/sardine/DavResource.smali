...
.method public constructor <init>(Lde/aflx/sardine/model/Response;)V
    ...
    iput-object p1, p0, Lde/aflx/sardine/DavResource;->customProps:Ljava/util/Map;
...
.method public constructor <init>(Ljava/lang/String;Ljava/util/Date;Ljava/util/Date;Ljava/lang/String;Ljava/lang/Long;Ljava/lang/String;Ljava/util/Map;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private getContentLength(Lde/aflx/sardine/model/Response;)J
    ...
    invoke-virtual {p1}, Lde/aflx/sardine/model/Propstat;->getProp()Lde/aflx/sardine/model/Prop;

    move-result-object p1

    invoke-virtual {p1}, Lde/aflx/sardine/model/Prop;->getGetcontentlength()Ljava/lang/String;
...
.method private getContentType(Lde/aflx/sardine/model/Response;)Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lde/aflx/sardine/model/Prop;->getResourcetype()Lde/aflx/sardine/model/Resourcetype;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lde/aflx/sardine/model/Resourcetype;->getCollection()Lde/aflx/sardine/model/Collection;
...
.method private getCreationDate(Lde/aflx/sardine/model/Response;)Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lde/aflx/sardine/model/Prop;->getCreationdate()Ljava/lang/String;
...
.method private getEtag(Lde/aflx/sardine/model/Response;)Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lde/aflx/sardine/model/Prop;->getGetetag()Ljava/lang/String;
...
.method private getModifiedDate(Lde/aflx/sardine/model/Response;)Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lde/aflx/sardine/model/Prop;->getGetlastmodified()Ljava/lang/String;
...
.method public getCustomProps()Ljava/util/Map;
    ...
    check-cast v3, Lde/aflx/sardine/util/QName;

    invoke-virtual {v3}, Lde/aflx/sardine/util/QName;->getLocalPart()Ljava/lang/String;
...
.method public getName()Ljava/lang/String;
    ...
    :catch_0
    sget-object v3, Lde/aflx/sardine/DavResource;->log:Lde/aflx/sardine/util/Logger;
