...
.method static constructor <clinit>()V
    ...
    sput-object v0, Les/iy;->a:Landroid/net/Uri;
    ...
    sput-object v0, Les/iy;->b:[Ljava/lang/String;
...
.method public static a(Ljava/lang/String;)I
    ...
    invoke-static {v2, p0}, Les/wd7;->f(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v2, p0}, Les/wd7;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v2, p0}, Les/wd7;->d(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static d(Ljava/io/InputStream;Landroid/content/Context;)V
    ...
    :cond_0
    invoke-static {p1}, Les/iy;->b(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p1}, Les/iy;->a(Ljava/lang/String;)I
    ...
    :cond_3
    invoke-static {v2}, Les/xb7;->c(Ljava/io/OutputStream;)V
    ...
    invoke-static {v0, p0}, Les/wd7;->d(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1

    invoke-static {p1}, Les/xb7;->c(Ljava/io/OutputStream;)V
...
.method public static f(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0}, Les/iy;->b(Landroid/content/Context;)Ljava/lang/String;
...
.method public static g([B)Ljava/lang/String;
    ...
    invoke-static {p0}, Les/iy;->c([B)Ljava/lang/String;
    ...
    invoke-static {p0, v1}, Les/wd7;->d(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static h(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p0, p1}, Les/iy;->e(Landroid/content/Context;Ljava/lang/String;)[B

    move-result-object p0

    invoke-static {p0}, Les/iy;->j([B)Ljava/lang/String;
...
.method public static l(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    sget-object p1, Les/iy;->b:[Ljava/lang/String;
...
.method public static declared-synchronized m(Landroid/content/Context;)Ljava/io/InputStream;
    ...
    invoke-static {v1, v2}, Les/wd7;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0, v2}, Les/wd7;->d(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-static {v2}, Les/yf7;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    invoke-static {v2}, Les/iy;->i(Ljava/lang/String;)Z
    ...
    invoke-static {p0, v2}, Les/iy;->l(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p0, v2}, Les/iy;->h(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    :try_start_4
    sget-object v3, Les/iy;->a:Landroid/net/Uri;
    ...
    invoke-static {v1, v5, p0}, Les/vh7;->b(Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v5}, Les/iy;->g([B)Ljava/lang/String;

    move-result-object v5

    invoke-static {p0}, Les/iy;->k(Landroid/content/Context;)Z
    ...
    invoke-static {v1, v5}, Les/wd7;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v4, p0}, Les/iy;->d(Ljava/io/InputStream;Landroid/content/Context;)V

    const-string v1, "bks_hash"

    invoke-static {v1, v5, p0}, Les/vh7;->e(Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)V
    :try_end_6
    ...
    :goto_3
    :try_start_7
    invoke-static {v3}, Les/xb7;->b(Ljava/io/InputStream;)V

    invoke-static {v2}, Les/xb7;->c(Ljava/io/OutputStream;)V

    invoke-static {v4}, Les/xb7;->b(Ljava/io/InputStream;)V
    ...
    invoke-static {v5, v4}, Les/wd7;->d(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_8
    ...
    invoke-static {v1}, Les/xb7;->b(Ljava/io/InputStream;)V
...
.method public static n(Landroid/content/Context;)Ljava/io/InputStream;
    ...
    invoke-static {p0}, Les/iy;->f(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v1, p0}, Les/wd7;->d(Ljava/lang/String;Ljava/lang/String;)V
