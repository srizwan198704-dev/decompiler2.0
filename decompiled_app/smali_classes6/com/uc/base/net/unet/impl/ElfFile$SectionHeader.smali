.class public Lcom/uc/base/net/unet/impl/ElfFile$SectionHeader;
...
.method private constructor <init>(Ljava/nio/ByteBuffer;I)V
    ...
    iput p2, p0, Lcom/uc/base/net/unet/impl/ElfFile$SectionHeader;->shName:I
    ...
    iput p2, p0, Lcom/uc/base/net/unet/impl/ElfFile$SectionHeader;->shType:I
    ...
    iput-wide v0, p0, Lcom/uc/base/net/unet/impl/ElfFile$SectionHeader;->shFlags:J
    ...
    iput-wide v0, p0, Lcom/uc/base/net/unet/impl/ElfFile$SectionHeader;->shAddr:J
    ...
    iput-wide v0, p0, Lcom/uc/base/net/unet/impl/ElfFile$SectionHeader;->shOffset:J
    ...
    iput-wide v0, p0, Lcom/uc/base/net/unet/impl/ElfFile$SectionHeader;->shSize:J
    ...
    iput p2, p0, Lcom/uc/base/net/unet/impl/ElfFile$SectionHeader;->shLink:I
    ...
    iput p2, p0, Lcom/uc/base/net/unet/impl/ElfFile$SectionHeader;->shInfo:I
    ...
    iput-wide v0, p0, Lcom/uc/base/net/unet/impl/ElfFile$SectionHeader;->shAddrAlign:J
    ...
    iput-wide p1, p0, Lcom/uc/base/net/unet/impl/ElfFile$SectionHeader;->shEntSize:J
    ...
    .line 26
    iput-object p1, p0, Lcom/uc/base/net/unet/impl/ElfFile$SectionHeader;->shNameStr:Ljava/lang/String;

    return-void
.end method

.method public synthetic constructor <init>(Ljava/nio/ByteBuffer;ILcom/uc/base/net/unet/impl/ElfFile$1;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 1
    invoke-direct {p0, p1, p2}, Lcom/uc/base/net/unet/impl/ElfFile$SectionHeader;-><init>(Ljava/nio/ByteBuffer;I)V
