...
# instance fields
.field private final aRi:Ljava/lang/Object;

.field private final aRj:Ljava/util/concurrent/ExecutorService;
...
.field private final aRl:Ljava/net/ServerSocket;

.field private final aRm:Ljava/lang/Thread;
...
.method private constructor <init>(Lcom/kwad/sdk/core/videocache/c;)V
    ...
    iput-object v1, p0, Lcom/kwad/sdk/core/videocache/f;->aRi:Ljava/lang/Object;

    invoke-static {}, Lcom/kwad/sdk/core/threads/GlobalThreadPools;->LO()Ljava/util/concurrent/ExecutorService;

    move-result-object v1

    iput-object v1, p0, Lcom/kwad/sdk/core/videocache/f;->aRj:Ljava/util/concurrent/ExecutorService;

    new-instance v1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v1, p0, Lcom/kwad/sdk/core/videocache/f;->aRk:Ljava/util/Map;
    ...
    iput-object p1, p0, Lcom/kwad/sdk/core/videocache/f;->aRn:Lcom/kwad/sdk/core/videocache/c;
    ...
    iput-object v1, p0, Lcom/kwad/sdk/core/videocache/f;->aRl:Ljava/net/ServerSocket;
    ...
    iput-object v0, p0, Lcom/kwad/sdk/core/videocache/f;->aRm:Ljava/lang/Thread;
    ...
    :goto_0
    iget-object v0, p0, Lcom/kwad/sdk/core/videocache/f;->aRj:Ljava/util/concurrent/ExecutorService;
...
.method private ME()V
    ...
    iget-object v0, p0, Lcom/kwad/sdk/core/videocache/f;->aRl:Ljava/net/ServerSocket;
    ...
    iget-object v1, p0, Lcom/kwad/sdk/core/videocache/f;->aRj:Ljava/util/concurrent/ExecutorService;
...
.method private MF()I
    ...
    iget-object v0, p0, Lcom/kwad/sdk/core/videocache/f;->aRi:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/kwad/sdk/core/videocache/f;->aRk:Ljava/util/Map;
    ...
    invoke-virtual {v3}, Lcom/kwad/sdk/core/videocache/g;->MF()I
...
.method public static synthetic a(Lcom/kwad/sdk/core/videocache/f;)V
    ...
    invoke-direct {p0}, Lcom/kwad/sdk/core/videocache/f;->ME()V
...
.method private a(Ljava/net/Socket;)V
    ...
    invoke-direct {p0, v3}, Lcom/kwad/sdk/core/videocache/f;->fn(Ljava/lang/String;)Lcom/kwad/sdk/core/videocache/g;
    ...
    :goto_0
    invoke-direct {p0}, Lcom/kwad/sdk/core/videocache/f;->MF()I
...
.method private ac(Ljava/lang/String;)Ljava/io/File;
    .locals 2

    iget-object v0, p0, Lcom/kwad/sdk/core/videocache/f;->aRn:Lcom/kwad/sdk/core/videocache/c;

    iget-object v1, v0, Lcom/kwad/sdk/core/videocache/c;->aQU:Ljava/io/File;

    iget-object v0, v0, Lcom/kwad/sdk/core/videocache/c;->aQV:Lcom/kwad/sdk/core/videocache/a/c;
...
.method private fm(Ljava/lang/String;)Ljava/io/File;
    .locals 3

    iget-object v0, p0, Lcom/kwad/sdk/core/videocache/f;->aRn:Lcom/kwad/sdk/core/videocache/c;

    iget-object v0, v0, Lcom/kwad/sdk/core/videocache/c;->aQU:Ljava/io/File;

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v2, p0, Lcom/kwad/sdk/core/videocache/f;->aRn:Lcom/kwad/sdk/core/videocache/c;

    iget-object v2, v2, Lcom/kwad/sdk/core/videocache/c;->aQV:Lcom/kwad/sdk/core/videocache/a/c;
...
.method private fn(Ljava/lang/String;)Lcom/kwad/sdk/core/videocache/g;
    .locals 3
    ...
    iget-object v2, p0, Lcom/kwad/sdk/core/videocache/f;->aRk:Ljava/util/Map;
...
.method private g(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, Lcom/kwad/sdk/core/videocache/f;->ac(Ljava/lang/String;)Ljava/io/File;
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/kwad/sdk/core/videocache/f;->fl(Ljava/lang/String;)Ljava/lang/String;
...
.method private r(Ljava/io/File;)V
    ...
    iget-object v0, v0, Lcom/kwad/sdk/core/videocache/c;->aQW:Lcom/kwad/sdk/core/videocache/a/a;
...
.method public final a(Ljava/lang/String;JLcom/kwad/sdk/core/network/a/a$a;Lcom/kwad/sdk/export/proxy/AdHttpResponseListener;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/kwad/sdk/core/videocache/f;->fi(Ljava/lang/String;)Z
...
.method public final fi(Ljava/lang/String;)Z
    ...
    invoke-static {p1, v0}, Lcom/kwad/sdk/utils/az;->aA(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final fj(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1}, Lcom/kwad/sdk/core/videocache/f;->fm(Ljava/lang/String;)Ljava/io/File;
...
.method public final fk(Ljava/lang/String;)Z
    ...
    iget-object v0, p0, Lcom/kwad/sdk/core/videocache/f;->aRk:Ljava/util/Map;
