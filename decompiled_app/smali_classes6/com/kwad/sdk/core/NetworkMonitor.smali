...
# static fields
.field private static volatile aCn:Z


# instance fields
.field private final aCo:Ljava/util/List;
...
.field private final aCs:Landroid/content/BroadcastReceiver;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/kwad/sdk/core/NetworkMonitor;->aCo:Ljava/util/List;

    new-instance v0, Ljava/util/WeakHashMap;

    invoke-direct {v0}, Ljava/util/WeakHashMap;-><init>()V

    iput-object v0, p0, Lcom/kwad/sdk/core/NetworkMonitor;->aCp:Ljava/util/WeakHashMap;

    invoke-static {v0}, Ljava/util/Collections;->synchronizedMap(Ljava/util/Map;)Ljava/util/Map;

    move-result-object v0

    iput-object v0, p0, Lcom/kwad/sdk/core/NetworkMonitor;->aCq:Ljava/util/Map;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/kwad/sdk/core/NetworkMonitor;->aCr:Z
    ...
    iput-object v0, p0, Lcom/kwad/sdk/core/NetworkMonitor;->aCs:Landroid/content/BroadcastReceiver;
...
.method private b(Lcom/kwad/sdk/core/NetworkMonitor$NetworkState;)V
    ...
    iget-object v0, p0, Lcom/kwad/sdk/core/NetworkMonitor;->aCo:Ljava/util/List;
...
.method private declared-synchronized bD(Landroid/content/Context;)V
    .locals 3

    monitor-enter p0

    :try_start_0
    sget-boolean v0, Lcom/kwad/sdk/core/NetworkMonitor;->aCn:Z
    :try_end_0
    ...
    iget-object v0, p0, Lcom/kwad/sdk/core/NetworkMonitor;->aCs:Landroid/content/BroadcastReceiver;
    ...
    sput-boolean p1, Lcom/kwad/sdk/core/NetworkMonitor;->aCn:Z
    :try_end_1
...
.method public final a(Landroid/content/Context;Lcom/kwad/sdk/core/NetworkMonitor$a;)V
    ...
    invoke-direct {p0, p1}, Lcom/kwad/sdk/core/NetworkMonitor;->bD(Landroid/content/Context;)V

    iget-object p1, p0, Lcom/kwad/sdk/core/NetworkMonitor;->aCo:Ljava/util/List;
...
.method public final a(Landroid/content/Context;Lcom/kwad/sdk/core/NetworkMonitor$a;Lcom/kwad/sdk/core/response/model/AdTemplate;)V
    ...
    iget-object p1, p0, Lcom/kwad/sdk/core/NetworkMonitor;->aCq:Ljava/util/Map;
