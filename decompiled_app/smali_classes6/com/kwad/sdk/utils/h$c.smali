.class final Lcom/kwad/sdk/utils/h$c;
...
.method private c(Landroid/os/Message;)V
    ...
    new-instance v3, Lcom/kwad/sdk/utils/h$c$1;

    invoke-direct {v3, p0}, Lcom/kwad/sdk/utils/h$c$1;-><init>(Lcom/kwad/sdk/utils/h$c;)V

    invoke-static {v0, v3}, Lcom/kwad/sdk/utils/ac;->a(Ljava/lang/String;Lcom/kwad/sdk/core/c;)Ljava/util/List;
    ...
    invoke-static {v0}, Lcom/kwad/sdk/utils/h$c;->c(Ljava/util/ArrayList;)V

    :cond_1
    if-eqz v3, :cond_2

    invoke-static {v3}, Lcom/kwad/sdk/utils/h$c;->U(Ljava/util/List;)V

    :cond_2
    invoke-static {}, Lcom/kwad/sdk/utils/h;->RX()Ljava/lang/ref/WeakReference;
    ...
    new-instance v0, Lcom/kwad/sdk/utils/h$c$2;

    invoke-direct {v0, p0}, Lcom/kwad/sdk/utils/h$c$2;-><init>(Lcom/kwad/sdk/utils/h$c;)V
    ...
    invoke-static {}, Lcom/kwad/sdk/utils/h;->RY()Landroid/content/ServiceConnection;
...
.method private static c(Ljava/util/ArrayList;)V
    ...
    :cond_0
    invoke-static {p0}, Lcom/kwad/sdk/utils/h$a;->S(Ljava/util/List;)Lorg/json/JSONArray;
...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    :cond_0
    :try_start_0
    invoke-direct {p0, p1}, Lcom/kwad/sdk/utils/h$c;->c(Landroid/os/Message;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
