...
# direct methods
.method public static FP()Lorg/json/JSONArray;
    .locals 2
    ...
    invoke-static {v0}, Lcom/kwad/sdk/collector/f;->bz(Landroid/content/Context;)Ljava/util/List;

    move-result-object v1

    invoke-static {v0}, Lcom/kwad/sdk/collector/f;->by(Landroid/content/Context;)Lcom/kwad/sdk/collector/g;

    move-result-object v0

    invoke-interface {v1, v0}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-static {v1}, Lcom/kwad/sdk/collector/g;->z(Ljava/util/List;)Lorg/json/JSONArray;
...
.method private static by(Landroid/content/Context;)Lcom/kwad/sdk/collector/g;
    .locals 2

    invoke-static {p0}, Lcom/kwad/sdk/utils/aw;->dD(Landroid/content/Context;)Z
...
.method private static bz(Landroid/content/Context;)Ljava/util/List;
    .locals 7
    ...
    invoke-static {p0, v4}, Lcom/kwad/sdk/utils/aw;->ay(Landroid/content/Context;Ljava/lang/String;)I
    ...
    :cond_2
    sget v5, Lcom/kwad/sdk/collector/g;->aAE:I
