...
# instance fields
.field final synthetic aAC:Lcom/kwad/sdk/collector/d$a;
...
.method public constructor <init>(Lcom/kwad/sdk/collector/d$a;)V
    ...
    iput-object p1, p0, Lcom/kwad/sdk/collector/d$1;->aAC:Lcom/kwad/sdk/collector/d$a;
...
.method private a(Lcom/kwad/library/solder/lib/b/c;)V
    ...
    iget-object p1, p0, Lcom/kwad/sdk/collector/d$1;->aAC:Lcom/kwad/sdk/collector/d$a;

    if-eqz p1, :cond_0

    const-string v0, "load canceled"

    invoke-interface {p1, v0}, Lcom/kwad/sdk/collector/d$a;->cU(Ljava/lang/String;)V
...
.method private a(Lcom/kwad/library/solder/lib/b/c;Lcom/kwad/library/solder/lib/ext/PluginError;)V
    ...
    :goto_0
    iget-object p2, p0, Lcom/kwad/sdk/collector/d$1;->aAC:Lcom/kwad/sdk/collector/d$a;

    invoke-interface {p2, p1}, Lcom/kwad/sdk/collector/d$a;->cU(Ljava/lang/String;)V
