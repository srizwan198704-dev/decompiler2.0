...
# instance fields
.field protected final bbi:Lcom/kwad/sdk/pngencrypt/DeflatedChunksSet;

.field protected bbj:Z

.field protected bbk:Z

.field protected bbl:[B

.field protected bbm:I
...
.method public constructor <init>(ILjava/lang/String;JLcom/kwad/sdk/pngencrypt/DeflatedChunksSet;)V
    ...
    iput-boolean p1, p0, Lcom/kwad/sdk/pngencrypt/d;->bbj:Z

    iput-boolean p1, p0, Lcom/kwad/sdk/pngencrypt/d;->bbk:Z

    const/4 p1, -0x1

    iput p1, p0, Lcom/kwad/sdk/pngencrypt/d;->bbm:I

    iput-object p5, p0, Lcom/kwad/sdk/pngencrypt/d;->bbi:Lcom/kwad/sdk/pngencrypt/DeflatedChunksSet;
...
.method public Ql()V
    ...
    iget-boolean v0, p0, Lcom/kwad/sdk/pngencrypt/d;->bbk:Z

    if-eqz v0, :cond_0

    iget v0, p0, Lcom/kwad/sdk/pngencrypt/d;->bbm:I

    if-ltz v0, :cond_0

    iget-object v0, p0, Lcom/kwad/sdk/pngencrypt/d;->bbl:[B
    ...
    iget v1, p0, Lcom/kwad/sdk/pngencrypt/d;->bbm:I
...
.method public final a(I[BII)V
    ...
    iget-object v1, p0, Lcom/kwad/sdk/pngencrypt/d;->bbl:[B
    ...
    iget-object p1, p0, Lcom/kwad/sdk/pngencrypt/d;->bbi:Lcom/kwad/sdk/pngencrypt/DeflatedChunksSet;

    invoke-virtual {p1, p2, p3, p4}, Lcom/kwad/sdk/pngencrypt/DeflatedChunksSet;->b([BII)V

    iget-boolean p1, p0, Lcom/kwad/sdk/pngencrypt/d;->bbj:Z

    if-eqz p1, :cond_1

    invoke-virtual {p0}, Lcom/kwad/sdk/pngencrypt/ChunkReader;->Qk()Lcom/kwad/sdk/pngencrypt/chunk/d;

    move-result-object p1

    iget-object p1, p1, Lcom/kwad/sdk/pngencrypt/chunk/d;->data:[B

    iget v0, p0, Lcom/kwad/sdk/pngencrypt/ChunkReader;->baB:I
