...
# instance fields
.field private arA:Ljava/util/Queue;
...
.field private ary:Lcom/kwad/framework/filedownloader/a$a;

.field private arz:Lcom/kwad/framework/filedownloader/a$c;
...
.method public constructor <init>(Lcom/kwad/framework/filedownloader/a$a;Lcom/kwad/framework/filedownloader/a$c;)V
    ...
    iput-boolean v0, p0, Lcom/kwad/framework/filedownloader/k;->arB:Z
...
.method private a(Lcom/kwad/framework/filedownloader/a$a;Lcom/kwad/framework/filedownloader/a$c;)V
    ...
    iput-object p1, p0, Lcom/kwad/framework/filedownloader/k;->ary:Lcom/kwad/framework/filedownloader/a$a;

    iput-object p2, p0, Lcom/kwad/framework/filedownloader/k;->arz:Lcom/kwad/framework/filedownloader/a$c;

    new-instance p1, Ljava/util/concurrent/LinkedBlockingQueue;

    invoke-direct {p1}, Ljava/util/concurrent/LinkedBlockingQueue;-><init>()V

    iput-object p1, p0, Lcom/kwad/framework/filedownloader/k;->arA:Ljava/util/Queue;
...
.method private bQ(I)V
    ...
    invoke-static {p1}, Lcom/kwad/framework/filedownloader/d/d;->ct(I)Z

    move-result p1

    if-eqz p1, :cond_1

    iget-object p1, p0, Lcom/kwad/framework/filedownloader/k;->arA:Ljava/util/Queue;
    ...
    iget-object v1, p0, Lcom/kwad/framework/filedownloader/k;->arA:Ljava/util/Queue;
...
.method private o(Lcom/kwad/framework/filedownloader/message/MessageSnapshot;)V
    ...
    iget-object v2, p0, Lcom/kwad/framework/filedownloader/k;->ary:Lcom/kwad/framework/filedownloader/a$a;
    ...
    :cond_0
    iget-object v0, p0, Lcom/kwad/framework/filedownloader/k;->arz:Lcom/kwad/framework/filedownloader/a$c;

    invoke-interface {v0}, Lcom/kwad/framework/filedownloader/a$c;->yY()V
...
.method private p(Lcom/kwad/framework/filedownloader/message/MessageSnapshot;)V
    ...
    iget-object v0, p0, Lcom/kwad/framework/filedownloader/k;->ary:Lcom/kwad/framework/filedownloader/a$a;
    ...
    :cond_1
    iget-boolean v1, p0, Lcom/kwad/framework/filedownloader/k;->arB:Z
    ...
    invoke-interface {v0}, Lcom/kwad/framework/filedownloader/a;->yE()Lcom/kwad/framework/filedownloader/i;
    ...
    :cond_2
    iget-object v0, p0, Lcom/kwad/framework/filedownloader/k;->arA:Ljava/util/Queue;

    invoke-interface {v0, p1}, Ljava/util/Queue;->offer(Ljava/lang/Object;)Z

    invoke-static {}, Lcom/kwad/framework/filedownloader/j;->zp()Lcom/kwad/framework/filedownloader/j;
    ...
    invoke-interface {v0}, Lcom/kwad/framework/filedownloader/a$a;->yW()Z
    ...
    invoke-direct {p0, p1}, Lcom/kwad/framework/filedownloader/k;->bQ(I)V
...
.method public final i(Lcom/kwad/framework/filedownloader/message/MessageSnapshot;)V
    ...
    invoke-interface {v0}, Lcom/kwad/framework/filedownloader/a;->yF()J
    ...
    invoke-interface {v0}, Lcom/kwad/framework/filedownloader/a;->yG()J
...
.method public final k(Lcom/kwad/framework/filedownloader/message/MessageSnapshot;)V
    ...
    iget-object v3, p0, Lcom/kwad/framework/filedownloader/k;->ary:Lcom/kwad/framework/filedownloader/a$a;
    ...
    invoke-interface {v0}, Lcom/kwad/framework/filedownloader/a;->yL()I
    ...
    invoke-interface {v0}, Lcom/kwad/framework/filedownloader/a;->yJ()Ljava/lang/Throwable;
...
.method public final m(Lcom/kwad/framework/filedownloader/message/MessageSnapshot;)V
    ...
    iget-object v1, p0, Lcom/kwad/framework/filedownloader/k;->ary:Lcom/kwad/framework/filedownloader/a$a;
    ...
    invoke-interface {v1}, Lcom/kwad/framework/filedownloader/a;->yJ()Ljava/lang/Throwable;
...
.method public final zs()Z
    ...
    iget-object v2, p0, Lcom/kwad/framework/filedownloader/k;->arA:Ljava/util/Queue;
...
.method public final zt()V
    ...
    iget-boolean v0, p0, Lcom/kwad/framework/filedownloader/k;->arB:Z
    ...
    invoke-interface {v0}, Lcom/kwad/framework/filedownloader/message/c;->yH()B
    ...
    :cond_1
    invoke-interface {v2}, Lcom/kwad/framework/filedownloader/a$a;->yP()Lcom/kwad/framework/filedownloader/a;

    move-result-object v4

    invoke-interface {v4}, Lcom/kwad/framework/filedownloader/a;->yE()Lcom/kwad/framework/filedownloader/i;

    move-result-object v3

    invoke-interface {v2}, Lcom/kwad/framework/filedownloader/a$a;->yQ()Lcom/kwad/framework/filedownloader/x$a;

    move-result-object v2

    invoke-direct {p0, v1}, Lcom/kwad/framework/filedownloader/k;->bQ(I)V
    ...
    invoke-interface {v0}, Lcom/kwad/framework/filedownloader/message/a;->AJ()Lcom/kwad/framework/filedownloader/message/MessageSnapshot;
    ...
    invoke-virtual {v0}, Lcom/kwad/framework/filedownloader/message/MessageSnapshot;->AP()Ljava/lang/Throwable;

    invoke-virtual {v0}, Lcom/kwad/framework/filedownloader/message/MessageSnapshot;->yL()I

    invoke-virtual {v0}, Lcom/kwad/framework/filedownloader/message/MessageSnapshot;->AO()J
    ...
    invoke-virtual {v0}, Lcom/kwad/framework/filedownloader/message/MessageSnapshot;->AK()I
    ...
    invoke-virtual {v0}, Lcom/kwad/framework/filedownloader/message/MessageSnapshot;->AC()Z

    invoke-virtual {v0}, Lcom/kwad/framework/filedownloader/message/MessageSnapshot;->AM()J
...
.method public final zu()Z
    ...
    invoke-interface {v0}, Lcom/kwad/framework/filedownloader/a;->yM()Z
