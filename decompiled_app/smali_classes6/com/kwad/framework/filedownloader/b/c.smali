...
# instance fields
.field private final asd:Lcom/kwad/framework/filedownloader/b/b;

.field private final ase:Lcom/kwad/framework/filedownloader/b/d;

.field private final asf:J

.field private volatile asg:Ljava/util/List;
...
.field private ash:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/kwad/framework/filedownloader/b/c;->asg:Ljava/util/List;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>()V

    iput-object v0, p0, Lcom/kwad/framework/filedownloader/b/c;->ash:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance v0, Lcom/kwad/framework/filedownloader/b/b;

    invoke-direct {v0}, Lcom/kwad/framework/filedownloader/b/b;-><init>()V

    iput-object v0, p0, Lcom/kwad/framework/filedownloader/b/c;->asd:Lcom/kwad/framework/filedownloader/b/b;

    new-instance v0, Lcom/kwad/framework/filedownloader/b/d;

    invoke-direct {v0}, Lcom/kwad/framework/filedownloader/b/d;-><init>()V

    iput-object v0, p0, Lcom/kwad/framework/filedownloader/b/c;->ase:Lcom/kwad/framework/filedownloader/b/d;

    invoke-static {}, Lcom/kwad/framework/filedownloader/f/e;->Bz()Lcom/kwad/framework/filedownloader/f/e;

    move-result-object v0

    iget-wide v0, v0, Lcom/kwad/framework/filedownloader/f/e;->auZ:J

    iput-wide v0, p0, Lcom/kwad/framework/filedownloader/b/c;->asf:J
...
.method public static synthetic a(Lcom/kwad/framework/filedownloader/b/c;)Ljava/lang/Thread;
    .locals 0

    iget-object p0, p0, Lcom/kwad/framework/filedownloader/b/c;->asi:Ljava/lang/Thread;

    return-object p0
.end method

.method public static synthetic a(Lcom/kwad/framework/filedownloader/b/c;Ljava/lang/Thread;)Ljava/lang/Thread;
    .locals 0

    const/4 p1, 0x0

    iput-object p1, p0, Lcom/kwad/framework/filedownloader/b/c;->asi:Ljava/lang/Thread;

    return-object p1
.end method

.method public static synthetic a(Lcom/kwad/framework/filedownloader/b/c;I)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/kwad/framework/filedownloader/b/c;->cd(I)V

    return-void
.end method

.method public static synthetic b(Lcom/kwad/framework/filedownloader/b/c;)Ljava/util/concurrent/atomic/AtomicInteger;
    .locals 0

    iget-object p0, p0, Lcom/kwad/framework/filedownloader/b/c;->ash:Ljava/util/concurrent/atomic/AtomicInteger;

    return-object p0
.end method

.method public static synthetic c(Lcom/kwad/framework/filedownloader/b/c;)Ljava/util/List;
    .locals 0

    iget-object p0, p0, Lcom/kwad/framework/filedownloader/b/c;->asg:Ljava/util/List;
...
.method private cd(I)V
    ...
    iget-object v0, p0, Lcom/kwad/framework/filedownloader/b/c;->ase:Lcom/kwad/framework/filedownloader/b/d;

    iget-object v1, p0, Lcom/kwad/framework/filedownloader/b/c;->asd:Lcom/kwad/framework/filedownloader/b/b;

    invoke-virtual {v1, p1}, Lcom/kwad/framework/filedownloader/b/b;->bY(I)Lcom/kwad/framework/filedownloader/d/c;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/kwad/framework/filedownloader/b/d;->b(Lcom/kwad/framework/filedownloader/d/c;)V

    iget-object v0, p0, Lcom/kwad/framework/filedownloader/b/c;->asd:Lcom/kwad/framework/filedownloader/b/b;

    invoke-virtual {v0, p1}, Lcom/kwad/framework/filedownloader/b/b;->bZ(I)Ljava/util/List;

    move-result-object v0

    iget-object v1, p0, Lcom/kwad/framework/filedownloader/b/c;->ase:Lcom/kwad/framework/filedownloader/b/d;

    invoke-virtual {v1, p1}, Lcom/kwad/framework/filedownloader/b/d;->ca(I)V
...
.method private ce(I)Z
    ...
    iget-object v0, p0, Lcom/kwad/framework/filedownloader/b/c;->asg:Ljava/util/List;
...
.method private cf(I)V
    ...
    iget-object v0, p0, Lcom/kwad/framework/filedownloader/b/c;->ash:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public final a(IIJ)V
    ...
    invoke-direct {p0, p1}, Lcom/kwad/framework/filedownloader/b/c;->ce(I)Z
...
.method public final a(ILjava/lang/String;JJI)V
    ...
    iget-object v1, v0, Lcom/kwad/framework/filedownloader/b/c;->asd:Lcom/kwad/framework/filedownloader/b/b;
    ...
    :cond_0
    iget-object v2, v0, Lcom/kwad/framework/filedownloader/b/c;->ase:Lcom/kwad/framework/filedownloader/b/d;
...
.method public final a(ILjava/lang/Throwable;J)V
    ...
    invoke-direct {p0, p1}, Lcom/kwad/framework/filedownloader/b/c;->cf(I)V
    ...
    iget-object p2, p0, Lcom/kwad/framework/filedownloader/b/c;->asg:Ljava/util/List;
...
.method public final a(Lcom/kwad/framework/filedownloader/d/a;)V
    ...
    invoke-direct {p0, v0}, Lcom/kwad/framework/filedownloader/b/c;->ce(I)Z
...
.method public final bX(I)V
    ...
    iget-wide v1, p0, Lcom/kwad/framework/filedownloader/b/c;->asf:J
...
.method public final bY(I)Lcom/kwad/framework/filedownloader/d/c;
    ...
    invoke-virtual {v0, p1}, Lcom/kwad/framework/filedownloader/b/b;->bY(I)Lcom/kwad/framework/filedownloader/d/c;
...
.method public final c(IJ)V
    ...
    iput-object v0, p0, Lcom/kwad/framework/filedownloader/b/c;->asi:Ljava/lang/Thread;
...
.method public final ca(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/kwad/framework/filedownloader/b/b;->ca(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/kwad/framework/filedownloader/b/d;->ca(I)V
...
.method public final cb(I)Z
    ...
    invoke-virtual {v0, p1}, Lcom/kwad/framework/filedownloader/b/d;->cb(I)Z

    iget-object v0, p0, Lcom/kwad/framework/filedownloader/b/c;->asd:Lcom/kwad/framework/filedownloader/b/b;

    invoke-virtual {v0, p1}, Lcom/kwad/framework/filedownloader/b/b;->cb(I)Z
...
.method public final cc(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/kwad/framework/filedownloader/b/b;->cc(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/kwad/framework/filedownloader/b/d;->cc(I)V
...
.method public final v(II)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/kwad/framework/filedownloader/b/b;->v(II)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/kwad/framework/filedownloader/b/d;->v(II)V
...
.method public final zR()Lcom/kwad/framework/filedownloader/b/a$a;
    ...
    iget-object v2, v1, Lcom/kwad/framework/filedownloader/b/b;->asa:Landroid/util/SparseArray;

    iget-object v1, v1, Lcom/kwad/framework/filedownloader/b/b;->asb:Landroid/util/SparseArray;
