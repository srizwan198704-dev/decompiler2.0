...
# static fields
.field private static volatile auU:Ljava/util/concurrent/ThreadPoolExecutor;
...
.method private static Bv()Z
    ...
    invoke-interface {v0}, Lcom/kwad/sdk/service/a/h;->Bv()Z
...
.method private static Bw()Ljava/util/concurrent/ThreadPoolExecutor;
    .locals 10

    sget-object v0, Lcom/kwad/framework/filedownloader/f/b;->auU:Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    :try_start_0
    sget-object v1, Lcom/kwad/framework/filedownloader/f/b;->auU:Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    sput-object v1, Lcom/kwad/framework/filedownloader/f/b;->auU:Ljava/util/concurrent/ThreadPoolExecutor;
...
.method public static a(ILjava/util/concurrent/LinkedBlockingQueue;Ljava/lang/String;)Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    invoke-static {}, Lcom/kwad/framework/filedownloader/f/b;->Bv()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {}, Lcom/kwad/framework/filedownloader/f/b;->Bw()Ljava/util/concurrent/ThreadPoolExecutor;
...
.method public static v(ILjava/lang/String;)Ljava/util/concurrent/ThreadPoolExecutor;
    .locals 1
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
