...
# instance fields
.field private auN:Landroid/util/SparseArray;
...
.field private auO:Ljava/util/concurrent/ThreadPoolExecutor;
...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Lcom/kwad/framework/filedownloader/services/h;->auN:Landroid/util/SparseArray;

    const-string v0, "Network"

    iput-object v0, p0, Lcom/kwad/framework/filedownloader/services/h;->auP:Ljava/lang/String;

    const/4 v1, 0x0

    iput v1, p0, Lcom/kwad/framework/filedownloader/services/h;->auR:I

    invoke-static {p1, v0}, Lcom/kwad/framework/filedownloader/f/b;->v(ILjava/lang/String;)Ljava/util/concurrent/ThreadPoolExecutor;

    move-result-object v0

    iput-object v0, p0, Lcom/kwad/framework/filedownloader/services/h;->auO:Ljava/util/concurrent/ThreadPoolExecutor;

    iput p1, p0, Lcom/kwad/framework/filedownloader/services/h;->auQ:I
...
.method private declared-synchronized Br()V
    ...
    iget-object v1, p0, Lcom/kwad/framework/filedownloader/services/h;->auN:Landroid/util/SparseArray;
    ...
    iget-object v3, p0, Lcom/kwad/framework/filedownloader/services/h;->auN:Landroid/util/SparseArray;

    invoke-virtual {v3, v2}, Landroid/util/SparseArray;->keyAt(I)I

    move-result v3

    iget-object v4, p0, Lcom/kwad/framework/filedownloader/services/h;->auN:Landroid/util/SparseArray;
...
# virtual methods
.method public final declared-synchronized Bs()I
    .locals 1

    monitor-enter p0

    :try_start_0
    invoke-direct {p0}, Lcom/kwad/framework/filedownloader/services/h;->Br()V

    iget-object v0, p0, Lcom/kwad/framework/filedownloader/services/h;->auN:Landroid/util/SparseArray;
...
.method public final declared-synchronized Bt()Ljava/util/List;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    :goto_0
    iget-object v2, p0, Lcom/kwad/framework/filedownloader/services/h;->auN:Landroid/util/SparseArray;
...
.method public final a(Lcom/kwad/framework/filedownloader/download/DownloadLaunchRunnable;)V
    ...
    invoke-virtual {p1}, Lcom/kwad/framework/filedownloader/download/DownloadLaunchRunnable;->Ak()V
    ...
    iget-object v0, p0, Lcom/kwad/framework/filedownloader/services/h;->auO:Ljava/util/concurrent/ThreadPoolExecutor;

    invoke-virtual {v0, p1}, Ljava/util/concurrent/ThreadPoolExecutor;->execute(Ljava/lang/Runnable;)V

    iget p1, p0, Lcom/kwad/framework/filedownloader/services/h;->auR:I
    ...
    iput p1, p0, Lcom/kwad/framework/filedownloader/services/h;->auR:I
...
.method public final cancel(I)V
    ...
    iget-object v1, p0, Lcom/kwad/framework/filedownloader/services/h;->auO:Ljava/util/concurrent/ThreadPoolExecutor;
...
.method public final declared-synchronized cl(I)Z
    ...
    :try_start_0
    invoke-virtual {p0}, Lcom/kwad/framework/filedownloader/services/h;->Bs()I
    ...
    :cond_0
    :try_start_1
    invoke-static {p1}, Lcom/kwad/framework/filedownloader/f/e;->cz(I)I
    ...
    iget v4, p0, Lcom/kwad/framework/filedownloader/services/h;->auQ:I
    ...
    invoke-static {p1, v3}, Lcom/kwad/framework/filedownloader/f/b;->v(ILjava/lang/String;)Ljava/util/concurrent/ThreadPoolExecutor;

    move-result-object v3

    iput-object v3, p0, Lcom/kwad/framework/filedownloader/services/h;->auO:Ljava/util/concurrent/ThreadPoolExecutor;
...
.method public final p(Ljava/lang/String;I)I
    ...
    invoke-virtual {v3}, Lcom/kwad/framework/filedownloader/download/DownloadLaunchRunnable;->Ap()Ljava/lang/String;
