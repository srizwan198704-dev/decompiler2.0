...
.field final asu:Lcom/kwad/framework/filedownloader/d/b;

.field private asv:Lcom/kwad/framework/filedownloader/download/a;
...
.field private asy:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.method private constructor <init>(Lcom/kwad/framework/filedownloader/download/a;ILjava/lang/String;Ljava/lang/String;Lcom/kwad/framework/filedownloader/d/b;)V
    ...
    iput p2, p0, Lcom/kwad/framework/filedownloader/download/ConnectTask;->ast:I

    iput-object p3, p0, Lcom/kwad/framework/filedownloader/download/ConnectTask;->url:Ljava/lang/String;

    iput-object p4, p0, Lcom/kwad/framework/filedownloader/download/ConnectTask;->asw:Ljava/lang/String;

    iput-object p5, p0, Lcom/kwad/framework/filedownloader/download/ConnectTask;->asu:Lcom/kwad/framework/filedownloader/d/b;

    iput-object p1, p0, Lcom/kwad/framework/filedownloader/download/ConnectTask;->asv:Lcom/kwad/framework/filedownloader/download/a;
...
.method private a(Lcom/kwad/framework/filedownloader/a/b;)V
    ...
    iget-object v0, p0, Lcom/kwad/framework/filedownloader/download/ConnectTask;->asu:Lcom/kwad/framework/filedownloader/d/b;

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Lcom/kwad/framework/filedownloader/d/b;->AW()Ljava/util/HashMap;
    ...
    iget v2, p0, Lcom/kwad/framework/filedownloader/download/ConnectTask;->ast:I
...
.method private b(Lcom/kwad/framework/filedownloader/a/b;)V
    ...
    iget-object v0, p0, Lcom/kwad/framework/filedownloader/download/ConnectTask;->asw:Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/kwad/framework/filedownloader/download/ConnectTask;->asw:Ljava/lang/String;

    invoke-interface {p1, v0, v1}, Lcom/kwad/framework/filedownloader/a/b;->addHeader(Ljava/lang/String;Ljava/lang/String;)V

    :cond_0
    iget-object v0, p0, Lcom/kwad/framework/filedownloader/download/ConnectTask;->asv:Lcom/kwad/framework/filedownloader/download/a;

    iget-wide v1, v0, Lcom/kwad/framework/filedownloader/download/a;->asD:J
    ...
    iget-wide v2, v0, Lcom/kwad/framework/filedownloader/download/a;->asC:J
    ...
    iget-wide v2, v0, Lcom/kwad/framework/filedownloader/download/a;->asD:J
...
.method private c(Lcom/kwad/framework/filedownloader/a/b;)V
    ...
    :cond_0
    invoke-static {}, Lcom/kwad/framework/filedownloader/f/f;->BF()Ljava/lang/String;
...
.method public final getRequestHeader()Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/kwad/framework/filedownloader/download/ConnectTask;->asx:Ljava/util/Map;

    return-object v0
.end method

.method public final zV()Lcom/kwad/framework/filedownloader/a/b;
    .locals 4
    ...
    invoke-interface {v0}, Lcom/kwad/framework/filedownloader/a/b;->zO()Ljava/util/Map;

    move-result-object v1

    iput-object v1, p0, Lcom/kwad/framework/filedownloader/download/ConnectTask;->asx:Ljava/util/Map;
    ...
    iget-object v3, p0, Lcom/kwad/framework/filedownloader/download/ConnectTask;->asx:Ljava/util/Map;
    ...
    iput-object v1, p0, Lcom/kwad/framework/filedownloader/download/ConnectTask;->asy:Ljava/util/List;

    iget-object v2, p0, Lcom/kwad/framework/filedownloader/download/ConnectTask;->asx:Ljava/util/Map;
...
.method public final zX()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/kwad/framework/filedownloader/download/ConnectTask;->asy:Ljava/util/List;
...
.method public final zY()Lcom/kwad/framework/filedownloader/download/a;
    .locals 1
