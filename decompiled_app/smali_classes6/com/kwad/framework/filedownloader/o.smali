...
# static fields
.field private static arF:Ljava/lang/Class;
...
.field private arH:Lcom/kwad/framework/filedownloader/services/e;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/kwad/framework/filedownloader/o;->arG:Ljava/util/ArrayList;
...
.method private a(Landroid/content/Context;Ljava/lang/Runnable;)V
    ...
    invoke-static {}, Lcom/kwad/framework/filedownloader/o;->zB()Ljava/lang/Class;
...
.method private static zB()Ljava/lang/Class;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    sget-object v0, Lcom/kwad/framework/filedownloader/o;->arF:Ljava/lang/Class;

    if-nez v0, :cond_0

    const-class v0, Lcom/kwad/sdk/api/proxy/app/FileDownloadService$SharedMainProcessService;

    sput-object v0, Lcom/kwad/framework/filedownloader/o;->arF:Ljava/lang/Class;
...
.method public final a(Lcom/kwad/framework/filedownloader/services/e;)V
    ...
    iput-object p1, p0, Lcom/kwad/framework/filedownloader/o;->arH:Lcom/kwad/framework/filedownloader/services/e;

    iget-object p1, p0, Lcom/kwad/framework/filedownloader/o;->arG:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Lcom/kwad/framework/filedownloader/o;->arG:Ljava/util/ArrayList;
...
.method public final a(Ljava/lang/String;Ljava/lang/String;ZIIIZLcom/kwad/framework/filedownloader/d/b;Z)Z
    ...
    iget-object v1, v0, Lcom/kwad/framework/filedownloader/o;->arH:Lcom/kwad/framework/filedownloader/services/e;
...
.method public final bR(I)Z
    ...
    :cond_0
    iget-object v0, p0, Lcom/kwad/framework/filedownloader/o;->arH:Lcom/kwad/framework/filedownloader/services/e;

    invoke-virtual {v0, p1}, Lcom/kwad/framework/filedownloader/services/e;->bR(I)Z
...
.method public final bS(I)B
    ...
    invoke-virtual {v0, p1}, Lcom/kwad/framework/filedownloader/services/e;->bS(I)B
...
.method public final bT(I)Z
    ...
    invoke-virtual {v0, p1}, Lcom/kwad/framework/filedownloader/services/e;->bT(I)Z
...
.method public final onDisconnected()V
    ...
    iput-object v0, p0, Lcom/kwad/framework/filedownloader/o;->arH:Lcom/kwad/framework/filedownloader/services/e;
