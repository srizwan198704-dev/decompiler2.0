.class public Lcom/huawei/openalliance/ad/utils/aa;
...
.method private static Code(Landroid/content/Context;Landroid/graphics/Bitmap;FF)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1}, Lcom/huawei/openalliance/ad/utils/aa;->Code(Landroid/renderscript/BaseObj;)V

    invoke-static {v0}, Lcom/huawei/openalliance/ad/utils/aa;->Code(Landroid/renderscript/BaseObj;)V

    invoke-static {p3}, Lcom/huawei/openalliance/ad/utils/aa;->Code(Landroid/renderscript/BaseObj;)V
    ...
    invoke-static {v2, p2}, Lcom/huawei/hms/ads/fh;->I(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_5

    invoke-static {v1}, Lcom/huawei/openalliance/ad/utils/aa;->Code(Landroid/renderscript/BaseObj;)V

    invoke-static {p0}, Lcom/huawei/openalliance/ad/utils/aa;->Code(Landroid/renderscript/BaseObj;)V
...
.method public static Code(Landroid/content/Context;Landroid/graphics/drawable/Drawable;FF)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p1, p2, p3}, Lcom/huawei/openalliance/ad/utils/aa;->Code(Landroid/content/Context;Landroid/graphics/Bitmap;FF)Landroid/graphics/Bitmap;

    move-result-object p1

    invoke-static {p0, p1}, Lcom/huawei/openalliance/ad/utils/aa;->Code(Landroid/content/Context;Landroid/graphics/Bitmap;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0, p0, p1}, Lcom/huawei/hms/ads/fh;->Code(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
